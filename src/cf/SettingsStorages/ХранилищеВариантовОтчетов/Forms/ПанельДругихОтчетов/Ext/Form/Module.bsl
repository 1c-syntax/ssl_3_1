...
Функция ДоступныеВариантыОтчетов()
	...
	|	ВариантыОтчетов.Отчет КАК СсылкаОтчета,
	...
	ДоступныеВариантыОтчетов = Запрос.Выполнить().Выгрузить();
	ДоступныеВариантыОтчетов.Колонки.СсылкаОтчета.Имя = "Отчет";
	
	Возврат ДоступныеВариантыОтчетов;
