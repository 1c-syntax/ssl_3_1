...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, Параметры, "НастройкиОтчета, СвойстваЗаголовка");
	...
	КомпоновщикНастроек.ЗагрузитьНастройки(НастройкиОтчета.СвойстваРезультата.ИтоговыеНастройки);
...
Процедура ЗаполнитьЗначения()
	...
	Если ТипЗнч(СвойстваЗаголовка.Расшифровка) = Тип("ИдентификаторРасшифровкиКомпоновкиДанных") Тогда 
		...
		ЗначениеЯчейки = ЗначениеЯчейки(СвойстваЗаголовка, ДанныеРасшифровки);
	...
	Для НомерСтроки = СвойстваЗаголовка.Низ + 1 По Документ.ВысотаТаблицы Цикл 
		...
		ЗначениеЯчейки = ЗначениеЯчейки(Ячейка, ДанныеРасшифровки);
...
//
&НаСервере
Функция ЗначениеЯчейки(Ячейка, ДанныеРасшифровки)
...
Процедура ДополнитьЗначенияИзКэша()
	...
	Если ЗначениеФильтра <> Неопределено Тогда 
		...
		ЗначенияФильтра = ОтчетыКлиентСервер.ЗначенияСписком(ЗначениеФильтра);
		ОтчетыКлиентСервер.ДополнитьСписок(Значения, ЗначенияФильтра);
		Возврат;
