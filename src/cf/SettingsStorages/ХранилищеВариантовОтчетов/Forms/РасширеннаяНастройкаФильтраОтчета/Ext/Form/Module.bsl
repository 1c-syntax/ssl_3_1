...
Процедура ИнициализироватьДанныеФормы()
	...
	УстановитьЛевоеЗначение(СвойстваЗаголовка.Поле, ОписаниеФильтра);
...
&НаСервере
Процедура УстановитьЛевоеЗначение(Поле, ОписаниеФильтра)
	
	Если ОписаниеФильтра = Неопределено Тогда 
		ПредставлениеЛевогоЗначения = Строка(Поле);
	Иначе
		ПредставлениеЛевогоЗначения = ОписаниеФильтра.Заголовок;
	КонецЕсли;
	...
	Для НомерЭлемента = 1 По 2 Цикл 
		...
		ЭтотОбъект[ИмяЭлемента] = ПредставлениеЛевогоЗначения;
...
Процедура УстановитьПравоеЗначение(ОписаниеФильтра)
	...
	Если Параметры.Свойство("ПравоеЗначение")
		И ЗначениеЗаполнено(Параметры.ПравоеЗначение) Тогда 
		
		ПравоеЗначение1 = Параметры.ПравоеЗначение;
	КонецЕсли;
