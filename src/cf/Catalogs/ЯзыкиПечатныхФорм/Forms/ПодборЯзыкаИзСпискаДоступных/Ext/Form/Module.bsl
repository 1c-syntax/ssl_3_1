...
Функция ВыбранныеЯзыки()
	...
	Для Каждого ВыделеннаяСтрока Из Элементы.Список.ВыделенныеСтроки Цикл
		Результат.Добавить(Новый Структура("Код,Наименование", Список.НайтиПоИдентификатору(ВыделеннаяСтрока).Код, Список.НайтиПоИдентификатору(ВыделеннаяСтрока).Наименование));
	КонецЦикла;
...
&НаКлиенте
Процедура УстановитьОтбор(Текст = Неопределено);
	...
	Элементы.Список.ОтборСтрок = Новый ФиксированнаяСтруктура(СтруктураОтбора);
