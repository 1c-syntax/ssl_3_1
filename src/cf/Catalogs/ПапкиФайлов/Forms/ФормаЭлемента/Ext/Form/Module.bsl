...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект)
	...
	ТекущийОбъект.ДополнительныеСвойства.Вставить("РабочийКаталог", ЭтотОбъект.РабочийКаталог);
...
Функция РабочийКаталогВладельцаОчисткаНаСервере(Ссылка, РодительСсылка, Наименование)
