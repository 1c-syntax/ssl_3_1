...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект)
	...
	ТекущийОбъект.ДополнительныеСвойства.Вставить("РабочийКаталог", РабочийКаталог);
...
Процедура РабочийКаталогВладельцаОчистка(Элемент, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	РабочийКаталог = РабочийКаталогВладельцаОчисткаНаСервере(Объект.Ссылка, Объект.Родитель, Объект.Наименование);
...
Функция РабочийКаталогВладельцаОчисткаНаСервере(Знач Ссылка, Знач РодительСсылка, Знач Наименование)
