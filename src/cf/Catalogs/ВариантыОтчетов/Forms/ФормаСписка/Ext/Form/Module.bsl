...
Функция ТекстЗапросаПредставленияНаДругихЯзыкахВТабличнойЧасти()
	...
	|		ИЛИ ВариантыОтчетов.ПредопределенныйВариант В (НЕОПРЕДЕЛЕНО,
	...
	|		КОГДА &ЭтоОсновнойЯзык
	|			ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(ЕСТЬNULL(ВариантыКонфигурации.Наименование, ВариантыРасширений.Наименование),
	|				ВариантыОтчетов.Наименование) КАК СТРОКА(150))
	...
	|			ВариантыОтчетов.Описание) КАК СТРОКА(1000))
	|	КОНЕЦ КАК Описание,
	|	ВЫБОР
	...
	|		И СведенияОРасширениях.Идентификатор = ВариантыОтчетов.Отчет
	|ГДЕ
