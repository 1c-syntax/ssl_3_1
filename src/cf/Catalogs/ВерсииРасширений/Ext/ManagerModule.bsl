...
//
Функция УстановленныеРасширения() Экспорт
	...
	УстановленныеРасширения.Вставить("ОсновныеСостояние", КонтрольныеСуммыРасширений(Основные, Истина));
	УстановленныеРасширения.Вставить("ИсправленияСостояние", КонтрольныеСуммыРасширений(Исправления, Истина));
...
//
Функция КонтрольныеСуммыРасширений(Расширения, УчитыватьСостояниеРасширений = Ложь)
	
	Список = Новый СписокЗначений;
	
	Для Каждого Расширение Из Расширения Цикл
		КонтрольнаяСумма = Расширение.Имя + " (" + Расширение.Версия + ") " + Base64Строка(Расширение.ХешСумма);
		Если УчитыватьСостояниеРасширений Тогда 
		...
		Попытка
			...
			Иначе
				...
				Если Выборка.Следующий() И Выборка.Количество() = 1 Тогда
					...
					// АПК:143-выкл - требуется ТекущаяДата(), так как именно она устанавливается в поле НачалоСеанса.
