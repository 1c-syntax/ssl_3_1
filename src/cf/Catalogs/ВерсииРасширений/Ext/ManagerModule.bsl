...
//     * Расширения - Структура со свойствами:
//          * Добавлено - Число
//          * Удалено   - Число
//          * Изменено  - Число
//          * СписокНовых - Массив из Строка
//     * Исправления - Структура со свойствами:
//          * Добавлено - Число
//          * Удалено   - Число
//          * Изменено  - Число
//          * СписокНовых - Массив из Строка
...
Функция ДинамическиИзмененныеРасширения() Экспорт
	...
	Если ПараметрыСеанса.УстановленныеРасширения.Свойство("РасширенияНедоступны") Тогда
...
Функция ИзмененияВСоставеРасширений(ТекущийСостав, НовыйСостав)
	...
	Для Каждого Расширение Из СтрРазделить(НовыйСостав, Символы.ПС) Цикл
		...
		СоответствиеНовых.Вставить(ИмяИХеш[0], ИмяИХеш[1]);
	КонецЦикла;
	...
	Для Каждого Расширение Из СтрРазделить(ТекущийСостав, Символы.ПС) Цикл
		...
		КонецЕсли;
		ИмяИХеш = СтрРазделить(Расширение, " ");
		СоответствиеТекущих.Вставить(ИмяИХеш[0], ИмяИХеш[1]);
	КонецЦикла;
