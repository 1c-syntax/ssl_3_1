...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)   
	...
	Если Объект.ТелефонCДобавочнымНомером И Объект.ВводитьНомерПоМаске Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр(
			...
			, "ТелефонCДобавочнымНомером", "Объект", Отказ);
	КонецЕсли;
...
&НаКлиенте
Процедура ТелефонCДобавочнымНомеромПриИзменении(Элемент) 
...
Процедура ОбновитьДоступностьЭлементовТелефонаФакса(Форма)
	...
	Форма.Элементы.МаскаПриВводеНомераТелефона.Доступность = (НЕ Форма.Объект.ТелефонCДобавочнымНомером И НЕ Форма.Объект.ВидРедактирования = "Диалог") ИЛИ Форма.Объект.ВводитьНомерПоМаске;
    Форма.Элементы.ТелефонCДобавочнымНомером.Доступность = НЕ Форма.Объект.ВводитьНомерПоМаске ИЛИ Форма.Объект.ТелефонCДобавочнымНомером;
