...
//  СтарыеЗначения - Структура
//
Процедура ЗарегистрироватьИзменениеРолейПрофилей(Объект, СтарыеЗначения) Экспорт
	...
	Иначе
		...
		МетаданныеРоли = ОбщегоНазначения.ОбъектМетаданныхПоИдентификатору(Объект.Ссылка, Ложь);
