...
Процедура ИспользуетсяВКонтекстеДругихИзмеренийАдресацииПриИзменении(Элемент)
	...
	Если Не Объект.ИспользуетсяСОбъектамиАдресации Тогда
		Объект.ТипыОсновногоОбъектаАдресации = Неопределено;
		Объект.ТипыДополнительногоОбъектаАдресации = Неопределено;
	КонецЕсли;
