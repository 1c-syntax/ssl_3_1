...
Функция ЗагрузитьДоверенностиВИнформационнуюБазу(ЗагруженныеФайлы) Экспорт
	...
	ПредыдущиеДоверенности = Новый Соответствие;
	...
	Для Каждого Элемент Из ФайлыДоверенностей Цикл
		...
		Доверенности.Добавить(Доверенность);
		ПредыдущиеДоверенности.Вставить(Доверенность, ПредыдущаяДоверенность);
	...
	Результат.Вставить("ПредыдущиеДоверенности", ПредыдущиеДоверенности);
