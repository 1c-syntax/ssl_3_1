...
//
Функция ФайлыДоверенностейИПодписей(ФайлыДляОбработки, УникальныйИдентификатор = Неопределено)
		...
		Если НРег(Файл.Расширение) = ".zip" Тогда
			...
			Для Каждого ФайлИзАрхива Из ФайлыИзАрхива Цикл
				...
				Если ЭтоИмяФайлаДоверенности(Файл.Имя) Тогда
					НайденФайлДоверенности = Истина;
				КонецЕсли;
			КонецЦикла;
			
			Если Не НайденФайлДоверенности Тогда
				ИсправитьИменаФайловИзАрхива(ОписанияФайлов);
			КонецЕсли;
...
Процедура ИсправитьИменаФайловИзАрхива(ОписанияФайлов)
