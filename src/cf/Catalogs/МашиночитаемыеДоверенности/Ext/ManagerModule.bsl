...
Функция РеквизитыДолжностногоЛица(СведенияОДолжностномЛице, ДляПечатнойФормы = Истина)
...
Функция РеквизитыФизическогоЛицаДоверителя(СведенияОФизическомЛицеДоверителе)
	...
	РеквизитыФизическогоЛица = РеквизитыФизическогоЛица(СведенияОФизическомЛицеДоверителе.СведФЛ);
...
Процедура ВывестиДоверенность(ТабличныйДокумент, Макет, Доверенность)
	...
	ВывестиСведенияОДоверителях(ТабличныйДокумент, Макет, Доверенность.СвДоверит);
...
Процедура ВывестиСведенияОДоверителях(ТабличныйДокумент, Макет, СведенияОДоверителях, ДляПередоверия = Ложь)
	
	Для Каждого СведенияОДоверителе Из СведенияОДоверителях Цикл
		
		ТипДоверителя = СведенияОДоверителе.ТипДоверит;
		
		Если ДляПередоверия Тогда
