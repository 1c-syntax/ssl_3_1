...
Функция ПечатьДоверенности(Доверенности, ОбъектыПечати, КодЯзыка)
	...
	Для Каждого Ссылка Из Доверенности Цикл
		...
		ЭлектронныеПодписи = ЭлектроннаяПодпись.УстановленныеПодписи(ФайлДоверенности);
		...
		Для Каждого Подпись Из ЭлектронныеПодписи Цикл
			...
			Штамп = ЭлектроннаяПодпись.ШтампВизуализацииЭлектроннойПодписи(СертификатКриптографии,
...
//   * ФайлыДоверенностей - Соответствие - файлы доверенностей
...
Процедура ДобавитьРеквизитыНотариальнойДоверенности(Объект, СведенияОНотариальномУдостоверении)
	...
	Объект.РеквизитыНотариальнойДоверенности = Новый ХранилищеЗначения(РеквизитыНотариальнойДоверенности);
