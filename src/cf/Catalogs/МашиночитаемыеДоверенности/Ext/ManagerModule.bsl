...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ru = 'Машиночитаемая доверенность'");
...
Функция ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании) Экспорт
	 ...
	 Если ПравоДоступа("Добавление", Метаданные.Справочники.МашиночитаемыеДоверенности) Тогда
		КомандаСоздатьНаОсновании = КомандыСозданияНаОсновании.Добавить();
		КомандаСоздатьНаОсновании.Менеджер = Метаданные.Справочники.МашиночитаемыеДоверенности.ПолноеИмя();
		КомандаСоздатьНаОсновании.Представление = НСтр("ru = 'Передоверить'");
		КомандаСоздатьНаОсновании.Идентификатор = "Передоверить";
		
		Значение = Новый СписокЗначений;
		Значение.Добавить(Перечисления.ВозможностьПередоверияМЧД.МногократноеПередоверие);
		Значение.Добавить(Перечисления.ВозможностьПередоверияМЧД.ОднократноеПередоверие);
		
		ПодключаемыеКоманды.ДобавитьУсловиеВидимостиКоманды(
			КомандаСоздатьНаОсновании, "ВозможностьПередоверия", Значение, ВидСравненияКомпоновкиДанных.ВСписке);
			
		ПодключаемыеКоманды.ДобавитьУсловиеВидимостиКоманды(
			КомандаСоздатьНаОсновании, "ФайлДоверенности", Справочники.МашиночитаемыеДоверенностиПрисоединенныеФайлы.ПустаяСсылка(), ВидСравненияКомпоновкиДанных.НеРавно);
...
Функция ДанныеДоверенности(Объект)
	...
	КодФормыПоКлассификаторуНалоговойДокументации = "1110415";
	...
	Если ДляНалоговыхОрганов Тогда
		...
		ИдентификаторФайлаДляПредставленияИнтересовВНалоговомОргане = СтрШаблон("%1_%2_%3_%4_%5_%6", 
			Префикс, Получатель, КонечныйПолучатель, Отправитель, ДатаФормирования, ИдентификационныйНомер);
	КонецЕсли;
	...
	Если ДляНалоговыхОрганов Тогда
		ОписаниеДоверенности.ИдФайлНО = ВРег(ИдентификаторФайлаДляПредставленияИнтересовВНалоговомОргане);
	КонецЕсли;
...
Функция СведенияОДоверителеЮридическогоЛица(РеквизитыОрганизации, РеквизитыУправляющихКомпаний, РеквизитыФизическихЛиц, ДляНалоговыхОрганов) // РосОргДоверТип
	...
	СведенияОЮридическомЛице = СведенияОЮридическомЛице(РеквизитыОрганизации, ДляНалоговыхОрганов);
...
Функция СведенияОЕдиноличномИсполнительномОрганеУправляющейКомпании(РеквизитыУправляющейКомпании, РеквизитыФизическихЛиц, ДляНалоговыхОрганов) // СВЮЛ
	...
	СведенияОЮридическомЛице = СведенияОЮридическомЛице(РеквизитыУправляющейКомпании, ДляНалоговыхОрганов);
...
Функция СведенияОПредставителях(Доверенность) // СвУпПредТип
	...
	Для Каждого ОписаниеПредставителя Из ОписанияПредставителей Цикл
		...
		ИначеЕсли РеквизитыПредставителя.ЭтоИностраннаяОрганизация Тогда
			ТипПредставителя = "5";
			СведенияОбИностранномЮридическомЛице = СведенияОбИностранномЮридическомЛице(РеквизитыПредставителя, ДляНалоговыхОрганов);
			Представитель.СведИО = СведенияОбИностранномЮридическомЛице;
		ИначеЕсли РеквизитыПредставителя.ЭтоФилиал Тогда
			ТипПредставителя = "4";
			СведенияОФилиалеЮридическогоЛица = СведенияОЮридическомЛице(РеквизитыПредставителя, ДляНалоговыхОрганов);
		...
		Иначе
			ТипПредставителя = "1";
			СведенияОЮридическомЛице = СведенияОЮридическомЛице(РеквизитыПредставителя, ДляНалоговыхОрганов);
...
Функция СведенияОПолномочияхПредставителей(Объект) // СвПолнТип
	...
	Если Объект.ВозможностьПередоверия = Перечисления.ВозможностьПередоверияМЧД.ОднократноеПередоверие
		Или Объект.ВозможностьПередоверия = Перечисления.ВозможностьПередоверияМЧД.МногократноеПередоверие Тогда
		СведенияОПолномочияхПредставителей.ПрУтрПолн = ?(Объект.ПолномочияУтрачиваютсяПриПередоверии, "2", "1");
	КонецЕсли;
...
Функция СведенияОЮридическомЛице(РеквизитыОрганизации, ДляНалоговыхОрганов) // СвОргТип
	...
	АдресЮридическогоЛица = СведенияОбАдресе(РеквизитыОрганизации.ЮридическийАдресЗначение, ДляНалоговыхОрганов);
...
Функция СведенияОбАдресе(Адрес, ДляНалоговыхОрганов) // АдрТип
	...
	ИдентификаторАдресаПоФИАС = ПоляАдреса.ИдентификаторДома;
	...
	Если Не ДляНалоговыхОрганов И ЗначениеЗаполнено(ИдентификаторАдресаПоФИАС) Тогда
...
Функция СведенияОДоверителеИностранногоЮридическогоЛица(РеквизитыОрганизации, РеквизитыФизическихЛиц, ДляНалоговыхОрганов) // ИнОргДоверТип
	...
	СведенияОбИностранномЮридическомЛице = СведенияОбИностранномЮридическомЛице(РеквизитыОрганизации, ДляНалоговыхОрганов);
...
Функция СведенияОбИностранномЮридическомЛице(РеквизитыОрганизации, ДляНалоговыхОрганов) // СвИнОргТип
	...
	ФактическийАдрес = СведенияОбАдресе(РеквизитыОрганизации.ФактическийАдресЗначение, ДляНалоговыхОрганов);
...
Функция СведенияОФизическомЛице(РеквизитыФизическогоЛица, ДляНалоговыхОрганов) // СведФЛТип
	...
	Если ЗначениеЗаполнено(РеквизитыФизическогоЛица.АдресРегистрацииЗначение) Тогда
		АдресМестаЖительства = СведенияОбАдресе(РеквизитыФизическогоЛица.АдресРегистрацииЗначение, ДляНалоговыхОрганов); 
	КонецЕсли;
...
Функция СведенияОДокументеУдостоверяющемЛичность(РеквизитыФизическогоЛица) // УдЛичнФЛТип
	...
	Если Не РеквизитыФизическогоЛица.Свойство("ДокументВид")
		Или Не ЗначениеЗаполнено(РеквизитыФизическогоЛица.ДокументВид)
		Или РеквизитыФизическогоЛица.ДокументВид = "0" Тогда
		Возврат Неопределено;
	КонецЕсли;
...
Функция ФайлыДоверенностей(Доверенности, ДляНалоговыхОрганов, ПроверятьДоступностьПерсональныхДанных = Ложь) Экспорт
	
	ФайлыДоверенностей = ОбщегоНазначения.ЗначенияРеквизитовОбъектов(Доверенности, "ФайлДоверенности, Ответственный, Доверители, Представители");
	Если ПроверятьДоступностьПерсональныхДанных Тогда
		ТекущийПользователь = Пользователи.ТекущийПользователь();
		ФизическоеЛицо = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ТекущийПользователь, "ФизическоеЛицо");
	КонецЕсли;
	ОписанияФайловДоверенностей = Новый Соответствие;
	
	Для Каждого Доверенность Из Доверенности Цикл
		ФайлыДоверенности = Новый Массив;
		ФайлДоверенности = ФайлыДоверенностей[Доверенность].ФайлДоверенности;
	
		Если ФайлДоверенности.Пустая() Тогда
			ФайлыДоверенностей[Доверенность] = ФайлыДоверенности;
			ОписанияФайловДоверенностей.Вставить(Доверенность, ФайлыДоверенности);
			Продолжить;
		КонецЕсли;
		
		Если ПроверятьДоступностьПерсональныхДанных Тогда
			ПоказыватьПерсональныеДанные = ПоказыватьПерсональныеДанные(ФайлыДоверенностей[Доверенность], ТекущийПользователь, ФизическоеЛицо);
			Если Не ПоказыватьПерсональныеДанные Тогда
				ОписаниеФайла = ОписаниеФайла();
				ОписаниеФайла.ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Для получения файла доверенности %1 обратитесь к ответственному: %2.'"),
					Доверенность,
					ФайлыДоверенностей[Доверенность].Ответственный);
		...
		ПодписиОбъекта = ЭлектроннаяПодпись.ПодписиОбъекта(ФайлДоверенности);
		Для Каждого ФайлПодписи Из ПодписиОбъекта Цикл
			ОписаниеФайла = ОписаниеФайла();
	...
	Возврат ОписанияФайловДоверенностей;
...
Функция ПечатьДоверенности(Доверенности, ОбъектыПечати, КодЯзыка)
	...
	ПроверятьДоступностьПерсональныхДанных = Не Пользователи.ЭтоПолноправныйПользователь() 
		И Не ПравоДоступа("Изменение", Метаданные.Справочники.МашиночитаемыеДоверенности);
	Если ПроверятьДоступностьПерсональныхДанных Тогда 
		ТекущийПользователь = Пользователи.ТекущийПользователь();
		ФизическоеЛицо = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ТекущийПользователь, "ФизическоеЛицо");
	КонецЕсли;
	...
	Для Каждого Ссылка Из Доверенности Цикл
		ФайлДоверенности = ФайлыДоверенностей[Ссылка].ФайлДоверенности;
		Если ФайлДоверенности.Пустая() Тогда
		...
		ПоказыватьПерсональныеДанные = Не ПроверятьДоступностьПерсональныхДанных
			Или ПоказыватьПерсональныеДанные(ФайлыДоверенностей[Ссылка], ТекущийПользователь, ФизическоеЛицо);
		
		Если Доверенность.Документ.Передов = Неопределено Тогда
			ВывестиДоверенность(ТабличныйДокумент, Макет, Доверенность.Документ.Довер, ПоказыватьПерсональныеДанные);
		Иначе
			ВывестиПередоверие(ТабличныйДокумент, Макет, Доверенность.Документ.Передов, ПоказыватьПерсональныеДанные);
		КонецЕсли;
		
		Штампы = ЭлектроннаяПодпись.ШтампыВизуализацииЭлектронныхПодписей(ФайлДоверенности);
...
Функция ПоказыватьПерсональныеДанные(РеквизитыДоверенности, ТекущийПользователь, ФизическоеЛицо = Неопределено) Экспорт
	
	Если РеквизитыДоверенности.Ответственный = ТекущийПользователь Тогда
		Возврат Истина;
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ФизическоеЛицо) Тогда
		Если РеквизитыДоверенности.Доверители.НайтиСтроки(Новый Структура("Доверитель", ФизическоеЛицо)).Количество() > 0 Тогда
			Возврат Истина;
		КонецЕсли;
		Если РеквизитыДоверенности.Представители.НайтиСтроки(Новый Структура("Представитель", ФизическоеЛицо)).Количество() > 0 Тогда
			Возврат Истина;
		КонецЕсли;
	КонецЕсли;
...
Функция РеквизитыЮридическогоЛица(СведенияОЮридическомЛице, ВычислятьЗначенияКонтактнойИнформацииПоПредставлениям = Ложь)
	...
	ЮридическийАдресЗначение = "";
	
	Если ВычислятьЗначенияКонтактнойИнформацииПоПредставлениям Тогда
...
Функция РеквизитыДолжностногоЛица(СведенияОДолжностномЛице, ДляПечатнойФормы, ПоказыватьПерсональныеДанные = Истина)
	...
	РеквизитыФизическогоЛица = РеквизитыФизическогоЛица(СведенияОФизическомЛице, ПоказыватьПерсональныеДанные);
	...
	ОчиститьПерсональныеДанные(Параметры, ПоказыватьПерсональныеДанные);
	
	Если ДляПечатнойФормы Тогда
		Для Каждого Параметр Из Параметры Цикл
			Если Не ЗначениеЗаполнено(Параметр.Значение) Тогда
				Параметры[Параметр.Ключ] = НСтр("ru = '-'");
			КонецЕсли;
		КонецЦикла;
	КонецЕсли;
...
Функция ПерсональныеДанные()
	...
	ПерсональныеДанные.Добавить("ИНН");
	ПерсональныеДанные.Добавить("ИННФЛ");
	ПерсональныеДанные.Добавить("НомерЗаписиЕдиногоРегистраНаселения");
	ПерсональныеДанные.Добавить("СНИЛС");
	ПерсональныеДанные.Добавить("ЭлектроннаяПочта");
	ПерсональныеДанные.Добавить("Телефон");
	ПерсональныеДанные.Добавить("КонтактныйТелефон");
	ПерсональныеДанные.Добавить("Пол");
	ПерсональныеДанные.Добавить("ПризнакНаличияГражданства");
	ПерсональныеДанные.Добавить("ДокументУдостоверяющийЛичность");
	
	Возврат ПерсональныеДанные;
	
КонецФункции

Процедура ОчиститьПерсональныеДанные(Параметры, ПоказыватьПерсональныеДанные)
	
	Если ПоказыватьПерсональныеДанные Тогда
		Возврат;
	КонецЕсли;
	
	ПерсональныеДанные = ПерсональныеДанные();
	Для Каждого Параметр Из Параметры Цикл
		Если Не ЗначениеЗаполнено(Параметры[Параметр.Ключ]) Тогда
			Продолжить;
		ИначеЕсли ПерсональныеДанные.Найти(Параметр.Ключ) <> Неопределено Тогда
			Параметры[Параметр.Ключ] = СтрокаЗаменыПерсональныхДанных();
		КонецЕсли;
	КонецЦикла;

КонецПроцедуры

Функция СтрокаЗаменыПерсональныхДанных()
	Возврат НСтр("ru = '***'");
КонецФункции

Функция РеквизитыФизическогоЛицаДоверителя(СведенияОФизическомЛицеДоверителе, ПоказыватьПерсональныеДанные = Истина)
	
	ИНН = СведенияОФизическомЛицеДоверителе.ИННФЛ;
	СНИЛС = СведенияОФизическомЛицеДоверителе.СНИЛС;
	РеквизитыФизическогоЛица = РеквизитыФизическогоЛица(СведенияОФизическомЛицеДоверителе.СведФЛ, ПоказыватьПерсональныеДанные);
...
Функция РеквизитыФизическогоЛица(СведенияОФизическомЛице, ПоказыватьПерсональныеДанные = Истина)
	...
	ФИО = МашиночитаемыеДоверенностиФНССлужебный.ФИОСтрокой(ФИОДоверителя);
	...
	Если СведенияОДокументеУдостоверяющемЛичность <> Неопределено Тогда
		...
		Иначе
			ДокументУдостоверяющийЛичность = СтрокаЗаменыПерсональныхДанных();
		КонецЕсли;
...
Функция РеквизитыИндивидуальногоПредпринимателя(СведенияОбИндивидуальномПредпринимателе, ПоказыватьПерсональныеДанные = Истина)
...
Функция РеквизитыНотариальногоУдостоверения(СведенияОНотариальномУдостоверении)
	
	ДолжностьНотариуса = СведенияОНотариальномУдостоверении.СвНотДейств.Должность;
	РегистрационныйНомерНотариуса = СведенияОНотариальномУдостоверении.СвНотДейств.РегНомНот;
	ФамилияНотариуса = СведенияОНотариальномУдостоверении.СвНотДейств.ФИОНотДейств.Фамилия;
	ИмяНотариуса = СведенияОНотариальномУдостоверении.СвНотДейств.ФИОНотДейств.Имя;
	ОтчествоНотариуса = СведенияОНотариальномУдостоверении.СвНотДейств.ФИОНотДейств.Отчество;
	ДополнительныеСведенияНотариуса = СведенияОНотариальномУдостоверении.ДопСвНотДовер;
	ИныеСведенияУдостоверительнойНадписи = СведенияОНотариальномУдостоверении.ИнСвУдНадпис;
	
	ФИОНотариуса =  СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = '%1 %2 %3'"),
		ФамилияНотариуса, ИмяНотариуса, ОтчествоНотариуса);
	
	МестоСовершения = СведенияОНотариальномУдостоверении.МестоДовер;
	
	ДолжностьВРИОНотариуса = "";
	РегистрационныйНомерВРИОНотариуса = "";
	ФИОВРИОНотариуса = "";
	
	Если СведенияОНотариальномУдостоверении.ВриоНот <> Неопределено Тогда
		ДолжностьВРИОНотариуса = СведенияОНотариальномУдостоверении.ВриоНот.Должность;
		РегистрационныйНомерВРИОНотариуса = СведенияОНотариальномУдостоверении.ВриоНот.РегНомНот;
		ФамилияВРИОНотариуса = СведенияОНотариальномУдостоверении.ВриоНот.ФИОВриоНот.Фамилия;
		ИмяВРИОНотариуса = СведенияОНотариальномУдостоверении.ВриоНот.ФИОВриоНот.Имя;
		ОтчествоВРИОНотариуса = СведенияОНотариальномУдостоверении.ВриоНот.ФИОВриоНот.Отчество;
		
		ФИОВРИОНотариуса =  СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = '%1 %2 %3'"),
			ФамилияВРИОНотариуса, ИмяВРИОНотариуса, ОтчествоВРИОНотариуса);
	КонецЕсли;
	
	Параметры = Новый Структура;
	Параметры.Вставить("ДолжностьНотариуса", ДолжностьНотариуса);
	Параметры.Вставить("РегистрационныйНомерНотариуса", РегистрационныйНомерНотариуса);
	Параметры.Вставить("ФИОНотариуса", ФИОНотариуса);
	Параметры.Вставить("МестоСовершения", МестоСовершения);
	Параметры.Вставить("ДолжностьВРИОНотариуса", ДолжностьВРИОНотариуса);
	Параметры.Вставить("РегистрационныйНомерВРИОНотариуса", РегистрационныйНомерВРИОНотариуса);
	Параметры.Вставить("ФИОВРИОНотариуса", ФИОВРИОНотариуса);
	Параметры.Вставить("ДополнительныеСведенияНотариуса", ДополнительныеСведенияНотариуса);
	Параметры.Вставить("ИныеСведенияУдостоверительнойНадписи", ИныеСведенияУдостоверительнойНадписи);
...
// Распределяет файлы по группам с целью поиска файлов доверенностей.
//
// Параметры:
...
//   * ПодписиФайлов      - Соответствие - файлы подписей доверенностей
//   * ФайлыПодписей      - Соответствие - другие файлы подписей
//   * ФайлыZIP           - Соответствие - архивы
//   * ДругиеФайлы        - Соответствие - файлы, не относящиеся к доверенностям
//
Функция ФайлыДоверенностейИПодписей(ФайлыДляОбработки, УникальныйИдентификатор = Неопределено) Экспорт
	
	ЗагруженныеФайлы = ОбщегоНазначения.СкопироватьРекурсивно(ФайлыДляОбработки);
	
	Результат = Новый Структура("ФайлыДоверенностей, ФайлыПодписей, ДругиеФайлы, ФайлыZIP, ПодписиФайлов");
	...
	ЗагруженныеФайлыПоДоверенностям = Новый Массив;
	...
	Для Каждого ЗагруженныйФайл Из ЗагруженныеФайлы Цикл
		...
		Если НРег(Файл.Расширение) = ".zip" Тогда
			...
			ФайлыИзАрхива = МашиночитаемыеДоверенностиФНССлужебный.РаспаковатьФайлыИзАрхива(ДвоичныеДанные);
			
			ОписанияФайлов = Новый Массив;
			НайденФайлДоверенности = 0;
			ИмяФайлаДоверенности = "";
			
			Для Каждого ФайлИзАрхива Из ФайлыИзАрхива Цикл
				Файл = Новый Файл(ФайлИзАрхива.Ключ);
				АдресВоВременномХранилище = ПоместитьВоВременноеХранилище(ФайлИзАрхива.Значение, УникальныйИдентификатор);
				
				ОписаниеФайла = Новый Структура;
				ОписаниеФайла.Вставить("ИмяФайла", Файл.Имя);
				ОписаниеФайла.Вставить("Хранение", АдресВоВременномХранилище);
				ОписанияФайлов.Добавить(ОписаниеФайла);
				
				Если ЭтоИмяФайлаДоверенности(Файл.Имя) Тогда
					НайденФайлДоверенности = НайденФайлДоверенности + 1;
					ИмяФайлаДоверенности = Файл.Имя;
				КонецЕсли;
			КонецЦикла;
			
			Если НайденФайлДоверенности = 0 Тогда
				ИсправитьИменаФайловИзАрхива(ОписанияФайлов, НайденФайлДоверенности, ИмяФайлаДоверенности);
			КонецЕсли;
			
			Если НайденФайлДоверенности = 1 Тогда
				Для Каждого ОписаниеФайла Из ОписанияФайлов Цикл
					ОписаниеФайла.Вставить("АрхивДоверенности", ИмяФайлаДоверенности);
				КонецЦикла;
			КонецЕсли;
			
			ОбщегоНазначенияКлиентСервер.ДополнитьМассив(ЗагруженныеФайлы, ОписанияФайлов);
	...
	Для Каждого ЗагруженныйФайл Из ЗагруженныеФайлы Цикл
		Файл = Новый Файл(ЗагруженныйФайл.ИмяФайла);
		Если НРег(Файл.Расширение) = ".xml" И ЭтоФайлДоверенности(ЗагруженныйФайл) Тогда
	...
	Результат.ФайлыДоверенностей = ФайлыДоверенностей;
	Результат.ФайлыПодписей = ФайлыПодписей;
	Результат.ФайлыZIP = ФайлыZIP;
	Результат.ДругиеФайлы = ДругиеФайлы;
	Результат.ПодписиФайлов = ПодписиФайлов;
		
	Возврат Результат;
	
КонецФункции

Процедура ИсправитьИменаФайловИзАрхива(ОписанияФайлов, НайденФайлДоверенности, ИмяФайлаДоверенности)
	
	Если ОписанияФайлов.Количество() <> 2 Тогда
		Возврат;
	КонецЕсли;
	
	ОписаниеФайлаДоверенности = Неопределено;
	ОписаниеФайлаПодписи = Неопределено;

	Для Каждого ОписаниеФайла Из ОписанияФайлов Цикл
		Файл = Новый Файл(ОписаниеФайла.ИмяФайла);

		Если НРег(Файл.Расширение) = ".xml" Тогда
			ОписаниеФайлаДоверенности = ОписаниеФайла;
		ИначеЕсли ЭтоФайлПодписи(Файл.Имя) Тогда
			ОписаниеФайлаПодписи = ОписаниеФайла;
		КонецЕсли;
	КонецЦикла;
	
	Если ОписаниеФайлаДоверенности = Неопределено
		Или ОписаниеФайлаПодписи = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	ДвоичныеДанные = ПолучитьИзВременногоХранилища(ОписаниеФайлаДоверенности.Хранение);
	ДоверенностьXML = ПолучитьСтрокуИзДвоичныхДанных(ДвоичныеДанные);
	
	Попытка
		РезультатЧтения = ПрочитатьИмяФайлаДоверенности(ДоверенностьXML, Ложь);
	Исключение
		Возврат;
	КонецПопытки;
	...
	Если ЗначениеЗаполнено(ИмяФайлаДоверенности) Тогда
		ФайлДоверенности = Новый Файл(ИмяФайлаДоверенности);
		ФайлПодписи = Новый Файл(ОписаниеФайлаПодписи.ИмяФайла);
		
		ОписаниеФайлаДоверенности.ИмяФайла = ИмяФайлаДоверенности;
		ОписаниеФайлаПодписи.ИмяФайла = ФайлДоверенности.ИмяБезРасширения + ФайлПодписи.Расширение;
		НайденФайлДоверенности = НайденФайлДоверенности + 1;
	КонецЕсли;
...
Функция ЭтоИмяФайлаДоверенности(ИмяФайла)
	...
	Возврат НРег(Файл.Расширение) = ".xml" И СтрНачинаетсяС(Файл.Имя, "ON_EMCHD") Или СтрНачинаетсяС(Файл.Имя, "ON_DOVEL");
	
КонецФункции

Функция ЭтоФайлДоверенности(ЗагруженныйФайл)
	...
	Попытка
		Пока ЧтениеXML.Прочитать() Цикл
			Если ЧтениеXML.ТипУзла = ТипУзлаXML.НачалоЭлемента И ЧтениеXML.ЛокальноеИмя = "Доверенность" Тогда
				Если ЧтениеXML.ПолучитьАтрибут("ВерсФорм") = "EMCHD_1" Тогда
					Возврат Истина;
				КонецЕсли;
			КонецЕсли;
		КонецЦикла;
...
Функция ЗагрузитьДоверенностиВИнформационнуюБазу(ЗагруженныеФайлы, Замещать = Ложь) Экспорт
	...
	Если ТипЗнч(ЗагруженныеФайлы) = Тип("Структура") Тогда
		Результат = ЗагруженныеФайлы;
	Иначе
		Результат = ФайлыДоверенностейИПодписей(ЗагруженныеФайлы);
	КонецЕсли;
	
	ФайлыДоверенностей = Результат.ФайлыДоверенностей;
	ПодписиФайлов = Результат.ПодписиФайлов;
	
	Доверенности = Новый Массив;
	ТекстыОшибок = Новый Массив;
	
	Если ФайлыДоверенностей.Количество() = 0 Тогда
		ТекстыОшибок.Добавить(НСтр("ru = 'Не удалось загрузить доверенность - неверный формат.
			|В этот список возможна загрузка доверенностей в формате 003.'"));
	КонецЕсли;
	
	КоличествоПропущенных = 0;
	КоличествоПрочитанных = 0;
	...
	Для Каждого Элемент Из ФайлыДоверенностей Цикл
		...
		Попытка
			...
			КоличествоПрочитанных = КоличествоПрочитанных + 1;
		Исключение
			ИнформацияОбОшибке = ИнформацияОбОшибке();
			ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось прочитать файл %1 по причине:
					|%2'"),
				ИмяФайла,
		...
		Иначе
			...
			Если ЗначениеЗаполнено(Объект.ФайлДоверенности) Тогда
				...
				//@skip-check query-in-loop - штучные запросы в количестве загружаемых доверенностей
				ПометитьНаУдалениеПрисоединенныеФайлы(Доверенность);
			КонецЕсли;
			
			ОбъектМетаданных = Доверенность.Метаданные();
		...
		РезультатПроверкиДоверенности = МашиночитаемыеДоверенностиФНССлужебный.РезультатПроверкиПодписейДоверенности(Объект.Ссылка, 
			Объект.ФайлДоверенности, Неопределено, Истина);
		Если РезультатПроверкиДоверенности.ЕстьВсеПодписи Тогда
			...
			Если Не ЗначениеЗаполнено(РезультатПроверкиДоверенности.ТекстОшибки) Тогда
				ПодписиВерны = Истина;
				Для Каждого Подпись Из РезультатПроверкиДоверенности.РезультатыПроверкиПодписей Цикл
					Если Подпись.ПодписьВерна <> Истина Тогда
						ПодписиВерны = Ложь;
					КонецЕсли;
				КонецЦикла;
				Если ПодписиВерны Тогда
					НачатьТранзакцию();
					Попытка
						Блокировка = Новый БлокировкаДанных;
						ЭлементБлокировки = Блокировка.Добавить("Справочник.МашиночитаемыеДоверенности");
	...
	Если КоличествоПропущенных > 1 Тогда
		Если КоличествоПрочитанных > 0 Тогда
			ТекстОшибки = НСтр("ru = 'Не удалось прочитать некоторые файлы доверенностей.
				|Возможно, файлы повреждены или имеют другой формат.'");
		Иначе
			ТекстОшибки = НСтр("ru = 'Не удалось прочитать файлы доверенностей.
				|Возможно, файлы повреждены или имеют другой формат.'");
		КонецЕсли;
	ИначеЕсли КоличествоПропущенных = 1 Тогда
		Если КоличествоПрочитанных > 0 Тогда 
			ТекстОшибки = НСтр("ru = 'Не удалось прочитать один из файлов доверенностей.
				|Возможно, файл поврежден или имеет другой формат.'");
		Иначе
			ТекстОшибки = НСтр("ru = 'Не удалось прочитать файл доверенности.
				|Возможно, файл поврежден или имеет другой формат.'");
		КонецЕсли;
	КонецЕсли;
	...
	ТекстОшибки = СтрСоединить(ТекстыОшибок, Символы.ПС + Символы.ПС);
...
Процедура ПометитьНаУдалениеПрисоединенныеФайлы(Доверенность)
	
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	МашиночитаемыеДоверенностиПрисоединенныеФайлы.Ссылка КАК Ссылка
	|ИЗ
	|	Справочник.МашиночитаемыеДоверенностиПрисоединенныеФайлы КАК МашиночитаемыеДоверенностиПрисоединенныеФайлы
	|ГДЕ
	|	МашиночитаемыеДоверенностиПрисоединенныеФайлы.ВладелецФайла = &ВладелецФайла
	|	И НЕ МашиночитаемыеДоверенностиПрисоединенныеФайлы.ПометкаУдаления;";
	
	Запрос.УстановитьПараметр("ВладелецФайла", Доверенность);
...
Функция РеквизитыДоверенностиИзФайла(ЗагруженныйФайл) Экспорт
	
	Результат = ФайлыДоверенностейИПодписей(ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ЗагруженныйФайл));
	
	ФайлыДоверенностей = Результат.ФайлыДоверенностей;
	
	Если ФайлыДоверенностей.Количество() = 0 Тогда
		ТекстОшибки = НСтр("ru = 'Не удалось прочитать доверенность - неверный формат.
			|Ожидался файл доверенности в формате 003.'");
		Возврат ТекстОшибки;
	КонецЕсли;
	...
	Для Каждого Элемент Из ФайлыДоверенностей Цикл
		...
		Результат = Новый Структура;
		Результат.Вставить("Ссылка", ?(ЗначениеЗаполнено(Доверенность), Доверенность, Неопределено));
		Результат.Вставить("Наименование", ?(ЗначениеЗаполнено(Доверенность), Объект.Наименование, АвтоНаименование(Объект)));
		Результат.Вставить("ДатаВыдачи", Объект.ДатаВыдачи);
		Результат.Вставить("ДатаОкончания", Объект.ДатаОкончания);
		Результат.Вставить("НомерДоверенности", Объект.НомерДоверенности);
		Результат.Вставить("Полномочия",  Объект.Полномочия.Выгрузить().Скопировать(,"Код, Мнемокод, Наименование"));
		
		МассивДоверителей = Новый Массив;
		Доверители = Объект.Доверители.Выгрузить();
		...
		Для Каждого СтрокаОрганизация Из Найдено Цикл
			...
			Если РеквизитыОрганизации.ЭтоФизическоеЛицо Тогда
				МассивДоверителей.Добавить(Новый Структура("Организация, ОрганизацияПредставитель, ФизическоеЛицо",
					Неопределено, Неопределено, РеквизитыОрганизации));
			Иначе

				НайденоПредставителиОрганизации = Доверители.НайтиСтроки(Новый Структура("ИдентификаторРодителя",
					СтрокаОрганизация.Идентификатор));

				Если НайденоПредставителиОрганизации.Количество() = 0 Тогда
					МассивДоверителей.Добавить(
								Новый Структура("Организация, ОрганизацияПредставитель, ФизическоеЛицо",
						РеквизитыОрганизации, Неопределено, Неопределено));
				Иначе
					Для Каждого СтрокаПредставительОрганизации Из НайденоПредставителиОрганизации Цикл
						РеквизитыПредставителяОрганизации = СтрокаПредставительОрганизации.ДоверительРеквизиты.Получить();

						Если РеквизитыПредставителяОрганизации.ЭтоФизическоеЛицо Тогда
							МассивДоверителей.Добавить(
								Новый Структура("Организация, ОрганизацияПредставитель, ФизическоеЛицо",
								РеквизитыОрганизации, Неопределено, РеквизитыПредставителяОрганизации));
						Иначе
							НайденоФизическиеЛица = Доверители.НайтиСтроки(Новый Структура("ИдентификаторРодителя",
								СтрокаПредставительОрганизации.Идентификатор));
							Если НайденоФизическиеЛица.Количество() = 0 Тогда
								МассивДоверителей.Добавить(
									Новый Структура("Организация, ОрганизацияПредставитель, ФизическоеЛицо",
									РеквизитыОрганизации, РеквизитыПредставителяОрганизации, Неопределено));
							...
							Иначе
								Для Каждого СтрокаФизическоеЛицо Из НайденоФизическиеЛица Цикл
									...
									МассивДоверителей.Добавить(
										Новый Структура("Организация, ОрганизацияПредставитель, ФизическоеЛицо",
										РеквизитыОрганизации, РеквизитыПредставителяОрганизации,
		...
		Результат.Вставить("Доверители", МассивДоверителей);
		
		МассивПредставителей = Новый Массив;
		Представители = Объект.Представители.Выгрузить();
		...
		Для Каждого СтрокаОрганизация Из Найдено Цикл
			...
			Если РеквизитыОрганизации.ЭтоФизическоеЛицо Тогда
				МассивПредставителей.Добавить(Новый Структура("Организация, ФизическоеЛицо", Неопределено,
			...
			Иначе
				...
				НайденоФизическиеЛица = Представители.НайтиСтроки(Новый Структура("ИдентификаторРодителя",
					СтрокаОрганизация.Идентификатор));
				Если НайденоФизическиеЛица.Количество() = 0 Тогда
					МассивПредставителей.Добавить(Новый Структура("Организация, ФизическоеЛицо", РеквизитыОрганизации,
						Неопределено));
				Иначе
					Для Каждого СтрокаФизическоеЛицо Из НайденоФизическиеЛица Цикл
						РеквизитыФизическогоЛица = СтрокаФизическоеЛицо.ПредставительРеквизиты.Получить();
						МассивПредставителей.Добавить(Новый Структура("Организация, ФизическоеЛицо",
							РеквизитыОрганизации, РеквизитыФизическогоЛица));
					КонецЦикла;
				КонецЕсли;
			КонецЕсли;
		...
		Результат.Вставить("Представители", МассивПредставителей);
...
Функция СвойстваДоверенностейИзФайлов(ЗагруженныеФайлы, УникальныйИдентификатор) Экспорт
	...
	ФайлыДоверенностейИПодписей = ФайлыДоверенностейИПодписей(ЗагруженныеФайлы, УникальныйИдентификатор);
	...
	Для Каждого Элемент Из ФайлыДоверенностейИПодписей.ФайлыДоверенностей Цикл
		...
		Если Доверенность = Неопределено Тогда
			...
			Доверенность = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = '%1 - %2 (будет загружена)'"),
				АвтоНаименование(Объект), ЕдиныйРегистрационныйНомер);
			...
			Для Каждого СтрокаОрганизация Из Найдено Цикл
				...
				Если РеквизитыОрганизации.ЭтоФизическоеЛицо Тогда
					Если ЗначениеЗаполнено(РеквизитыОрганизации.ИННФЛ) Тогда
						ИННПредставителей.Добавить(РеквизитыОрганизации.ИННФЛ);
					КонецЕсли;
				Иначе
					
					Если ЗначениеЗаполнено(РеквизитыОрганизации.ИНН) Тогда
						ИННПредставителей.Добавить(РеквизитыОрганизации.ИНН);
					КонецЕсли;
					...
					Для Каждого СтрокаФизическоеЛицо Из НайденоФизическиеЛица Цикл
						Если ЗначениеЗаполнено(СтрокаФизическоеЛицо.ИННФЛ) Тогда
							ИННПредставителей.Добавить(СтрокаФизическоеЛицо.ИННФЛ);
						КонецЕсли;
					КонецЦикла;
				КонецЕсли;
		...
		СвойстваДоверенности.Вставить("ИмяФайла", ИмяФайла);
		СвойстваДоверенности.Вставить("АдресФайла", АдресФайла);
		СвойстваДоверенности.Вставить("МашиночитаемаяДоверенность", Доверенность);
		СвойстваДоверенности.Вставить("НомерДоверенности", ЕдиныйРегистрационныйНомер);
		СвойстваДоверенности.Вставить("ПоляОтбора", СтрСоединить(ИННПредставителей, ";"));
		
		ФайлыДоверенности = Новый Массив;
		ФайлыДоверенности.Добавить(Элемент.Ключ);
		
		ДругиеФайлы.Вставить(ИмяФайла, Истина);
		Для Каждого ДополнительныйФайл Из Элемент.Значение Цикл
			ДругиеФайлы.Вставить(ДополнительныйФайл.ИмяФайла, Истина);
			ФайлыДоверенности.Добавить(ДополнительныйФайл);
		КонецЦикла;
		
		ПодписиФайлов = ФайлыДоверенностейИПодписей.ПодписиФайлов.Получить(Элемент.Ключ);
		Если ПодписиФайлов <> Неопределено Тогда
			Для Каждого Подпись Из ПодписиФайлов Цикл
				ДругиеФайлы.Вставить(Подпись.ИмяФайла, Истина);
				ФайлыДоверенности.Добавить(Подпись);
			КонецЦикла;
		КонецЕсли;
		
		СвойстваДоверенности.Вставить("ФайлыДоверенности", ПоместитьВоВременноеХранилище(ФайлыДоверенности, УникальныйИдентификатор));
		Доверенности.Добавить(СвойстваДоверенности);
		
	КонецЦикла;
	
	Для Каждого КлючИЗначение Из ФайлыДоверенностейИПодписей.ФайлыZIP Цикл
		ДругиеФайлы.Вставить(КлючИЗначение.Ключ.ИмяФайла, Истина);

		ПодписиФайлов = ФайлыДоверенностейИПодписей.ПодписиФайлов.Получить(КлючИЗначение.Ключ);
		Если ПодписиФайлов <> Неопределено Тогда
			Для Каждого Подпись Из ПодписиФайлов Цикл
				ДругиеФайлы.Вставить(Подпись.ИмяФайла, Истина);
			КонецЦикла;
	...
	Результат.Вставить("ДругиеФайлы", ДругиеФайлы);
...
Процедура СгруппироватьФайлыПоДоверенностям(ФайлыДоверенностей, ДругиеФайлы)
	...
	Для Каждого Элемент Из ДругиеФайлы Цикл
		...
		Для Каждого ГруппаФайлов Из ФайлыДоверенностей Цикл
			...
			Если ЗагруженныйФайл.Свойство("АрхивДоверенности") <> ФайлДоверенности.Свойство("АрхивДоверенности") Тогда
				Продолжить;
			КонецЕсли;
			
			Файл = Новый Файл(ФайлДоверенности.ИмяФайла);
			Если СтрНайти(ЗагруженныйФайл.ИмяФайла, Файл.ИмяБезРасширения) 
				Или ЗагруженныйФайл.Свойство("АрхивДоверенности") И ЗагруженныйФайл.АрхивДоверенности = ФайлДоверенности.АрхивДоверенности Тогда
...
Функция ПодписиФайлов(ЗагруженныеФайлы, ФайлыПодписей)
	...
	Для Каждого ЗагруженныйФайл Из ЗагруженныеФайлы Цикл
		...
		Для Каждого Элемент Из ФайлыПодписей Цикл
			...
			Если ЗагруженныйФайл.Свойство("АрхивДоверенности") <> ФайлПодписи.Свойство("АрхивДоверенности") Тогда
				Продолжить;
			КонецЕсли;
			...
			Если СтрНачинаетсяС(ФайлПодписи.ИмяФайла, Файл.ИмяБезРасширения) Тогда
				...
				Если ЗагруженныйФайл.Свойство("АрхивДоверенности") И ЗагруженныйФайл.АрхивДоверенности <> ФайлПодписи.АрхивДоверенности Тогда
					Продолжить;
				КонецЕсли;
...
Процедура ДобавитьПодписи(Файл, ПодписиФайла, Доверенность) Экспорт
...
Процедура ДобавитьДополнительныеФайлы(Доверенность, ДополнительныеФайлы, ПодписиФайлов)
	...
	Для Каждого ЗагруженныйФайл Из ДополнительныеФайлы Цикл
		...
		ПодписиФайла = ПодписиФайлов[ЗагруженныйФайл];
		Если ПодписиФайла = Неопределено Тогда
			Продолжить;
		КонецЕсли;
...
Функция ДобавитьПрисоединенныйФайл(Владелец, ИмяФайла, АдресФайла) Экспорт
...
Процедура ЗаполнитьДоверенность(Объект, ОписаниеДоверенности)
	...
	Объект.Нотариальная = Сред(ФлагОбязательностиЭлементов, 3, 1) = "1";
	...
	Если Объект.Нотариальная Тогда
		ДобавитьРеквизитыНотариальнойДоверенности(Объект, ОписаниеДоверенности.Документ.Довер.СвНотУд);
		Объект.НомерВРеестреНотариальныхДействий = ОписаниеДоверенности.Документ.Довер.СвДов.НомРНДДовер;
	КонецЕсли;
	...
	Для Каждого СведенияОПредставителе Из СведенияОПредставителях Цикл
		...
		ИначеЕсли ТипПредставителя = "4" Тогда
			...
			СведенияОФизическомЛицеФилиала = Представитель.СведФизЛ;
			Филиал = ДобавитьФилиалПредставителя(Объект, Неопределено, СведенияОФилиалеЮридическогоЛица);
			Если СведенияОФизическомЛицеФилиала <> Неопределено Тогда
				ДобавитьФизическоеЛицоПредставителя(Объект, Филиал.Идентификатор, СведенияОФизическомЛицеФилиала);
			КонецЕсли;
	...
	ПризнакУтратыПолномочийПриПередоверии = СведенияОПолномочияхПредставителей.ПрУтрПолн;
	...
	Объект.ПолномочияУтрачиваютсяПриПередоверии = ПризнакУтратыПолномочийПриПередоверии = "2";
	
	Если ТипПолномочия = "0" Тогда
		Объект.ПолномочияВТекстовомВиде = Истина;
		Объект.ТекстПолномочий = ТекстовоеСодержаниеПолномочия;
...
Функция ДобавитьОрганизациюДоверителя(Объект, СвязаннаяОрганизация, СведенияОЮридическомЛице)
	...
	Параметры = РеквизитыЮридическогоЛица(СведенияОЮридическомЛице, Истина);
	...
	Доверитель.ДоверительРеквизиты = Новый ХранилищеЗначения(РеквизитыУчастника, Новый СжатиеДанных(9));
...
Функция ДобавитьОрганизациюПредставителя(Объект, СвязаннаяОрганизация, СведенияОЮридическомЛице)
	...
	Представитель.ПредставительРеквизиты = Новый ХранилищеЗначения(РеквизитыУчастника, Новый СжатиеДанных(9));
...
Функция ДобавитьФилиалПредставителя(Объект, СвязаннаяОрганизация, СведенияОЮридическомЛице)
	
	Параметры = РеквизитыЮридическогоЛица(СведенияОЮридическомЛице, Истина);
	
	РеквизитыУчастника = МашиночитаемыеДоверенностиФНССлужебныйКлиентСервер.РеквизитыУчастника(
		ТипЭлементаОрганизация(), Неопределено, ВидУчастникаФилиал());
...
Процедура ДобавитьДолжностноеЛицоДоверителя(Объект, СвязаннаяОрганизация, СведенияОДолжностномЛице)
	...
	Параметры = РеквизитыДолжностногоЛица(СведенияОДолжностномЛице, Ложь);
...
Функция ДобавитьФизическоеЛицоПредставителя(Объект, ИдентификаторРодителя, СведенияОФизическомЛицеДоверителе)
	...
	Если ИдентификаторРодителя = Неопределено Тогда
		Представитель.ИдентификаторРодителя = Новый УникальныйИдентификатор("00000000-0000-0000-0000-000000000000");
	Иначе
		Представитель.ИдентификаторРодителя = ИдентификаторРодителя;
	КонецЕсли;
...
Функция ДобавитьИндивидуальногоПредпринимателяДоверителя(Объект, СвязаннаяОрганизация, СведенияОбИндивидуальномПредпринимателе)
	...
	Параметры = РеквизитыИндивидуальногоПредпринимателя(СведенияОбИндивидуальномПредпринимателе, Истина);
	...
	ДоверительОрганизация.ДоверительРеквизиты = Новый ХранилищеЗначения(РеквизитыУчастника, Новый СжатиеДанных(9));
	...
	ДоверительФизическоеЛицо.ДоверительРеквизиты = Новый ХранилищеЗначения(РеквизитыУчастника, Новый СжатиеДанных(9));
...
Процедура ДобавитьРеквизитыНотариальнойДоверенности(Объект, СведенияОНотариальномУдостоверении)
	
	РеквизитыНотариальнойДоверенности = МашиночитаемыеДоверенностиФНССлужебный.РеквизитыНотариальнойДоверенности();
	РеквизитыНотариальнойДоверенности.МестоСовершения = СведенияОНотариальномУдостоверении.МестоДовер;
	РеквизитыНотариуса = МашиночитаемыеДоверенностиФНССлужебный.РеквизитыНотариуса();
	РеквизитыНотариуса.Должность = СведенияОНотариальномУдостоверении.СвНотДейств.Должность;
	РеквизитыНотариуса.РегистрационныйНомер = СведенияОНотариальномУдостоверении.СвНотДейств.РегНомНот;
	РеквизитыНотариуса.Фамилия = СведенияОНотариальномУдостоверении.СвНотДейств.ФИОНотДейств.Фамилия;
	РеквизитыНотариуса.Имя = СведенияОНотариальномУдостоверении.СвНотДейств.ФИОНотДейств.Имя;
	РеквизитыНотариуса.Отчество = СведенияОНотариальномУдостоверении.СвНотДейств.ФИОНотДейств.Отчество;
	РеквизитыНотариальнойДоверенности.Нотариус = РеквизитыНотариуса;
	Если СведенияОНотариальномУдостоверении.ВриоНот <> Неопределено Тогда
		РеквизитыНотариуса = МашиночитаемыеДоверенностиФНССлужебный.РеквизитыНотариуса();
		РеквизитыНотариуса.Должность = СведенияОНотариальномУдостоверении.ВриоНот.Должность;
		РеквизитыНотариуса.РегистрационныйНомер = СведенияОНотариальномУдостоверении.ВриоНот.РегНомНот;
		РеквизитыНотариуса.Фамилия = СведенияОНотариальномУдостоверении.ВриоНот.ФИОВриоНот.Фамилия;
		РеквизитыНотариуса.Имя = СведенияОНотариальномУдостоверении.ВриоНот.ФИОВриоНот.Имя;
		РеквизитыНотариуса.Отчество = СведенияОНотариальномУдостоверении.ВриоНот.ФИОВриоНот.Отчество;
		РеквизитыНотариальнойДоверенности.ИсполняющийОбязанностиНотариуса = РеквизитыНотариуса;
	КонецЕсли;
	
	Объект.РеквизитыНотариальнойДоверенности = Новый ХранилищеЗначения(РеквизитыНотариальнойДоверенности, Новый СжатиеДанных(9));
...
Функция АвтоНаименование(Объект) Экспорт
	...
	Если ЗначениеЗаполнено(Объект.РодительскаяДоверенность) Или ЗначениеЗаполнено(
		Объект.РодительскаяДоверенностьНомер) Тогда

		Если ЗначениеЗаполнено(Объект.РодительскаяДоверенностьНомер) И ЗначениеЗаполнено(Объект.ФайлДоверенности) Тогда
			...
			Если ТипЗнч(Доверители) = Тип("Массив") И Доверители.Количество() > 0 Тогда
				Если Доверители[0].ЭтоФизическоеЛицо Тогда
					НаименованиеОрганизацияДоверитель = Доверители[0].ФИО;
				Иначе
					НаименованиеОрганизацияДоверитель = Доверители[0].НаименованиеПолное;
				КонецЕсли;
			КонецЕсли;
			
		КонецЕсли;
		
		Если НаименованиеОрганизацияДоверитель = "" И ЗначениеЗаполнено(Объект.РодительскаяДоверенность) Тогда
			...
			Если Доверители.Количество() > 0 Тогда
				...
				Иначе
					НаименованиеОрганизацияДоверитель = СтрШаблон("%1 %2 %3", РеквизитыДоверителя.Фамилия,
	...
	Для Каждого Строка Из Объект.Доверители Цикл
		...
		Если РеквизитыДоверителя = Неопределено Тогда
			Продолжить;
		КонецЕсли;
...
Функция КонтактнаяИнформацияПоПредставлению(Представление, ТипКонтактнойИнформации)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.КонтактнаяИнформация") И ЗначениеЗаполнено(Представление) Тогда
...
// Возвращаемое значение:
//  СправочникСсылка.МашиночитаемыеДоверенности
//
Функция НайтиДоверенность(ЕдиныйРегистрационныйНомер) Экспорт
	
	НайденныеДоверенности = НайтиДоверенности(ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ЕдиныйРегистрационныйНомер));
	Возврат НайденныеДоверенности[ЕдиныйРегистрационныйНомер];
	
КонецФункции

Функция НайтиДоверенности(НомераДоверенностей)
	
	НомераДляПоиска = Новый Массив;
	
	Для Каждого НомерДоверенности Из НомераДоверенностей Цикл
		НомераДляПоиска.Добавить(НРег(НомерДоверенности));
		НомераДляПоиска.Добавить(ВРег(НомерДоверенности));
	КонецЦикла;
	...
	|ГДЕ
	|	МашиночитаемыеДоверенности.НомерДоверенности В (&НомераДляПоиска)
	|	И НЕ МашиночитаемыеДоверенности.ПометкаУдаления";
	
	Запрос = Новый Запрос(ТекстЗапроса);
	Запрос.УстановитьПараметр("НомераДляПоиска", НомераДляПоиска);
	
	Выборка = Запрос.Выполнить().Выбрать();
	НайденныеДоверенности = Новый Соответствие;
	
	Пока Выборка.Следующий() Цикл
		НайденныеДоверенности.Вставить(НРег(Выборка.НомерДоверенности), Выборка.Ссылка);
		НайденныеДоверенности.Вставить(ВРег(Выборка.НомерДоверенности), Выборка.Ссылка);
	КонецЦикла;
	
	Результат = Новый Соответствие;
	
	Для Каждого НомерДоверенности Из НомераДоверенностей Цикл
		Если НайденныеДоверенности[НомерДоверенности] <> Неопределено Тогда
			Результат.Вставить(НомерДоверенности, НайденныеДоверенности[НомерДоверенности]);
		КонецЕсли;
	КонецЦикла;
...
Функция СведенияОФилиалеЮридическогоЛица(РеквизитыОрганизации, РеквизитыУправляющихКомпаний, РеквизитыФизическихЛиц, ДляНалоговыхОрганов) // ФилПерПолн
	...
	СведенияОФилиалеЮридическогоЛица.СвФил = СведенияОЮридическомЛице(РеквизитыОрганизации, ДляНалоговыхОрганов);
...
Процедура ЗаполнитьПередовериеИзОбъектаXDTO(Объект, ОписаниеДоверенности)
	...
	Если Объект.Нотариальная Тогда
		ДобавитьРеквизитыНотариальнойДоверенности(Объект, ОписаниеДоверенности.Документ.Передов.СвНотУд);
		Объект.НомерВРеестреНотариальныхДействий = ОписаниеДоверенности.Документ.Передов.СвПереДовер.НомРНДДовер;
	КонецЕсли;
	...
	ПризнакУтратыПолномочийПриПередоверии = СведенияОПередаваемыхПолномочиях.ПрУтрПолн;
...
Процедура ВывестиДоверенность(ТабличныйДокумент, Макет, Доверенность, ПоказыватьПерсональныеДанные)
	...
	РегистрационныйНомерДоверенностиВРНД = СведенияОДоверенности.НомРНДДовер;
	СведенияОНотариальномУдостоверении = Доверенность.СвНотУд;
	...
	РеквизитыШапки.Вставить("ДатаВыдачиДоверенности", Формат(Дата(ДатаВыдачиДоверенности), "ДЛФ=D;"));
	РеквизитыШапки.Вставить("СрокДействияДоверенности", ?(СрокДействияДоверенности = Неопределено, "", Формат(Дата(СрокДействияДоверенности), "ДЛФ=D;")));
	РеквизитыШапки.Вставить("ЕдиныйРегистрационныйНомер", ЕдиныйРегистрационныйНомер);
	РеквизитыШапки.Вставить("ПравоПередоверия", ПравоПередоверия);
	РеквизитыШапки.Вставить("ВозможностьОтзыва", ВозможностьОтзыва);
	РеквизитыШапки.Вставить("РегистрационныйНомерДоверенностиВРНД", РегистрационныйНомерДоверенностиВРНД);
	
	ВывестиОбласть(ТабличныйДокумент, Макет, "ШапкаДоверенности", РеквизитыШапки);
	ВывестиОбласть(ТабличныйДокумент, Макет, "ШапкаДоверителей", РеквизитыШапки);
	ВывестиСведенияОДоверителях(ТабличныйДокумент, Макет, Доверенность.СвДоверит, ПоказыватьПерсональныеДанные);
	ВывестиОтступ(ТабличныйДокумент, Макет);
	ВывестиОбласть(ТабличныйДокумент, Макет, "ШапкаПредставителей", РеквизитыШапки);
	...
	Для Каждого СведенияОПредставителе Из СведенияОПредставителях Цикл
		...
		ИначеЕсли ТипПредставителя = "2" Тогда
			СведенияОбИндивидуальномПредпринимателе = Представитель.СведИП;
			Параметры = РеквизитыИндивидуальногоПредпринимателя(СведенияОбИндивидуальномПредпринимателе, ПоказыватьПерсональныеДанные);
		...
		ИначеЕсли ТипПредставителя = "3" Тогда
			СведенияОФизическомЛице = Представитель.СведФизЛ;
			Параметры = РеквизитыДолжностногоЛица(СведенияОФизическомЛице, Истина, ПоказыватьПерсональныеДанные);
		...
		ИначеЕсли ТипПредставителя = "4" Тогда
			...
			ВывестиОбласть(ТабличныйДокумент, Макет, "ЗаголовокСведенийОбОрганизации");
			ВывестиОбласть(ТабличныйДокумент, Макет, "СведенияОФилиале", Параметры);
		ИначеЕсли ТипПредставителя = "5" Тогда
			СведенияОбИностранномЮридическомЛице = Представитель.СведИО;
			Параметры = РеквизитыИностранногоЮридическогоЛица(СведенияОбИностранномЮридическомЛице);
			ВывестиОбласть(ТабличныйДокумент, Макет, "ЗаголовокСведенийОбОрганизации");
	...
	Если ЗначениеЗаполнено(РегистрационныйНомерДоверенностиВРНД) Тогда
		Параметры = РеквизитыНотариальногоУдостоверения(СведенияОНотариальномУдостоверении);
		Параметры.Вставить("РегистрационныйНомерДоверенностиВРНД", РегистрационныйНомерДоверенностиВРНД);
		
		ВывестиСведенияОНотариальномУдостоверении(ТабличныйДокумент, Макет, Параметры);
	КонецЕсли;
	
КонецПроцедуры

Процедура ВывестиСведенияОНотариальномУдостоверении(ТабличныйДокумент, Макет, Параметры)
	
	ВывестиОбласть(ТабличныйДокумент, Макет, "ШапкаРеквизитовНотариуса");
	ВывестиОбласть(ТабличныйДокумент, Макет, "СведенияОНотариусе", Параметры);
	
	Если ЗначениеЗаполнено(Параметры.РегистрационныйНомерВРИОНотариуса) Тогда
		ВывестиОбласть(ТабличныйДокумент, Макет, "СведенияОВРИОНотариуса", Параметры);
	КонецЕсли;
	
	Если ЗначениеЗаполнено(Параметры.ДополнительныеСведенияНотариуса) Тогда
		ВывестиОбласть(ТабличныйДокумент, Макет, "ДополнительныеСведенияНотариуса", Параметры);
	КонецЕсли;
	
	Если ЗначениеЗаполнено(Параметры.ИныеСведенияУдостоверительнойНадписи) Тогда
		ВывестиОбласть(ТабличныйДокумент, Макет, "ИныеСведенияУдостоверительнойНадписи", Параметры);
	КонецЕсли;
	
	ВывестиОбласть(ТабличныйДокумент, Макет, "ПодвалРеквизитовНотариуса", Параметры);
	
КонецПроцедуры

Процедура ВывестиСведенияОДоверителях(ТабличныйДокумент, Макет, СведенияОДоверителях, ПоказыватьПерсональныеДанные)
	...
	Для Каждого СведенияОДоверителе Из СведенияОДоверителях Цикл
		...
		Если ТипДоверителя = "1" Тогда
			...
			Параметры = РеквизитыЮридическогоЛица(СведенияОЮридическомЛице);
			ВывестиОбласть(ТабличныйДокумент, Макет, "ЗаголовокСведенийОбОрганизацииДоверителе");
			ВывестиОбласть(ТабличныйДокумент, Макет, "СведенияОбОрганизации", Параметры);
			...
			Для Каждого СведенияОЛицеДоверителя Из СведенияОЛицахДоверителя Цикл
				...
				Если СведенияОЕдиноличномИсполнительномОрганеУправляющейКомпании <> Неопределено Тогда
					...
					Для Каждого СведенияОДолжностномЛице Из СведенияОДолжностныхЛицах Цикл
						Параметры = РеквизитыДолжностногоЛица(СведенияОДолжностномЛице, Истина, ПоказыватьПерсональныеДанные);
				...
				Если СведенияОЕдиноличномИсполнительномОрганеИндивидуальномПредпринимателе <> Неопределено Тогда
					Параметры = РеквизитыИндивидуальногоПредпринимателя(СведенияОЕдиноличномИсполнительномОрганеИндивидуальномПредпринимателе, ПоказыватьПерсональныеДанные);
					ВывестиОбласть(ТабличныйДокумент, Макет, "ЗаголовокСведенийОбИндивидуальномПредпринимателеУровень2");
					ВывестиОбласть(ТабличныйДокумент, Макет, "СведенияОбИндивидуальномПредпринимателе", Параметры);
				КонецЕсли;
				
				Если СведенияОЛицахДействующихОтИмениЮридическогоЛицаДоверителя <> Неопределено Тогда
					Параметры = РеквизитыДолжностногоЛица(СведенияОЛицахДействующихОтИмениЮридическогоЛицаДоверителя, Истина, ПоказыватьПерсональныеДанные);
		...
		ИначеЕсли ТипДоверителя = "2" Тогда
			...
			Для Каждого СведенияОРуководителеИностранногоЮридическогоЛица Из СведенияОРуководителяхИностранногоЮридическогоЛица Цикл
				Параметры = РеквизитыДолжностногоЛица(СведенияОРуководителеИностранногоЮридическогоЛица, Истина, ПоказыватьПерсональныеДанные);
				ВывестиОбласть(ТабличныйДокумент, Макет, "ЗаголовокЛицаДоверителяУровень2");
				ВывестиОбласть(ТабличныйДокумент, Макет, "СведенияОФизлице", Параметры);
			КонецЦикла;
		...
		ИначеЕсли ТипДоверителя = "4" Тогда
			...
			СведенияОФизическомЛицеДоверителе = Доверитель.ФЛДовер;
			Параметры = РеквизитыФизическогоЛицаДоверителя(СведенияОФизическомЛицеДоверителе, ПоказыватьПерсональныеДанные);
...
Процедура ВывестиПередоверие(ТабличныйДокумент, Макет, Передоверие, ПоказыватьПерсональныеДанные)
	...
	РегистрационныйНомерДоверенностиВРНД = СведенияОДоверенности.НомРНДДовер;
	СведенияОНотариальномУдостоверении = Передоверие.СвНотУд;
	
	НомерДоверенностиОснования = СведенияОПервоначальнойДоверенности.НомДоверПерв;
	ДатаВыдачиДоверенностиОснования = СведенияОПервоначальнойДоверенности.ДатаВыдДовер;
	
	Если СведенияОДоверенностиОснованииПередоверия <> Неопределено Тогда
		НомерДоверенностиОснования = СведенияОДоверенностиОснованииПередоверия.НомДоверN;
		ДатаВыдачиДоверенностиОснования = СведенияОДоверенностиОснованииПередоверия.ДатаВыдДовер;
	КонецЕсли;
	
	ПредставлениеДоверенностиОснования = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = '№ %1 от %2'"),
		НомерДоверенностиОснования,
		Формат(ДатаВыдачиДоверенностиОснования, "ДЛФ=D;"));
	...
	СведенияОДоверителяхПервоначальнойДоверенности = СведенияОПервоначальнойДоверенности.СвДоверПерв;
	Для Каждого СведенияОДоверителе Из СведенияОДоверителяхПервоначальнойДоверенности Цикл
		
		ТипДоверителя = СведенияОДоверителе.ТипДоверит;
		Доверитель = СведенияОДоверителе.ДоверитПерв;
		
		ВывестиОтступ(ТабличныйДокумент, Макет);
		
		Если ТипДоверителя = "1" Тогда
			СведенияОЮридическомЛице = Доверитель.РосОргДовер;
			
			Параметры = РеквизитыЮридическогоЛица(СведенияОЮридическомЛице);
			ВывестиОбласть(ТабличныйДокумент, Макет, "ЗаголовокСведенийОбОрганизацииВладельцеПолномочий");
			ВывестиОбласть(ТабличныйДокумент, Макет, "СведенияОбОрганизации", Параметры);
			
		ИначеЕсли ТипДоверителя = "2" Тогда
			
			СведенияОбИностранномЮридическомЛице = Доверитель.ИнОргДовер;
		...
		ИначеЕсли ТипДоверителя = "3" Тогда
			...
			СведенияОбИндивидуальномПредпринимателе = Доверитель.ИПДовер;
			Параметры = РеквизитыИндивидуальногоПредпринимателя(СведенияОбИндивидуальномПредпринимателе, ПоказыватьПерсональныеДанные);
			ВывестиОбласть(ТабличныйДокумент, Макет, "ЗаголовокСведенийОбИндивидуальномПредпринимателеВладельцеПолномочий");
			ВывестиОбласть(ТабличныйДокумент, Макет, "СведенияОбИндивидуальномПредпринимателе", Параметры);
		...
		ИначеЕсли ТипДоверителя = "4" Тогда
			...
			СведенияОФизическомЛицеДоверителе = Доверитель.ФЛДовер;
			Параметры = РеквизитыФизическогоЛицаДоверителя(СведенияОФизическомЛицеДоверителе, ПоказыватьПерсональныеДанные);
			ВывестиОбласть(ТабличныйДокумент, Макет, "ЗаголовокСведенийОФизическомЛицеВладельцеПолномочий");
			ВывестиОбласть(ТабличныйДокумент, Макет, "СведенияОФизлице", Параметры);
	...
	Для Каждого СведенияОЛицеПередавшемПолномочия Из СведенияОЛицахПередавшихПолномочия Цикл
		...
		Если ТипЛицаПередавшегоПолномочия = "1" Тогда
			...
			Параметры = РеквизитыЮридическогоЛица(СведенияОЮридическомЛице);
			ВывестиОбласть(ТабличныйДокумент, Макет, "ЗаголовокСведенийОбОрганизацииПередавшейПолномочия");
			ВывестиОбласть(ТабличныйДокумент, Макет, "СведенияОбОрганизации", Параметры);
			...
			Для Каждого СведенияОЛицеДоверителя Из СведенияОЛицахДоверителя Цикл
				...
				Если СведенияОЕдиноличномИсполнительномОрганеУправляющейКомпании <> Неопределено Тогда
					...
					Для Каждого СведенияОДолжностномЛице Из СведенияОДолжностныхЛицах Цикл
						Параметры = РеквизитыДолжностногоЛица(СведенияОДолжностномЛице, Истина, ПоказыватьПерсональныеДанные);
						Параметры.Вставить("ПредставлениеДоверенности", ПредставлениеДоверенностиОснования);
						ВывестиОбласть(ТабличныйДокумент, Макет, "ЗаголовокЛицаДоверителяУровень3");
		...
		ИначеЕсли ТипЛицаПередавшегоПолномочия = "2" Тогда
			...
			Параметры = РеквизитыИндивидуальногоПредпринимателя(СведенияОбИндивидуальномПредпринимателе, ПоказыватьПерсональныеДанные);
			Параметры.Вставить("ПредставлениеДоверенности", ПредставлениеДоверенностиОснования);
			ВывестиОбласть(ТабличныйДокумент, Макет, "ЗаголовокСведенийОбИндивидуальномПредпринимателеПередавшемПолномочияУровень1");
			ВывестиОбласть(ТабличныйДокумент, Макет, "СведенияОбИндивидуальномПредпринимателеПоДоверенности", Параметры);
		...
		ИначеЕсли ТипЛицаПередавшегоПолномочия = "3" Тогда
			...
			Параметры = РеквизитыФизическогоЛицаДоверителя(СведенияОФизическомЛицеДоверителе, ПоказыватьПерсональныеДанные);
			Параметры.Вставить("ПредставлениеДоверенности", ПредставлениеДоверенностиОснования);
			ВывестиОбласть(ТабличныйДокумент, Макет, "ЗаголовокЛицаПередавшегоПолномочия");
			ВывестиОбласть(ТабличныйДокумент, Макет, "СведенияОФизлицеПоДоверенности", Параметры);
...
Функция ДоверителиПервоначальнойДоверенностиПоФайлу(ФайлДоверенности) Экспорт
	
	Если ФайлДоверенности.Пустая() Тогда
		Возврат НСтр(
				"ru = 'Данные о первоначальном доверителе не доступны, так как не загружен файл доверенности.'");
	КонецЕсли;

	ПараметрыДанныхФайла = РаботаСФайламиКлиентСервер.ПараметрыДанныхФайла();
	ПараметрыДанныхФайла.ВызыватьИсключение = Ложь;

	ДанныеФайла = РаботаСФайлами.ДанныеФайла(ФайлДоверенности, ПараметрыДанныхФайла);
	ДвоичныеДанные = ПолучитьИзВременногоХранилища(ДанныеФайла.СсылкаНаДвоичныеДанныеФайла);
	Если ДвоичныеДанные = Неопределено И ДанныеФайла.ПометкаУдаления Тогда
		Возврат НСтр(
			"ru = 'Данные о первоначальном доверителе не доступны, так как файл доверенности помечен на удаление.'");
	КонецЕсли;
	ДоверенностьXML = ПолучитьСтрокуИзДвоичныхДанных(ДвоичныеДанные);

	ОписаниеДоверенности = ДоверенностьXDTO(ДоверенностьXML);

	Возврат ДоверителиПервоначальнойДоверенности(ОписаниеДоверенности);

КонецФункции

Функция РеквизитыДоверенностиОснования(ОписаниеДоверенности, ВычислятьЗначенияКонтактнойИнформацииПоПредставлениям = Ложь)
	...
	НомерДоверенностиОснования = СведенияОПервоначальнойДоверенности.НомДоверПерв;
	СведенияОДоверителяхДоверенностиОснования = СведенияОПервоначальнойДоверенности.СвДоверПерв;
	
	Если СведенияОДоверенностиОснованииПередоверия <> Неопределено Тогда
		НомерДоверенностиОснования = СведенияОДоверенностиОснованииПередоверия.НомДоверN;
		СведенияОДоверителяхДоверенностиОснования = СведенияОДоверенностиОснованииПередоверия.СвДоверПерв;
	КонецЕсли;
	...
	Для Каждого СведенияОДоверителе Из СведенияОДоверителяхДоверенностиОснования Цикл
		...
		Если ТипДоверителя = "1" Тогда
			...
			СведенияОЮридическомЛице = Доверитель.РосОргДовер;
			Параметры = РеквизитыЮридическогоЛица(СведенияОЮридическомЛице, ВычислятьЗначенияКонтактнойИнформацииПоПредставлениям);
		...
		Если Параметры <> Неопределено И ЗначениеЗаполнено(Параметры.ИНН) Тогда
			ИННДоверителя = Параметры.ИНН;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	
	Результат = Новый Структура;
	Результат.Вставить("НомерДоверенности", НомерДоверенностиОснования);
	Результат.Вставить("ИННДоверителя", ИННДоверителя);
	
	Возврат Результат;
	
КонецФункции

Функция ДоверителиПервоначальнойДоверенности(ОписаниеДоверенности)
	...
	Для Каждого СведенияОДоверителе Из СведенияОДоверителяхПервоначальнойДоверенности Цикл
		...
		Параметры.Вставить("ЭтоФизическоеЛицо", ТипДоверителя = "4");
		Параметры.Вставить("ЭтоИностраннаяОрганизация", ТипДоверителя = "2");
		Параметры.Вставить("ЭтоИндивидуальныйПредприниматель", ТипДоверителя = "3");
				
		Доверители.Добавить(Параметры);
...
Функция НайтиДубликатыДоверенностейВИнформационнойБазе(ЗагруженныеФайлы) Экспорт
	
	НомераДоверенностейИзФайлов = МашиночитаемыеДоверенностиФНССлужебный.НомераДоверенностейИзФайлов(ЗагруженныеФайлы);
	НайденныеДоверенности = НайтиДоверенности(НомераДоверенностейИзФайлов);
	
	Возврат НайденныеДоверенности;
	
КонецФункции

Функция ОписаниеДоверенности(ДвоичныеДанные) Экспорт
	...
	Исключение
		ИнформацияОбОшибке = ИнформацияОбОшибке();
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось прочитать доверенность по причине:
				|%1'"),
	...
	ЭтоПередоверие = ОписаниеДоверенности.Документ.Довер = Неопределено;
	ПредыдущаяДоверенность = Неопределено;
		
	Если ЭтоПередоверие Тогда
		ПредыдущаяДоверенность = РеквизитыДоверенностиОснования(ОписаниеДоверенности, Истина);
	КонецЕсли;
	
	Результат = Новый Структура;
	Результат.Вставить("ЕдиныйРегистрационныйНомер", ЕдиныйРегистрационныйНомер);
	Результат.Вставить("ПредыдущаяДоверенность", ПредыдущаяДоверенность);
