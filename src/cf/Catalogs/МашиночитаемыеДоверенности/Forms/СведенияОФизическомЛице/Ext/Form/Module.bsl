...
Процедура ПриИзмененииВидаДокумента(Форма)
	...
	Если Не ЗначениеЗаполнено(Форма.ДокументВид) 
		Или Форма.ДокументВид = "0"
		Или Форма.ДокументВид = "91" Тогда
		Форма.ДокументНомер = "";
...
Процедура ВидимостьВидаДокумента(Форма)
	Форма.Элементы.ДокументКодПодразделения.Видимость = Форма.ПоказыватьПерсональныеДанные И Форма.ДокументВид = "21";
