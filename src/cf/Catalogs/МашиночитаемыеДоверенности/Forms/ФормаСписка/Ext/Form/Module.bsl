...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка);
	...
	ЕстьПравоИзменения = ПравоДоступа("Изменение", Метаданные.Справочники.МашиночитаемыеДоверенности);
	Элементы.СписокПолучитьСтатус.Видимость = ЕстьПравоИзменения;
...
Процедура ВыгрузитьВФайл(Команда)
	...
	ПроверятьДоступностьПерсональныхДанных = Не ПользователиКлиент.ЭтоПолноправныйПользователь()
		И Не ЕстьПравоИзменения;
	МашиночитаемыеДоверенностиФНССлужебныйКлиент.ВыгрузитьДоверенностиВФайлы(Элементы.Список.ВыделенныеСтроки, 
		ПроверятьДоступностьПерсональныхДанных);
