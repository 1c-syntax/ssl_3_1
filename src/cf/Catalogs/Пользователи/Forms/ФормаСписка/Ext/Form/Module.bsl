...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВыборУчастниковОбсуждения = Параметры.ВыборУчастниковОбсуждения;
	...
	АдресПользовательБезФотографии = ПоместитьВоВременноеХранилище(БиблиотекаКартинок.ПользовательБезФотографии, 
