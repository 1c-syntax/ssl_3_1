...
Процедура ЗаполнитьПользователейИБ()
	...
	Для Каждого ПользовательИБ Из ВсеПользователиИБ Цикл
		...
		НоваяСтрока.АутентификацияOpenIDConnect  = СвойстваПользовательИБ.АутентификацияOpenIDConnect;
		НоваяСтрока.АутентификацияТокеномДоступа = СвойстваПользовательИБ.АутентификацияТокеномДоступа;
