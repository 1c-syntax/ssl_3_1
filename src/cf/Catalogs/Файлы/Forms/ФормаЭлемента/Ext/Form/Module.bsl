...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ЗначениеЗаполнено(ЗначениеКопирования) Тогда
		...
		Если ТипХраненияФайла = Перечисления.ТипыХраненияФайлов.ВИнформационнойБазе Тогда
			ТекущийОбъект.ТипХраненияФайла = ТипХраненияФайла;
			РаботаСФайламиСлужебный.ЗаписатьФайлВИнформационнуюБазу(ТекущийОбъект.Ссылка, ДвоичныеДанные);
		Иначе
			
			ТекущийОбъект.Том = Неопределено;
			ТекущийОбъект.ПутьКФайлу = Неопределено;
			ТекущийОбъект.ТипХраненияФайла = Неопределено;
			
			РаботаСФайламиВТомахСлужебный.ДобавитьФайл(ТекущийОбъект, ДвоичныеДанные);
