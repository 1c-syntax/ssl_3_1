...
Процедура ОбновитьИзФайлаНаДиске(Команда)
	...
	ДанныеФайла = ДанныеФайла(ЭтотОбъект.Объект.Ссылка, УникальныйИдентификатор, "ВызовСервера");
...
Процедура Редактировать(Команда)
	...
	ДанныеФайла = ДанныеФайла(ЭтотОбъект.Объект.Ссылка, УникальныйИдентификатор, "ДляОткрытия");
...
Процедура Печать(Команда)
	...
	Если ЗначениеЗаполнено(ЭтотОбъект.Объект.Ссылка) Или Записать() Тогда
		Файлы = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ЭтотОбъект.Объект.Ссылка);
...
Процедура СохранитьКак()
	...
	ДанныеФайла = ДанныеФайла(ЭтотОбъект.Объект.Ссылка, УникальныйИдентификатор, "ДляСохранения");
...
Процедура ЗашифроватьСервер(МассивДанныхДляЗанесенияВБазу,
	...
	РаботаСФайламиСлужебный.ЗаписатьИнформациюОШифровании(
		ЭтотОбъект.Объект.Ссылка, ПараметрыЗаписиИнформацииОШифровании);
...
Процедура СоздатьКопиюВерсии(Приемник, Источник)
	...
	СведенияОФайле.ВремяИзмененияУниверсальное = Источник.ДатаМодификацииУниверсальная;
