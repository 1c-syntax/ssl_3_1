...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Для Каждого Строка Из ВыбранныеДанные Цикл
		...
		Попытка
			...
			ОбновляемыйФайл = Строка.Ссылка.ПолучитьОбъект();
			...
			Если НаборЗаписей.Количество() = 0 Тогда
				...
				ЗаполнитьЗначенияСвойств(МенеджерЗаписи, ОбновляемыйФайл);
				МенеджерЗаписи.Файл          = ОбновляемыйФайл.Ссылка;
				СтруктураРеквизитов          = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ОбновляемыйФайл.Ссылка, "Автор, ВладелецФайла");
