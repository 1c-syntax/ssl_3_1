...
Процедура ПередЗаписью(Отказ)
	...
	Если УправлениеДоступомСлужебный.УпрощенныйИнтерфейсНастройкиПравДоступа()
		И ПоддерживаетсяНастройкаПравПользователейБТС() Тогда
		
		// Для УправлениеДоступомСлужебныйВМоделиСервиса.УчастникиПоПрофилю
		...
		// АПК:1320-выкл - Попытка-Исключение не требуется, т.к. блокировка выполняется в обработчике ПередЗаписью
...
Процедура ОтправитьСообщениеИзмененияГруппыДоступа(ЭтоУдаление = Ложь)
	
	Если ОбменДанными.Загрузка Тогда
		Возврат;
	КонецЕсли;
	
	Если ПоддерживаетсяУправлениеДоступомВМоделиСервиса() Тогда
...
Процедура ПередУдалением(Отказ)
	...
	ОтправитьСообщениеИзмененияГруппыДоступа(Истина);
...
Функция ПоддерживаетсяУправлениеДоступомВМоделиСервиса()
...
Функция ПоддерживаетсяНастройкаПравПользователейБТС()
	
	Если Не ПоддерживаетсяУправлениеДоступомВМоделиСервиса() Тогда
		Возврат Ложь;
	КонецЕсли;
	...
	Возврат МодульУправлениеДоступомСлужебныйВМоделиСервиса.ПоддерживаетсяНастройкаПравПользователейБТС();
