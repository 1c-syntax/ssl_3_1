...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		Если Не ДоступнаАвторизацияНаПочтовомСервисе() Тогда
			СкрытьВариантАутентификацииНаПочтовомСервисе();
		КонецЕсли;
	КонецЕсли;
...
&НаСервере
Процедура СкрытьВариантАутентификацииНаПочтовомСервисе()
...
Функция ДоступнаАвторизацияНаПочтовомСервисе()
	...
	Возврат РаботаСПочтовымиСообщениямиСлужебный.ДоступнаАвторизацияПочтовогоСервиса(
		Объект.АдресЭлектроннойПочты,
		Объект.ИмяПочтовогоСервиса);
