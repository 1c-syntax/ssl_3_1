...
#Если Не ВебКлиент Тогда
	...
	ИначеЕсли Элементы.ВебСтраница.Документ.contentType = "application/json" Тогда
		ОтветСервера = Элементы.ВебСтраница.Документ.body.innerText;
	ИначеЕсли СтрНайти(Элементы.ВебСтраница.Документ.body.innerText, АдресПеренаправления) Тогда
