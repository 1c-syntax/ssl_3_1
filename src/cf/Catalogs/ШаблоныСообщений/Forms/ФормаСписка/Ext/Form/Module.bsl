...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступныеВарианты = ШаблоныСообщенийСлужебный.ДоступныеВариантыОтправкиШаблоновСообщений();
	
	// кнопки в группе, если одна кнопка, то группа не нужна
	Элементы.ФормаСоздатьШаблонСообщенияSMS.Видимость       = ДоступныеВарианты.SMS;
	Элементы.ФормаСоздатьШаблонЭлектронногоПисьма.Видимость = ДоступныеВарианты.Почта;
	Элементы.ФормаПоказыватьКонтекстныеШаблоны.Видимость = Пользователи.ЭтоПолноправныйПользователь();
	
	Если Не ДоступныеВарианты.SMS Тогда
	...
	Если Не ДоступныеВарианты.Почта Тогда
		Элементы.ФормаГруппаСоздать.Вид = ВидГруппыФормы.ГруппаКнопок;
...
Процедура ИнициализироватьОтборы()
	...
	ВидыШаблонов.Вставить(0,
		НСтр("ru = 'Всех сообщений'"),
		НСтр("ru = 'Всех сообщений'"));
	...
	Список.Параметры.УстановитьЗначениеПараметра("Произвольный", НСтр("ru = 'Произвольного сообщения'"));
	...
	Назначение = "";
	ШаблонДля = НСтр("ru = 'Всех сообщений'");
