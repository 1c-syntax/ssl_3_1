...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		Список, "ЭтоОсновнойЯзык", ТекущийЯзык() = Метаданные.ОсновнойЯзык, Истина);
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
...
Процедура УстановитьЗаголовок()
	...
	Если ЗначениеЗаполнено(Свойство) Тогда
		...
		Иначе
			...
			Реквизиты.Добавить("ЗаголовокФормыВыбораЗначения");
			ЗначенияРеквизитов = УправлениеСвойствамиСлужебный.ЛокализованныеЗначенияРеквизитов(Свойство, Реквизиты);
			СтрокаЗаголовка = ЗначенияРеквизитов.ЗаголовокФормыВыбораЗначения;
		КонецЕсли;
	КонецЕсли;
