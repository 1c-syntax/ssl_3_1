...
Функция ВыполнитьПроверкиНаСервере(Проверки)
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("КонтрольВеденияУчетаСлужебный.ВыполнитьПроверкиВФоновомЗадании", 
		Новый Структура("Проверки", Проверки), ПараметрыВыполнения);
