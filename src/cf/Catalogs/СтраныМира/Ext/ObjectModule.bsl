...
Функция ПроверитьУникальностьЭлементов()
	...
	Пока Выборка.Следующий() Цикл
		...
		ИначеЕсли СтрСравнить(Выборка.НаименованиеПолное, НаименованиеПолное) = 0 Тогда
		...
		ИначеЕсли СтрСравнить(Выборка.КодАльфа2, КодАльфа2) = 0 Тогда
		...
		ИначеЕсли СтрСравнить(Выборка.КодАльфа3, КодАльфа3) = 0 Тогда
