...
Процедура ПередЗаписью(Отказ)
	...
	Задание = РегламентныеЗадания.НайтиПоУникальномуИдентификатору(РегламентноеЗадание); // АПК:453 задание запускается от имени пользователя, выбранного в форме рассылки.
