...
Процедура ПовторитьРассылку(Команда)
	...
	ПараметрыЗапуска.Форма = ЭтотОбъект.ВладелецФормы;
	ПараметрыЗапуска.ЭтоФормаЭлемента = (ЭтотОбъект.ВладелецФормы = "Справочник.РассылкиОтчетов.Форма.ФормаЭлемента");
