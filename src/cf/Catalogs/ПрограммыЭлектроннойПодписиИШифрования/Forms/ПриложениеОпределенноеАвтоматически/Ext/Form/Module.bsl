...
Процедура Изменить(Команда)
	...
	ДобавитьВСправочник(ПредопределенноеЗначение(
		"Перечисление.РежимыИспользованияПрограммыЭлектроннойПодписи.Настроено"));
...
Процедура ДобавитьВСправочник(РежимИспользования)
	...
	Если Не ЕстьПраваНаДобавлениеПрограммы Тогда
		ПоказатьПредупреждение( , НСтр("ru = 'Для настройки приложения обратитесь к администратору.'"));
	ИначеЕсли ЭтоПодчиненныйУзелРИБ Тогда
		ПоказатьПредупреждение( , НСтр("ru = 'Для настройки приложения необходимо добавить новый элемент в справочник в главном узле информационной базы.'"));
	Иначе
