...
Процедура ЗаполнитьПрограммуШифрованияНаСервере()
	...
	ОписанияПрограмм = ЭлектроннаяПодписьСлужебныйКлиентСервер.МенеджерКриптографииОписанияПрограмм(
		...
		ЭлектроннаяПодписьСлужебныйКлиентСервер.АлгоритмПодписиСертификата(ДвоичныеДанныеСертификата));
...
Процедура ЗаполнитьПрограммуШифрования(Оповещение = Неопределено)
	...
	ОписанияПрограмм = ЭлектроннаяПодписьСлужебныйКлиентСервер.МенеджерКриптографииОписанияПрограмм(
		Неопределено, Новый Массив, ЭлектроннаяПодписьКлиент.ОбщиеНастройки().ОписанияПрограмм,
