...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭлектроннаяПодпись.ДоступнаУсовершенствованнаяПодпись() Тогда
		Если ЗначениеЗаполнено(Параметры.ТипПодписи) Тогда
			...
			Элементы.ТипПодписи.СписокВыбора.Добавить(Параметры.ТипПодписи);
			ТипПодписи = Параметры.ТипПодписи;
			СписокТипов = Новый СписокЗначений;
			ЭлектроннаяПодписьСлужебный.ЗаполнитьСписокТиповПодписейКриптографии(СписокТипов, "Подписание", ТипПодписи);
		...
		Иначе
			...
			Для Каждого ЭлементСписка Из СписокТипов Цикл
				...
				Элементы.ТипПодписи.СписокВыбора.Добавить(ЭлементСписка.Значение);
			КонецЦикла;
