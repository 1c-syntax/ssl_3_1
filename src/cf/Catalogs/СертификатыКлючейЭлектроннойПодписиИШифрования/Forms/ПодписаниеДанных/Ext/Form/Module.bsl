...
Процедура ВидимостьСтраницТипаПодписания(Форма)
	...
	Если Форма.ТипПодписанта = "ПодписатьСертификатом" Тогда
		...
		Форма.Элементы.ГруппаКонтейнер.Видимость = Истина;
		Форма.Элементы.ГруппаКонтейнер1.Видимость = Истина;
		Форма.Элементы.ГруппаКомандыПодтверждения.Видимость = Истина;
	Иначе
		Форма.Элементы.СтраницыПодписание.ТекущаяСтраница = Форма.Элементы.СтраницаОтправитьНаПодписание;
		Форма.Элементы.ГруппаКонтейнер.Видимость = Ложь;
		Форма.Элементы.ГруппаКонтейнер1.Видимость = Ложь;
		Форма.Элементы.ГруппаКомандыПодтверждения.Видимость = Ложь;
	КонецЕсли;
