...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СертификатПараметрыРеквизитов = СертификатПараметрыРеквизитов();
...
Функция СертификатПараметрыРеквизитов()
	ПараметрыРеквизитов = Новый Структура;
	Возврат ПараметрыРеквизитов;
КонецФункции
...
Процедура ПоказатьСтраницуУточнениеСвойствСертификата(Форма, СертификатКриптографии, ДанныеСертификата, СвойстваСертификата)
	...
	СертификатПараметрыРеквизитов = Форма.СертификатПараметрыРеквизитов; // см. ЭлектроннаяПодписьСлужебныйКлиентСервер.СертификатПараметрыРеквизитов
