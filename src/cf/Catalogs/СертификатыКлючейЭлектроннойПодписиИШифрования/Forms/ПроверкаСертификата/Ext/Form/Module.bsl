		...
		Если Не РезультатПроверки Тогда
			...
			Если ЭтоИзвестнаяОшибка Тогда
				...
				ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы,
					ИмяГруппыРешениеНадпись, "Заголовок", ОписаниеИзвестнойОшибки.Решение);
			КонецЕсли;
		КонецЕсли;
	Иначе
...
Функция ОшибкаПоКлассификатору(ОписаниеОшибки)
	...
	Возврат ЭлектроннаяПодпись.ОшибкаПоКлассификатору(ОписаниеОшибки);
