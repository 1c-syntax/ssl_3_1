...
Процедура УстановитьЭлемент(Форма, Действие, НаСервере,
	...
	Если ЗначениеЗаполнено(ОписаниеОшибки) Тогда
		...
		Если ПредупреждениеПослеПроверкиУЦ <> Неопределено Тогда
			...
			ЭлементФормыНадписьРешение.Заголовок = ПредупреждениеПослеПроверкиУЦ.Решение;
		КонецЕсли;
			
		ИмяЭлементаНадписьРешениеПодписание = "Подписание" + ?(НаСервере, "ОшибкаСерверНадпись", "ОшибкаКлиентНадпись"); 
		ЭлементФормыНадписьРешениеПодписание = Форма.Элементы[ИмяЭлементаНадписьРешениеПодписание]; 

		Если Действие = "Расшифровка" И ЭлементНадписьОшибка.Заголовок = ЭлементФормыНадписьРешениеПодписание.Заголовок Тогда
			ЭлементФормыНадписьРешение.Видимость = ЭлементФормыНадписьРешениеПодписание.Видимость;
