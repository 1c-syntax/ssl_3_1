...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не СтандартныеПроверки И ДополнительныеПроверки.Количество() = 0 Тогда
...
Процедура УстановитьЭлемент(Форма, Действие, НаСервере,
	...
	Если ЗначениеЗаполнено(ОписаниеОшибки) Тогда
		...
		Если Действие = "Расшифровка" И ЭлементНадписьОшибка.Заголовок = ЭлементФормыНадписьОшибкаПодписание.Заголовок Тогда
			ЭлементФормыНадписьРешение.Видимость = ЭлементФормыНадписьОшибкаПодписание.Видимость;
			ЭлементФормыНадписьРешение.Заголовок = НСтр("ru = 'См. пункт Подписание данных.'");
			Возврат;
		КонецЕсли;
