...
&НаКлиенте
Процедура УдалитьФайлНаКлиенте(ПутьКФайлу, ДополнительныеПараметры) Экспорт
...
Процедура ЗаполнитьТаблицуЛишнихФайлов()
	...
	РаботаСФайламиВТомахСлужебный.ПроверитьЦелостностьФайлов(ТаблицаФайловНаДиске, ТомХраненияФайлов);
