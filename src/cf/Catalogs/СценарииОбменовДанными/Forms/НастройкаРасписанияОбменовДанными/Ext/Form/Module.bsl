...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		Элементы.ВключитьОтключитьВыгрузкуЗагрузку.Видимость = Ложь;
		Элементы.ФормаВыполнитьСценарий.Видимость = Ложь;
	КонецЕсли;
...
Процедура ВключитьОтключитьРегламентноеЗаданиеНаСервере(Ссылка)
	...
	Попытка
		...
		Отказ = Ложь;
		Расписание = Справочники.СценарииОбменовДанными.ПолучитьРасписаниеВыполненияОбменаДанными(Ссылка);
