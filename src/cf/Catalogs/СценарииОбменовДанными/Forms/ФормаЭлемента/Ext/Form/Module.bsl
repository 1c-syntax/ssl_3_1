...
Процедура НастройкиОбменаУзелИнформационнойБазыПриИзменении(Элемент)
	...
	Если РазделениеВключено Тогда
		ТекущиеДанные.ИдентификаторТранспорта = ПолучитьИдентификаторТранспортаДляУзла(ТекущиеДанные.УзелИнформационнойБазы);
	Иначе	
...
&НаСервереБезКонтекста
Функция ПолучитьИдентификаторТранспортаДляУзла(Знач УзелИнформационнойБазы)
	
	Возврат ТранспортСообщенийОбмена.ТранспортПоУмолчанию(УзелИнформационнойБазы);
