	...
	Если ВидФормы = "ФормаОбъекта" И Параметры.Свойство("ОбъектАвторизации") Тогда
		...
		Иначе
			ОписаниеОшибкиКакПредупреждения =
				НСтр("ru = 'Разрешение на вход в приложение не предоставлялось.'");
...
// Параметры:
//  Источник - СправочникОбъект.ВнешниеПользователи
//
Функция ЕстьНедопустимыеИзменения(Источник) Экспорт
	...
	Если Источник.Подготовлен
	 Или Источник.УстановитьРолиНепосредственно
