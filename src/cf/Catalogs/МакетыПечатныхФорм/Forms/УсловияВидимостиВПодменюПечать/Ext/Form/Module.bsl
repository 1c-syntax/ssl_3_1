...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ЭтоМакетВыгрузки Тогда
		
		АвтоЗаголовок = Ложь;
		ШаблонЗаголовка = НСтр("ru = 'Условия видимости в подменю ""Выгрузить в файл"": %1 (Макет файла выгрузки)'");
		ТекстЗаголовка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			ШаблонЗаголовка, 
			Параметры.ПредставлениеМакетаВыгрузки);
