...
Процедура ПолучитьНастройкиОбменаДаннымиДляВторойИнформационнойБазыНаСервере(Отказ,
	...
	Если ЗначениеЗаполнено(СтрокаНастроекПодключенияXML) Тогда
		...
		АдресНастроекПодключенияXML = АдресНастройкиПодключения(СтрокаНастроекПодключенияXML);
	...
	Если ЗначениеЗаполнено(СтрокаНастроекПодключенияJSON) Тогда
		...
		АдресНастроекПодключенияJSON = АдресНастройкиПодключения(СтрокаНастроекПодключенияJSON);
...
&НаСервере
Функция АдресНастройкиПодключения(СтрокаНастроекПодключения)
	
	Поток = Новый ПотокВПамяти;
	ЗаписьДанных = Новый ЗаписьДанных(Поток, "UTF-8",,,, Истина);
	ЗаписьДанных.ЗаписатьСимволы(СтрокаНастроекПодключения);
	АдресНастроекПодключения = ПоместитьВоВременноеХранилище(Поток.ЗакрытьИПолучитьДвоичныеДанные());

	Возврат АдресНастроекПодключения;
