...
// Описание подключения внешней компоненты (AddInNativeExtension).
//
// Возвращаемое значение:
//  Структура:
...
Функция ОписаниеКомпоненты() Экспорт
	...
	Параметры = Новый Структура;
	Параметры.Вставить("ИмяОбъекта", "AddInNativeExtension");
	Параметры.Вставить("ПолноеИмяМакета", "ОбщийМакет.КомпонентаTWAIN");
	Возврат Параметры;
