...
// Блокирует бользователя в системе взаимодействия. 
...
Процедура ЗаблокироватьНедействительныхПользователейВСистемеВзаимодействий(ПараметрыОбновления) Экспорт
	...
	Если ОбъектыСОшибками > 0 Тогда
		...
		ОшибкаЖураналаРегистрации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		...
		ЗаписьЖурналаРегистрации(
			...
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ОшибкаЖураналаРегистрации, ОбъектыСОшибками) +
