...
Функция ПроверитьИЗарегистрироватьCOMСоединитель(Знач СтруктураНастроек) Экспорт
	
	Если ТипЗнч(СтруктураНастроек) <> Тип("Структура") Тогда
		СтруктураНастроек = РегистрыСведений.НастройкиТранспортаОбменаДанными.НастройкиТранспорта(
			СтруктураНастроек, Перечисления.ВидыТранспортаСообщенийОбмена.COM)
	КонецЕсли;
