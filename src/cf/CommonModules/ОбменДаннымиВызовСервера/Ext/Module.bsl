...
// Скрывает или возвращает отображение плашки с предупреждением о наличии цикличных настроек синхронизации (обменов).
// Плашка расположена в общей форме "НастройкиСинхронизацииДанных" (форма списка со всеми настройками обменов).
//
// Параметры:
//  Направление - Булево - если ИСТИНА, то скрываем, иначе отображаем.
//
Процедура СкрытьПоказатьПредупреждениеЗацикливанияОтПользователя(Знач Направление) Экспорт
	
	ОбменДаннымиКонтрольЗацикливания.СкрытьПоказатьПредупреждениеЗацикливанияОтПользователя(Направление);
...
// Возвращает признак того, что набор записей регистра по переданным значениям не содержит данных.
// 
// Параметры:
//  СтруктураЗаписи - Структура - структура со значениями измерений переданного регистра.
//  ИмяРегистра - Строка - имя регистра сведений как объекта метаданных.
// 
// Возвращаемое значение:
//  Булево
//
...
//  ДействиеПриОбменеСтрокой - Строка - строковое представление перечисления ДействияПриОбмене 
// 
// Возвращаемое значение:
//  Строка
//
...
//                    - Строка - строковое представление перечисления ДействияПриОбмене 
// 
// Возвращаемое значение:
//  Структура:
...
// 
// Возвращаемое значение:
//   см. ОбменДаннымиПовтИсп.ВсеСсылочныеТипыКонфигурации
//
...
#Область ОбменДаннымиПодПолнымиПравами
...
// Проверить необходимость отложенной записи узла.
// 
// Параметры:
...
// Возвращаемое значение:
//  Структура:
//    * НеобходимаДлительнаяОперация - Булево
//    * ЕстьАктивноеФоновоеЗадание - Булево
//    * АдресСтруктурыУзла - Неопределено
...
// Определяет, входит ли узел обмена в определяемый тип ПланыОбменаБСД.
// 
// Параметры:
//  Узел - ПланОбменаСсылка
// 
// Возвращаемое значение:
//  Булево - узел входит в планы обмена БСД
//
Функция УзелВходитВПланыОбменаБСД(Узел) Экспорт
	
	ТипУзла = ТипЗнч(Узел);
	Возврат Метаданные.ОпределяемыеТипы.ПланыОбменаБСД.Тип.СодержитТип(ТипУзла);
