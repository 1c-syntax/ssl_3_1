...
Функция НаборЗаписейРегистраПустой(СтруктураЗаписи, ИмяРегистра) Экспорт
	...
	МетаданныеРегистра = Метаданные.РегистрыСведений.Найти(ИмяРегистра); // ОбъектМетаданныхРегистрСведений
	...
	Для Каждого Измерение Из МетаданныеРегистра.Измерения Цикл
		...
		Если СтруктураЗаписи.Свойство(Измерение.Имя) Тогда
			...
			НаборЗаписей.Отбор.Найти(Измерение.Имя).Установить(СтруктураЗаписи[Измерение.Имя]);
