...
Процедура ОткрытьФормуИзмененияПрефиксаИБ(Знач ПрефиксИБ) Экспорт
	...
	ИмяФормыИзмененияПрефикса = "Обработка.ПомощникСозданияОбменаДанными.Форма.ИзменениеПрефиксаУзлаИБ";
	ОткрытьФорму(ИмяФормыИзмененияПрефикса, ПараметрыФормы,,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ОткрытьФормуУдаленияПредупрежденийСинхронизации(ПараметрыОткрытия, ОписаниеОповещения = Неопределено) Экспорт
	...
	ИмяФормыУдаленияПредупреждений = "РегистрСведений.РезультатыОбменаДанными.Форма.УдалениеУстаревшихПредупреждений";
	ОткрытьФорму(ИмяФормыУдаленияПредупреждений, ПараметрыОткрытия, ЭтотОбъект, , , , ОписаниеОповещения);
...
Процедура ОткрытьПомощникНастройкиОбменаДанными(Знач ИмяПланаОбмена, Знач ИдентификаторНастройки) Экспорт
	...
	// Процедура не используется, так как для настройки синхронизации больше не используется форма НастройкаПодключения
...
#Область ЭкспортныеСлужебныеФункцииСвойства
...
//    * Успех - Строка
//    * Выполнение - Строка
//    * Предупреждение_СообщениеОбменаБылоРанееПринято - Строка
//    * ВыполненоСПредупреждениями - Строка
//    * Ошибка_ТранспортСообщения - Строка
//
...
Процедура ИнтерактивнаяОбработкаПовторитьЗагрузкуСообщенияОбменаДаннымиПередЗапуском(Параметры, Контекст) Экспорт
	...
	Форма = ОткрытьФорму(
		"Обработка.ПомощникСозданияОбменаДанными.Форма.ПовторнаяСинхронизацияДанныхПередЗапуском", , , , , , 
...
#Область СлужебныйПрограммныйИнтерфейсИнтерактивногоДополненияВыгрузки
...
//
// Возвращаемое значение:
//     ФормаКлиентскогоПриложения - открытая форма с переданными параметрами
//
...
//
// Возвращаемое значение:
//     ФормаКлиентскогоПриложения - открытая форма обработки ИнтерактивноеИзменениеВыгрузки с переданными параметрами
//
...
#Область СлужебныеПроцедурыИФункцииИнтерактивногоДополненияВыгрузки
