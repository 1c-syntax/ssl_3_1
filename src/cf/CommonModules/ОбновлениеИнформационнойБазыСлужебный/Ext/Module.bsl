...
Функция ОбработчикиПереходаСДругойПрограммы(ПредыдущееИмяКонфигурации, ИтерацииОбновления) 
	...
	Для Каждого ИтерацияОбновления Из ИтерацииОбновления Цикл
		...
		Для Каждого Обработчик Из ОбработчикиНачальногоЗаполнения Цикл
			Если Обработчик.РежимВыполнения = "Отложенно" Тогда
				Продолжить;
			КонецЕсли;
...
Функция ИмяКлючевогоРеквизита(НаборДанныхДляЗаполнения)
	...
	ИмяКлючевогоРеквизита = НаборДанныхДляЗаполнения.НастройкиПредопределенныхЭлементов.ИмяКлючевогоРеквизита;
...
Процедура ЗаполнитьРеквизитыНачальнымиДанными(ЗаполняемыйЭлемент, НаборДанныхДляЗаполнения, НастройкиЗаполнения)
	...
	ИмяКлючевогоРеквизита = ИмяКлючевогоРеквизита(НаборДанныхДляЗаполнения);
	...
	Если НаборДанныхДляЗаполнения.НастройкиПредопределенныхЭлементов.ПриНачальномЗаполненииЭлемента Тогда
		МенеджерОбъекта.ПриНачальномЗаполненииЭлемента(ЗаполняемыйЭлемент, СтрокаТаблицы, НаборДанныхДляЗаполнения.НастройкиПредопределенныхЭлементов.ДополнительныеПараметры);
	КонецЕсли;
...
Функция ОбновитьЭлементыПредопределенныхЭлементов(СсылкиНаОбъекты, МетаданныеОбъекта, НастройкиЗаполнения)
	...
	Пока СсылкиНаОбъекты.Следующий() Цикл
		...
		Попытка
			...
			Если ПараметрыДляЗаполненияОбъекта.НастройкиПредопределенныхЭлементов.ПриНачальномЗаполненииЭлемента Тогда
				МенеджерОбъекта.ПриНачальномЗаполненииЭлемента(ЗаполняемыйЭлемент, СтрокаТаблицы, 
					ПараметрыДляЗаполненияОбъекта.НастройкиПредопределенныхЭлементов.ДополнительныеПараметры);
			КонецЕсли;
