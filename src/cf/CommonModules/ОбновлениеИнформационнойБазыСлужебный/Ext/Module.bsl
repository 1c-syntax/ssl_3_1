...
Функция ОпределитьДанныеЗаполнения(Знач ПредопределенныеДанные, Знач СтрокаТаблицы, Знач ПоляИсключения, Знач ЗаполняемыеРеквизиты)

	ТолькоЗаполняемыеРеквизиты = ЗаполняемыеРеквизиты.Количество() > 0;
