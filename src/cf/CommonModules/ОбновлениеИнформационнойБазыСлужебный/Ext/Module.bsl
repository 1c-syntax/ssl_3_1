...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("УстановитьПорядокОтложенногоОбновления", Истина);
	Методы.Вставить("ВыполнитьОтложенноеОбновление", Истина);
	Методы.Вставить("ЗагрузитьИУстановитьИсправления", Истина);
	Методы.Вставить("ОчисткаУстаревшихДанных", Истина);
