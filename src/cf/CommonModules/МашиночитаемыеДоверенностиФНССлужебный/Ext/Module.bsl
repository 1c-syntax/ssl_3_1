...
Процедура ПриЗаполненииРеквизитовОрганизацииМЧД(Реквизиты)
	...
	Если ЭтоИП Тогда
		...
		Если ЗначениеЗаполнено(Реквизиты.ЭлектроннаяПочта) И ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.КонтактнаяИнформация") Тогда
			МодульУправлениеКонтактнойИнформацией = ОбщегоНазначения.ОбщийМодуль("УправлениеКонтактнойИнформацией");
			Реквизиты.ЭлектроннаяПочтаЗначение = МодульУправлениеКонтактнойИнформацией.КонтактнаяИнформацияВJSON(
				Реквизиты.ЭлектроннаяПочта, Перечисления["ТипыКонтактнойИнформации"].АдресЭлектроннойПочты);
		КонецЕсли;
		
		Реквизиты.Телефон = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(СведенияОбОрганизации, "ТелефонОрганизации", "");
		Если ЗначениеЗаполнено(Реквизиты.Телефон) И ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.КонтактнаяИнформация") Тогда
			МодульУправлениеКонтактнойИнформацией = ОбщегоНазначения.ОбщийМодуль("УправлениеКонтактнойИнформацией");
			Реквизиты.ТелефонЗначение = МодульУправлениеКонтактнойИнформацией.КонтактнаяИнформацияВJSON(
				Реквизиты.Телефон, Перечисления["ТипыКонтактнойИнформации"].Телефон);
		КонецЕсли;
		...
		РеквизитыЛицаБезДоверенности.СтраховойНомерПФР = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(СведенияОбОрганизации, "ИПРегистрационныйНомерПФР", "");
		...
		Если ЗначениеЗаполнено(РеквизитыЛицаБезДоверенности.Телефон) И ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.КонтактнаяИнформация") Тогда
			МодульУправлениеКонтактнойИнформацией = ОбщегоНазначения.ОбщийМодуль("УправлениеКонтактнойИнформацией");
			РеквизитыЛицаБезДоверенности.ТелефонЗначение = МодульУправлениеКонтактнойИнформацией.КонтактнаяИнформацияВJSON(
				Реквизиты.Телефон, Перечисления["ТипыКонтактнойИнформации"].Телефон);
		КонецЕсли;
...
Функция ЗаголовокДекорации(Реквизиты, ИмяЭлементаОрганизация = Неопределено, ТолькоОбязательные = Ложь, ПоказыватьПерсональныеДанные = Истина) Экспорт

	Результат = СтруктураЗаголовкаДекорации(Реквизиты, ПоказыватьПерсональныеДанные, ИмяЭлементаОрганизация, ТолькоОбязательные, Ложь);
...
Функция ЗаголовокДекорацииДляТаблицы(Реквизиты, ИмяЭлементаОрганизация = Неопределено, ТолькоОбязательные = Ложь, ПоказыватьПерсональныеДанные = Истина) Экспорт

	Результат = СтруктураЗаголовкаДекорации(Реквизиты, ПоказыватьПерсональныеДанные, ИмяЭлементаОрганизация, ТолькоОбязательные, Истина);
...
Функция СтруктураЗаголовкаДекорации(Реквизиты, ПоказыватьПерсональныеДанные, ИмяЭлементаОрганизация = Неопределено, ТолькоОбязательные = Ложь, ДляТаблицы = Ложь)
