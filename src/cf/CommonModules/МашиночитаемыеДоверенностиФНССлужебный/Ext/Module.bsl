...
Функция НомераДоверенностейИзФайлов(ЗагруженныеФайлы) Экспорт
	...
	Для Каждого ЗагруженныйФайл Из ЗагруженныеФайлы Цикл
		...
		Если НРег(Файл.Расширение) = ".zip" Тогда
			ДвоичныеДанные = Новый ДвоичныеДанные(ЗагруженныйФайл.ПолноеИмя);
...
Функция ЗагрузитьЦепочкуДоверенностейИзРеестра(НомерДоверенности, ИННДоверителя, ТокенДоступа = "") Экспорт
	...
	ПолныеДанныеДоверенностиМЧДРР = ПолныеДанныеДоверенностиМЧДРР(НомерДоверенности, ИННДоверителя, ТокенДоступа);
...
Функция ЗагрузитьДоверенностьИзРеестра(НомерДоверенности, ИННДоверителя, ТокенДоступа = "") Экспорт
	...
	ЦепочкаДоверенностей = ЗагрузитьЦепочкуДоверенностейИзРеестра(НомерДоверенности, ИННДоверителя, ТокенДоступа);
