...
Функция ПолучитьКлючЗаписиИОтключитьНапоминание(ПараметрыНапоминания) Экспорт
	КлючЗаписи = РегистрыСведений.НапоминанияПользователя.СоздатьКлючЗаписи(ПараметрыНапоминания);
	НапоминанияПользователяСлужебный.ОтключитьНапоминание(ПараметрыНапоминания, Истина, Истина);
	Возврат КлючЗаписи;
КонецФункции
