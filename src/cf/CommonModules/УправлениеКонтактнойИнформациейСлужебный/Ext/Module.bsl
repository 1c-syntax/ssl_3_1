...
Функция ТипыАдресныхОбъектов()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.АдресныйКлассификатор") Тогда			
		...
		СписокСокращений = МодульАдресныйКлассификаторПовтИсп.ТипыАдресныхОбъектовДляРаспознаванияАдреса();
	Иначе
		СписокСокращений = Новый ФиксированноеСоответствие(Новый Соответствие());
	КонецЕсли;
