...
//    * ОбращаетсяКВнешнимРесурсам - Булево - если РаботаетСВнешнимиРесурсами = Ложь, но регламентное задание обращается
//        к внешним ресурсам (Интернет-сервисам), например, регламентное задание ЗагрузкаКурсовВалют,
//        тогда следует установить Истина. По умолчанию равен параметру РаботаетСВнешнимиРесурсами.
//        Регламентные задания, работающие с Интернет-сервисами, не выполняются при отключенной функциональной
//        опции "Разрешить доступ к Интернет-сервисам".
