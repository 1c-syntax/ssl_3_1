...
Функция ИнформацияДляПоддержки() Экспорт
	...
	Текст = НСтр("ru = '[НазваниеПрограммы], [ВерсияПрограммы];
	                   |Платформа 1С:Предприятие: [ВерсияПлатформы] [РазрядностьПлатформы]; 
	                   |Библиотека стандартных подсистем: [ВерсияБСП];
	                   |Приложение: [ПрограммаПросмотра]
	...
	Текст = СтрЗаменить(Текст, "[ПрограммаПросмотра]", СистемнаяИнформация.ИнформацияПрограммыПросмотра);
