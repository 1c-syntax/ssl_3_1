...
//      "ДоверительИНН", "ДоверительКПП", "КодПолномочия" и т.п. 
...
Функция ДоверенностиСОтбором(Отбор, Знач ВыбранныеПоля, Знач НаДату = Неопределено) Экспорт
	...
	|	МашиночитаемыеДоверенностиПолномочия.Код КАК КодПолномочия
	|ИЗ
	...
	|		{ЛЕВОЕ СОЕДИНЕНИЕ Справочник.МашиночитаемыеДоверенности.Полномочия КАК МашиночитаемыеДоверенностиПолномочия
	|		ПО (МашиночитаемыеДоверенности.Ссылка = МашиночитаемыеДоверенностиПолномочия.Ссылка)}";
...
//
// Возвращает структуру реквизитов доверенности, прочитанной из переданного файла или архива. 
// Если не удалось прочитать, возвращает текст ошибки
// 
// Параметры:
//  ЗагруженныйФайл - Структура - файл доверенности (xml), архив с доверенностью (zip):
...
//   * Доверители - Массив из Структура:
//      ** Организация - Неопределено, Структура - см. МашиночитаемыеДоверенностиФНСПереопределяемый.ПриЗаполненииРеквизитовОрганизации.Реквизиты
//      ** ОрганизацияПредставитель - Неопределено, Структура - см. МашиночитаемыеДоверенностиФНСПереопределяемый.ПриЗаполненииРеквизитовОрганизации.Реквизиты
//      ** ФизическоеЛицо - Неопределено, Структура - см. МашиночитаемыеДоверенностиФНСПереопределяемый.ПриЗаполненииРеквизитовФизическогоЛица.Реквизиты
...
Функция РеквизитыДоверенностиИзФайла(ЗагруженныйФайл) Экспорт
	...
	Возврат Справочники.МашиночитаемыеДоверенности.РеквизитыДоверенностиИзФайла(ЗагруженныйФайл);
	
КонецФункции

// Возвращает список новых либо перезаполненных существующих элементов справочника МашиночитаемыеДоверенности данными из
// файлов.
//
// Параметры:
...
//  Структура:
//   * Доверенности - Массив из СправочникСсылка.МашиночитаемыеДоверенности
//   * ТекстыОшибок - Массив из Строка
//
Функция ЗагрузитьДоверенностиВИнформационнуюБазу(ЗагруженныеФайлы, Замещать = Ложь) Экспорт
	Возврат МашиночитаемыеДоверенностиФНССлужебный.ЗагрузитьДоверенностиВИнформационнуюБазу(ЗагруженныеФайлы, Замещать);
КонецФункции
