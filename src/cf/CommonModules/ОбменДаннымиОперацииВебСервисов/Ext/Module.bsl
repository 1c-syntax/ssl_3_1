...
Функция ПолучитьЧастьФайла(ИдентификаторПередачи, НомерЧасти, ДанныеЧасти, Область = 0) Экспорт
	...
	Если ОбменДаннымиСлужебный.ПутьКФайлуСодержитНедопустимыеСимволы(ИмяФайлаЧасти) Тогда
...
Функция ОтветныйВызов(ИдентификаторЗадачи, Ошибка, Область) Экспорт
	...
	ВключенПризнакОтменаПовторногоВыполненияЗадания = СтрНайти(Ошибка, МодульОбменДаннымиВнутренняяПубликация.ПризнакОтменыПовторногоВыполненияЗадания()) > 0;
		
	Если Ошибка = "" Или ВключенПризнакОтменаПовторногоВыполненияЗадания Тогда
		
		Если ВключенПризнакОтменаПовторногоВыполненияЗадания Тогда
			Ошибка = СтрЗаменить(Ошибка, МодульОбменДаннымиВнутренняяПубликация.ПризнакОтменыПовторногоВыполненияЗадания() + ":", "");
		КонецЕсли;
