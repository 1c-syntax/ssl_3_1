...
Функция ПоясненияПоОшибке(ТекстОшибки, Знач КодЯзыка = Неопределено) Экспорт
...
Функция ВыполнитьЗапрос(АдресСервера, АдресРесурса, ПараметрыЗапроса) Экспорт
...
Функция ОбновитьТокенДоступа(Знач УчетнаяЗапись, Знач ТокенОбновления = Неопределено)
