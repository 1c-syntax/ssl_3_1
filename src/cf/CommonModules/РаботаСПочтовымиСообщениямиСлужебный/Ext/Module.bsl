...
Функция ОткрытаяАвторизацияПочтовогоСервисаОпубликована() Экспорт
	...
	Попытка
		...
		СервисОпубликован = Ответ.КодСостояния = 200;
...
Функция АдресОткрытойАвторизацииПочтовогоСервиса() Экспорт
	...
	Возврат ОбщегоНазначения.АдресПубликацииИнформационнойБазыВИнтернете() + "/hs/oauth2_mail/callback";
