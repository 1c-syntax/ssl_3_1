...
Функция РежимДобавленияНабораЗаписей() Экспорт
	...
	Возврат Вычислить("РежимЗамещения.Добавление");
	// АПК:488-вкл
...
Функция РежимЗамещенияНабораЗаписей() Экспорт
	...
	// АПК:488-выкл Поддержка новых типов платформы (исполняемый код безопасен)
	Возврат Вычислить("РежимЗамещения.Замещение");
	// АПК:488-вкл
...
Функция РежимОбновленияНабораЗаписей() Экспорт
	...
	Если Не РежимыЗамещенияДоступны(Истина) Тогда
		Возврат Неопределено;
	КонецЕсли;
	...
	// АПК:488-выкл Поддержка новых типов платформы (исполняемый код безопасен)
	Возврат Вычислить("РежимЗамещения.Обновление");
	// АПК:488-вкл
...
Функция РежимСлиянияНабораЗаписей() Экспорт
	...
	// АПК:488-выкл Поддержка новых типов платформы (исполняемый код безопасен)
	Возврат Вычислить("РежимЗамещения.Слияние");
	// АПК:488-вкл
...
Функция РежимыЗамещенияДоступны(ВключаяОбновление = Ложь)
...
Функция ТипРежимЗамещения() Экспорт
	...
	Возврат Вычислить("Тип(""РежимЗамещения"")");
	// АПК:488-вкл
