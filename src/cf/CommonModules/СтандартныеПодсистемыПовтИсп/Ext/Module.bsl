...
Функция ОписаниеТипаВсеСсылки() Экспорт
	...
	ВсеСсылки = Новый ОписаниеТипов(Новый ОписаниеТипов(Новый ОписаниеТипов(Новый ОписаниеТипов(Новый ОписаниеТипов(
	...
	Для Каждого ВнешнийИсточник Из Метаданные.ВнешниеИсточникиДанных Цикл
		ВсеСсылки = Новый ОписаниеТипов(ВсеСсылки,
			ВнешниеИсточникиДанных[ВнешнийИсточник.Имя].Таблицы.ТипВсеСсылки().Типы());
	КонецЦикла;
