...
Функция СвойстваВидовОбъектовМетаданных() Экспорт
	...
	ДобавитьСвойстваВидаОбъектов(Результат, КритерииОтбора, Ложь, Ложь, Ложь,
...
Процедура ДобавитьСвойстваВидаОбъектов(Результат, Менеджер, ЕстьМодульМенеджера, ЕстьСсылка, ЕстьКлючЗаписи,
	...
	Если Метаданные.ВариантВстроенногоЯзыка = Метаданные.СвойстваОбъектов.ВариантВстроенногоЯзыка.Русский Тогда
		...
		Свойства.ИмяТипа        = ?(ЕстьСсылка,     ИмяВидаОбъектаЯзыкРусский + "Ссылка",
		                          ?(ЕстьКлючЗаписи, ИмяВидаОбъектаЯзыкРусский + "КлючЗаписи", ""));
	Иначе
		Свойства.ИмяКоллекции   = ИмяКоллекцииЯзыкАнглийский;
		Свойства.ИмяВидаОбъекта = ИмяВидаОбъектаЯзыкАнглийский;
		Свойства.ИмяТипа        = ?(ЕстьСсылка,     ИмяВидаОбъектаЯзыкАнглийский + "Ref",
		                          ?(ЕстьКлючЗаписи, ИмяВидаОбъектаЯзыкАнглийский + "RecordKey", ""));
	КонецЕсли;
...
//   * ЕстьСсылка     - Булево
//   * ЕстьКлючЗаписи - Строка
//   * ИмяТипа        - Строка - имя типа ссылки или типа ключа записи, если есть.
//   * ЕстьМодульМенеджера - Булево
