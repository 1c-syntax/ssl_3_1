...
//   Булево
//
Функция Используется1СДокументооборотДляХраненияФайловОбъекта(ВладелецПрисоединенныхФайлов,
		МодульИнтеграцияС1СДокументооборотБазоваяФункциональностьКлиент = Неопределено, Форма = Неопределено,
		Команда = Неопределено) Экспорт
