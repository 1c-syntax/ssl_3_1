...
// Только для внутреннего использования.
Функция ПрочитанныеДействияДляУстраненияОшибок(СпособУстранения)
	...
	ЧтениеJSON.УстановитьСтроку(СпособУстранения);
	СпособУстранения = ПрочитатьJSON(ЧтениеJSON); // Соответствие
...
// 
// Возвращаемое значение:
//  Неопределено - действия для устранения ошибки
//  Массив
//
