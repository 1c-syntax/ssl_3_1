...
Функция ОшибкаПоКлассификатору(ТекстДляПоискаВКлассификаторе, ОшибкаНаСервере, ОшибкаПроверкиПодписи) Экспорт
	...
	Если ОшибкаПроверкиПодписи Тогда
		...
		СтрокаОшибки = НайтиСтрокуОшибки(КлассификаторОшибок, Отбор, ТекстДляПоиска, ОшибкаНаСервере);
	...
	Возврат НайтиСтрокуОшибки(КлассификаторОшибок, Отбор, ТекстДляПоиска, ОшибкаНаСервере);

КонецФункции

Функция НайтиСтрокуОшибки(КлассификаторОшибок, Отбор, ТекстДляПоиска, ОшибкаНаСервере)
		...
		Если СтрНайти(ТекстДляПоиска, СтрокаКлассификатора.ТекстОшибкиНижнийРегистр) <> 0 Тогда
			...
			Если Не ОшибкаНаСервере Тогда
				ДополнитьРешениеАвтоматическимиДействиями(ПредставлениеОшибки.Решение,
					ПредставлениеОшибки.ДействияДляУстранения);
			КонецЕсли;
