...
Функция ОбщиеНастройки() Экспорт
	...
	ОбщиеНастройки.Вставить("АдресаСерверовМетокВремени",
		СтрРазделить(Константы.АдресаСерверовМетокВремени.Получить(), ", ;" + Символы.ПС));
	ОбщиеНастройки.Вставить("УсовершенствоватьПодписиАвтоматически", Константы.УсовершенствоватьПодписиАвтоматически.Получить());
	ОбщиеНастройки.Вставить("ДобавлятьМеткиВремениАвтоматически", Константы.ДобавлятьМеткиВремениАвтоматически.Получить());
	ОбщиеНастройки.Вставить("УсовершенствоватьПодписиСДаты", Константы.УсовершенствоватьПодписиСДаты.Получить());
...
Функция ЭтоМодельСервисаСДоступнымУсовершенствованием()
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		Если ЭлектроннаяПодписьСлужебный.ИспользоватьСервисОблачнойПодписи() Тогда
			...
			Если НастройкиПодключения.Свойство("АдресСервера") И ЗначениеЗаполнено(НастройкиПодключения.АдресСервера) Тогда
				Возврат Истина;
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
...
Функция ДанныеУдостоверяющегоЦентра(ПоляПоиска) Экспорт
	...
	Возврат ЭлектроннаяПодписьКлиентСерверЛокализация.ДанныеУдостоверяющегоЦентра(ПоляПоиска, АккредитованныеУдостоверяющиеЦентры);
