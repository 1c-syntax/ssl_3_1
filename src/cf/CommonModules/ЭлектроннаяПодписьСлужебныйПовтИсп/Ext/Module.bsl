...
Функция ОбщиеНастройки() Экспорт
	...
	Если Не ПустаяСтрока(АдресаСерверовМетокВремени) Тогда
		ОбщиеНастройки.Вставить("АдресаСерверовМетокВремени", ЭлектроннаяПодписьСлужебный.АдресаСерверовМетокВремени(АдресаСерверовМетокВремени));
	Иначе
