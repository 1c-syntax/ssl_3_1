...
Функция ФорматСвойства(Свойство)
	...
	Если ТипЗнч(Свойство) = Тип("Строка") Тогда
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "&Условие", "ДополнительныеРеквизитыИСведения.Имя = &Свойство");
	Иначе
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "&Условие", "ДополнительныеРеквизитыИСведения.Ссылка = &Свойство");
	КонецЕсли;
	...
	Возврат Результат[0].ФорматСвойства;
