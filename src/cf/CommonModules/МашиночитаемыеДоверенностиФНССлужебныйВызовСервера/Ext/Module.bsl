...
Функция РеквизитыПредставителяСталиНеобязательными() Экспорт
	...
	Возврат МашиночитаемыеДоверенностиФНСПовтИсп.ПаспортныеДанныеПредставителяДоверенностиНеобязательны();
...
//
Функция ФайлыДоверенностей(Знач Доверенности, Знач ДляНалоговыхОрганов, Знач ПроверятьДоступностьПерсональныхДанных = Ложь) Экспорт
	
	Результат = Новый Массив;
	ФайлыДоверенностей = Справочники.МашиночитаемыеДоверенности.ФайлыДоверенностей(Доверенности, ДляНалоговыхОрганов, 
