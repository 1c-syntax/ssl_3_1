...
Процедура ПриДобавленииПереименованийОбъектовМетаданных(Переименования) Экспорт
	...
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "2.3.3.25", 
		"Роль.ИспользованиеТекущихДел", "Роль.ИспользованиеОбработкиТекущиеДела", "СтандартныеПодсистемы");
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("СформироватьСписокТекущихДелПользователя", Истина);
