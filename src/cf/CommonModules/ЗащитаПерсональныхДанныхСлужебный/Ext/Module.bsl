...
Функция СведенияОПерсональныхДанных() Экспорт
	...
	ИнтеграцияПодсистемБСП.ЗаполнитьСведенияОПерсональныхДанных(ТаблицаСведений);
...
Функция КатегорииПерсональныхДанных() Экспорт
	...
	ИнтеграцияПодсистемБСП.ЗаполнитьОбластиПерсональныхДанных(КатегорииДанных);
...
Функция УничтожаемыеПерсональныеДанные() Экспорт
	...
	ИнтеграцияПодсистемБСП.ПриЗаполненииСведенийОбУничтожаемыхПерсональныхДанных(ТаблицаСведений);
