...
//                    созданного файла.
//   СведенияОФайле - см. РаботаСФайламиКлиентСервер.СведенияОФайле, в режиме "ФайлСВерсией".
//
// Возвращаемое значение:
...
Функция НайтиВРегистреПоПути(ИмяФайла) Экспорт
	...
	Попытка
		...
		Если НЕ РезультатЗапроса.Пустой() Тогда
			...
			НайденныеСвойства.ВРегистреПапка = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
