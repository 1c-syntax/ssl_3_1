...
Функция ОбновитьОбъектФайла(ФайлСсылка, СведенияОФайле, ВерсияСсылка = Неопределено, 
	...
	Попытка
		...
		Если ТипХраненияФайлов = Перечисления.ТипыХраненияФайлов.ВТомахНаДиске Тогда
			ТипХраненияФайлов = РаботаСФайламиВТомахСлужебный.ТипХраненияФайла(Расширение, СведенияОФайле.Размер);
		КонецЕсли;
		...
		Если ДвоичныеДанные = Неопределено Тогда
			ДвоичныеДанные = ПолучитьИзВременногоХранилища(СведенияОФайле.АдресВременногоХранилищаФайла); // ДвоичныеДанные
		КонецЕсли;
	...
	Иначе // хранение на диске
		...
		РаботаСФайламиВТомахСлужебный.ЗаписатьДанныеФайлаВТом(Версия, ДвоичныеДанные);
	КонецЕсли;
