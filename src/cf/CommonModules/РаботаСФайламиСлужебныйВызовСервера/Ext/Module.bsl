...
Функция ТабличныйДокументСоШтампом(Знач Файл) Экспорт
...
Функция ОфисныйДокументСоШтампом(Знач Файл) Экспорт
...
Функция ЖурналСканированияДляТехподдержки() Экспорт
	...
	Возврат ЖурналРегистрации.ЖурналДляТехподдержки(Отбор, 200, Новый УникальныйИдентификатор);
КонецФункции

Функция ПараметрыЛогирования(ИдентификаторКлиента) Экспорт
	Результат = Новый Структура;
	Результат.Вставить("ДатаНачалаЛогированияСканирования", ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("КомпонентаСканирования", 
		"ДатаНачалаЛогированияСканирования", Дата(1,1,1)));
