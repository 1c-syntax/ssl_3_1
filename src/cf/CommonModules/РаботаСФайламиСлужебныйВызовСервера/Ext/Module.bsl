...
Функция ЗанятьФайл(ДанныеФайла, СтрокаОшибки = "", 
	Знач УникальныйИдентификатор = Неопределено, Знач Пользователь = Неопределено, ДополнительныеСвойства = Неопределено) Экспорт
	...
	Попытка
		...
		Если ТипЗнч(ДополнительныеСвойства) = Тип("Структура") Тогда
			ОбщегоНазначенияКлиентСервер.ДополнитьСтруктуру(ФайлОбъект.ДополнительныеСвойства, ДополнительныеСвойства, Ложь);
		КонецЕсли;
...
Функция СократитьСтрокуКонтрольнойСуммой(ИмяБезРасширения, ИспользуемоеКоличествоСимволов) Экспорт
	
	Возврат ОбщегоНазначения.СократитьСтрокуКонтрольнойСуммой(ИмяБезРасширения, ИспользуемоеКоличествоСимволов);
