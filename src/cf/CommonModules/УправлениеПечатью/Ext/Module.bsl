...
Процедура УстановитьПараметры(ДеревоМакета, ЗначенияПараметров, ПараметрыЗаполненияОбласти) Экспорт
	...
	Если ЗаполнятьКолонтитулы Тогда
		Для Каждого Колонтитул Из СтруктураДокумента.Колонтитулы Цикл
			УстановитьПараметрыВДереве(ЗначенияПараметров, Колонтитул.Значение, ДеревоМакета, ДобавлятьСвязи);
		КонецЦикла;
	КонецЕсли;
...
Функция КоллекцииПолейИсточниковДанных(ИсточникиДанных) Экспорт
	...
	Результат.Добавить(КоллекцияПолейОбщиеРеквизиты(), "ОбщиеРеквизиты");
...
//
Процедура УстановитьПараметрыВДереве(Знач ЗначенияПараметров, ДеревоXML, ДеревоМакета = Неопределено, ДобавлятьСвязи = Истина)
