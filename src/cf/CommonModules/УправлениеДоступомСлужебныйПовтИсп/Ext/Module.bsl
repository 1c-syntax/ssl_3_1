...
// Если добавлено поле Регистратор, то оно первое в списке.
//
// Параметры:
...
//      ** Имя - Строка - имя поля.
//      ** Тип - ОписаниеТипов
//   * БлокироватьПоРегистратору - Булево
//
Функция ОписаниеПолейБлокировкиРегистра(ПолноеИмяРегистра) Экспорт
	...
	Если МетаданныеРегистра = Неопределено Тогда
		БлокироватьПоРегистратору = Ложь;
	Иначе
		ЭтоРегистрРасчета = ОбщегоНазначения.ЭтоРегистрРасчета(МетаданныеРегистра);
		
		БлокироватьПоРегистратору = ЭтоРегистрРасчета
			Или ОбщегоНазначения.ЭтоРегистрСведений(МетаданныеРегистра)
		...
		Если БлокироватьПоРегистратору
		 Или ЭтоПериодическийРегистрСведений
		 Или ЭтоРегистрРасчета Тогда
			...
			Для Каждого СтандартныйРеквизит Из МетаданныеРегистра.СтандартныеРеквизиты Цикл
				Если БлокироватьПоРегистратору
				   И СтандартныйРеквизит.Имя = "Регистратор" Тогда
					...
					Поля.Вставить(0, СтандартныйРеквизит.Имя);
					ОписаниеПоля = Новый Структура("Имя, Тип",
						СтандартныйРеквизит.Имя, СтандартныйРеквизит.Тип);
					ОписаниеПолей.Вставить(0, Новый ФиксированнаяСтруктура(ОписаниеПоля));
					
				ИначеЕсли ЭтоПериодическийРегистрСведений
	...
	Результат.Вставить("БлокироватьПоРегистратору", БлокироватьПоРегистратору);
