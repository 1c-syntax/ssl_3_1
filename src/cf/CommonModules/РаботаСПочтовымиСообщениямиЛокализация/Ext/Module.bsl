...
Процедура ПриПолученииАдресовСерверовDNS(АдресаСерверовDNS, СтандартнаяОбработка) Экспорт
	...
	// Локализация
	АдресаСерверовDNS.Добавить("78.88.8.8"); // dns.yandex - Не нарушает безопасность информации, так как ip-адрес публичный и его недоступность не блокирует работу приложения.
	АдресаСерверовDNS.Добавить("78.88.8.1"); // dns.yandex - Не нарушает безопасность информации, так как ip-адрес публичный и его недоступность не блокирует работу приложения.
