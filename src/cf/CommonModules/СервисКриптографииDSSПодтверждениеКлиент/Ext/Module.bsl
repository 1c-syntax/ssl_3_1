...
Процедура ФильтроватьСписокСпособов(КонтекстФормы, ИмяЭлемента = "ПодтверждениеСпособПодтверждения") Экспорт
	...
	РеестрИмен = ПолучитьБазовыйРеестрРеквизитов(КонтекстФормы);
 	ИменаЭлементов = РеестрИмен.ИменаЭлементовФормы;
	НовоеИмя = ПолучитьИмяЭлементаФормы(ИменаЭлементов, ИмяЭлемента);

	ДанныеПодтверждения = ПолучитьДанныеПодтвержденияИзФормы(КонтекстФормы, РеестрИмен);
...
//  Неопределено
// 
Функция ПолучитьБазовыйРеестрРеквизитов(КонтекстФормы, ПроверкаНаличия = Ложь) Экспорт
...
//
Функция ПолучитьДанныеПодтвержденияИзФормы(КонтекстФормы, РеестрИмен = Неопределено)
