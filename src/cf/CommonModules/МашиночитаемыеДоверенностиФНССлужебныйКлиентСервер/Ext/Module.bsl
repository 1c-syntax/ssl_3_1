...
Функция РеквизитыФизическогоЛицаСписок(Назначение = Неопределено, ДляЗаполнения = Истина, ВидФизическогоЛица = Неопределено) Экспорт
	...
	Реквизиты.Добавить("ДатаРождения",             НСтр("ru = 'Дата рождения'"), ЭтоДоверитель);
	Реквизиты.Добавить("ДокументВид",              НСтр("ru = 'Вид документа'"), ЭтоДоверитель);
	Реквизиты.Добавить("ДокументНомер",            НСтр("ru = 'Серия и номер'"), ЭтоДоверитель);
	Реквизиты.Добавить("ДокументКемВыдан",         НСтр("ru = 'Кем выдан'"), ЭтоДоверитель);
	Реквизиты.Добавить("ДокументДатаВыдачи",       НСтр("ru = 'Дата выдачи'"), ЭтоДоверитель);
	Реквизиты.Добавить("ДокументКодПодразделения", НСтр("ru = 'Код подразделения'"), ЭтоДоверитель);
