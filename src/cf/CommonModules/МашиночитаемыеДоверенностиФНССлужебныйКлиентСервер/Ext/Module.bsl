...
// 
// Параметры:
//  СторонаМЧД - ПеречислениеСсылка.ТипыУчастниковМЧД, Неопределено
...
//  Назначение - см. НазначениеДоверенности
// 
// Возвращаемое значение:
//  СписокЗначений
//	
Функция РеквизитыОрганизацииСписок(СторонаМЧД, ДляЗаполнения = Истина, ВидОрганизации = Неопределено, Назначение = Неопределено) Экспорт
