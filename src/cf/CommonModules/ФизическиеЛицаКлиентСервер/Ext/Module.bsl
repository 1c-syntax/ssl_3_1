...
//  ФорматИмени - Строка - задает порядок следования частей имени во входной строке.
...
//  ФорматПолногоИмени - Строка - определяет порядок следования частей имени во входных данных.
...
//  ИнициалыВНачале    - Булево - используется локализованным алгоритмом для выбора вида
