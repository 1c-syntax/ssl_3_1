...
// Выполнят установку порядка разделов поиска 
// для события ПолнотекстовыйПоискСерверПереопределяемый.ПриПолученииРазделовПолнотекстовогоПоиска
//
// Параметры:
...
//   ПорядокРазделов - Массив - синонимы подсистем - разделов, чем выше индекс - тем ниже в списке будет раздел.
//
Процедура УстановитьПорядокРазделовПолнотекстовогоПоиска(РазделыПоиска, ПорядокРазделов) Экспорт
