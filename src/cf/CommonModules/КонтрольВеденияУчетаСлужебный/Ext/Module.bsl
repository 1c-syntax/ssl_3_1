...
//
Функция СформироватьОбщуюСтрокуИндикатор(Форма, СсылкаНаОбъект, КоличествоПроблемПоОбъекту,
...
Функция ПрочитанныеПараметры(ПараметрыВыполненияПроверки)
	...
	Результат.ОбластьПроверки = ?(СтрНачинаетсяС(Результат.ПолноеИмя, "Регистр"), "Регистры", "СсылочныеОбъекты");
