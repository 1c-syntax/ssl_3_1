...
// Проверяет, что на уровне записей (и на уровне прав) текущему пользователю
...
//          - Неопределено - возвращает в этом параметре подготовленные наборы значений
...
//  Неопределено - если поставляемый профиль не существует в справочнике.
//
