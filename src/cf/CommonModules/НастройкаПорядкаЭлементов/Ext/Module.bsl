...
Процедура ПриНастройкеПроверкиМетодовВызываемыхКакПроизвольныйКод(Настройки) Экспорт
	...
	Методы.Вставить("Подключаемый_ПереместитьЭлемент");
	Настройки.ИсключенияКогдаУказанныйМетодНеВызывается.Вставить("ОбщийМодуль.НастройкаПорядкаЭлементов", Методы);
