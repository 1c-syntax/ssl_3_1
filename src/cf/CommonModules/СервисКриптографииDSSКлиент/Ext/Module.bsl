...
//				см. СервисКриптографииDSSПодтверждениеСервер.ПодготовитьНаборДокументов()
//
...
//                  				- Массив - несколько файлов которые нужно обработать см. СервисКриптографииDSSСлужебный.ПодготовитьПакетДляПодписи()
...
// Создает подпись документа в асинхронном режиме.
//
// Параметры:
//  ОповещениеОЗавершении		- ОписаниеОповещения - указывает процедуру для получения результата операции: 
//    * Результат				- см. ОтветСервисаПоУмолчанию
...
//  НастройкиПользователя 		- СправочникСсылка.УчетныеЗаписиDSS
//                        		- Структура - см. СервисКриптографииDSS.НастройкиПользователяПоУмолчанию.
//  СвойствоПодписи				- см. СервисКриптографииDSSКлиентСервер.ПолучитьСвойствоПодписиАсинхронной
...
Процедура ПодписатьАсинхронно(
	...
	СервисКриптографииDSSСлужебныйКлиент.ПодписатьАсинхронно(
					ТекущиеНастройки, 
					ОповещениеОЗавершении,
					СвойствоПодписи,
					ИдентификаторСертификата,
