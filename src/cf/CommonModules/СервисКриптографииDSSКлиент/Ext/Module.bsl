...
//    * Результат					- см. ОтветСервисаПоУмолчанию
//    * ДополнительныеПараметры	- Произвольный - значение, указанное при создании описания оповещения.
//  ОписаниеОшибки 			- Строка - подробнее СервисКриптографииDSSСлужебныйКлиент.ПолучитьОписаниеОшибки
...
Процедура ВывестиОшибку(ОповещениеОЗавершении, 
	...
	Иначе
		Содержимое = СервисКриптографииDSSКлиентСервер.ПолучитьКодОшибки(ОписаниеОшибки);
	КонецЕсли;
