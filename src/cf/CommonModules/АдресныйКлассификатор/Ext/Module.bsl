...
Функция КодРегионаПоНаименованию(Название) Экспорт
	...
	Для Каждого ОписаниеРегиона Из Классификатор Цикл
		ПолноеНаименование = АдресныйКлассификаторСлужебный.СоединитьНаименованиеИТипАдресногоОбъекта(
			ОписаниеРегиона.Наименование , ОписаниеРегиона.Сокращение, Истина);
	...
	Если ЗначениеЗаполнено(ЧастиСлова.Сокращение) Тогда
		...
		Если ПолныеНаименованияТиповАдресныхОбъектов.Получить(ВРег(ЧастиСлова.Сокращение)) <> Неопределено Тогда
			НаименованиеРегиона = ЧастиСлова.Наименование + " " + ПолныеНаименованияТиповАдресныхОбъектов.Получить(ВРег(ЧастиСлова.Сокращение));
			КодСубъектаРФ = СписокРегионов.Получить(ВРег(НаименованиеРегиона));
			Если КодСубъектаРФ <> Неопределено Тогда
				Возврат КодСубъектаРФ;
			КонецЕсли;
