...
Функция КодРегионаПоНаименованию(Название) Экспорт
	...
	Фильтр = Новый Структура("Наименование", НаименованиеРегиона);
	Варианты = Классификатор.НайтиСтроки(Фильтр);
	Если Варианты.Количество() = 0 Тогда
		ЧастиСлова = АдресныйКлассификаторСлужебный.НаименованиеИСокращение(НаименованиеРегиона);
	...
	Если ЗначениеЗаполнено(ЧастиСлова.Сокращение) Тогда
		СокращенияАдресныхОбъектов = АдресныйКлассификаторСлужебный.СокращенияАдресныхОбъектов(Новый Массив);
		Если СокращенияАдресныхОбъектов.Получить(ВРег(ЧастиСлова.Сокращение)) <> Неопределено Тогда
			НаименованиеРегиона = ЧастиСлова.Наименование + " " + СокращенияАдресныхОбъектов.Получить(ВРег(ЧастиСлова.Сокращение));
			КодСубъектаРФ = СписокРегионов.Получить(ВРег(НаименованиеРегиона));
			Если КодСубъектаРФ <> Неопределено Тогда
				Возврат КодСубъектаРФ;
			КонецЕсли;
...
//                         - Неопределено - идентификационный код ФИАС региона.
...
//                                      - Неопределено - идентификационный код ФИАС муниципального район.
...
//                           - Неопределено - идентификационный код ФИАС поселения.
...
//                                   - Неопределено - идентификационный код ФИАС населенного пункта.
//   * Территория - Строка - текстовое представление территории. В терминах ФИАС элемент планировочной структуры.
...
//                            - Неопределено - идентификационный код ФИАС территории.
