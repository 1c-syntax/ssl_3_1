...
Функция СлужебныйПользовательИБ()
	...
	ИначеЕсли Не ПользовательИБ.ПолноеИмя = ИмяПользователя
	      Или Не ПользовательИБ.АутентификацияСтандартная
	      Или Не ПользовательИБ.ЗапрещеноИзменятьПароль
	      Или ПользовательИБ.ПоказыватьВСпискеВыбора
	      Или Не ПользовательИБ.ПарольУстановлен
	      Или Не ПользовательИБ.Роли.Содержит(РольДляЗапуска) Тогда
