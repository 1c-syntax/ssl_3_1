...
//
Процедура НастроитьСоставХранимыхДанныхФайлов(Знач РеквизитыДляХраненияФайлов) Экспорт
...
Процедура НастроитьСоставХранимыхДанныхДляРеквизита(ИмяРеквизита, ОбъектМетаданных = Неопределено, ИмяВнешнегоХранилища = "")
	...
	Если ИмяРеквизита = "ДвоичныеДанные" Тогда
		...
		Выполнить("СоставХранимыхДанных = ХранилищеДвоичныхДанных.ПолучитьСоставХранимыхДанных()"); // Не нарушает безопасность информации, так как выполняется фиксированная строка, содержащая только вызов метода платформы.
		// АПК:487-вкл

		Если УстановитьЭлементСоставаХранимыхДанныхДляРеквизита(СоставХранимыхДанных, ОбъектМетаданныхРеквизита, Хранение) Тогда

			// АПК:487-выкл Поддержка новых методов платформы (исполняемый код безопасен)
			Выполнить("ХранилищеДвоичныхДанных.УстановитьСоставХранимыхДанных(СоставХранимыхДанных)"); // Не нарушает безопасность информации, так как выполняется фиксированная строка, содержащая только вызов метода платформы.
			// АПК:487-вкл			
		КонецЕсли;
...
Функция ИспользованиеРеквизитаЯвноОтключеноВоВсехХранилищахДвоичныхДанных(ИмяРеквизита, ОбъектМетаданных = Неопределено)
	...
	Если Не Результат Тогда
		...
		Если Не ОтключеноВоВстроенномХранилище Тогда
			...
			// АПК:487-выкл Поддержка новых методов платформы (исполняемый код безопасен)
			Выполнить("СоставХранимыхДанныхХранилища = ХранилищеДвоичныхДанных.ПолучитьСоставХранимыхДанных()"); // Не нарушает безопасность информации, так как выполняется фиксированная строка, содержащая только вызов метода платформы.
			// АПК:487-вкл
...
Функция ЕстьОшибкаВНастройкахХранилищаДвоичныхДанных(ИмяРеквизита, Знач ИмяВнешнегоХранилища = "", ОписаниеОшибки = "")
	...
	ИначеЕсли ИмяРеквизита = "ДвоичныеДанныеВОперационномВстроенномХранилище" Тогда
		...
		Результат = РежимИспользованияХранилищаДвоичныхДанных.Разрешить <> ХранилищеДвоичныхДанных.ПолучитьРежимИспользованияХранилищаДвоичныхДанных();
