...
//   *ПоказыватьРегистрироватьВРеестре - Булево - показывать флажок Регистрировать в реестре
//   *ЗарегистрированаВРеестре - Булево
//   *СостояниеРегистрации - Строка, ФорматированнаяСтрока - если ЗарегистрированаВРеестре = Истина,
//     тогда отображается в шапке, иначе около флажка регистрации. 
//   *ЗаголовокФлажкаРегистрации - Строка - заголовок флажка
