...
// См. ЭлектроннаяПодписьСлужебныйПовтИсп.ОписаниеКомпоненты
Функция ОписаниеКомпоненты() Экспорт
	
	Возврат СтандартныеПодсистемыКлиент.ПараметрыРаботыКлиента().ЭлектроннаяПодпись.ОписаниеКомпоненты;
