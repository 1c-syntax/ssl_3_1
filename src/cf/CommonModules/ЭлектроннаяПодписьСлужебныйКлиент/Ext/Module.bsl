...
Процедура ПослеСбораТехническойИнформацииОПрограммах(ИнформацияОПрограммах, Контекст) Экспорт
	...
	АдресФайлаТехническойИнформации = ЭлектроннаяПодписьСлужебныйВызовСервера.АдресФайлаТехническойИнформации(
		Контекст.СопроводительныйТекст, ПроверенныеПутиКМодулямПрограмм());
	
	Контекст.ДополнительныеФайлы.Добавить(
		Новый Структура("Имя, Данные", ИмяФайлаТехническойИнформации() + ".txt", АдресФайлаТехническойИнформации));
