...
Процедура ПередПериодическойОтправкойДанныхКлиентаНаСервер(Параметры) Экспорт
	...
	Если ПараметрыПриложенияЦентрМониторинга["ДатаПоследнегоВызова"] + 20*60 > ТекущаяДатаСеанса Тогда
		Возврат;
	КонецЕсли;
	ПараметрыПриложенияЦентрМониторинга["ДатаПоследнегоВызова"] = ТекущаяДатаСеанса;
...
Функция ПолучитьПараметрыПриложения() Экспорт
    ...
    Если ПараметрыПриложения[ИмяПараметра] = Неопределено Тогда
		...
		ЦентрМониторингаПараметрыПриложения.Вставить("ДатаПоследнегоВызова", ОбщегоНазначенияКлиент.ДатаСеанса());
