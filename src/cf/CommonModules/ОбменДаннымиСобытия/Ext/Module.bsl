...
//
// Параметры:
//   Объект - СправочникОбъект, ДокументОбъект - объект, для которого выполняется правило регистрации.
...
//
// Параметры:
//   ЭлементДанных - КонстантаМенеджерЗначения, СправочникОбъект, ДокументОбъект, РегистрСведенийНаборЗаписей, и т.п. -
//                   элемент данных.
...
//   Получатель - ПланОбменаСсылка, Неопределено - узел получателя.
		...
		Если ОбщегоНазначения.ЭтоОбъектСсылочногоТипа(МетаданныеЭлемента) Тогда
			...
			Для Каждого СтрокаДанные Из НаборДанных Цикл
				...
				Если ВыгрузкаОбъектаРазрешена(УзелОбъект.Ссылка, СсылкаНаОбъект.ПолучитьОбъект()) Тогда
					КоллекцияСсылок.Добавить(СсылкаНаОбъект);
				КонецЕсли;
