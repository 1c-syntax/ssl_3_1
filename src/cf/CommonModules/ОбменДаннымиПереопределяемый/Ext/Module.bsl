...
//
Процедура ПриПоискеИмениПланаОбменаЧерезУниверсальныйФормат(
	ИмяПланаОбмена, ИдентификаторНастройки, НайденноеИмяПланаОбмена) Экспорт
...
// Определяет завершена ли настройка синхронизации.
// Параметры:
//
//  СтандартнаяОбработка - Булево - в данный параметр передается признак выполнения
//  НастройкаЗавершена - Булево - Истина, настройка синхронизации завершена.
//  УзелОбмена - ПланОбменаОбъект - узел плана обмена, для которого требуется определить завершена ли настройка.
//
Процедура ПриОпределенииПризнакаОЗавершенииНастройкиСинхронизации(СтандартнаяОбработка, НастройкаЗавершена, УзелОбмена = Неопределено) Экспорт
	
КонецПроцедуры

// Возвращает список всех приоритетов конвертации для указанной версии формата EnterpriseData.
//
// Параметры:
