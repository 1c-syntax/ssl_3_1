...
// 
// Возвращаемое значение:
//  Структура - Параметры подписанта:
//    * ОГРН - Строка - ОГРН организации
//    * ИНН - Строка - ИНН организации
//    * ИННФЛ - Строка - ИНН физического лица
//   * Имя - Строка
//   * Отчество - Строка
//   * Фамилия - Строка
...
Функция ПараметрыПодписанта(Подписант) Экспорт
	...
	Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Подписант, 
		"ИНН, НомерТелефона, ИННФЛ, ОГРН, Имя, Отчество, Фамилия, Должность, Организация, НаименованиеОрганизации, ФизическоеЛицо, Наименование, Добавил");
