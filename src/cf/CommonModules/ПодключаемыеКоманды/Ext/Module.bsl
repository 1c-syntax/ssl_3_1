	...
	Для Каждого ВидКоманд Из ВидыКоманд Цикл
		...
		Если ЕстьКомандыПоУмолчанию Тогда
			...
			Если ГруппаВидаКоманд.Видимость Тогда
				...
				ГруппаСКомандамиПоУмолчанию = "ГруппаСКомандамиПоУмолчанию" + ПрефиксГрупп + ВидКоманд.ИмяПодменю;
				
				ГруппаСКомандамиПоУмолчанию = Элементы.Вставить(ГруппаСКомандамиПоУмолчанию, Тип("ГруппаФормы"),
