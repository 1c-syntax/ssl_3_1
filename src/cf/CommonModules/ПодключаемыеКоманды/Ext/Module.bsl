	...
	Для Каждого ВидКоманд Из ВидыКоманд Цикл
		...
		Для Каждого Команда Из КомандыВида Цикл 
			...
			Если СвойстваКорневогоПодменюКоманды = Неопределено Тогда
				...
				СвойстваКорневогоПодменюКоманды.ЕстьВКоманднойПанели = КнопкаФормы.ПоложениеВКоманднойПанели <> ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
...
//       * ПодключенныеОбъекты - Соответствие из КлючЗначения - кэш для быстрого определения списка объектов,
