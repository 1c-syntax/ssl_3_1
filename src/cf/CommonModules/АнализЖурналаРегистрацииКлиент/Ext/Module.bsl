...
//
// Параметры:
//   ФормаОтчета - ФормаКлиентскогоПриложения, РасширениеУправляемойФормыДляОтчета - Форма отчета.
//   Элемент - ПолеФормы, РасширениеПоляФормыДляПоляТабличногоДокумента - Табличный документ.
...
// Параметры:
//  ВыбранныйВариант - СписокЗначений - где:
//    * Значение - Строка - 
//  ПараметрыОбработчика - Структура - где:
//    * Расшифровка - ИдентификаторРасшифровкиКомпоновкиДанных - 
//    * ФормаОтчета - ФормаКлиентскогоПриложения, РасширениеУправляемойФормыДляОтчета - где:
