...
Процедура ДобавитьФайл(ПрисоединенныйФайл, ДвоичныеДанныеИлиПуть,
	...
	ЗаполнитьСведенияОФайле(ПрисоединенныйФайл, ДвоичныеДанныеИлиПуть, ДатаДляРазмещенияВТоме, ЗаполнятьСлужебныйРеквизитХранилище, ТомДляРазмещения);
...
Процедура ЗаполнитьСведенияОФайле(ПрисоединенныйФайл, ДвоичныеДанныеИлиПуть, 
	...
	РасширениеФайла = ПрисоединенныйФайл.Расширение;
	...
	Если ТипХраненияФайла = Перечисления.ТипыХраненияФайлов.ВТомахНаДиске Тогда
		ТипХраненияФайла = ТипХраненияФайла(РасширениеФайла, РазмерФайла);
	КонецЕсли;
	...
	Иначе
		...
		ТомХранения = ?(ЗначениеЗаполнено(ТомДляРазмещения), ТомДляРазмещения, СвободныйТом(РазмерФайла));
...
//                                  к файлу на диске.
//
Процедура ЗаписатьДанныеФайлаВТом(ПрисоединенныйФайл, ДвоичныеДанныеИлиПуть) Экспорт
