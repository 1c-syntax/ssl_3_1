...
//                       - см. См. РаботаСФайламиВТомахСлужебный.ПараметрыДобавленияФайла - элемент справочника
...
//                         - Строка - двоичные данные файла или полный путь к файлу на диске.
...
// Параметры:
//   ПрисоединенныйФайл  - ОпределяемыйТип.ПрисоединенныйФайлОбъект
//                       - см. РаботаСФайламиВТомахСлужебный.ПараметрыДобавленияФайла - элемент справочника 
...
Функция ОбъемыТомов(Тома)
	...
	Для Каждого Тип Из ТипыПрисоединенныхФайлов Цикл
		...
		ТекстыЗапросов.Добавить(СтрЗаменить(ШаблонаТекстаЗапроса, "&ИмяСправочника", 
			Метаданные.НайтиПоТипу(Тип).ПолноеИмя()));
	КонецЦикла;
