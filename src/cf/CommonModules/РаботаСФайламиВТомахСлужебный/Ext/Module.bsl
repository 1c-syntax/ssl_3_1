...
Процедура ДобавитьФайлыВТома(ПутьКАрхивуWindows, ПутьКАрхивуLinux) Экспорт
	...
	ZIPАрхив = Новый ЧтениеZipФайла(ПолноеИмяФайлаZip);
	ZIPАрхив.ИзвлечьВсе(ИмяКаталога, РежимВосстановленияПутейФайловZIP.НеВосстанавливать);
	
	СоответствиеПутейФайлов = Новый Соответствие;
	
	Для Каждого ZIPЭлемент Из ZIPАрхив.Элементы Цикл
