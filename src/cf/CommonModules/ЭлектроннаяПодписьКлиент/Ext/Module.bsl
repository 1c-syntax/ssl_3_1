...
// 
// Параметры:
//  Клиентские - Булево - получать отпечатки сертификатов на компьютере.
//  Серверные - Булево - получать отпечатки сертификатов на сервере.
//  Сервис - Булево - получать отпечатки сертификатов в сервисе.
// 
// Возвращаемое значение:
//  Структура - параметры получения отпечатков сертификатов:
...
//   * Серверные - Булево, Неопределено - получает отпечатки сертификатов пользователя ОС на сервере, если включена настройка,
//   если Неопределено, получение сертификатов пользователя ОС на сервере не будет осуществляться.
//   * Сервис - Булево, Неопределено - получает отпечатки сертификатов пользователя ОС в сервисе, если включена настройка,
//   если Неопределено, получение сертификатов на сервере DSS не будет осуществляться.
//
