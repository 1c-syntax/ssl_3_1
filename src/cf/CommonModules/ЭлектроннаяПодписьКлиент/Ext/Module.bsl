...
//                           - Структура - См. ЭлектроннаяПодписьКлиент.ПараметрыЗаписиСертификата.
//
Процедура ЗаписатьСертификатВСправочник(ОбработчикЗавершения,
	...
	ЭлектроннаяПодписьСлужебныйКлиент.СоздатьМенеджерКриптографии(
		...
		ЭлектроннаяПодписьСлужебныйКлиент, Контекст), "", Неопределено);
...
//                       - Структура - См. ЭлектроннаяПодписьКлиент.ПараметрыДобавленияСертификата.
//
// Пример:
