...
//                              Если ПараметрыПодписи.РазрешитьОтправкуНаПодписание = Истина, представление значения
//                              обязательно и должно содержать имя файла длиной не более 250 символов.
//    Вариант 2.
...
//                          Если ПараметрыПодписи.РазрешитьОтправкуНаПодписание = Истина, представление значения
//                          обязательно и должно содержать имя файла длиной не более 250 символов и без дублей
...
//                          сможет открыть пользователь. Имена файлов должны быть уникальны.
//
//  Форма - ФормаКлиентскогоПриложения - форма, из которой нужно получить уникальный идентификатор,
//                                который будет использоваться при блокировке объекта.
//        - УникальныйИдентификатор - уникальный идентификатор, который будет
