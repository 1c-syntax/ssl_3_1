...
//             = см. РезультатПроверкиПодписи - если ПараметрыПроверки.РезультатВВидеСтруктуры - Истина.
...
//   * РезультатВВидеСтруктуры - см. ЭлектроннаяПодписьКлиентСервер.РезультатПроверкиПодписи
//
...
Процедура ОткрытьПодпись(ТекущиеДанные) Экспорт
	...
	СвойстваПодписи = Новый Структура(
		...
		|Объект, ПорядковыйНомер, ТребуетсяПроверка");
