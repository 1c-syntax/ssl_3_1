...
Процедура ПередЗаписьюНаСервере(ТекущийОбъект) Экспорт
	...
	ИменаМультиязычныхРеквизитов = Новый Соответствие;
	...
	Если МультиязычныеСтрокиВРеквизитах(ОбъектМетаданных) Тогда
		...
		Если Не ОбщегоНазначения.ЭтоРегистр(ОбъектМетаданных) И ТекущийОбъект.ЭтоНовый()  Тогда
			...
			ИменаМультиязычныхРеквизитов = НаименованияЛокализуемыхРеквизитовОбъектаВШапке(ОбъектМетаданных);
			
			Для Каждого Реквизит Из ИменаМультиязычныхРеквизитов Цикл
	...
	Для каждого ИмяРеквизита Из Реквизиты Цикл
		...
		Если ИменаМультиязычныхРеквизитов[ИмяРеквизита] <> Неопределено Тогда
	...
	Если ИменаМультиязычныхРеквизитов.Количество() > 0 Тогда
		СкопироватьМультиязычныеЗначенияВРеквизитыШапки(ТекущийОбъект, ИменаМультиязычныхРеквизитов, КодПервогоДополнительногоЯзыкаИнформационнойБазы());
		СкопироватьМультиязычныеЗначенияВРеквизитыШапки(ТекущийОбъект, ИменаМультиязычныхРеквизитов, КодВторогоДополнительногоЯзыкаИнформационнойБазы());
	КонецЕсли;
