...
Функция МинимальнаяВерсияПлатформы() Экспорт // АПК:581 - экспортная, так как используется при тестировании.
	...
	Если ВерсияРежимаСовместимости = "8.3.21" Тогда
		Возврат "8.3.21.1775; 8.3.22.1923";
	ИначеЕсли ВерсияРежимаСовместимости= "8.3.22" Тогда
		Возврат "8.3.22.2355; 8.3.23.2011, 8.3.24.1304";
	ИначеЕсли ВерсияРежимаСовместимости= "8.3.23" Тогда
		Возврат "8.3.23.2011, 8.3.24.1304";
	КонецЕсли;
