...
//  ИнформацияПоКолонкам	 - ТаблицаЗначений - с колонками:
//     * Видимость - Булево - 
...
// 
// Параметры:
//  Объект - См. ВерсионированиеОбъектовПереопределяемый.ПриПодготовкеДанныхОбъекта.Объект
...
// Параметры:
//  Объект - См. ВерсионированиеОбъектовПереопределяемый.ПриВосстановленииВерсииОбъекта.Объект
//  ДополнительныеРеквизиты - См. ВерсионированиеОбъектовПереопределяемый.ПриВосстановленииВерсииОбъекта.ДополнительныеРеквизиты
// 
...
// 
// Параметры:
//  ВидыДоступа - См. УправлениеДоступомПереопределяемый.ПриЗаполненииВидовДоступа.ВидыДоступа
//
...
Процедура ДополнительныеРеквизитыОбработкаПроверкиЗаполнения(Источник, Отказ, ПроверяемыеРеквизиты) Экспорт
	...
	Если Проверка.ДополнительныеРеквизиты = Неопределено Тогда
		Возврат; // Не подключены дополнительные реквизиты.
	КонецЕсли;
	...
	ЗначенияСвойств = УправлениеСвойствами.ЗначенияСвойств(Источник.Ссылка, Истина, Ложь, Реквизиты);
	Если ЗначенияСвойств.Количество() = Результат.Количество() Тогда
		Возврат; // Реквизиты заполнены.
	КонецЕсли;
...
//   СтрокаТаблицы - СтрокаТаблицыЗначений - со свойствами:
...
//      * Условие - Строка -
//      * Значение - Строка, Число, Булево, Дата, ЛюбаяСсылка -
//
...
//                  - ДанныеФормыСтруктура - объект со свойствами:
//                       * Ссылка - ЛюбаяСсылка -
//  КлючНазначения - Строка -
//
// Возвращаемое значение:
//  ТаблицаЗначений - см. УправлениеСвойствамиПереопределяемый.ЗаполнитьНаборыСвойствОбъекта.НаборыСвойств
//
...
Функция ОтображатьЗакладкуДополнительно(Ссылка, Наборы) Экспорт
	...
	Запрос.Текст = 
		...
		|ИЗ
		|	[ИмяТаблицы].ДополнительныеРеквизиты КАК ДополнительныеРеквизиты
		|ГДЕ
