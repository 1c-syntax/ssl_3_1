...
Функция ВыполнитьРассылку(Отчеты, ПараметрыДоставки, НаименованиеРассылки = "", ПараметрыЖурнала = Неопределено) Экспорт
	...
	Для Каждого СтрокаПолучатель Из ДеревоОтчетов.Строки Цикл
		...
		Попытка
			...
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Отчеты отправлены ''%1'' от %2. %3'"),
				ПредставлениеПолучателя, ПредставлениеОтправителя, ДополнительныеСведения);
...
Функция ШаблонТемы() Экспорт
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = '%1 от %2'"), "[НаименованиеРассылки]", "[ДатаВыполнения(ДЛФ='D')]");
КонецФункции
...
Функция ШаблонИмениАрхива() Экспорт
	...
	Возврат "[НаименованиеРассылки]_[ДатаВыполнения(ДФ='yyyy-MM-dd')]";
