...
Асинх Функция ПодключитьКомпонентуАсинх(Контекст) Экспорт
	...
	Если Не Контекст.ВыполненПоискНовойВерсии Тогда
		...
		Если Контекст.Кэшировать Тогда
			...
			ПровереноПодключение = Неопределено;

			Если ПодключаемыйМодуль <> Неопределено Тогда
				ПровереноПодключение = ПроверитьПодключениеВнешнейКомпоненты(Контекст.Местоположение,
					Контекст.Идентификатор);
				Если ПровереноПодключение Тогда
			...
			Если ПровереноПодключение <> Ложь Тогда
			...
			// Если в кэше уже есть символическое имя - значит к этому сеансу ранее компонента уже подключалась.
					...
					Если ПровереноПодключение = Неопределено Тогда
						ПровереноПодключение = ПроверитьПодключениеВнешнейКомпоненты(Контекст.Местоположение,
							Контекст.Идентификатор);
					КонецЕсли;
			...
			Если ПровереноПодключение = Ложь Тогда
				ОчиститьОбъектКомпонентыВКэше(Контекст.Местоположение);
			КонецЕсли;
