...
Функция СведенияОбОрганизации(Знач Организация, Знач Поля = "", Знач Дата = Неопределено, Знач КодЯзыка = Неопределено) Экспорт
	...
	ОбщиеСведения.Добавить(РегистрационныеДанныеОрганизации(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(ДополнительныеСведенияОрганизации(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(КонтактнаяИнформацияОрганизации(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(БанковскийСчетОрганизации(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(РегистрационныеДанныеОбособленногоПодразделения(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(КонтактнаяИнформацияОбособленногоПодразделения(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(РегистрационныеДанныеОтделенияИностраннойОрганизации(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(КонтактнаяИнформацияОтделенияИностраннойОрганизации(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(РегистрационныеДанныеИндивидуальногоПредпринимателя(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(КонтактнаяИнформацияИндивидуальногоПредпринимателя(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(РегистрационныеДанныеРуководителяОрганизации(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(КонтактнаяИнформацияРуководителяОрганизации(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(РегистрационныеДанныеГлавногоБухгалтера(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(КонтактнаяИнформацияГлавногоБухгалтера(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(РегистрационныеДанныеУполномоченногоПредставителя(Организация, Поля, Дата, КодЯзыка));
	ОбщиеСведения.Добавить(КонтактнаяИнформацияУполномоченногоПредставителя(Организация, Поля, Дата, КодЯзыка));
		...
		Для каждого Элемент Из Сведения Цикл
			...
			Иначе
				ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
									НСтр("ru = 'Элемент с таким ключом ""%1"" уже определен.'"), Элемент.Ключ);
			КонецЕсли;
...
Функция РегистрационныеДанныеОтделенияИностраннойОрганизации(Знач Организация, Знач Поля = "", Знач Дата = Неопределено, Знач КодЯзыка = Неопределено) Экспорт
	...
	РегистрационныеДанные = Новый Структура();
	ОрганизацииПереопределяемый.ПриОпределенииРегистрационныхДанныхОтделенияИностраннойОрганизации(Организация, 
...
Функция РегистрационныеДанныеРуководителяОрганизации(Знач Организация, Знач Поля = "", Знач Дата = Неопределено, Знач КодЯзыка = Неопределено) Экспорт
	...
	ОрганизацииПереопределяемый.ПриОпределенииРегистрационныхДанныхРуководителяОрганизации(Организация, Поля, Дата, РегистрационныеДанныеРуководителя, КодЯзыка);
...
Функция КонтактнаяИнформацияРуководителяОрганизации(Знач Организация, Знач Поля = "", Знач Дата = Неопределено, Знач КодЯзыка = Неопределено) Экспорт
	...
	ОрганизацииПереопределяемый.ПриОпределенииКонтактнойИнформацииРуководителяОрганизации(Организация, Поля, Дата, КонтактнаяИнформацияРуководителя, КодЯзыка);
