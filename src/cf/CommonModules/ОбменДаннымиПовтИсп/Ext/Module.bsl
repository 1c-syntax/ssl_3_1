...
// Устарела. Следует использовать новую (см. ОбменДаннымиПовтИсп.УзелПланаОбменаПоКоду).
//
...
Функция УзелПланаОбменаПоКоду(ИмяПланаОбмена, КодУзла) Экспорт
	...
	Возврат ОбменДаннымиСервер.УзелПланаОбменаПоКоду(ИмяПланаОбмена, КодУзла);
...
// Перечень метаданных объектов, входящих в составы планов обмена БСП, кроме РИБ,
// по которым могут быть зарегистрированы проблемы "Незаполненные реквизиты"
// и "Непроведенные документы".
//
// Возвращаемое значение:
//   Соответствие - ключ соответствия - метаданные объекта, значение - Истина.
//
Функция ОбъектыДляРегистрацииПроблемСДаннымиПриЗагрузке() Экспорт
...
// 
//  Возвращаемое значение:
//   Истина - узел принадлежит плану обмена сообщениями, иначе Ложь.
//
