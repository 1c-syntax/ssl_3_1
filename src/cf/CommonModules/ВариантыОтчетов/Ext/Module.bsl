...
// Параметры:
//  Настройки - см. ВариантыОтчетов.КоллекцияПредопределенныхВариантовОтчетов
//  ОтчетИлиПодсистема - СтрокаДереваЗначений, ОбъектМетаданныхОтчет, ОбъектМетаданныхПодсистема - Описание отчета
//                       или подсистемы, для которой устанавливается режим вывода.
...
//      * Истина - варианты группируются по отчету.
...
//      * Ложь - все варианты отчета считаются самостоятельными,
//               по умолчанию видны и выводятся независимо в панелях отчетов.
//               Этот режим использовался в версии 2.2.1 и ранее.
//      * "ПоОтчетам" - см. описание к значению Истина.
//      * "ПоВариантам" - см. описание к значению Ложь.
//
...
//      * ЭлементОтбора - Булево - если Ложь, то сбрасывается настройка "ЭлементОтбораКомпоновкиДанных".
//      * ЗначениеПараметраНастроек - Булево - если Ложь, то сбрасывается настройка "ЗначениеПараметраНастроекКомпоновкиДанных".
//      * ВыбранныеПоля - Булево - признак необходимости сброса настройки "ВыбранныеПоляКомпоновкиДанных" (возвращается
//                                 из ключа Прочие).
//      * Порядок - Булево - признак необходимости сброса настройки "ПорядокКомпоновкиДанных" (возвращается из ключа Прочие).
//      * ЭлементУсловногоОформления - Булево - признак необходимости сброса настройки
//          "ЭлементУсловногоОформленияКомпоновкиДанных" (возвращается из ключа Прочие).
//      * Прочие - Булево - если Истина, то сбрасываются прочие настройки, не описанные в структуре явно.
//
...
Процедура ПодготовитьЗапросОтчетовСПростымиОтборами(Знач Запрос, ТекстЗапроса, Знач ЕстьОтборПоТипамОтчетов, Знач ПараметрыПоиска)
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ИмяОтчета", ИмяОтчета);
...
Функция ЭтоПредопределенныйВариантОтчета(ВариантОтчета) Экспорт 
	...
	Если ТипВариантаОтчета = Тип("СправочникОбъект.ПредопределенныеВариантыОтчетов")
		Или ТипВариантаОтчета = Тип("СправочникОбъект.ПредопределенныеВариантыОтчетовРасширений") Тогда 
