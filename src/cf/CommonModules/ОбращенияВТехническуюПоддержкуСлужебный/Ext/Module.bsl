...
Процедура ПриСозданииНаСервере(Форма) Экспорт
	...
	ОпределитьВидимостьЭлементовФормы(ЭлементыФормы);
...
Процедура ОпределитьВидимостьЭлементовФормы(ЭлементыФормы)
...
Функция СообщенияВСлужбуТехническойПоддержкиДоступны()
	...
	РаботаСВнешнимиРесурсамиДоступна = Не РегламентныеЗаданияСервер.РаботаСВнешнимиРесурсамиЗаблокирована();
...
Функция РаботаСПочтовымиСообщениямиДоступна()
	...
	Возврат ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.РаботаСПочтовымиСообщениями");
