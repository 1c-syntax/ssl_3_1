...
Процедура ПолеТокенаНачалоВыбора(Элемент, Токен, СтандартнаяОбработка) Экспорт
...
Процедура ПолеТокенаИзменениеТекстаРедактирования(Элемент, Текст, СтандартнаяОбработка) Экспорт
...
Процедура ПоказатьИнформациюОбИнтеграции(Форма, ОписаниеИнтеграции, ОповещениеОбИзмененииИнтеграции) Экспорт
	...
	ИначеЕсли ОписаниеИнтеграции.Тип = ТипыИнтеграции.Max Тогда
		ИмяФормы = ИмяФормы + ".СозданиеБотаMax";
