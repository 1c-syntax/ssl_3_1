...
Функция МаксимальнаяОбщаяВерсияИнтерфейсаОбмена(ВерсииИнтерфейсаОбменаКорреспондента) Экспорт
	...
	Для Каждого Версия Из ВерсииИнтерфейсаОбменаКорреспондента Цикл
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ВыполнитьЗагрузкуДляУзлаИнформационнойБазыИзСервисаПередачиФайлов", Истина);
	Методы.Вставить("ВыполнитьВыгрузкуДляУзлаИнформационнойБазыВСервисПередачиФайлов", Истина);
