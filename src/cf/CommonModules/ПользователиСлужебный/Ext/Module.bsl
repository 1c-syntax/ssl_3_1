...
Процедура УстановитьНастройкиВосстановленияПароля(НастройкиВосстановленияПароля) Экспорт
	...
	Если ПользователиСлужебныйКлиентСервер.ВерсияПредприятияПоддерживаетВосстановлениеПаролей() Тогда
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Если Не ОбщегоНазначения.РазделениеВключено()
		И ПользователиСлужебныйКлиентСервер.ВерсияПредприятияПоддерживаетВосстановлениеПаролей() Тогда
...
Функция ДоступнаНастройкаВосстановленияПароля(УровеньДоступа) Экспорт
	...
	Возврат ПользователиСлужебныйКлиентСервер.ВерсияПредприятияПоддерживаетВосстановлениеПаролей();
...
Функция ОбновитьПочтуДляВосстановленияПароля(ПользовательСсылка, ОбъектАвторизации = Неопределено) Экспорт
	...
	Результат = "ОбновлениеНеТребуется";
...
Процедура ОбновитьВнешнегоПользователя(СсылкаНаОбъектАвторизации, ПометкаУдаленияОбъектаАвторизации)
	...
	Попытка
		...
		Если Не РезультатЗапроса.Пустой() Тогда
			...
			Если ПользователиСлужебныйКлиентСервер.ВерсияПредприятияПоддерживаетВосстановлениеПаролей()
