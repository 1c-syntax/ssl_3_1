...
Функция ОписаниеПользователя(Пользователь) Экспорт
	...
	Результат.Фотография = СвойстваПользователя.Фотография.Получить();
...
Процедура ПриДобавленииИсключенийПоискаСсылок(Массив) Экспорт
	...
	Массив.Добавить(Метаданные.Справочники.ВнешниеПользователи.Реквизиты.ОбъектАвторизации.ПолноеИмя());
...
Процедура ДобавитьПоляПользователейГруппы(Настройки)
	...
	ВыбранныеПоля = Настройки.Структура[0].Выбор;
...
Процедура ОбновитьВнешнегоПользователя(СсылкаНаОбъектАвторизации, ПометкаУдаленияОбъектаАвторизации)
	...
	|			ИЛИ ВнешниеПользователи.Недействителен = ЛОЖЬ
	|				И &ПометкаУдаленияОбъектаАвторизации)");
