...
Функция ПользователиДляВключенияВосстановленияПароля() Экспорт
	...
	Если ВнешниеПользователи.ИспользоватьВнешнихПользователей() Тогда
		Возврат ПользователиДляВключенияВосстановленияПароляСУчетомВнешнихПользователей();
	КонецЕсли;
...
Функция ПользователиДляВключенияВосстановленияПароляСУчетомВнешнихПользователей()	
