	...
	Если ЗначениеЗаполнено(ЭтоКоличествоКоллизий) Тогда
		...
		Иначе
			...
			Если ЗначениеЗаполнено(СтрокаПоиска) Тогда
				СтрокаОтбора = "ВерсииОбъектов.Комментарий ПОДОБНО &Комментарий";
...
Функция ЕстьПроблемыВерсийПриСинхронизацииДанных(УзлыОбмена) Экспорт
	...
	|	ВЫБОР
	|		КОГДА ВерсииОбъектов.Объект ЕСТЬ NULL
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ КАК ЕстьПроблемыВерсий
	|ИЗ
	|	РегистрСведений.ВерсииОбъектов КАК ВерсииОбъектов
	|ГДЕ
	|	НЕ ВерсииОбъектов.ВерсияПроигнорирована
	|	И ВерсииОбъектов.АвторВерсии В (&УзлыОбмена)
	...
	Если Выборка.Следующий() Тогда
		...
		Возврат Выборка.ЕстьПроблемыВерсий;
