...
Процедура ОчиститьУстаревшиеВерсииОбъектов() Экспорт
	...
	ПодготовитьПараметрыЗапроса(Запрос, ШаблонЗапроса, ТекстыЗапросов);
...
Процедура ПодготовитьПараметрыЗапроса(Запрос, ШаблонЗапроса, ТекстыЗапросов)
	...
	Для Индекс = 0 По ГраницыУдаленияОбъектов.Количество() - 1 Цикл
		...
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ГраницаУдаления", "&ГраницаУдаления" + ИндексСтрокой);
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&СписокТипов", "&СписокТипов" + ИндексСтрокой);
