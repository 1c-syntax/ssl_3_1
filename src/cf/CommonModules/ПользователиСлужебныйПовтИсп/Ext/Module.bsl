...
// Проверяет доступность восстановления пароля пользователя.
//
// Возвращаемое значение:
//  Булево - Истина, если платформа поддерживает восстановления пароля пользователя.
//
Функция ВерсияПредприятияПоддерживаетВосстановлениеПаролей() Экспорт
	...
	Возврат Свойства.ЗапрещеноВосстанавливатьПароль <> Неопределено
			Или Свойства.CannotRecoveryPassword <> Неопределено;
