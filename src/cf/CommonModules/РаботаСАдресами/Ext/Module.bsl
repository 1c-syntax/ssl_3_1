...
//   Поля - Массив - список полей для формирования адреса в нужном порядке. Например, "Регион", "Город".
//        - Строка - предопределенные варианты: "НаселенныйПункт" - возвращает адрес до уровня населенного 
//              пункта (без улицы и номера дома).
//        - Неопределено - набор полей по умолчанию.
// Возвращаемое значение:
