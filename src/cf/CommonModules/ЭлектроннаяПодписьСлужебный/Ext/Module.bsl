...
Функция ПредставлениеОшибки() Экспорт
	...
	ПредставлениеОшибки.Вставить("НеверныйХэшПодписи", Ложь);
...
Функция НовыйКлассификаторОшибокКриптографии()
	...
	Результат.Колонки.Добавить("НеверныйХэшПодписи", Новый ОписаниеТипов("Булево"));
...
Функция ПредставлениеКлассификатораОшибок(ДанныеКлассификатора) Экспорт
	...
	Для Каждого ИзвестнаяОшибка Из КлассификаторОшибок.Classifier Цикл
		...
		Если ЗначениеЗаполнено(Категория) Тогда
			НоваяОшибка.НеверныйХэшПодписи = ОшибкаНеверныйХэшПодписи(Категория);
			Если Не НоваяОшибка.НеверныйХэшПодписи Тогда
...
Функция ОшибкаНеверныйХэшПодписи(Категория)
