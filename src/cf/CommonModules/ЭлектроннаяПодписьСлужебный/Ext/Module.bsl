...
Процедура ДополнитьТехническойИнформациейОСервере(ТехническаяИнформация) Экспорт
	...
	Если ЭлектроннаяПодпись.СоздаватьЭлектронныеПодписиНаСервере()
		Или ЭлектроннаяПодпись.ПроверятьЭлектронныеПодписиНаСервере() Тогда
		
		ТехническаяИнформация = ТехническаяИнформация + Символы.ПС
			+ НСтр("ru = 'Электронная подпись на сервере не используется.'");
	Иначе
	...
	ТехническаяИнформация = ТехническаяИнформация
		+ Символы.ПС + ТехническаяИнформацияОВерсияхПодсистем()
		+ Символы.ПС + НСтр("ru = 'Режим работы информационной базы'") + " - "
		+ Формат(ОбщегоНазначения.ИнформационнаяБазаФайловая(), НСтр("ru = 'БЛ=Клиент-серверный; БИ=Файловый'"))
		+ Символы.ПС + НСтр("ru = 'Расширения:'") + Символы.ПС + ТехническаяИнформацияОРасширениях();
...
Функция ТехническаяИнформацияОПрограммах()
	...
	ДиагностическаяИнформация = НСтр("ru = 'Программы на сервере:'") + Символы.ПС;
...
Функция ТехническаяИнформацияОРасширениях()
	...
	Для Каждого Расширение Из Расширения Цикл
		...
		ПредставлениеРасширений = ПредставлениеРасширений
			...
			+ Формат(Расширение.Активно, НСтр("ru = 'БЛ=Включено; БИ=Отключено'")) + Символы.ПС;
