...
Функция НастройкиПодключенияПоОбработке(ПомощникСозданияОбмена) Экспорт
	...
	Настройки.ПоддерживаемыеОбъектыФормата = ПомощникСозданияОбмена.ПоддерживаемыеОбъектыФормата;
	Настройки.ПоддерживаемыеОбъектыФорматаКорреспондента = ПомощникСозданияОбмена.ПоддерживаемыеОбъектыФорматаКорреспондента;
