...
Функция СсылкиНаУдаляемыеОбъекты(Источник) Экспорт
	...
	ЗначенияПометокУдаления = ОбщегоНазначения.ЗначениеРеквизитаОбъектов(
		РезультатЗапроса.ВыгрузитьКолонку("Ссылка"),
		"ПометкаУдаления");
		
	СсылкиНаУдаляемыеОбъекты = Новый Соответствие;
	Для каждого ОбъектЗначениеПометки Из ЗначенияПометокУдаления Цикл
	
		Если ОбъектЗначениеПометки.Значение Тогда
			СсылкиНаУдаляемыеОбъекты.Вставить(
				ОбъектЗначениеПометки.Ключ, 
				РезультатЗапроса.Найти(ОбъектЗначениеПометки.Ключ, "Ссылка").Представление);
		КонецЕсли;
...
Функция СсылкиНаУдаляемыеОбъектыВРеквизитах(Источник, Реквизиты, ЭтоРегистрБухгалтерии = Ложь)
	ЗначенияСсылочныхТипов = Новый Массив;
	...
	Для Каждого Реквизит Из Реквизиты Цикл
		...
		ИначеЕсли СтрНайти(Реквизит.Имя,"Субконто") > 0 И ЭтоРегистрБухгалтерии Тогда 	
...
Функция СсылкиНаУдаляемыеОбъектыВНабореЗаписей(НаборЗаписей, Знач Реквизиты, ЭтоРегистрБухгалтерии = Ложь)
	ЗначенияСсылочныхТипов = Новый Массив;

	Для Каждого Запись Из НаборЗаписей Цикл
		ОбщегоНазначенияКлиентСервер.ДополнитьМассив(
			ЗначенияСсылочныхТипов,
			СсылкиНаУдаляемыеОбъектыВРеквизитах(Запись, Реквизиты, ЭтоРегистрБухгалтерии));
	КонецЦикла;
...
Функция СсылкиНаУдаляемыеОбъектыВРегистрах(Источник, МетаданныеИсточника)
	...
	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(МетаданныеИсточника, "Ресурсы") Тогда
		...
		ОбщегоНазначенияКлиентСервер.ДополнитьМассив(ЗначенияСсылочныхТипов, СсылкиНаУдаляемыеОбъектыВНабореЗаписей(
			Источник, Реквизиты, ЭтоРегистрБухгалтерии));
	КонецЕсли;
