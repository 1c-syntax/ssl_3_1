...
Функция ИнициализироватьСтруктуруСообщения() Экспорт
	...
	СтруктураСообщения.Вставить("ТекстПроизвольногоСообщения", "");
...
Функция ОписаниеПараметровШаблона() Экспорт
	...
	Результат.Вставить("МакетыВыгрузки",                  Новый Соответствие);
	Результат.Вставить("КомандыПечати",                   Новый Массив);
	Результат.Вставить("КомандыВыгрузки",                 Новый Массив);
...
Функция КонструкторПараметровОтправки(Шаблон, Предмет, УникальныйИдентификатор) Экспорт
	...
	ПараметрыОтправки.ДополнительныеПараметры.Вставить("МакетыВыгрузки", Новый Массив);
