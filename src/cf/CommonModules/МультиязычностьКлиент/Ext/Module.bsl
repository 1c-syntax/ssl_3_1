...
Процедура ПриОткрытии(Форма, Объект, Элемент, СтандартнаяОбработка) Экспорт
	...
	Иначе
		...
		КоличествоДополнительныхЯзыков = СтандартныеПодсистемыКлиент.ПараметрКлиента("КоличествоДополнительныхЯзыков");
		Для ПорядковыйНомерЯзыка = 1 По КоличествоДополнительныхЯзыков Цикл
			...
			Представления.Вставить(ИмяРеквизита + ИмяСуффиксаЯзыка, Объект[ИмяРеквизита + ИмяСуффиксаЯзыка]);
		КонецЦикла;
