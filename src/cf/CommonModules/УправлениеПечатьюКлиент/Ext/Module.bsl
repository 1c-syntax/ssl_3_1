...
//                        * ДополнительныеПараметры - Произвольный - дополнительные параметры оповещения.
//  НаПринтер            - Булево - не Если Истина, то вывод печатных форм будет произведен на принтер, иначе - на экран.
//
Процедура ВыполнитьКомандыПечати(МассивОбъектов, Команды, ОбработчикЗавершения, НаПринтер = Ложь) Экспорт
