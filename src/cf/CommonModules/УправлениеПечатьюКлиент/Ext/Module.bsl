...
Процедура ПриПереключенииЯзыка(Ответ, Параметры) Экспорт
	...
	Команда = Параметры.Команда; // КомандаФормы - 
	
	ВыбранныйЯзык = Сред(Команда.Имя, СтрДлина("Язык_") + 1);
	Форма.ТекущийЯзык = ВыбранныйЯзык;
	Форма.Элементы.Язык.Заголовок = Форма.Элементы[Команда.Имя].Заголовок;
