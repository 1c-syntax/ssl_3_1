...
// Используется для улучшения документирующих комментариев. Не предназначена для использования в других целях.
// 
// Возвращаемое значение:
//  Структура:
...
Процедура ПереключитьЯзык(Форма, Команда) Экспорт
	...
	Параметры.Вставить("ВыбранныйЯзык", Сред(Команда.Имя, СтрДлина("Язык_") + 1));

	КнопкаФормы = Форма.Элементы[Команда.Имя]; // КнопкаФормы
	Параметры.Вставить("Заголовок", КнопкаФормы.Заголовок);
