...
// Параметры:
//  РезультатОтчета - ПолеФормы, РасширениеПоляФормыДляПоляТабличногоДокумента
//  РазрезСвойствЗаголовков - см. СтандартныйРазрезСвойствЗаголовковОтчета
// 
// Возвращаемое значение:
//  СписокЗначений
//
...
Функция ЗаполнитьЗначенияФильтра(ПараметрыЗаполнения) Экспорт 
	...
	Для НомерСтроки = СвойстваЗаголовка.Низ + 1 По Документ.ВысотаТаблицы Цикл 
		...
		Если НомерСтроки > КоличествоЧитаемыхСтрок Тогда 
			Прервать;
		КонецЕсли;
