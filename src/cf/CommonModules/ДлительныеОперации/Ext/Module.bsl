...
//
//  ПараметрыВыполнения - см. ДлительныеОперации.ПараметрыВыполненияФункции;
//                      - ФормаКлиентскогоПриложения - форма, из которой из которой выполняется вызов;
//                      - УникальныйИдентификатор - идентификатор формы, из которой выполняется вызов.
//
//  Параметр1...ПараметрN - Произвольный - произвольные параметры вызова функции.
//                                         Количество параметров может быть от 0 до 7.
//
...
//
//  Параметр1...ПараметрN - Произвольный - произвольные параметры вызова процедуры.
//                                         Количество параметров может быть от 0 до 7.
//                                         Дополнительно последним параметром можно передать коллекцию
//                                         ПараметрыВыполненияПроцедуры для настройки выполнения фонового задания
//                                         (см. функцию ДлительныеОперации.ПараметрыВыполненияФункции).
//
// Возвращаемое значение:
//  Структура - параметры выполнения задания: 
//   * Статус               - Строка - "Выполняется", если задание еще не завершилось;
...
//  ПараметрыВыполнения    - см. функцию ДлительныеОперации.ПараметрыВыполненияВФоне.
//
// Возвращаемое значение:
//  Структура              - параметры выполнения задания: 
//   * Статус               - Строка - "Выполняется", если задание еще не завершилось;
