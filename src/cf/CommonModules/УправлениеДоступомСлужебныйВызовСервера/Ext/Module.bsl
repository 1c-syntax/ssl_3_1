...
Функция СписокТиповДляВыбора(Знач СоставТипов) Экспорт
	
	Список = Новый СписокЗначений;
	Для Каждого Тип Из СоставТипов.Типы() Цикл
		ОбъектМетаданных = Метаданные.НайтиПоТипу(Тип);
		Если ОбъектМетаданных = Неопределено Тогда
			Продолжить;
		КонецЕсли;
		Если ПравоДоступа("Просмотр", ОбъектМетаданных) Тогда
			Список.Добавить(Тип, Строка(Тип));
		КонецЕсли;
	КонецЦикла;
...
Функция ПолноеИмяТаблицыСсылочногоТипа(Знач ТипСсылки) Экспорт
