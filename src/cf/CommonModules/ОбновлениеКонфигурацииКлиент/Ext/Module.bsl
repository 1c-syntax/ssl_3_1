...
#Если Не ВебКлиент Тогда
	...
	Если СтрНайти(ПараметрЗапуска, "ВыполнитьОбновлениеИЗавершитьРаботу") Тогда 
		
		ФайлИнфо = Новый Файл(КаталогСкрипта);
		Если ФайлИнфо.Существует() Тогда // АПК:566 синхронные вызовы вне веб-клиента разрешены;
