...
Процедура ПоказатьПоискИУстановкуОбновлений(ПараметрыУстановкиОбновлений = Неопределено) Экспорт
	...
	Если ВозможенЗапускОбновления() Тогда
...
// Определяет возможно ли выполнить обновление конфигурации.
//
// Возвращаемое значение:
//  Булево - возможность обновления.
//
Функция ВозможенЗапускОбновления() Экспорт
...
#ИначеЕсли МобильныйКлиент Тогда
	...
	ВозможенЗапускОбновления = Ложь;
	ТекстСообщения = НСтр("ru = 'Обновление программы недоступно в мобильном клиенте.'");
