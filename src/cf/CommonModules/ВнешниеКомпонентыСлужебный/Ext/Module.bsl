...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Заполнение реквизитов ""%1"", ""%2"", ""%3"", которые ранее ошибочно были не заполнены, а также регистрация стандартных компонент для их автоматического обновления.'"),
...
Функция РеквизитыКомпоненты()
	...
	Реквизиты.Вставить("Windows_x86_ЯндексБраузер");
	Реквизиты.Вставить("Windows_x86_64_ЯндексБраузер");
	Реквизиты.Вставить("Linux_x86_ЯндексБраузер");
	Реквизиты.Вставить("Linux_x86_64_ЯндексБраузер");
	Реквизиты.Вставить("MacOS_x86_64_ЯндексБраузер");
	...
	Если ЧтениеXML.Имя = "bundle" И ЧтениеXML.ТипУзла = ТипУзлаXML.НачалоЭлемента Тогда
		Пока ЧтениеXML.Прочитать() Цикл
			Если ЧтениеXML.Имя = "component" И ЧтениеXML.ТипУзла = ТипУзлаXML.НачалоЭлемента Тогда
				...
				Если ОперационнаяСистема = "windows" И АрхитектураПлатформы = "i386"
						И ТипКомпоненты = "plugin" И (ПрограммаПросмотра = "chrome" 
				...
				Если ОперационнаяСистема = "windows" И АрхитектураПлатформы = "i386"
						И ТипКомпоненты = "plugin" И (ПрограммаПросмотра = "yandexbrowser" 
						Или ПрограммаПросмотра = "anychromiumbased") Тогда
				...
				Если ОперационнаяСистема = "macos" И (АрхитектураПлатформы = "x86_64"
						Или АрхитектураПлатформы = "universal") И ТипКомпоненты = "plugin"
						И (ПрограммаПросмотра = "yandexbrowser" 
						Или ПрограммаПросмотра = "anychromiumbased") Тогда
