...
Процедура УстановитьКонстантуНеИспользоватьРазделениеПоОбластямДанных(Параметры) Экспорт
	...
	ИначеЕсли ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.РаботаВМоделиСервиса.ОбменДаннымиВМоделиСервиса")
		И ОбщегоНазначения.ЭтоАвтономноеРабочееМесто() Тогда
		
		НовыеЗначения.Вставить("НеИспользоватьРазделениеПоОбластямДанных", Ложь);
		
		// При обновлении АРМ синхронизируем значения константы с ЭтоАвтономноеРабочееМесто
	...
	Для каждого КлючИЗначения Из НовыеЗначения Цикл
		...
		Если КлючИЗначения.Ключ = "НеИспользоватьРазделениеПоОбластямДанных"
			ИЛИ КлючИЗначения.Ключ = "СтандартныеПодсистемыВАвтономномРежиме" Тогда
		...
		ИначеЕсли КлючИЗначения.Ключ = "ЭтоАвтономноеРабочееМесто"
			И ОбщегоНазначения.ЭтоАвтономноеРабочееМесто() = Истина Тогда 
