...
Процедура ПотребоватьПерезапускСеансаПоПричинеДинамическогоОбновленияРасширенийПрограммы() Экспорт
	...
	ЭтоРазделенныйРежимБезРасширенийОбластиДанных = ЭтоРазделенныйРежимСеансаБезРазделителей();
	
	Если ЭтоРазделенныйРежимБезРасширенийОбластиДанных Тогда
		...
		Если ФоновоеЗадание <> Неопределено
		   И ФоновоеЗадание.РазделениеДанных.Количество() > 0 Тогда
			ЭтоРазделенныйРежимБезРасширенийОбластиДанных = Ложь;
		КонецЕсли;
	КонецЕсли;
