...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ОбновитьДатуПоследнегоИспользованияВерсииРасширений", Истина);
	Методы.Вставить("ДобавитьНовуюВерсиюРасширений", Истина);
	Методы.Вставить("УстановитьПоследнююВерсиюРасширений", Истина);
	Методы.Вставить("ЗаполнитьВсеПараметрыРаботыРасширенийФоновоеЗадание", Истина);
	Методы.Вставить("ЗаполнениеПараметровРаботыРасширений", Истина);
	Методы.Вставить("УдалениеУстаревшихПараметровРаботыВерсийРасширенийОбработчикЗадания", Истина);
	Методы.Вставить("ОбработкаСервисовИнтеграции", Истина);
...
Процедура ПриНастройкеПроверкиМетодовВызываемыхКакПроизвольныйКод(Настройки) Экспорт
	...
	Для Каждого РегламентноеЗадание Из Метаданные.РегламентныеЗадания Цикл
		ИменаПроцедур.Вставить(РегламентноеЗадание.ИмяМетода, Истина);
	КонецЦикла;
	
	ОписаниеОбработчика = Настройки.ОписаниеОбработчиков.Добавить();
	ОписаниеОбработчика.ИменаПроцедур = ИменаПроцедур;
	ОписаниеОбработчика.ЗаголовокОшибки = НСтр("ru = 'Обработчик регламентного задания (ручной запуск) ""%1"".'");
