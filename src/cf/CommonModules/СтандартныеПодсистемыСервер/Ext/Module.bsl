...
Функция ЭтоПредопределенныеДанные(Знач Элемент, ИмяРеквизита = "", ЗначениеРеквизита = "") Экспорт
	...
	ЗначенияРеквизитов.Вставить("ИмяПредопределенныхДанных", "");
	ЗначенияРеквизитов.Вставить("ИмяПредопределенногоНабора", "");
	ЗначенияРеквизитов.Вставить("ИмяПредопределенногоВида", "");
	ЗначенияРеквизитов.Вставить("ПредопределеннаяПапка", Ложь);
...
Процедура ПередЗапускомПрограммы()
	...
	Если Не ТекущийПользовательИБ.АутентификацияСтандартная
	   ...
	   И Не ТекущийПользовательИБ.АутентификацияOpenID
