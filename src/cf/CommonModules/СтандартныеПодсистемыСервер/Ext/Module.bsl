...
Функция МинимальнаяВерсияПлатформыДляЗапуска() Экспорт
	...
	Возврат "8.3.21.1622; 8.3.22.1704"; // Недопустимо менять в исправительных релизах.
...
Функция МинимальнаяВерсияПлатформыДляИспользования() Экспорт
	...
	Версии.Добавить("8.3.21", "8.3.22.2501; 8.3.23.2137; 8.3.24.1467;");
	Версии.Добавить("8.3.22", "8.3.22.2501; 8.3.23.2137; 8.3.24.1548; 8.3.25.1286");
	Версии.Добавить("8.3.23", "8.3.23.2137; 8.3.24.1548; 8.3.25.1286");
...
//
Функция ВерсииЗащищенногоПрограммногоКомплекса() Экспорт  // АПК:581 - экспортная, так как используется при тестировании.
	
	Версии = Новый Массив;
	Версии.Добавить("8.3.21.1676");
	Версии.Добавить("8.3.21.1901");
	Версии.Добавить("8.3.24.1440");
	Версии.Добавить("8.3.24.1599");
