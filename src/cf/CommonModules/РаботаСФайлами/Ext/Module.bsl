...
//
// Параметры:
//   ВладелецФайлов - ОпределяемыйТип.ВладелецПрисоединенныхФайлов - объект-приемник файлов.
//   ИмяСправочника - Строка - если требуется конвертация в указанную таблицу.
//
// Возвращаемое значение:
//  Соответствие:
