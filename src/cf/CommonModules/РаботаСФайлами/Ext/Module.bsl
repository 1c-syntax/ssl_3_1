...
//
// Пример:
//  1. Сохранение данных файла на сервере:
...
Функция ДобавитьФайл(ПараметрыФайла,
	...
	ПредварительноСохраняетсяНаДиск = (РаботаСФайламиВТомахСлужебный.ТипХраненияФайла(РасширениеБезТочки, ПрисоединенныйФайл.Размер) = Перечисления.ТипыХраненияФайлов.ВТомахНаДиске);
	
	Если ПрисоединенныйФайл.ТипХраненияФайла = Перечисления.ТипыХраненияФайлов.ВТомахНаДиске 
		И ПредварительноСохраняетсяНаДиск Тогда
			УстановитьОтключениеБезопасногоРежима(Истина);
	...
	Попытка
		...
		Иначе
			...
			Если Не ПредварительноСохраняетсяНаДиск Тогда
	...
	Исключение
		...
		Если ПредварительноСохраняетсяНаДиск Тогда
