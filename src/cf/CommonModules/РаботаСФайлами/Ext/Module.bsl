...
Функция ДвоичныеДанныеФайлов(Знач ПрисоединенныеФайлы, Знач ВызыватьИсключение = Истина) Экспорт
	...
	Если ЕстьРеквизитТекущаяВерсия Тогда
		Если РаботаСФайламиСлужебныйПовтИсп.ДедупликацияВыполнена() Тогда
			...
			|	ХранилищеФайлов.ХранилищеДвоичныхДанных.ДвоичныеДанные КАК ХранилищеФайла
			|ИЗ
			...
			|	ХранилищеФайлов.ХранилищеДвоичныхДанных.ДвоичныеДанные
			|ИЗ
			|	&ТаблицаПрисоединенныеФайлы КАК ПрисоединенныеФайлы
			|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ХранилищеФайлов КАК ХранилищеФайлов
		...
		Иначе
			...
			|		ИНАЧЕ ХранилищеФайлов.ХранилищеДвоичныхДанных.ДвоичныеДанные
	...
	Для Каждого ФайлИсточник Из ФайлыИсточник Цикл
		...
		Попытка
			...
			Если ПрисоединенныйФайл.ТипХраненияФайла = Перечисления.ТипыХраненияФайлов.ВИнформационнойБазе Тогда
				...
				РегистрыСведений.ХранилищеФайлов.ЗаписатьДвоичныеДанные(СсылкаНового, ХранилищеФайла.Получить());
			КонецЕсли;
