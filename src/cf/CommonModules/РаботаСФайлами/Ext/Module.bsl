...
Процедура СохранитьНастройкиСканированияПользователя(НастройкиСканированияПользователя, ИдентификаторКлиента) Экспорт
	...
	НастройкиСканирования = Новый Массив;
	
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("ПоказыватьДиалогСканера",
		НастройкиСканированияПользователя.ПоказыватьДиалогСканера, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("ИмяУстройства",
		НастройкиСканированияПользователя.ИмяУстройства, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("ФорматСканированногоИзображения",
		НастройкиСканированияПользователя.ФорматСканированногоИзображения, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("СохранятьВPDF",
		НастройкиСканированияПользователя.СохранятьВPDF, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("ФорматХраненияМногостраничный",
		НастройкиСканированияПользователя.ФорматХраненияМногостраничный, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("Разрешение",
		НастройкиСканированияПользователя.Разрешение, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("Цветность",
		НастройкиСканированияПользователя.Цветность, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("Поворот",
		НастройкиСканированияПользователя.Поворот, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("РазмерБумаги",
		НастройкиСканированияПользователя.РазмерБумаги, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("ДвустороннееСканирование",
		НастройкиСканированияПользователя.ДвустороннееСканирование, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("ИспользоватьImageMagickДляПреобразованияВPDF",
		НастройкиСканированияПользователя.ИспользоватьImageMagickДляПреобразованияВPDF, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("КачествоJPG",
		НастройкиСканированияПользователя.КачествоJPG, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("СжатиеTIFF",
		НастройкиСканированияПользователя.СжатиеTIFF, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("ПутьКПрограммеКонвертации",
		НастройкиСканированияПользователя.ПутьКПрограммеКонвертации, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("КаталогЖурналаСканирования",
		НастройкиСканированияПользователя.КаталогЖурналаСканирования, ИдентификаторКлиента));
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("ИспользоватьКаталогЖурналаСканирования",
	...
	НастройкиСканирования.Добавить(РаботаСФайламиСлужебный.СформироватьНастройкуСканирования("ФорматХраненияОдностраничный", ФорматХраненияОдностраничный, ИдентификаторКлиента));
	
	ОбщегоНазначенияВызовСервера.ХранилищеОбщихНастроекСохранитьМассив(НастройкиСканирования, Истина);
КонецПроцедуры
