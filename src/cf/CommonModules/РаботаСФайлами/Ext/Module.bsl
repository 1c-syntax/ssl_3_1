...
//	ПараметрыДанныхФайла.ИдентификаторФормы = УникальныйИдентификатор; // см. примечание ниже
//	Пока Выборка.Следующий() Цикл
//		МассивДанныхФайлов.Добавить(РаботаСФайлами.ДанныеФайла(Выборка.Файл, ПараметрыДанныхФайла));
//	КонецЦикла;
//  
//  Примечание. Установка идентификатора формы предотвращает преждевременную очистку временного хранилища из-за 
//  возможных серверных вызовов при открытии файлов (например, если файл зашифрован или когда открывается форма 
