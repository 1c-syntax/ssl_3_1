...
Функция ДвоичныеДанныеФайла(Знач ПрисоединенныйФайл, Знач ВызыватьИсключение = Истина) Экспорт
	...
	Возврат РаботаСФайламиСлужебный.ДвоичныеДанныеФайла(ПрисоединенныйФайл, ВызыватьИсключение);
...
Функция ДвоичныеДанныеФайлов(Знач ПрисоединенныеФайлы, Знач ВызыватьИсключение = Истина) Экспорт
	...
	Если ЕстьРеквизитТекущаяВерсия Тогда
		Если РаботаСФайламиСлужебныйПовтИсп.ДедупликацияВыполнена() Тогда
			...
			|		КОГДА ПрисоединенныеФайлы.ТипХраненияФайла = ЗНАЧЕНИЕ(Перечисление.ТипыХраненияФайлов.ВоВнешнемХранилищеДвоичныхДанных)
			|			ТОГДА ЕСТЬNULL(МестаХраненияДвоичныхДанных.ДвоичныеДанныеВОперационномВнешнемХранилище, НЕОПРЕДЕЛЕНО)
			|		КОГДА ПрисоединенныеФайлы.ТипХраненияФайла = ЗНАЧЕНИЕ(Перечисление.ТипыХраненияФайлов.ВоВстроенномХранилищеДвоичныхДанных)
	...
	Пока Выборка.Следующий() Цикл
		Если РаботаСФайламиВХранилищеДвоичныхДанныхСлужебный.ТипХраненияНеИспользуетДиски(Выборка.ТипХраненияФайла) Тогда
			...
			КонецЕсли;
		Иначе
			ДвоичныеДанные = РаботаСФайламиВТомахСлужебный.ДанныеФайла(Выборка.Ссылка, ВызыватьИсключение);
			Если ДвоичныеДанные <> Неопределено Тогда
				ДвоичныеДанныеФайлов.Вставить(Выборка.Ссылка, ДвоичныеДанные);
			КонецЕсли;
		КонецЕсли;
