...
Функция ПараметрыПолученияФайла() Экспорт
	...
	ПараметрыПолучения.Вставить("ПроверятьДоставкуПакетовПриОшибке", Истина);
	ПараметрыПолучения.Вставить("ПроверятьДоступКИнтернетСервисам", Истина);
...
#Если ВебКлиент Тогда
	ВызватьИсключение НСтр("ru = 'Прокси недоступен в веб-клиенте.'");
#Иначе
...
#Если ВебКлиент Тогда
	...
	Результат.Вставить("Представление", НСтр("ru = 'Прокси недоступен в веб-клиенте.'"));
	Возврат Результат;
