...
// Возвращает Истина, если тип является типом денежной суммы.
//
// Параметры:
//  ТипЗначения - Тип
//
...
//  Булево
//
Функция ЭтоТипДенежнойСуммы(ТипЗначения) Экспорт
	
	Возврат ТипЗначения = Метаданные.ОпределяемыеТипы.ДенежнаяСуммаЛюбогоЗнака.Тип
		Или ТипЗначения = Метаданные.ОпределяемыеТипы.ДенежнаяСуммаНеотрицательная.Тип;
