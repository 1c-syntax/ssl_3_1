...
Процедура ПриСозданииНаСервере_ФормаДокумента(Форма) Экспорт
	...
	ДекорацияСостояниеОригинала = Форма.Элементы.Добавить("ДекорацияСостояниеОригинала", Тип("ДекорацияФормы"), Форма);
...
//		Если Неопределено, тогда колонки будут расположены в конце списка.
//
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	// Команда "Установить оригинал получен" на командой панели списка 
		...
		Команда.Представление = НСтр("ru='Установить состояние ""Оригинал получен""'");
...
Процедура УстановитьНовоеСостояниеОригинала(ДанныеЗаписи, ИмяСостояния) Экспорт
	...
	Если ТипЗнч(ДанныеЗаписи) = Тип("Массив") Тогда
		Для Каждого Запись Из ДанныеЗаписи Цикл
			...
			Если Запись.СостояниеОригиналаПервичногоДокумента <> ИмяСостояния  Тогда
...
Процедура ОбработатьШтрихкод(Штрихкод) Экспорт
	...
	СсылкаПоШтрихкоду = СсылкаПоШтрихкодуТабличногоДокумента(СсылкаПоШтрихкоду);
