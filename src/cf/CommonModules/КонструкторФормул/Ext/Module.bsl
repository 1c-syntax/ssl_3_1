...
//   * ИдентификаторСтроки - Строка, Число
//   * ИмяСписка - Строка
//   * КоллекцииПолей - Неопределено, Массив из ДоступныеПоляКомпоновкиДанных - указывается при использовании компоновщика 
//      настроек, для учета случаев его переинициализации (например неявной, при перезапуске рабочего процесса).
//
