...
//
// Параметры:
//   ФормаОтчета       - ФормаКлиентскогоПриложения, РасширениеУправляемойФормыДляОтчета - форма отчета, в которую
//     добавляется команда, где:
...
//
// Возвращаемое значение:
//   Структура - см. СвойстваРасширеннойИнформацииОНастройках
//
...
// 	ДополнительныеНастройкиЭлементов - Соответствие, Неопределено, Произвольный - 
// 
// Возвращаемое значение:
//  Структура - содержит:
//  * ТолькоПользовательские - Булево - 
...
//  * НастройкиОтчета - Структура - см. ВариантыОтчетов.НастройкиФормыОтчета.
//  * ОтчетОбъектИлиПолноеИмя - ОтчетОбъект, Строка - 
//  * ДеревоВарианта - ДеревоЗначений - см. ДеревоВарианта
//  * НастройкиВарианта - ДеревоЗначений - см. ТаблицаНастроекВарианта
//  * ПользовательскиеНастройки - ТаблицыЗначений - см. ТаблицаПользовательскихНастроек
//  * ОтключаемыеСвязи - Массив - где:
//          * ПоТипу - ТаблицыЗначений - см. ТаблицаСвязейПоТипу
//          * ПараметровВыбора - ТаблицыЗначений - см. ТаблицаСвязейПараметровВыбора
//          * ОбъектовМетаданных - ТаблицыЗначений - см. ТаблицаСвязейОбъектовМетаданных
...
// 
// Параметры:
// 	Информация - Структура - см. СвойстваРасширеннойИнформацииОНастройках
...
// 	НаборСтрокДерева - КоллекцияСтрокДереваЗначений - 
// 	Подтип - Строка - 
// Возвращаемое значение:
...
// Параметры:
// 	Информация - Структура - см. СвойстваРасширеннойИнформацииОНастройках
// 	НастройкаВарианта - СтрокаДереваЗначений - 
//
...
// 	ДополнительныеПараметры - Структура - см. ВариантыОтчетов.НастройкиФормыОтчета
// 
// Возвращаемое значение:
// 	Структура - содержит:
...
// 	Сведения - Соответствие - см. ВидыСведений
...
// 	ЭлементыНастроек - ТаблицаЗначений - см. ПалитраКоллекцииЭлементовНастроек
