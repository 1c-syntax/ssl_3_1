...
// Параметры:
//  Отчет - ОтчетОбъект
//        - ВнешнийОтчетОбъект - отчет, которому необходимо установить схему.
...
//           - Структура - см. ВариантыОтчетов.ПодключитьОтчетИЗагрузитьНастройки.
...
//               - ВнешнийОтчетОбъект - проверяемый отчет.
