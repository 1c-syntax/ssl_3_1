...
//
// Параметры:
//   ФормаОтчета - ФормаКлиентскогоПриложения, РасширениеУправляемойФормыДляОтчета - форма, в которую добавляется
//     команда, где:
...
// 
// Параметры:
// 	Форма - ФормаКлиентскогоПриложения, РасширениеУправляемойФормыДляОтчета - 
...
//
// Возвращаемое значение:
//   см. СвойстваРасширеннойИнформацииОНастройках
//
Функция РасширеннаяИнформацияОНастройках(КомпоновщикНастроекКД, НастройкиОтчета, ОтчетОбъектИлиПолноеИмя, УсловияВывода = Неопределено) Экспорт
	...
	Информация = СвойстваРасширеннойИнформацииОНастройках(
		НастройкиКД, НастройкиОтчета, ОтчетОбъектИлиПолноеИмя, УсловияВывода, ДополнительныеНастройкиЭлементов);
	
	Для Каждого ПользовательскаяНастройкаКД Из ПользовательскиеНастройкиКД.Элементы Цикл
		ПользовательскиеНастройки = Информация.ПользовательскиеНастройки; // см. ТаблицаПользовательскихНастроек
		
		СвойстваНастройки = ПользовательскиеНастройки.Добавить();
...
// Конструктор коллекции расширенной информации о настройках отчета.
// 
// Параметры:
//   НастройкиКД - НастройкиКомпоновкиДанных -
//   НастройкиОтчета - Структура -
//   ОтчетОбъектИлиПолноеИмя - ОтчетОбъект, Строка -
//   УсловияВывода - Неопределено, Структура -
//     * ТолькоПользовательские - Булево -
//     * ТолькоБыстрые - Булево -
//     * ИдентификаторТекущегоУзлаКД - ИдентификаторКомпоновкиДанных, Неопределено - 
//   ДополнительныеНастройкиЭлементов - Соответствие, Неопределено - 
// 
// Возвращаемое значение:
//  Структура - содержит:
//    * ТолькоПользовательские - Булево - 
...
//    * НастройкиОтчета - см. ВариантыОтчетов.НастройкиФормыОтчета.
//    * ОтчетОбъектИлиПолноеИмя - ОтчетОбъект, Строка -
//    * ДеревоВарианта - см. ДеревоВарианта
//    * НастройкиВарианта - см. ТаблицаНастроекВарианта
//    * ПользовательскиеНастройки - см. ТаблицаПользовательскихНастроек
//    * ОтключаемыеСвязи - Массив - 
//    * Связи - Структура - где:
//        ** ПоТипу - см. ТаблицаСвязейПоТипу
//        ** ПараметровВыбора - см. ТаблицаСвязейПараметровВыбора
//        ** ОбъектовМетаданных - см. ТаблицаСвязейОбъектовМетаданных
//    * ДополнительныеНастройкиЭлементов - Соответствие - где:
//        ** Ключ - Строка - 
//        ** Значение - Структура - 
//    * СоответствиеИменОбъектовМетаданных - Соответствие - где:
//        ** Ключ - Тип - ссылочный тип.
//        ** Значение - Строка -
//    * Поиск - Структура - где:
//        ** НастройкиВариантаПоПолюКД - Соответствие - где:
//             *** Ключ - ПолеКомпоновкиДанных - 
//             *** Значение - см. ТаблицаНастроекВарианта
//        ** ПользовательскиеНастройки - Соответствие - где:
//             *** Ключ - ИдентификаторКомпоновкиДанных - 
//             *** Значение - см. ТаблицаПользовательскихНастроек 
//    * ПользовательскиеНастройки - см. ТаблицаПользовательскихНастроек
//    * ЕстьБыстрыеНастройки - Булево - 
//    * ЕстьОбычныеНастройки - Булево - 
//    * ЕстьНесуществующиеПоля - Булево - 
//    * ЕстьВложенныеОтчеты - Булево - 
//    * ЕстьВложенноеОформление - Булево - 
//    * ЕстьВложенныеПоля - Булево - 
//    * ЕстьВложенныеСортировки - Булево - 
//    * СвойстваГруппЭлементов - Структура - 
//    * ГруппыЭлементов - Соответствие - 
//    * ДеревоВариантаКорневаяСтрока - СтрокаДереваЗначений - 
//
Функция СвойстваРасширеннойИнформацииОНастройках(НастройкиКД, НастройкиОтчета, ОтчетОбъектИлиПолноеИмя,
	УсловияВывода, ДополнительныеНастройкиЭлементов)
	...
	ДеревоВарианта = ДеревоВарианта();
	Информация.Вставить("ДеревоВарианта", ДеревоВарианта);
	
	НастройкиВарианта = ТаблицаНастроекВарианта();
	Информация.Вставить("НастройкиВарианта", НастройкиВарианта);
	
	ПользовательскиеНастройки = ТаблицаПользовательскихНастроек();
	Информация.Вставить("ПользовательскиеНастройки", ПользовательскиеНастройки);
	
	Информация.Вставить("ОтключаемыеСвязи", Новый Массив);
	
	СвязиПоТипу = ТаблицаСвязейПоТипу();
	СвязиПараметровВыбора = ТаблицаСвязейПараметровВыбора();
	СвязиОбъектовМетаданных = ТаблицаСвязейОбъектовМетаданных(НастройкиОтчета, Информация.ОтчетОбъектИлиПолноеИмя);
	
	Связи = Новый Структура;
	Связи.Вставить("ПоТипу", СвязиПоТипу);
	Связи.Вставить("ПараметровВыбора", СвязиПараметровВыбора);
	Связи.Вставить("ОбъектовМетаданных", СвязиОбъектовМетаданных);
	
	Информация.Вставить("Связи", Связи);
	...
	Поиск.Вставить("НастройкиВариантаПоПолюКД", Новый Соответствие);
	Поиск.Вставить("ПользовательскиеНастройки", Новый Соответствие);
	
	Информация.Вставить("Поиск", Поиск);
	...
	СвойстваГруппЭлементов = СвойстваГруппыЭлементовФормы();
	Информация.Вставить("СвойстваГруппЭлементов", СвойстваГруппЭлементов);
...
Процедура ОчиститьРасширеннуюИнформациюОНастройках(ИнформацияОНастройках) Экспорт
	...
	ПользовательскиеНастройки = ИнформацияОНастройках.ПользовательскиеНастройки; // см. ТаблицаПользовательскихНастроек
	ПользовательскиеНастройки.Колонки.Очистить();
...
// Конструктор дерева вариантов отчетов.
// 
// Возвращаемое значение:
//   ДеревоЗначений - где:
//     * УзелКД - НастройкиКомпоновкиДанных -
//              - ТаблицаКомпоновкиДанных - 
//              - ДиаграммаКомпоновкиДанных - 
//     * ДоступнаяНастройкаКД - ДоступноеПолеКомпоновкиДанных - 
//                            - ДоступныеПараметрыКомпоновкиДанных -
//     * ПользовательскаяНастройкаКД - ЭлементОтбораКомпоновкиДанных -
//                                   - ЗначениеПараметраНастроекКомпоновкиДанных - 
//     * ПользовательскаяНастройка - СтрокаТаблицыЗначений - 
//     * ИдентификаторКД - ИдентификаторКомпоновкиДанных - 
//     * Идентификатор - Строка - 
//     * Тип - Строка - 
//     * Подтип - Строка - 
//     * Состояние - Строка - 
//     * ЕстьСтруктура - Булево - 
//     * ЕстьПоляИОформление - Булево - 
//     * Глобальная - Булево - 
//     * СодержитОтборы - Булево - 
//     * СодержитПоля - Булево - 
//     * СодержитСортировки - Булево - 
//     * СодержитУсловноеОформление - Булево - 
//     * Представление - Строка - 
//     * ПредставлениеПоУмолчанию - Строка - 
//     * Заголовок - Строка - 
//     * ВыводРазрешен - Булево - 
//     * ВыводитьТолькоФлажок - Булево - 
//
...
// Добавляет строку в дерево вариантов.
// 
// Параметры:
// 	Информация - см. СвойстваРасширеннойИнформацииОНастройках
// 	УзелКД - ДиаграммаКомпоновкиДанных - 
// 	       - НастройкиКомпоновкиДанных -
// 	       - НастройкиВложенногоОбъектаКомпоновкиДанных - 
// 	       - ТаблицаКомпоновкиДанных - 
// 	       - ГруппировкаКомпоновкиДанных - 
// 	НаборСтрокДерева - см. ДеревоВарианта
// 	Подтип - Строка - 
// Возвращаемое значение:
...
// Возвращает значение параметра вывода Заголовок.
//
// Параметры:
//  ПараметрыВывода - ЗначенияПараметровВыводаГруппировкиКомпоновкиДанных - 
...
// Конструктор коллекции настроек вариантов отчетов.
// 
// Возвращаемое значение:
...
//     * ПользовательскаяНастройкаКД - см. ТаблицаПользовательскихНастроек
//     * СтрокаДерева - см. ТаблицаНастроекВарианта
//     * ПользовательскаяНастройка 
//     * Владелец - см. ТаблицаНастроекВарианта
//     * Глобальная - Булево -
//     * ИмяКоллекции - Строка -
//     * ИдентификаторКД - ИдентификаторКомпоновкиДанных - 
//     * Идентификатор - Строка -
...
//     * Подтип - Строка -
//     * Состояние - Строка -
//     * ПолеКД - ПолеКомпоновкиДанных - 
//     * Значение - Неопределено - 
//     * ВидСравнения - ВидСравненияКомпоновкиДанных - 
//     * ВводСписком - Булево -
//     * ИнформацияОТипах - Структура - 
//     * ФормаВыбора - Строка -
//     * ОтмеченныеЗначения - СписокЗначений - 
//     * ПараметрыВыбора - 
//     * СвязьПоТипу 
...
//     * СписокЗначенийПереопределен - Булево -
//     * БыстрыйВыбор - Булево -
//     * ОграничиватьВыборУказаннымиЗначениями - Булево -
//     * СобытиеПриИзменении - Булево -
//     * Ширина - Число -
//     * ВыводитьВГруппеОсновныхНастроек - Булево -
//     * ПредставлениеПоУмолчанию - Строка -
//     * Представление - Строка -
//     * ВыводРазрешен - Булево -
//     * ВыводитьФлажок - Булево -
...
// Возвращает таблицу с описанием пользовательских настроек.
// 
// Возвращаемое значение:
// 	ТаблицаЗначений - где:
//   * УзелКД 
...
// Конструктор коллекции связей элементов настроек.
// 
// Параметры:
// 	НастройкиОтчета - Структура - 
// 	ОтчетОбъектИлиПолноеИмя - ОтчетОбъект, Строка - 
...
//   * ВедущийТип - Тип -
//   * ПодчиненныйТип - Тип -
//   * ПодчиненныйРеквизит - Строка -
//   * ЕстьВедущие - Булево -
//   * ЕстьПодчиненные - Булево -
//   * Ведущие - Массив -
//   * Подчиненные - Массив -
//   * ВедущийПолноеИмя - Строка -
//   * ПодчиненныйПолноеИмя - Строка -
//
Функция ТаблицаСвязейОбъектовМетаданных(НастройкиОтчета, ОтчетОбъектИлиПолноеИмя)
	...
	// Механизмы расширения.
	ИнтеграцияПодсистемБСП.ПриДополненииСвязиОбъектовМетаданных(Результат);
...
// Добавляет строку дерева значений с описанием настройки варианта отчета.
// 
// Параметры:
// 	НастройкиКД - НастройкиКомпоновкиДанных - 
// 	Информация - см. СвойстваРасширеннойИнформацииОНастройках
...
// Добавляет запись в коллекцию свойств элементов настроек отчета.
//
// Параметры:
//   Информация - см. СвойстваРасширеннойИнформацииОНастройках
//   УзелКД - НастройкиКомпоновкиДанных - 
...
//   НаборЭлементов - КоллекцияЗначенийПараметровКомпоновкиДанных -
//                  - КоллекцияЭлементовОтбораКомпоновкиДанных -
//                  - ГруппаЭлементовОтбораКомпоновкиДанных -
//                  - ВыбранныеПоляКомпоновкиДанных - 
//   Владелец - СтрокаДереваЗначений - 
...
//          - ГруппаВыбранныхПолейКомпоновкиДанных -
//          - ОтборКомпоновкиДанных - 
//   ЭлементКД - ЭлементОтбораКомпоновкиДанных - 
//             - ЗначениеПараметраНастроекКомпоновкиДанных - 
//             - ВыбранноеПолеКомпоновкиДанных - 
//             - ЭлементПорядкаКомпоновкиДанных - 
//   НастройкаВарианта - см. ТаблицаНастроекВарианта
//
...
// Добавляет запись в коллекции связей.
// 
// Параметры:
// 	Информация - см. СвойстваРасширеннойИнформацииОНастройках
// 	НастройкаВарианта - см. ТаблицаНастроекВарианта
...
Процедура ПриОпределенииПараметровВыбора(Информация, НастройкаВарианта)
	...
	// Механизмы расширения.
	ИнтеграцияПодсистемБСП.ПриОпределенииПараметровВыбораВариантыОтчетов(Неопределено, НастройкаВарианта);
	// Глобальные настройки вывода типов.
	...
	Для Каждого СвязьПараметровВыбора Из Связи.ПараметровВыбора Цикл
		...
		Иначе // Фиксированный параметр выбора.
			...
			Если Не ЗначениеЗаполнено Тогда
				Продолжить;
			КонецЕсли;
			Подчиненный.ПараметрыВыбора.Добавить(
				Новый ПараметрВыбора(СвязьПараметровВыбора.ПодчиненныйИмяПараметра, Ведущий.Значение));
		КонецЕсли;
	КонецЦикла;
КонецПроцедуры
...
// Добавляет запись с описанием пользовательской настройки.
// 
// Параметры:
// 	Информация - см. СвойстваРасширеннойИнформацииОНастройках
// 	СвойстваНастройки - СтрокаДереваЗначений - где:
// 	  * Обычная - Булево -
// 	СтрокаДерева - СтрокаДереваЗначений, Неопределено - 
// 	НастройкаВарианта - СтрокаДереваЗначений, Неопределено - 
// 
// Возвращаемое значение:
// 	СтрокаДереваЗначений -
//
...
// Определяет заголовок и признак пометки на удаление элемента настройки отчета.
// 
// Параметры:
// 	СвойстваНастройки - СтрокаДереваЗначений, Неопределено -
//    * Обычная - Булево -
// 	НастройкаВариантаКД - ЭлементОтбораКомпоновкиДанных -
// 	                    - ЗначениеПараметраКомпоновкиДанных - 
// 	                    - ВыбранноеПолеКомпоновкиДанных - 
// 	                    - ГруппаВыбранныхПолейКомпоновкиДанных - 
// 	ПользовательскаяНастройкаКД - Неопределено - 
// 	ДоступнаяНастройкаКД - ДоступноеПолеОтбораКомпоновкиДанных, ДоступныйПараметрКомпоновкиДанных - 
//
...
// 	ДополнительныеПараметры - см. ВариантыОтчетов.НастройкиФормыОтчета
// 
// Возвращаемое значение:
// 	Структура - содержит:
...
// 	Форма - ФормаКлиентскогоПриложения, РасширениеУправляемойФормыДляОтчета - 
// 	ЭлементыНастроек - см. ПалитраКоллекцииЭлементовНастроек
// 	СвойстваЭлементов - Структура - содержит:
//    * Группы - Структура -
//    * Поля - ТаблицаЗначений -
//
Процедура УстановитьСвойстваЭлементовФормыНастроек(Форма, ЭлементыНастроек, СвойстваЭлементов)
	...
	Для Каждого Элемент Из НайденныеЭлементы Цикл 
		...
		ИначеЕсли ТипЗнч(ЭлементНастройки) = Тип("ЭлементОтбораКомпоновкиДанных") Тогда 
			...
			ИначеЕсли Не ЗначениеЗаполнено(ЭлементНастройки.Представление) Тогда 
				Поле.Заголовок = Поле.Заголовок + " (" + НРег(ЭлементНастройки.ВидСравнения) + "):";
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
	...
	Для Каждого Элемент Из НайденныеЭлементы Цикл 
		...
		Если ТипЗнч(Поле) = Тип("ДекорацияФормы") Тогда 
			...
			СвязанноеПоле = НайденныеСвязанныеЭлементы.Получить(0).Поле; // ПолеФормы
...
// Параметры:
// 	ЭлементыНастроек - см. ПалитраКоллекцииЭлементовНастроек
// 	СвойстваЭлементов - Структура - Описание:
//   * Группы - Структура - 
//   * Поля - ТаблицаЗначений - 
//
...
Функция РеквизитыДобавляемыеЭлементовНастроек(ЭлементыНастроек, ВидыЭлементов, ИменаРеквизитов, ПутьКДаннымЭлементов)
	...
	Для Каждого ВидЭлемента Из ВидыЭлементов Цикл 
		...
		Для Каждого Элемент Из НайденныеЭлементы Цикл 
			...
			ШаблонИмениЭлемента = СтрЗаменить(Поле.Имя, СвойстваВидовЭлементов[ВидЭлемента], "%1");
...
// 	ОписаниеЭлементаНастройки - СтрокаТаблицыЗначений, Неопределено - 
// 	ИмяСписка - Строка - 
// 	ИменаРеквизитов - Структура - содержит:
//   * Сгенерированных - Структура -
//   * Предопределенных - Структура -
//
