...
// Отправляет сообщение менеджеру сервиса об изменении наличия прав для входа в программу.
// 
// Параметры:
//  Пользователь - СправочникСсылка.Пользователи
//  ЕстьПрава    - Булево - новое наличие прав на запуск.
//
Процедура СообщитьЕстьПраваДляВходаВПрограмму(Пользователь, ЕстьПрава) Экспорт
	...
	ИнфоПользователя.Вставить("ЕстьПрава", ЕстьПрава);
