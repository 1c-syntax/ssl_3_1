...
Функция СвойстваСертификата(Сертификат) Экспорт
	...
	Возврат ЭлектроннаяПодписьСлужебныйКлиентСервер.СвойстваСертификата(
		Сертификат, ЭлектроннаяПодписьСлужебный.РазницаСУниверсальнымВременем(), ДвоичныеДанныеСертификата);
...
//    * Значение - источник получения
//                      "Сервер", "Сервис".
//                       если ПараметрыПолучения - Булево, то Значение = Истина (для обратной совместимости)
//
