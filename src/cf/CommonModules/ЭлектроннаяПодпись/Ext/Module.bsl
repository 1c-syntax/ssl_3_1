				...
				Если ОбновитьПоПорядковомуНомеру Тогда
					Для Каждого КлючИЗначение Из СвойстваПодписи Цикл
						Если КлючИЗначение.Ключ = "Сертификат"
							...
							Или КлючИЗначение.Ключ = "РезультатПроверкиПодписиПоМЧД" Тогда
							Продолжить;
						КонецЕсли;
				...
				Иначе
					...
					Для Каждого КлючИЗначение Из СвойстваПодписи Цикл
						Если КлючИЗначение.Ключ = "Сертификат"
							...
							Или КлючИЗначение.Ключ = "ИдентификаторПодписи" И ЗначениеЗаполнено(ОбновляемаяПодпись.ИдентификаторПодписи)
							Или КлючИЗначение.Ключ = "РезультатПроверкиПодписиПоМЧД" Тогда
							Продолжить;
						КонецЕсли;
