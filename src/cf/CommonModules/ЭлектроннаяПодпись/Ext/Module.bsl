	...
	Попытка
		...
		Для Каждого ПодписьОбъекта Из ПодписиОбъекта Цикл
			...
			Если ОбновитьПоПорядковомуНомеру И ПодписьОбъекта.ПорядковыйНомер = СвойстваПодписи.ПорядковыйНомер 
				...
				НаборЗаписей.Отбор.ПорядковыйНомер.Установить(ПодписьОбъекта.ПорядковыйНомер);
				...
				Если ОбновитьПоПорядковомуНомеру И ПодписьОбъекта.ПорядковыйНомер = СвойстваПодписи.ПорядковыйНомер Тогда
...
Функция ШтампыВизуализацииЭлектронныхПодписей(Знач ПодписанныйФайл, Знач ЭлектронныеПодписи = Неопределено,
	...
	ПараметрыШтампов = ЭлектроннаяПодписьСлужебный.ПараметрыШтампов(ЭлектронныеПодписи, ТекстыОтметок);
...
Функция УсовершенствоватьПодпись(Подпись, ТипПодписи, ДобавитьАрхивнуюМеткуВремени = Ложь,
	...
	ПараметрыУсовершенствования.Вставить("ВыполнятьПроверкуУдостоверяющегоЦентра",
	...
	ПараметрыПроверки.Вставить("ВыполнятьПроверкуУдостоверяющегоЦентра",
		ПараметрыУсовершенствования.ВыполнятьПроверкуУдостоверяющегоЦентра);
	
	РезультатПроверкиСертификата = ПроверитьСертификат(МенеджерКриптографии,
		ПараметрыПодписиКриптографии.СертификатПоследнейМеткиВремени, ОписаниеОшибки,, ПараметрыПроверки);
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса.БазоваяФункциональность") Тогда
		Методы.Вставить("ПродлениеДостоверностиПодписей");
	КонецЕсли;
