...
Функция ИгнорироватьПроблему(ОтчетДанныеРасшифровки, ТабличныйДокумент, ИндексРасшифровки) Экспорт
	...
	Запрос.УстановитьПараметр("КлючУникальности", Результат.КлючУникальности);
	Запрос.Текст = 
		"ВЫБРАТЬ
		...
		|	И РезультатыПроверкиУчета.КлючУникальности = &КлючУникальности";
...
Функция РасшифровкаВыделеннойЯчейки(ОтчетДанныеРасшифровки, ТабличныйДокумент, ИндексРасшифровки) Экспорт
	...
	Результат.Вставить("КлючУникальности");
	...
	Результат.КлючУникальности = Новый УникальныйИдентификатор(ЗначениеЧастями[5]);
