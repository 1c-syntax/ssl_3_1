...
Функция ЗаполнитьРезультатПроверкиАдресаПоКлассификаторуСервис1С(Знач АдресаДляПроверки,
	...
	Если РезультатПроверки.КодСостояния <> 200 
		И РезультатПроверки.КодСостояния <> 400 Тогда
		
		ОписаниеСервиса.СервисКлассификатора = СервисКлассификатора1С(20);
		Сервис = ОписаниеСервиса.СервисКлассификатора;
...
Функция ВыполнитьЗапросЧерезВебСервис(СтрокаЗапроса, ВремяОжидания = 60)
	...
	Если Ответ.КодСостояния <> 200 Тогда
		...
		ОписаниеСервиса.СервисКлассификатора = СервисКлассификатора1С(ВремяОжидания);
		Сервис = ОписаниеСервиса.СервисКлассификатора;
