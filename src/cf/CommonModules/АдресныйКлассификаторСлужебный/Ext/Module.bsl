...
Процедура УстановитьИдентификаторыАдресаПоЗагруженнымДанным(Адрес)
	...
	|	АдресныеОбъектыУровень0.ДополнительныеАдресныеСведения КАК ДополнительныеСведения0,
	...
	|	АдресныеОбъектыУровень1.ДополнительныеАдресныеСведения КАК ДополнительныеСведения1,
	...
	|	АдресныеОбъектыУровень2.ДополнительныеАдресныеСведения КАК ДополнительныеСведения2,
	...
	|	АдресныеОбъектыУровень3.ДополнительныеАдресныеСведения КАК ДополнительныеСведения3,
	...
	|	АдресныеОбъектыУровень4.ДополнительныеАдресныеСведения КАК ДополнительныеСведения4,
	...
	|	АдресныеОбъектыУровень5.ДополнительныеАдресныеСведения КАК ДополнительныеСведения5,
	|	ВЫБОР
	|		КОГДА НЕ АдресныеОбъектыУровень5.Идентификатор ЕСТЬ NULL
	|			ТОГДА АдресныеОбъектыУровень5.Идентификатор
	|		ИНАЧЕ ВЫБОР
	|				КОГДА НЕ АдресныеОбъектыУровень4.Идентификатор ЕСТЬ NULL
	|					ТОГДА АдресныеОбъектыУровень4.Идентификатор
	|				ИНАЧЕ ВЫБОР
	|						КОГДА НЕ АдресныеОбъектыУровень3.Идентификатор ЕСТЬ NULL
	|							ТОГДА АдресныеОбъектыУровень3.Идентификатор
	|						ИНАЧЕ ВЫБОР
	|								КОГДА НЕ АдресныеОбъектыУровень2.Идентификатор ЕСТЬ NULL
	|									ТОГДА АдресныеОбъектыУровень2.Идентификатор
	|								ИНАЧЕ ВЫБОР
	|										КОГДА НЕ АдресныеОбъектыУровень1.Идентификатор ЕСТЬ NULL
	|											ТОГДА АдресныеОбъектыУровень1.Идентификатор
	|										ИНАЧЕ ВЫБОР
	|												КОГДА НЕ АдресныеОбъектыУровень0.Идентификатор ЕСТЬ NULL
	|													ТОГДА АдресныеОбъектыУровень0.Идентификатор
	|												ИНАЧЕ АдресныеОбъектыУровень0.Идентификатор
	|											КОНЕЦ
	|									КОНЕЦ
	|							КОНЕЦ
	|					КОНЕЦ
	...
	|		ПО АдресныеОбъектыУровень1.Наименование = &Наименование1
	|			И АдресныеОбъектыУровень1.Сокращение = &Сокращение1
	|			И (АдресныеОбъектыУровень0.Идентификатор = АдресныеОбъектыУровень1.РодительскийИдентификатор
	|			ИЛИ ИСТИНА В (ВЫБРАТЬ ПЕРВЫЕ 1 ИСТИНА ИЗ РегистрСведений.СвязиАдресныхОбъектов КАК СвязанныеАдресныеОбъектыУровень1
	|			ГДЕ (АдресныеОбъектыУровень1.Идентификатор = СвязанныеАдресныеОбъектыУровень1.Идентификатор) И
	|			 (СвязанныеАдресныеОбъектыУровень1.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень0.Идентификатор)))
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдресныеОбъекты КАК АдресныеОбъектыУровень2
	|		ПО АдресныеОбъектыУровень2.Наименование = &Наименование2
	|			И АдресныеОбъектыУровень2.Сокращение = &Сокращение2
	|			И (АдресныеОбъектыУровень1.Идентификатор = АдресныеОбъектыУровень2.РодительскийИдентификатор
	|			ИЛИ ИСТИНА В (ВЫБРАТЬ ПЕРВЫЕ 1 ИСТИНА ИЗ РегистрСведений.СвязиАдресныхОбъектов КАК СвязанныеАдресныеОбъектыУровень2
	|			ГДЕ (АдресныеОбъектыУровень2.Идентификатор = СвязанныеАдресныеОбъектыУровень2.Идентификатор) И
	|			 (СвязанныеАдресныеОбъектыУровень2.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень1.Идентификатор)))
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдресныеОбъекты КАК АдресныеОбъектыУровень3
	|		ПО АдресныеОбъектыУровень3.Наименование = &Наименование3
	|			И АдресныеОбъектыУровень3.Сокращение = &Сокращение3
	|			И (АдресныеОбъектыУровень2.Идентификатор = АдресныеОбъектыУровень3.РодительскийИдентификатор
	|			ИЛИ ИСТИНА В (ВЫБРАТЬ ПЕРВЫЕ 1 ИСТИНА ИЗ РегистрСведений.СвязиАдресныхОбъектов КАК СвязанныеАдресныеОбъектыУровень3
	|			ГДЕ (АдресныеОбъектыУровень3.Идентификатор = СвязанныеАдресныеОбъектыУровень3.Идентификатор) И
	|			 (СвязанныеАдресныеОбъектыУровень3.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень2.Идентификатор)))
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдресныеОбъекты КАК АдресныеОбъектыУровень4
	|		ПО АдресныеОбъектыУровень4.Наименование = &Наименование4
	|			И АдресныеОбъектыУровень4.Сокращение = &Сокращение4
	|			И (АдресныеОбъектыУровень3.Идентификатор = АдресныеОбъектыУровень4.РодительскийИдентификатор
	|			ИЛИ ИСТИНА В (ВЫБРАТЬ ПЕРВЫЕ 1 ИСТИНА ИЗ РегистрСведений.СвязиАдресныхОбъектов КАК СвязанныеАдресныеОбъектыУровень4
	|			ГДЕ (АдресныеОбъектыУровень4.Идентификатор = СвязанныеАдресныеОбъектыУровень4.Идентификатор) И
	|			 (СвязанныеАдресныеОбъектыУровень4.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень3.Идентификатор)))
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдресныеОбъекты КАК АдресныеОбъектыУровень5
	|		ПО АдресныеОбъектыУровень5.Наименование = &Наименование5
	|			И АдресныеОбъектыУровень5.Сокращение = &Сокращение5
	|			И (АдресныеОбъектыУровень4.Идентификатор = АдресныеОбъектыУровень5.РодительскийИдентификатор
	|			ИЛИ ИСТИНА В (ВЫБРАТЬ ПЕРВЫЕ 1 ИСТИНА ИЗ РегистрСведений.СвязиАдресныхОбъектов КАК СвязанныеАдресныеОбъектыУровень5
	|			ГДЕ (АдресныеОбъектыУровень5.Идентификатор = СвязанныеАдресныеОбъектыУровень5.Идентификатор) И
	|			 (СвязанныеАдресныеОбъектыУровень5.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень4.Идентификатор)))
	|ГДЕ
	|	АдресныеОбъектыУровень0.Наименование = &Наименование0
	|	И АдресныеОбъектыУровень0.Сокращение = &Сокращение0
	|	И АдресныеОбъектыУровень0.Уровень = 1
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ ПЕРВЫЕ 50
	...
	Адреса                = РезультатЗапроса[0];
	Дома                  = РезультатЗапроса[1];
...
Процедура ЗаполнитьАктуальныеАдресныеСведенияВнутр(Результат, Значение)
	...
	ТекстЗапроса = "ВЫБРАТЬ ПЕРВЫЕ 1
	               ...
	               |	ЕСТЬNULL(АдресныеОбъектыУровень0.Наименование, """") КАК НаименованиеУровень0,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень0.Сокращение, """")  КАК СокращениеУровень0,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень0.Идентификатор, """") КАК ИдентификаторУровень0,
	               |	АдресныеОбъектыУровень0.КодСубъектаРФ КАК КодСубъектаРФ,
	               |	АдресныеОбъектыУровень0.КодКЛАДР КАК КодКЛАДР,
	               |	АдресныеОбъектыУровень0.ДополнительныеАдресныеСведения КАК ДополнительныеАдресныеСведения,
	               |	АдресныеОбъектыУровень0.Уровень КАК Уровень0,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень1.Наименование, """") КАК НаименованиеУровень1,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень1.Сокращение, """")  КАК СокращениеУровень1,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень1.Идентификатор, """") КАК ИдентификаторУровень1,
	               |	АдресныеОбъектыУровень1.Уровень КАК Уровень1,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень2.Наименование, """") КАК НаименованиеУровень2,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень2.Сокращение, """")  КАК СокращениеУровень2,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень2.Идентификатор, """") КАК ИдентификаторУровень2,
	               |	АдресныеОбъектыУровень2.Уровень КАК Уровень2,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень3.Наименование, """") КАК НаименованиеУровень3,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень3.Сокращение, """")  КАК СокращениеУровень3,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень3.Идентификатор, """") КАК ИдентификаторУровень3,
	               |	АдресныеОбъектыУровень3.Уровень КАК Уровень3,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень4.Наименование, """") КАК НаименованиеУровень4,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень4.Сокращение, """")  КАК СокращениеУровень4,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень4.Идентификатор, """") КАК ИдентификаторУровень4,
	               |	АдресныеОбъектыУровень4.Уровень КАК Уровень4,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень5.Наименование, """") КАК НаименованиеУровень5,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень5.Сокращение, """") КАК СокращениеУровень5,
	               |	ЕСТЬNULL(АдресныеОбъектыУровень5.Идентификатор, """") КАК ИдентификаторУровень5,
	               ...
	               |	РегистрСведений.АдресныеОбъекты КАК АдресныеОбъектыУровень0
	               |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдресныеОбъекты КАК АдресныеОбъектыУровень1
	               |		ПО АдресныеОбъектыУровень0.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень1.Идентификатор
	               |			ИЛИ ИСТИНА В (ВЫБРАТЬ ПЕРВЫЕ 1 ИСТИНА ИЗ 
	               |			РегистрСведений.СвязиАдресныхОбъектов КАК СвязанныеАдресныеОбъектыУровень1
	               |			ГДЕ (АдресныеОбъектыУровень0.Идентификатор = СвязанныеАдресныеОбъектыУровень1.Идентификатор)
	               |			И (СвязанныеАдресныеОбъектыУровень1.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень1.Идентификатор))
	               |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдресныеОбъекты КАК АдресныеОбъектыУровень2
	               |		ПО (АдресныеОбъектыУровень1.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень2.Идентификатор)
	               |			ИЛИ ИСТИНА В (ВЫБРАТЬ ПЕРВЫЕ 1 ИСТИНА ИЗ 
	               |			РегистрСведений.СвязиАдресныхОбъектов КАК СвязанныеАдресныеОбъектыУровень2
	               |			ГДЕ (АдресныеОбъектыУровень1.Идентификатор = СвязанныеАдресныеОбъектыУровень2.Идентификатор)
	               |			И (СвязанныеАдресныеОбъектыУровень2.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень2.Идентификатор))
	               |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдресныеОбъекты КАК АдресныеОбъектыУровень3
	               |		ПО (АдресныеОбъектыУровень2.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень3.Идентификатор)
	               |			ИЛИ ИСТИНА В (ВЫБРАТЬ ПЕРВЫЕ 1 ИСТИНА ИЗ 
	               |			РегистрСведений.СвязиАдресныхОбъектов КАК СвязанныеАдресныеОбъектыУровень3
	               |			ГДЕ (АдресныеОбъектыУровень2.Идентификатор = СвязанныеАдресныеОбъектыУровень3.Идентификатор)
	               |			И (СвязанныеАдресныеОбъектыУровень3.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень3.Идентификатор))
	               |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдресныеОбъекты КАК АдресныеОбъектыУровень4
	               |		ПО (АдресныеОбъектыУровень3.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень4.Идентификатор)
	               |			ИЛИ ИСТИНА В (ВЫБРАТЬ ПЕРВЫЕ 1 ИСТИНА ИЗ 
	               |			РегистрСведений.СвязиАдресныхОбъектов КАК СвязанныеАдресныеОбъектыУровень4
	               |			ГДЕ (АдресныеОбъектыУровень3.Идентификатор = СвязанныеАдресныеОбъектыУровень4.Идентификатор)
	               |			И (СвязанныеАдресныеОбъектыУровень4.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень4.Идентификатор))
	               |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдресныеОбъекты КАК АдресныеОбъектыУровень5
	               |		ПО (АдресныеОбъектыУровень4.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень5.Идентификатор)
	               |			ИЛИ ИСТИНА В (ВЫБРАТЬ ПЕРВЫЕ 1 ИСТИНА ИЗ 
	               |			РегистрСведений.СвязиАдресныхОбъектов КАК СвязанныеАдресныеОбъектыУровень5
	               |			ГДЕ (АдресныеОбъектыУровень4.Идентификатор = СвязанныеАдресныеОбъектыУровень5.Идентификатор)
	               |			И (СвязанныеАдресныеОбъектыУровень5.МуниципальныйРодительскийИдентификатор = АдресныеОбъектыУровень5.Идентификатор))
	               |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДополнительныеАдресныеСведения КАК ДополнительныеСведения
	               ...
	               |			ТОГДА АдресныеОбъектыУровень1.Наименование + "" "" + АдресныеОбъектыУровень1.Сокращение + "", ""
	               |		ИНАЧЕ """"
	               |	КОНЕЦ + АдресныеОбъектыУровень0.Наименование + "" "" + АдресныеОбъектыУровень0.Сокращение,
	               ...
	               |	АдресныеОбъектыУровень0.ДополнительныеАдресныеСведения,
	...
	ДополнительныйОтбор = "";
	Если Значение.Свойство("Родитель") Тогда
		ДополнительныйОтбор = "И АдресныеОбъектыУровень1.Идентификатор = &ИдентификаторРодитель";
		Запрос.УстановитьПараметр("ИдентификаторРодитель", Новый УникальныйИдентификатор(Значение.Родитель));
	КонецЕсли;
			...
			Для каждого СтрокаДом Из МассивДомов Цикл
				...
				Если ЗначениеЗаполнено(ДанныеОДоме[0]) Тогда
					...
					Если ДанныеОДоме.Количество() > 1 Тогда
						...
						Если ДанныеОДоме.Количество() > 2 Тогда
...
Функция АнализОдногоАдресаПоКлассификатору(Адрес)
	...
	Адреса                 = РезультатЗапроса[0];
	Дома                   = РезультатЗапроса[1];
	ДополнительныеСведения = РезультатЗапроса[3];
...
Процедура ЗаполнитьПоляВСоответствииСУровнемАдреса(Адрес, Выборка, Суффикс, СловарьИменПолей, Муниципальный = Ложь)
	...
	Если ЗначениеЗаполнено(Выборка["НаименованиеУровень" + Суффикс]) Тогда
		...
		Если Муниципальный И СтрСравнить(ИмяУровня,"City") = 0 Тогда
			ИмяУровня = "Locality";
		КонецЕсли;
...
Процедура ОбработатьОбщепринятыеСокращения(ДоступныеУровни)
	...
	Для каждого НераспознаннаяЧастьАдреса Из НераспознанныеСтроки Цикл
		...
		ИначеЕсли ВРЕГ(НераспознаннаяЧастьАдреса.Наименование) = "ЛИТЕРА" Тогда
			НераспознаннаяЧастьАдреса.Наименование = "Литер";
		КонецЕсли;
	КонецЦикла;
...
Функция ИсточникДанныхАдресногоКлассификатораВебСервис() Экспорт
	...
	СервисРезультат = ВерсияПоставщикаДанных();
...
Процедура ДобавитьИнформациюОДоме(ВариантыДомов, ОписаниеДома, НаименованиеЗданийИСтроений, СтрокаПоиска = "")
	...
	Если ЗначениеЗаполнено(ОписаниеДома.Корпус) Тогда
		...
		Иначе
			ТекстПроСтроения = Новый ФорматированнаяСтрока("корпус" + " ",
				Новый ФорматированнаяСтрока(СтрокаПоиска, Новый Шрифт(,, Истина) , ЦветаСтиля.РезультатУспехЦвет),
				Сред(ОписаниеДома.Корпус, СтрДлина(СтрокаПоиска) + 1));
		КонецЕсли;
	...
	Попытка
		...
		Пока ТекущаяЗапись.Прочитать() Цикл
			...
			Если СтрСравнить(ТипЗаписи, "STRSTAT") = 0
				...
				И СтрСравнить(Значение, "Литер") <> 0 Тогда
					Продолжить;
			КонецЕсли;
...
Функция ВыполнитьЗапросЧерезВебСервис(СтрокаЗапроса, ВремяОжидания = 120)
