...
Функция ПроверитьАдресаПоЗагруженнымДанным(Адреса, ПроверятьУстареваниеАдресов = Ложь)
	...
	АнализДомовИДополнительныхСведений(Результаты, Адреса, Дома, ДополнительныеСведения);
...
Процедура АнализДомовИДополнительныхСведений(Результаты, Знач Адреса, Знач Дома, Знач ДополнительныеСведения)
