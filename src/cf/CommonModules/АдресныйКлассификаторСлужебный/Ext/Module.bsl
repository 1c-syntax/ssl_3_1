...
Функция РаспознатьАдресЗагруженныеДанные(ИсходныеЧастиАдреса, КодРегиона)
	...
	АдресПоНайденнымДанным = ОпределитьАдресПоНайденнымДанным(СопоставленныеЧастиАдреса, Муниципальный);
...
Функция ОпределитьАдресПоНайденнымДанным(Знач СопоставленныеЧастиАдреса, Муниципальный)
