	...
	Для Каждого ОписаниеФайла Из ОписаниеФайлов Цикл
		...
		Если ФайлАрхива.Существует() И ВРег(Прав(ПолноеИмяФайла, 4)) = ".ZIP" Тогда
			...
			Если Не ЕстьФайлВерсииСМуниципальнымиДанными Тогда
				...
				ТекстПричины = ?(ЕстьФайлВерсииСАдминистративнымиДанными, НСтр(
					"ru = 'Допускается загрузка адресных сведений только в формате государственного адресного реестра.'"), НСтр(
					"ru = 'Файл не содержит адресных сведений'"));
...
Функция ТекстЗапросаПроверкиАдресов()
	...
	ТекстЗапроса = "ВЫБРАТЬ
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ Регионы КАК АдресныеОбъектыИдентификаторы
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ МуниципальныеАдресныеОбъекты1 КАК АдресныеОбъектыИдентификаторы
		|		ПО (АдресныеОбъектыИдентификаторы.Ключ = АдресаПоПолям.Ключ)
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.МуниципальнаяИерархия КАК МуниципальнаяИерархия
		|		ПО (МуниципальнаяИерархия.РодительскийИдентификатор = АдресныеОбъектыИдентификаторы.Идентификатор)
		|			И (МуниципальнаяИерархия.Идентификатор = АдресныеОбъекты.Идентификатор)
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ МуниципальныеАдресныеОбъекты2 КАК АдресныеОбъектыИдентификаторы
		|		ПО (АдресныеОбъектыИдентификаторы.Ключ = АдресаПоПолям.Ключ)
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.МуниципальнаяИерархия КАК МуниципальнаяИерархия
		|		ПО (МуниципальнаяИерархия.РодительскийИдентификатор = АдресныеОбъектыИдентификаторы.Идентификатор)
		|			И (МуниципальнаяИерархия.Идентификатор = АдресныеОбъекты.Идентификатор)
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ МуниципальныеАдресныеОбъекты3 КАК АдресныеОбъектыИдентификаторы
		|		ПО (АдресныеОбъектыИдентификаторы.Ключ = АдресаПоПолям.Ключ)
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.МуниципальнаяИерархия КАК МуниципальнаяИерархия
		|		ПО (МуниципальнаяИерархия.РодительскийИдентификатор = АдресныеОбъектыИдентификаторы.Идентификатор)
		|			И (МуниципальнаяИерархия.Идентификатор = АдресныеОбъекты.Идентификатор)
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ МуниципальныеАдресныеОбъекты4 КАК АдресныеОбъектыИдентификаторы
		|		ПО (АдресныеОбъектыИдентификаторы.Ключ = АдресаПоПолям.Ключ)
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.МуниципальнаяИерархия КАК МуниципальнаяИерархия
		|		ПО (МуниципальнаяИерархия.РодительскийИдентификатор = АдресныеОбъектыИдентификаторы.Идентификатор)
		|			И (МуниципальнаяИерархия.Идентификатор = АдресныеОбъекты.Идентификатор)
		...
		|		ПО (АдресныеОбъекты.Наименование = АдресаПоПолям.Наименование2)
		|			И (АдресныеОбъекты.ТипОбъекта = АдресаПоПолям.ТипОбъекта2)
		|		ЛЕВОЕ СОЕДИНЕНИЕ АдминистративныеАдресныеОбъекты1 КАК АдресныеОбъектыИдентификаторы
		|		ПО (АдресныеОбъектыИдентификаторы.Ключ = АдресаПоПолям.Ключ)
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдминистративнаяИерархия КАК АдминистративнаяИерархия
		|		ПО (АдминистративнаяИерархия.РодительскийИдентификатор = АдресныеОбъектыИдентификаторы.Идентификатор)
		|			И (АдминистративнаяИерархия.Идентификатор = АдресныеОбъекты.Идентификатор)
		...
		|		ПО (АдресныеОбъекты.Наименование = АдресаПоПолям.Наименование3)
		|			И (АдресныеОбъекты.ТипОбъекта = АдресаПоПолям.ТипОбъекта3)
		|		ЛЕВОЕ СОЕДИНЕНИЕ АдминистративныеАдресныеОбъекты2 КАК АдресныеОбъектыИдентификаторы
		|		ПО (АдресныеОбъектыИдентификаторы.Ключ = АдресаПоПолям.Ключ)
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдминистративнаяИерархия КАК АдминистративнаяИерархия
		|		ПО (АдминистративнаяИерархия.РодительскийИдентификатор = АдресныеОбъектыИдентификаторы.Идентификатор)
		|			И (АдминистративнаяИерархия.Идентификатор = АдресныеОбъекты.Идентификатор)
		...
		|		ПО (АдресныеОбъекты.Наименование = АдресаПоПолям.Наименование4)
		|			И (АдресныеОбъекты.ТипОбъекта = АдресаПоПолям.ТипОбъекта4)
		|		ЛЕВОЕ СОЕДИНЕНИЕ АдминистративныеАдресныеОбъекты3 КАК АдресныеОбъектыИдентификаторы
		|		ПО (АдресныеОбъектыИдентификаторы.Ключ = АдресаПоПолям.Ключ)
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдминистративнаяИерархия КАК АдминистративнаяИерархия
		|		ПО (АдминистративнаяИерархия.РодительскийИдентификатор = АдресныеОбъектыИдентификаторы.Идентификатор)
		|			И (АдминистративнаяИерархия.Идентификатор = АдресныеОбъекты.Идентификатор)
		...
		|		ПО (АдресныеОбъекты.Наименование = АдресаПоПолям.Наименование5)
		|			И (АдресныеОбъекты.ТипОбъекта = АдресаПоПолям.ТипОбъекта5)
		|		ЛЕВОЕ СОЕДИНЕНИЕ АдминистративныеАдресныеОбъекты4 КАК АдресныеОбъектыИдентификаторы
		|		ПО (АдресныеОбъектыИдентификаторы.Ключ = АдресаПоПолям.Ключ)
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АдминистративнаяИерархия КАК АдминистративнаяИерархия
		|		ПО (АдминистративнаяИерархия.РодительскийИдентификатор = АдресныеОбъектыИдентификаторы.Идентификатор)
		|			И (АдминистративнаяИерархия.Идентификатор = АдресныеОбъекты.Идентификатор)
...
Процедура СведенияПоСпискуОКМТОВебСервис(СписокОКТМО, Результат)
	...
	Для Каждого ЗаписьОКТМО Из СписокОКТМО Цикл
		...
		Для Каждого СтрокаДанных Из РезультатВебСервис.Данные Цикл
			...
			СведенияПоОКТМО.ПочтовыйИндекс   = ТипЧисло.ПривестиЗначение(СтрокаДанных.ZIPcode);

			СведенияПоОКТМО.Регион = СокрЛП(СтрокаДанных.area);
			СведенияПоОКТМО.РегионИдентификатор = ?(ПустаяСтрока(СтрокаДанных.areaId), Неопределено,
				Новый УникальныйИдентификатор(СокрЛП(СтрокаДанных.areaId)));
			...
			СведенияПоОКТМО.МуниципальныйРайонИдентификатор = ?(ПустаяСтрока(СтрокаДанных.munDistrictId), Неопределено,
				Новый УникальныйИдентификатор(СокрЛП(СтрокаДанных.munDistrictId)));
			СведенияПоОКТМО.МуниципальныйРайонТипКраткий = СокрЛП(СтрокаДанных.munDistrictType);
			СведенияПоОКТМО.МуниципальныйРайонТипПолный = СокрЛП(СписокСокращений.Получить("3"
			...
			СведенияПоОКТМО.НаселенныйПунктИдентификатор = ?(ПустаяСтрока(СтрокаДанных.localityId), Неопределено,
				Новый УникальныйИдентификатор(СокрЛП(СтрокаДанных.localityId)));
			СведенияПоОКТМО.НаселенныйПунктТипКраткий = СокрЛП(СтрокаДанных.localityType);
			СведенияПоОКТМО.НаселенныйПунктТипПолный = СокрЛП(СписокСокращений.Получить("6"
				+ СведенияПоОКТМО.НаселенныйПунктТипКраткий));

			СведенияПоОКТМО.Поселение = СокрЛП(СтрокаДанных.settlement);
			СведенияПоОКТМО.ПоселениеИдентификатор = ?(ПустаяСтрока(СтрокаДанных.settlementId), Неопределено,
				Новый УникальныйИдентификатор(СокрЛП(СтрокаДанных.settlementId)));
			СведенияПоОКТМО.ПоселениеТипКраткий = СокрЛП(СтрокаДанных.settlementType);
			СведенияПоОКТМО.ПоселениеТипПолный = СокрЛП(СписокСокращений.Получить("4"
				+ СведенияПоОКТМО.ПоселениеТипКраткий));
			СведенияПоОКТМО.КодПоселения = КодПоселения(СведенияПоОКТМО.ПоселениеТипКраткий);

			СведенияПоОКТМО.Территория = СокрЛП(СтрокаДанных.territory);
			СведенияПоОКТМО.ТерриторияИдентификатор = ?(ПустаяСтрока(СтрокаДанных.territoryId), Неопределено,
				Новый УникальныйИдентификатор(СокрЛП(СтрокаДанных.territoryId)));
			СведенияПоОКТМО.ТерриторияТипКраткий = СокрЛП(СтрокаДанных.territoryType);
			СведенияПоОКТМО.ТерриторияТипПолный = СокрЛП(СписокСокращений.Получить("7"
				+ СведенияПоОКТМО.ТерриторияТипКраткий));
