...
Функция СообщенияСкриптов()
	...
	Сообщения.Вставить("[СообщениеСчетчикФайловОбновления]", НСтр("ru = 'Количество файлов обновления: {0}'"));
	Сообщения.Вставить("[СообщениеВосстановлениеБазы]", НСтр("ru = 'Восстановление ИБ из временного архива'"));
	Сообщения.Вставить("[СообщениеНачалоСеансаСоединенияСБазой]", НСтр("ru = 'Начат сеанс внешнего соединения с ИБ'"));
	Сообщения.Вставить("[СообщениеУдалениеЗадачиПланировщика]", НСтр("ru = 'Удаление задачи планировщика задач: {0}'"));
	Сообщения.Вставить("[СообщениеОтказУдаленияЗадачиПланировщика]", НСтр("ru = 'Ошибка при удалении задачи из планировщика задач: {0}'"));
	Сообщения.Вставить("[СообщениеОтказСоединенияСБазой]", НСтр("ru = 'Исключение в createConnection: {0}, {1}'"));
	Сообщения.Вставить("[СообщениеВызовЗавершитьОбновление]", НСтр("ru = 'ОбновлениеКонфигурации.ЗавершитьОбновление({0}, {1}, {2})'"));
	Сообщения.Вставить("[СообщениеОтказПриВызовеЗавершитьОбновление]", НСтр("ru = 'Исключение при вызове ОбновлениеКонфигурации.ЗавершитьОбновление: {0}, {1}'"));
	Сообщения.Вставить("[СообщениеРезультатОбновленияБазы]", НСтр("ru = 'Обновление информационной базы завершилась успешно'"));
	Сообщения.Вставить("[СообщениеОтказОбновленияБазы]", НСтр("ru = 'Ошибка при обновлении информационной базы'"));
	...
	Сообщения.Вставить("[СообщениеОбновлениеЛогирование1С]", НСтр("ru = 'Протокол обновления сохранен в журнал регистрации.'"));
	Сообщения.Вставить("[СообщениеКопированиеБазы]", НСтр("ru = '\r\n\Выполняется копирование из:\r\n\{0}\r\n\в:\r\n\{1}'"));
	Сообщения.Вставить("[СообщениеФайлБазыНеСуществует]", НСтр("ru = 'Файл базы данных 1Cv8.1CD не существует по пути: {0}'"));
	Сообщения.Вставить("[СообщениеКаталогРезервнойКопииБазыНеСуществует]", НСтр("ru = 'Папки для сохранения резервной копии не существует: {0}'"));
	Сообщения.Вставить("[СообщениеПараметрыФайлаРезервнойКопии]", НСтр("ru = '\r\n\Файл резервной копии уже существует: {0}\r\n\Создан: {1}\r\n\Последнее обращение: {2}\r\n\Последнее изменение: {3}\r\n\Размер: {4}\r\n\Тип: {5}\r\n\Атрибуты:\r\n\{6}'"));
	Сообщения.Вставить("[СообщениеДискНеСуществует]", НСтр("ru = '\r\n\Диск не найден по пути {0}\r\n\Исключение: {1}, {2}'"));
	Сообщения.Вставить("[СообщениеДискНедоступен]", НСтр("ru = 'Диск не доступен по пути {0}'"));
	Сообщения.Вставить("[СообщениеДисковогоПространстваНедостаточно]", НСтр("ru = '\r\n\Недостаточно свободного места для создания резервной копии.\r\n\Освободите место или укажите папку на другом диске.\r\n\Требуется: {0} Mb\r\n\Доступно на диске {1}: {2} Mb\r\n\Размер файла 1Cv8.1CD: {3} Mb\r\n\Тип диска: {4}'"));
	Сообщения.Вставить("[СообщениеРезультатСозданияРезервнойКопииБазы]", НСтр("ru = 'Резервная копия базы создана'"));
	...
	Сообщения.Вставить("[СообщениеРезультатВосстановленияБазы]", НСтр("ru = 'База данных восстановлена из резервной копии'"));
	...
	Сообщения.Вставить("[СообщениеВызовРазрешитьРаботуПользователей]", НСтр("ru = 'СоединенияИБ.РазрешитьРаботуПользователей()'"));
	Сообщения.Вставить("[СообщениеОтказВызоваРазрешитьРаботуПользователей]", НСтр("ru = 'Исключение при вызове СоединенияИБ.РазрешитьРаботуПользователей: {0}, {1}'"));
	Сообщения.Вставить("[СообщениеОтказОбновленияИсправлений]", НСтр("ru = 'Не удалось обновить исправления конфигурации. Подробности см. в предыдущей записи.'"));
	Сообщения.Вставить("[СообщениеОтказВызоваОбновитьИсправленияИзСкрипта]", НСтр("ru = 'Исключение при вызове ОбновлениеКонфигурацииВызовСервера.ОбновитьИсправленияИзСкрипта: {0}, {1}'"));
	Сообщения.Вставить("[СообщениеВызовВыполнитьОбновлениеИнформационнойБазы]", НСтр("ru = 'ОбновлениеИнформационнойБазыВызовСервера.ВыполнитьОбновлениеИнформационнойБазы({0})'"));
	Сообщения.Вставить("[СообщениеОтказВызоваВыполнитьОбновлениеИнформационнойБазы]", НСтр("ru = 'Исключение при вызове ОбновлениеИнформационнойБазыВызовСервера.ВыполнитьОбновлениеИнформационнойБазы: {0}, {1}.'"));
	Сообщения.Вставить("[СообщениеОтказОбновленияБазыОбщее]", НСтр("ru = 'При выполнении обновления информационной базы произошла ошибка:'"));
	Сообщения.Вставить("[СообщениеБлокировкаБазы]", НСтр("ru = 'в связи с необходимостью обновления конфигурации'"));
	Сообщения.Вставить("[СообщениеОтказЗавершенияРаботыПользователей]", НСтр("ru = 'Попытка завершения работы пользователей завершилась безуспешно: отменена блокировка ИБ.'"));
	Сообщения.Вставить("[СообщениеОтменаБлокировкиРаботыПользователей]", НСтр("ru = 'Исключение при вызове doDisconnectAndBlockUsers: {0}, {1}'"));
	Сообщения.Вставить("[СообщениеКонецСеансаСоединенияСБазой]", НСтр("ru = 'Завершен сеанс внешнего соединения с ИБ'"));
	Сообщения.Вставить("[СообщениеБлокировкаРаботыПользователейЛогирование]", НСтр("ru = 'Установка блокировки сеансов в связи с необходимостью обновления конфигурации'"));
	Сообщения.Вставить("[СообщениеБлокировкаРаботыПользователей]", НСтр("ru = 'в связи с необходимостью обновления конфигурации'"));
	Сообщения.Вставить("[СообщениеСчетчикСеансовБазы]", НСтр("ru = 'Количество сеансов информационной базы: {0}'"));
	Сообщения.Вставить("[СообщениеРезультатБлокировкиСеансов]", НСтр("ru = 'Блокировка начала сеансов установлена: {0}'"));
	Сообщения.Вставить("[СообщениеСчетчикЗависшихСеансовБазы]", НСтр("ru = 'Количество зависших сеансов информационной базы: {0}, попытка № {1}'"));
	Сообщения.Вставить("[СообщениеВызовВыполнитьОтложенноеОбновлениеСейчас]", НСтр("ru = 'ОбновлениеИнформационнойБазыСлужебный.ВыполнитьОтложенноеОбновлениеСейчас()'"));
	Сообщения.Вставить("[СообщениеОтказВызоваВыполнитьОтложенноеОбновлениеСейчас]", НСтр("ru = 'Исключение при вызове ОбновлениеИнформационнойБазыСлужебный.ВыполнитьОтложенноеОбновлениеСейчас: {0}, {1}.'"));
	Сообщения.Вставить("[СообщениеОтказВызоваУдалитьИсправленияИзСкрипта]", НСтр("ru = 'Исключение при вызове ОбновлениеКонфигурацииВызовСервера.УдалитьИсправленияИзСкрипта: {0}, {1}.'"));
	Сообщения.Вставить("[СообщениеОтказУдаленияИсправлений]", НСтр("ru = 'Не удалось удалить исправления конфигурации. Подробности см. в предыдущей записи.'"));
	Сообщения.Вставить("[СообщениеПараметрыCOMСоединителя]", НСтр("ru = 'Используется COM соединение: {0}'"));
	Сообщения.Вставить("[СообщениеОтказОбновленияБазыИзФайла]", НСтр("ru = 'Не удалось обновить по файлу, возможно конфигурация не находится на поддержке, попытка загрузки конфигурации'"));
	...
	Сообщения.Вставить("[СообщениеИнициализация]", НСтр("ru = 'Инициализация'"));
	Сообщения.Вставить("[СообщениеЗавершениеРаботыПользователей]", НСтр("ru = 'Завершение работы пользователей'"));
	Сообщения.Вставить("[СообщениеСозданиеРезервнойКопииБазы]", НСтр("ru = 'Создание резервной копии информационной базы'"));
	Сообщения.Вставить("[СообщениеВыполнениеОтложенныхОбработчиковОбновления]", НСтр("ru = 'Выполнение отложенных обработчиков обновления'"));
	Сообщения.Вставить("[СообщениеОбновлениеКонфигурации]", НСтр("ru = 'Обновление конфигурации информационной базы'"));
	Сообщения.Вставить("[СообщениеЗагрузкаРасширений]", НСтр("ru = 'Обновление расширений информационной базы'"));
	Сообщения.Вставить("[СообщениеЗагрузкаФайлаОбновлений]", НСтр("ru = 'Загрузка файла обновления в основную базу ({0}/{1})'"));
	Сообщения.Вставить("[СообщениеПараметрыОбновленияКонфигурации]", НСтр("ru = 'Обновление конфигурации информационной базы ({0}/{1})'"));
	Сообщения.Вставить("[СообщениеВыполнениеОбработчиковОбновления]", НСтр("ru = 'Выполнение обработчиков обновления ({0}/{1})'"));
	Сообщения.Вставить("[СообщениеРазрешениеПодключений]", НСтр("ru = 'Разрешение подключений новых соединений'"));
	Сообщения.Вставить("[СообщениеЗавершениеОбновления]", НСтр("ru = 'Завершение'"));
	Сообщения.Вставить("[СообщениеОтказИнициализации]", НСтр("ru = ': Ошибка инициализации переменных:'") + Символы.НПП);
	Сообщения.Вставить("[СообщениеСозданиеОбъектаCOMСоединителя]", НСтр("ru = ': Создание объекта COM-соединителя...'"));
	Сообщения.Вставить("[СообщениеОтказСозданияОбъектаCOMСоединителя]", НСтр("ru = ': Ошибка создания объекта COM-соединителя:'") + Символы.НПП);
	Сообщения.Вставить("[СообщениеУстановкаСоединенияСБазой]", НСтр("ru = ': Установка соединения с'") + Символы.НПП);
	Сообщения.Вставить("[СообщениеОтказСоединенияСБазойОбщее]", НСтр("ru = ': Ошибка установки соединения с'") + Символы.НПП);
	Сообщения.Вставить("[СообщениеОсновноеСобытие]", НСтр("ru = 'Удаление исправлений (патчей)'"));
	Сообщения.Вставить("[СообщениеВызовУдалитьИсправленияИзСкрипта]", НСтр("ru = ': Вызов ОбновлениеКонфигурацииВызовСервера.УдалитьИсправленияИзСкрипта()...'"));
	Сообщения.Вставить("[СообщениеВызовОбновитьИсправленияИзСкрипта]", НСтр("ru = ': Вызов ОбновлениеКонфигурацииВызовСервера.ОбновитьИсправленияИзСкрипта()...'"));
	Сообщения.Вставить("[СообщениеОшибкаБСП]", НСтр("ru = ': Ошибка БСП:'") + Символы.НПП);
	Сообщения.Вставить("[СообщениеВажность]", НСтр("ru = 'Обязательная'"));
