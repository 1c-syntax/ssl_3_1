...
Функция СообщенияСкриптов()
	...
	Сообщения["[СообщениеОтказУдаленияЗадачиПланировщика]"] = НСтр("ru = 'Ошибка при удалении задачи из планировщика задач: {0}'");
	...
	Сообщения["[СообщениеРезультатОбновленияБазы]"] = НСтр("ru = 'Обновление информационной базы завершилась успешно'");
	Сообщения["[СообщениеОтказОбновленияБазы]"] = НСтр("ru = 'Ошибка при обновлении информационной базы'");
	...
	Сообщения["[СообщениеОтказОбновленияБазыОбщее]"] = НСтр("ru = 'При выполнении обновления информационной базы произошла ошибка:'");
	...
	Сообщения["[СообщениеОтказИнициализации]"] = НСтр("ru = 'Ошибка инициализации переменных'");
	Сообщения["[СообщениеСозданиеОбъектаCOMСоединителя]"] = НСтр("ru = 'Создание объекта COM-соединителя...'");
	Сообщения["[СообщениеОтказСозданияОбъектаCOMСоединителя]"] = НСтр("ru = 'Ошибка создания объекта COM-соединителя:'");
	Сообщения["[СообщениеУстановкаСоединенияСБазой]"] = НСтр("ru = 'Установка соединения с'");
	Сообщения["[СообщениеОтказСоединенияСБазойОбщее]"] = НСтр("ru = 'Ошибка установки соединения с'");
