	...
	Если Параметры.Операция = "Подписание" Тогда
		...
		Иначе
			Если ЭлектроннаяПодпись.ДоступнаУсовершенствованнаяПодпись() Тогда
				...
				КонецЕсли;
			Иначе
				СвойстваПодписи = ЭлектроннаяПодписьСлужебный.СвойстваПодписиИзДвоичныхДанных(ДвоичныеДанныеРезультата,
					Ложь);
			КонецЕсли;
...
Функция ДополнитьРешениеКлассификатораОшибокПодробностями(Знач ОшибкаПоКлассификатору,
	...
	Возврат ЭлектроннаяПодписьСлужебный.ДополнитьРешениеКлассификатораОшибокПодробностями(ОшибкаПоКлассификатору,
		ДополнительныеДанные, ПараметрыДополненияТекстаРешенияОшибкиКлассификатораНаКлиенте, МестоОшибки);
