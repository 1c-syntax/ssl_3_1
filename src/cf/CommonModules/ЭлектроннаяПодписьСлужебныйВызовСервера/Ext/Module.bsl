...
// Добавляет подпись, возвращает текст ошибки при неудаче.
// 
// Параметры:
//  СсылкаНаОбъект Ссылка на объект
//  СвойстваПодписи - см. ЭлектроннаяПодписьСлужебныйКлиентСервер.СвойстваПодписи
//  ИдентификаторФормы Идентификатор формы
//  ВерсияОбъекта - Неопределено - версия объекта
// 
// Возвращаемое значение:
//  Строка 
//
Функция ДобавитьПодпись(Знач СсылкаНаОбъект,Знач СвойстваПодписи,Знач ИдентификаторФормы,Знач ВерсияОбъекта) Экспорт
...
// Двоичные данные сертификата из справочника
// 
// Параметры:
...
Функция ОтпечаткиСертификатов(ТолькоЛичные, ОписаниеОшибки = Null, Сервис = Истина) Экспорт
	...
	Возврат ЭлектроннаяПодпись.ОтпечаткиСертификатов(ТолькоЛичные, ОписаниеОшибки, Сервис);
...
Функция ОтпечаткиСертификатовСервиса() Экспорт
	...
	Возврат ЭлектроннаяПодписьСлужебный.ОтпечаткиСертификатовСервиса();
...
Функция ЛичныеСертификаты(СвойстваСертификатовНаКлиенте, Отбор, Ошибка = "") Экспорт
	...
	Если ЭлектроннаяПодписьСлужебный.ИспользоватьЭлектроннуюПодписьВМоделиСервиса() Тогда
		...
		ЭлектроннаяПодписьСлужебныйКлиентСервер.ДобавитьСвойстваСертификатов(ТаблицаСвойствСертификатов, МассивСертификатов, Истина,
			ЭлектроннаяПодписьСлужебный.РазницаСУниверсальнымВременем(), ТекущаяДатаСеанса(), ПараметрыДобавленияСвойств);
			
	КонецЕсли;
	
	Если ЭлектроннаяПодписьСлужебный.ИспользоватьСервисОблачнойПодписи() Тогда
		
		ЭлектроннаяПодписьЛокализация.ПриДобавленииСвойствСертификатовОблачногоСервиса(ТаблицаСвойствСертификатов, Истина);
...
Функция ДобавленныеСертификаты(НовыйСертификат) Экспорт
	
	Результат = Новый Массив;
	
	Если ТипЗнч(НовыйСертификат) = Тип("СправочникСсылка.СертификатыКлючейЭлектроннойПодписиИШифрования") Тогда
		Сертификаты = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(НовыйСертификат);
	Иначе
		Сертификаты = НовыйСертификат;
	КонецЕсли;
	...
	Запрос.Текст =
	"ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	СертификатыКлючейЭлектроннойПодписиИШифрования.ДанныеСертификата КАК СтарыйСертификатДанные,
	|	СертификатыКлючейЭлектроннойПодписиИШифрованияНовый.ДанныеСертификата КАК НовыйСертификатДанные,
	|	СертификатыКлючейЭлектроннойПодписиИШифрования.Ссылка КАК СтарыйСертификатСсылка,
	|	СертификатыКлючейЭлектроннойПодписиИШифрованияНовый.Ссылка КАК НовыйСертификатСсылка
	|ИЗ
	|	Справочник.СертификатыКлючейЭлектроннойПодписиИШифрования КАК СертификатыКлючейЭлектроннойПодписиИШифрованияНовый
	...
	|		ПО (СертификатыКлючейЭлектроннойПодписиИШифрованияНовый.КомуВыдан <> """"
	|				ИЛИ СертификатыКлючейЭлектроннойПодписиИШифрованияНовый.Фирма <> """")
	|			И СертификатыКлючейЭлектроннойПодписиИШифрованияНовый.Ссылка <> СертификатыКлючейЭлектроннойПодписиИШифрования.Ссылка
	|			И СертификатыКлючейЭлектроннойПодписиИШифрованияНовый.КомуВыдан = СертификатыКлючейЭлектроннойПодписиИШифрования.КомуВыдан
	|			И СертификатыКлючейЭлектроннойПодписиИШифрованияНовый.Фирма = СертификатыКлючейЭлектроннойПодписиИШифрования.Фирма
	|			И СертификатыКлючейЭлектроннойПодписиИШифрованияНовый.ДействителенДо > СертификатыКлючейЭлектроннойПодписиИШифрования.ДействителенДо
	|			И (СертификатыКлючейЭлектроннойПодписиИШифрования.ДействителенДо <> ДАТАВРЕМЯ(1, 1, 1))
	|ГДЕ
	|	СертификатыКлючейЭлектроннойПодписиИШифрованияНовый.Ссылка В(&Сертификаты)
	|
	|УПОРЯДОЧИТЬ ПО
	...
	ВыборкаНовый = РезультатЗапроса.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
	Пока ВыборкаНовый.Следующий() Цикл
		
		Структура = Новый Структура("НовыйСертификат, СтарыйСертификат", ВыборкаНовый.НовыйСертификатСсылка);
		СвойстваНовогоСубъекта = Неопределено;
		Выборка = ВыборкаНовый.Выбрать();
		Пока Выборка.Следующий() Цикл
			Если Выборка.СтарыйСертификатДанные = Null Тогда
				Прервать;
			КонецЕсли;
			
			Если СвойстваНовогоСубъекта = Неопределено Тогда
				ДанныеСертификата = Выборка.НовыйСертификатДанные.Получить();
				...
				СвойстваНовогоСубъекта = ЭлектроннаяПодпись.СвойстваСубъектаСертификата(СертификатКриптографии);
			КонецЕсли;

			ДанныеСертификата = Выборка.СтарыйСертификатДанные.Получить();
			СертификатКриптографии = Новый СертификатКриптографии(ДанныеСертификата);
			СвойстваСтарогоСубъекта = ЭлектроннаяПодпись.СвойстваСубъектаСертификата(СертификатКриптографии);

			Если ЭлектроннаяПодписьСлужебныйКлиентСервер.ЭтоЗаменаСертификата(СвойстваНовогоСубъекта,
				СвойстваСтарогоСубъекта) Тогда
				
				Структура.СтарыйСертификат = Выборка.СтарыйСертификатСсылка;
				Прервать;
			КонецЕсли;
		КонецЦикла;
...
Функция ВыполнитьНаСторонеСервера(Знач Параметры, АдресРезультата, ОперацияНачалась, ОшибкаНаСервере) Экспорт
	...
	Если Параметры.Операция = "Шифрование" Тогда
		ПараметрыСоздания.АлгоритмШифрования = Параметры.АлгоритмШифрования;
	КонецЕсли;
	...
	Если Параметры.Операция = "Подписание" Тогда
		...
		СвойстваСертификата = ЭлектроннаяПодписьСлужебныйКлиентСервер.СвойстваСертификата(
			СертификатКриптографии, ЭлектроннаяПодписьСлужебный.РазницаСУниверсальнымВременем(), ДвоичныеДанныеСертификата);
		...
		Если ЭлектроннаяПодписьСлужебныйКлиентСервер.ДоступныДополнительныеСвойстваСертификата() Тогда
			АлгоритмСертификата = СвойстваСертификата.АлгоритмОткрытогоКлюча;
		Иначе
		...
		КонецЕсли;
		АлгоритмСоответствует = ЭлектроннаяПодписьСлужебныйКлиентСервер.АлгоритмПодписиСоответствуетСертификату(
			СвойстваСертификата.Представление, АлгоритмСертификата, МенеджерКриптографии.АлгоритмПодписи);

		Если АлгоритмСоответствует <> Истина Тогда

			ОшибкаНаСервере.Вставить("ОписаниеОшибки", АлгоритмСоответствует);
			Возврат Ложь;
	...
	Если Параметры.Операция = "Подписание" Тогда
		...
		Если ЭтоXMLDSig Тогда
			...
			СвойстваПодписи.НеподтвержденнаяДатаПодписи = СвойстваПодписи.ДатаПодписи;
		Иначе
		...
		ПодписанныйОбъект = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Параметры.ЭлементДанныхДляСервера, "Объект", Неопределено);
		
		// СтандартныеПодсистемы.МашиночитаемыеДоверенности
		Если ЗначениеЗаполнено(Параметры.РезультатПроверкиМЧДДляПодписания) И ОбщегоНазначения.ПодсистемаСуществует(
		"СтандартныеПодсистемы.МашиночитаемыеДоверенности") Тогда
			...
			Параметры.ВыбраннаяДоверенность, ПодписанныйОбъект, СвойстваСертификата.ДвоичныеДанные, ТекущаяДатаСеанса(),
		...
		Если ПодписанныйОбъект <> Неопределено Тогда
			...
			ПредставлениеОшибки = ДобавитьПодпись(ПодписанныйОбъект,
...
Функция ПреобразоватьПодписиВМассив(Подписи, ИдентификаторФормы) Экспорт
	...
	Для Каждого ТекущийЭлемент Из Подписи Цикл
		ПараметрыПолученияПодписей.ПорядковыйНомер = ТекущийЭлемент.ПорядковыйНомер;
		ПодписиОбъекта = ЭлектроннаяПодпись.ПодписиОбъекта(ТекущийЭлемент.ПодписанныйОбъект, ПараметрыПолученияПодписей);
		Для Каждого ТекущаяПодпись Из ПодписиОбъекта Цикл
		...
		Если Менеджер = Неопределено Тогда
			Программа.РезультатПроверкиНаСервере =
				ЭлектроннаяПодписьСлужебныйКлиентСервер.ТекстОшибкиПоискаПрограммы(
					НСтр("ru = 'Не установлено на сервере %1.'"), ПараметрыСоздания.ОписаниеОшибки);
		Иначе
			Программа.РезультатПроверкиНаСервере = "";
...
Функция ДополнитьРешениеКлассификатораОшибокПодробностями(Знач ОшибкаПоКлассификатору,
	Знач ДополнительныеДанные, Знач МестоОшибки = Неопределено) Экспорт
	
	Возврат ЭлектроннаяПодписьСлужебный.ДополнитьРешениеКлассификатораОшибокПодробностями(ОшибкаПоКлассификатору,
		ДополнительныеДанные, МестоОшибки);
		
КонецФункции

Функция ОшибкаПоКлассификатору(Знач ТекстОшибки, Знач ОшибкаНаСервере = Ложь, Знач ОшибкаПроверкиПодписи = Ложь,
		УказанСертификат = Ложь) Экспорт
	
	Возврат ЭлектроннаяПодписьСлужебный.ОшибкаПоКлассификатору(ТекстОшибки, ОшибкаНаСервере, ОшибкаПроверкиПодписи,
		УказанСертификат);
...
Процедура ДобавитьОписаниеДополнительныхДанных(ДополнительныеДанные, ОписаниеФайлов, Сведения) Экспорт
	...
	Если Сертификаты = Неопределено Тогда
		ДополнительныеДанные.Свойство("ДанныеСертификата", Сертификаты);
	КонецЕсли;
	...
	Если Подписи = Неопределено Тогда
		ДополнительныеДанные.Свойство("ДанныеПодписи", Подписи);
	КонецЕсли;
	...
	ДополнительныеДанные.Свойство("ДополнительныеФайлы", ДополнительныеФайлы);
	Если ТипЗнч(ДополнительныеФайлы) = Тип("Массив") Тогда
		Для Каждого Файл Из ДополнительныеФайлы Цикл
			ОписаниеФайлов.Добавить(Файл);
		КонецЦикла;
	КонецЕсли;
...
Процедура ДобавитьОписаниеСертификата(Сертификат, ОписаниеФайлов, Сведения, Номер)
	...
	Если ТипЗнч(ДанныеСертификата) = Тип("ДвоичныеДанные") Тогда
		Если Не ЗначениеЗаполнено(ПредставлениеСертификата) Тогда
			Попытка
				...
				Если ЭлектроннаяПодписьСлужебныйКлиентСервер.ДоступныДополнительныеСвойстваСертификата() Тогда
					АлгоритмПодписи = ЭлектроннаяПодписьСлужебныйКлиентСервер.ПредставлениеАлгоритмаПодписи(
		...
		Если АлгоритмПодписи = "" Тогда
			АлгоритмПодписи = ЭлектроннаяПодписьСлужебныйКлиентСервер.АлгоритмПодписиСертификата(
				ДанныеСертификата, Истина);
		КонецЕсли;
		ДанныеСертификата = ПолучитьДвоичныеДанныеИзСтроки("-----BEGIN CERTIFICATE-----" + Символы.ПС + Base64Строка(
			ДанныеСертификата) + Символы.ПС + "-----END CERTIFICATE-----");
	Иначе
		Расширение = "txt";
	...
	Если ТипЗнч(Сертификат) = Тип("СправочникСсылка.СертификатыКлючейЭлектроннойПодписиИШифрования") Тогда
		Сведения = Сведения + СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			Символы.Таб + НСтр("ru = 'Приложение: %1'"), Строка(ЗначенияРеквизитов.Программа)) + Символы.ПС;
		
		Сведения = Сведения + СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			Символы.Таб + НСтр("ru = 'Вводить пароль в приложении электронной подписи: %1'"),
...
Процедура ДобавитьОписаниеПодписи(Подпись, ОписаниеФайлов, Сведения, Номер)
	...
	Если ТипЗнч(ДанныеПодписи) = Тип("ДвоичныеДанные") Тогда
		...
		АлгоритмХеширования = ЭлектроннаяПодписьСлужебныйКлиентСервер.АлгоритмХеширования(
			ДанныеПодписи, Истина);
		ДанныеПодписи = ПолучитьДвоичныеДанныеИзСтроки("-----BEGIN CMS-----" + Символы.ПС + Base64Строка(ДанныеПодписи)
			+ Символы.ПС + "-----END CMS-----");
	Иначе
		Расширение = ".txt";
...
Функция АдресАрхиваТехническойИнформации(
	...
	Если ТипЗнч(СопроводительныйТекст) = Тип("Строка") Тогда
		...
		ИмяФайла = ПолучитьИмяВременногоФайла("txt"); // АПК:441 Временные файлы удаляются далее по коду.
		ТекстСостояния.Записать(ИмяФайла);
...
Функция ЖурналДляТехподдержки()
	
	ОтборДляЖурнала = Новый Структура;
	ОтборДляЖурнала.Вставить("Пользователи", Пользователи.ТекущийПользователь());
	ОтборДляЖурнала.Вставить("ДатаНачала", ТекущаяДатаСеанса() - 10*60);
	
	УстановитьОтключениеБезопасногоРежима(Истина);
	УстановитьПривилегированныйРежим(Истина);
	ЖурналДляТехподдержки = ЖурналРегистрации.ЖурналДляТехподдержки(ОтборДляЖурнала, 100);
	УстановитьПривилегированныйРежим(Ложь);
	УстановитьОтключениеБезопасногоРежима(Ложь);
	
	Возврат ЖурналДляТехподдержки;
	
КонецФункции

// Адреса файлов технической информации.
// 
// Возвращаемое значение:
//  Структура - адреса файлов технической информации:
// * ТехническаяИнформация - Строка
// * ЖурналРегистрации - Строка
//
Функция АдресаФайловТехническойИнформации(Знач СопроводительныйТекст,
			Знач ПроверенныеПутиКМодулямПрограммНаКлиенте) Экспорт
	
	Адреса = Новый Структура("ТехническаяИнформация, ЖурналРегистрации");
	...
	Адреса.ТехническаяИнформация = АдресФайла;
	Адреса.ЖурналРегистрации = ЖурналДляТехподдержки();
...
Функция ПолучитьДистрибутив(Параметры, Идентификатор) Экспорт
...
Функция РезультатДиагностикиСерверовМетокВремени() Экспорт
	...
	Иначе
		СтрокаПодключения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Подключение к серверам меток времени на сервере <%1>.'"), ИмяКомпьютера());
...
Функция ФайлЯвляетсяСертификатом(Знач ДанныеСертификата) Экспорт
	...
	Возврат СертификатКриптографии <> Неопределено;
