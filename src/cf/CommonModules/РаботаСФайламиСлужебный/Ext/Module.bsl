...
Процедура ЗаписатьДанныеФайлаВРегистрПриОбмене(Источник)
	...
	Если Источник.ДополнительныеСвойства.Свойство("ДвоичныеДанныеФайла", ДвоичныеДанныеФайла) Тогда
		РегистрыСведений.ХранилищеФайлов.ЗаписатьДвоичныеДанные(Источник.Ссылка, ДвоичныеДанныеФайла);
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ИзвлечьТекстИзФайловНаСервере", Истина);
	Методы.Вставить("ОчиститьНенужныеФайлы", Истина);
	Методы.Вставить("РегламентнаяСинхронизацияФайловWebdav", Истина);
