...
Процедура КриптографияПриСозданииФормыНаСервере(Форма, ЭтоФормаСписка = Истина, ТолькоКартинкаСтрок = Ложь) Экспорт
	...
	Если Не ТолькоКартинкаСтрок Тогда
		...
		Элементы.ФормаОтправитьНаПодписание.Видимость = ОтправкаНаПодписание;
		Если ЗначениеЗаполнено(ЗаголовокОтправкиНаПодписание) Тогда
			Элементы.ФормаОтправитьНаПодписание.Заголовок = ЗаголовокОтправкиНаПодписание;
		КонецЕсли;
		...
		Если ЭтоФормаСписка Тогда
			...
			Элементы.СписокКонтекстноеМенюОтправитьНаПодписание.Видимость = ОтправкаНаПодписание;
			Если ЗначениеЗаполнено(ЗаголовокОтправкиНаПодписание) Тогда
				Элементы.СписокКонтекстноеМенюОтправитьНаПодписание.Заголовок = ЗаголовокОтправкиНаПодписание;
			КонецЕсли;
		...
		Иначе
			...
			Элементы.ЭлектронныеПодписиОтправитьНаПодписание.Видимость = ОтправкаНаПодписание;
			Если ЗначениеЗаполнено(ЗаголовокОтправкиНаПодписание) Тогда
				Элементы.ЭлектронныеПодписиОтправитьНаПодписание.Заголовок = ЗаголовокОтправкиНаПодписание;
			КонецЕсли;
