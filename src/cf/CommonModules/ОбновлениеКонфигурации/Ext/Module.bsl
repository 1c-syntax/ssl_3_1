	...
	Если Исправления.Свойство("Установить", Устанавливаемые)
		...
		Для Каждого Патч Из Устанавливаемые Цикл
			...
			Исключение
				...
				ОписаниеОшибки.Вставить("Причина", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
...
Процедура ОписанияНовыхПатчей(АдресХранилища, ТекущиеИсправления) Экспорт
