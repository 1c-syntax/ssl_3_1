...
Процедура ПриДобавленииПереименованийОбъектовМетаданных(Переименования) Экспорт
	...
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "2.3.3.11", 
		"Роль.ИспользованиеЗаметок", "Роль.ДобавлениеИзменениеЗаметок", "СтандартныеПодсистемы");
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	Если ПравоДоступа("ИнтерактивноеДобавление", Метаданные.Справочники.Заметки) Тогда
		Команда = Команды.Добавить();
		Команда.Вид = "Органайзер";
		Команда.Представление = НСтр("ru = 'Создать заметку'");
		Команда.ФункциональныеОпции = "ИспользоватьЗаметки";
		Команда.Картинка = БиблиотекаКартинок.Заметка;
		Команда.ТипПараметра = Метаданные.ОпределяемыеТипы.ПредметЗаметок.Тип;
		Команда.РежимЗаписи = "НеЗаписывать";
		Команда.Порядок = 50;
		Команда.Обработчик = "ЗаметкиПользователяСлужебныйКлиент.СоздатьЗаметкуПоПредмету"; 
