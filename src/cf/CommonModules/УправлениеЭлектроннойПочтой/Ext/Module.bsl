		...
		Исключение
			...
			Если Не ЗначениеЗаполнено(РезультатОтправки) Тогда 
				...
				Если Письма.Количество() <> 0 Тогда
					...
					Для Каждого КлючИЗначение Из Письма Цикл
						
						ПараметрыОбработкиОшибки = ПараметрыОбработкиОшибкиОтправки();
						ПараметрыОбработкиОшибки.ПисьмоОбъект                      = КлючИЗначение.Ключ.ПолучитьОбъект();
						ПараметрыОбработкиОшибки.Ссылка                            = КлючИЗначение.Ключ;
						ПараметрыОбработкиОшибки.ПредставлениеПисьма               = КлючИЗначение.Значение.ПредставлениеПисьма;
						ПараметрыОбработкиОшибки.КоличествоПопыток                 = КлючИЗначение.Значение.КоличествоПопыток;
