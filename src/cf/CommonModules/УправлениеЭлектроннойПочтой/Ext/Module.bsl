...
Процедура ЗаписатьВложениеЭлектронногоПисьма(Объект, Вложение,МассивПодписей,КоличествоПустыхИменВоВложениях)
	...
	Если ЕстьПодписи Тогда
		...
		Для Каждого ПодписьВложения Из МассивПодписей Цикл
			...
			ДанныеПодписи.Подпись = ПодписьВложения.Данные;
			РезультатЧтенияСвойствПодписи = МодульЭлектроннаяПодпись.СвойстваПодписи(ПодписьВложения.Данные);
...
// Создает предопределенные папки для электронной почты.
//
// Параметры:
