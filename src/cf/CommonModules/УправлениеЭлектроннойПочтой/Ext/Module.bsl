...
Процедура ОпределитьИдентификаторыВходящегоСообщения(ЗаголовокПисьма, ТаблицаИдентификаторов)
	...
	ПозицияОткрывающегосяТега = СтрНайти(ЗаголовокПисьма.Заголовок, "<", НаправлениеПоиска.СНачала, ПозицияIDОригинальногоСообщения);
	ПозицияЗакрывающегосяТега = СтрНайти(ЗаголовокПисьма.Заголовок, ">", НаправлениеПоиска.СНачала, ПозицияIDОригинальногоСообщения);
	
	ОригинальныйIDСообщенияMicrosoft =
		Сред(ЗаголовокПисьма.Заголовок, ПозицияОткрывающегосяТега + 1, ПозицияЗакрывающегосяТега - ПозицияОткрывающегосяТега -1);
