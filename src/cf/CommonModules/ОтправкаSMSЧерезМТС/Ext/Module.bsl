...
Функция ВыполнитьЗапрос(ИмяМетода, ПараметрыЗапроса)
	...
	HTTPЗапрос = ОтправкаSMS.ПодготовитьHTTPЗапрос("/m2m/m2m_api.asmx/" + ИмяМетода, ПараметрыЗапроса, Истина);
...
Процедура ПриОпределенииСпособовАвторизации(СпособыАвторизации) Экспорт
	...
	СпособыАвторизации.Вставить(0, "ПоКлючу", НСтр("ru = 'По ключу (рекомендуется)'"));
