...
Функция ПодготовитьПакетДляПодписи(МассивДокументов) Экспорт
	...
	Для каждого СтрокаМассива Из МассивДокументов Цикл
		...
		НоваяСтрока = Новый Структура("Content, Name, Type, OriginalContent, ВернутьКак");
		НоваяСтрока.Content = СтрокаМассива.Содержание;
		...
		НоваяСтрока.ВернутьКак = ТипДокумента;
