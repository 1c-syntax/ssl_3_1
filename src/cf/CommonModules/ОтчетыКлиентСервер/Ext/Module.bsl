...
#Область УнификацияФормыОтчетаИФормыНастроекОтчета
...
Процедура ПривестиЗначениеКТипу(Значение, ОписаниеТипов, ВидСравнения = Неопределено) Экспорт
	
	Если ВидСравнения <> Неопределено И ЭтоВидСравненияБезСтрогойТипизации(ВидСравнения) Тогда
		Возврат;
	КонецЕсли;
...
Функция ЭтоВидСравненияБезСтрогойТипизации(ВидСравнения) Экспорт 
	ВидыСравнений = Новый Массив;
	ВидыСравнений.Добавить(ВидСравненияКомпоновкиДанных.Содержит);
	ВидыСравнений.Добавить(ВидСравненияКомпоновкиДанных.НеСодержит);
	ВидыСравнений.Добавить(ВидСравненияКомпоновкиДанных.НачинаетсяС);
	ВидыСравнений.Добавить(ВидСравненияКомпоновкиДанных.НеНачинаетсяС);
	ВидыСравнений.Добавить(ВидСравненияКомпоновкиДанных.Подобно);
	ВидыСравнений.Добавить(ВидСравненияКомпоновкиДанных.НеПодобно);
	
	Возврат ВидыСравнений.Найти(ВидСравнения) <> Неопределено;
КонецФункции

Функция ИзменитьТипНаОбычнуюСтроку(ОписаниеТипов) Экспорт
...
Функция ИмяКомандыВставитьИзБуфера() Экспорт
	...
	Возврат "ВставитьИзБуфераОбмена";
...
Функция ПараметрыОбновленияФормыОтчета(Знач ИмяСобытия = "") Экспорт
	...
	Результат = Новый Структура;
	// "ПриСозданииНаСервере", "ПослеФормирования", "ПриОбновленииСоставаПользовательскихНастроекНаСервере" и др.
	Результат.Вставить("ИмяСобытия", ИмяСобытия);
	Результат.Вставить("ВариантМодифицирован", Ложь);
	Результат.Вставить("ПользовательскиеНастройкиМодифицированы", Ложь);
	Результат.Вставить("Результат", Новый Структура);
	Результат.Вставить("ОтчетОбъектИлиПолноеИмя", "");
	Результат.Вставить("КомпоновщикНастроекКД", Неопределено);
	Результат.Вставить("НастройкиКД", Неопределено);
	Результат.Вставить("ПользовательскиеНастройкиКД", Неопределено);
	Результат.Вставить("СброситьНастройкиВарианта", Ложь);
	Результат.Вставить("СброситьПользовательскиеНастройки", Ложь);
	Результат.Вставить("ОбновитьНастройкиВарианта", Ложь);
	Результат.Вставить("ОтчетОбъектИлиПолноеИмя", "");
	Результат.Вставить("Переформировать", Ложь);
	Результат.Вставить("Непосредственно", Ложь);
	// Для события "ФормаНастроек"
	Результат.Вставить("ФормаНастроекРасширенныйРежим", 0);
	Результат.Вставить("ФормаНастроекИмяСтраницы", "");
	// ФормаНастроекОтчета
	Результат.Вставить("УсловияОтборов", Неопределено);
	Результат.Вставить("Результат", Новый Структура("РазвернутьУзлыДеревьев", Новый Массив));
	Результат.Вставить("Прервать", Ложь);
