...
Процедура УстановитьПризнакЗагрузкиДанныхРИБ(Включить) Экспорт
	...
	Если Константы.ВыполняетсяЗагрузкаДанныхРИБ.Получить() = Включить Тогда
		Возврат;
	КонецЕсли;
	
	Константы.ВыполняетсяЗагрузкаДанныхРИБ.Установить(Включить);
