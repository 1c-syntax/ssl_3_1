...
//                           максимальный размер).
//   * СжатиеTIFF - Число - сжатие, значения:
//       2 - LZW
//       3 - CCITT3
//       4 - CCITT4
//       5 - RLE
...
Функция ПараметрыСканирования(Заполнить = Ложь) Экспорт
	...
	ПараметрыСканирования = РаботаСФайламиСлужебныйВызовСервера.ПараметрыСканирования(Заполнить, ИдентификаторКлиента);
...
Процедура КомандаУправленияПрисоединеннымиФайлами(Форма, Команда) Экспорт
	...
	НомерЭлемента = Число(СтрЗаменить(ЧастиИмениКоманды[1], РаботаСФайламиКлиентСервер.ТолькоОдинФайлТекст(), ""));
	ВладелецПрисоединенныхФайлов = ЗначениеПараметраПрисоединенногоФайла(Форма, НомерЭлемента, "ПутьКДаннымВладельца");
...
Процедура КомандаУправленияПрисоединеннымиФайламиЗавершение(Форма, Команда, ВладелецПрисоединенныхФайлов)
	...
	ПараметрыВыполнения.НомерЭлемента = СтрЗаменить(ЧастиИмениКоманды[1], РаботаСФайламиКлиентСервер.ТолькоОдинФайлТекст(), "");
...
Процедура ИзменитьВидимостьДополнительныхКоманд(Форма)
	...
	Для ИндексЭлемента = 0 По Форма.ПараметрыРаботыСФайлами.ОписанияЭлементовФормы.ВГраница() Цикл
		...
		Если КнопкаКомандыСканировать <> Неопределено Тогда
			...
			КнопкаКомандыСканироватьИзКонтекстногоМеню = Форма.Элементы.Найти("УправлениеПрисоединеннымиФайламиСканироватьИзКонтекстногоМеню" 
				+ ИндексЭлемента);
		...
		Если КнопкаКомандыСоздатьИзШаблона <> Неопределено Тогда
			...
			КнопкаКомандыСоздатьИзШаблонаИзКонтекстногоМеню = Форма.Элементы.Найти("УправлениеПрисоединеннымиФайламиСоздатьПоШаблонуИзКонтекстногоМеню" 
				+ ИндексЭлемента);
