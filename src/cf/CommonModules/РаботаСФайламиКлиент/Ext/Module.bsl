...
Процедура ОбновитьОбластьПредпросмотра(Форма, НомерЭлемента, Файл)
	...
	ИмяРеквизита = Форма.ПараметрыРаботыСФайлами[НомерЭлементаЧислом].ПутьКДаннымИзображения;
	...
	Если ЭлементКартинки <> Неопределено Тогда
		...
		ТекстНевыбраннойКартинки = Форма.ПараметрыРаботыСФайлами[НомерЭлементаЧислом].ТекстНевыбраннойКартинки;
