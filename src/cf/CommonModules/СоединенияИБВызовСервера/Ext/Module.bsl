...
//
Функция УстановитьБлокировкуСоединений(ТекстСообщения = "", КодРазрешения = "КодРазрешения",
	ОжиданиеНачалаБлокировки = 0, ДлительностьБлокировки = 0) Экспорт // АПК:142 расширен программный интерфейс с сохранением обратной совместимости.
