...
Функция ОписанияОшибок()
	...
	Результат.Вставить(3, НСтр("ru = 'Пользователь с указанным ID кабинета не существует.'"));
	...
	Результат.Вставить(10, НСтр("ru = 'Не существует сообщение с таким идентификатором.'"));
