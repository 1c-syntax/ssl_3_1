...
Процедура ВыполнитьОбменДаннымиЧерезФайловыйРесурс(СтруктураНастроекОбмена)
	...
	Если СтруктураНастроекОбмена.ПроизводитьЗагрузкуДанных Тогда
		...
		Если УдалитьСообщениеОбмена Тогда
			ФайлСообщенияОбмена = Новый Файл(СообщениеОбмена);
			Каталог = ФайлСообщенияОбмена.Путь;
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("УдалитьНеактуальныеСообщенияОбмена", Истина);
	Методы.Вставить("ВыполнитьОбменДаннымиПоРегламентномуЗаданию", Истина);
