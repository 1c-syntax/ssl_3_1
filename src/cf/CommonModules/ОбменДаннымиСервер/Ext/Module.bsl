...
//                                                   использован кэш для поиска ссылок
...
// Возвращает признак того, что в данный момент загружаются данные в подчиненный узел РИБ.
//
// Возвращаемое значение:
//   Булево
//
Функция ВыполняетсяЗагрузкаДанныхРИБ() Экспорт

	УстановитьПривилегированныйРежим(Истина);
	
	Возврат Константы.ВыполняетсяЗагрузкаданныхРИБ.Получить();
