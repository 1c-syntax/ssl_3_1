...
Процедура ВыполнитьТранспортСообщенияОбменаПередОбработкой(СтруктураНастроекОбмена)
	...
	ОбработкаТранспортаСообщенийОбмена = СтруктураНастроекОбмена.ОбработкаТранспортаСообщенийОбмена; // ОбработкаОбъект.ТранспортСообщенийОбменаEMAIL,  ОбработкаОбъект.ТранспортСообщенийОбменаFILE,  ОбработкаОбъект.ТранспортСообщенийОбменаFTP
...
Процедура ВыполнитьОбменДаннымиСВнешнейСистемойЗагрузкаДанных(СтруктураНастроекОбмена)
	...
	ОбработкаТранспортаСообщенийОбмена = СтруктураНастроекОбмена.ОбработкаТранспортаСообщенийОбмена; // ОбработкаОбъект.ТранспортСообщенийОбменаEMAIL, ОбработкаОбъект.ТранспортСообщенийОбменаFILE,  ОбработкаОбъект.ТранспортСообщенийОбменаFTP, ОбработкаОбъект.ТранспортСообщенийОбменаВнешняяСистема
...
Процедура ВыполнитьОбменДаннымиСВнешнейСистемойВыгрузкаНастроекXDTO(СтруктураНастроекОбмена)
	...
	ОбработкаТранспортаСообщенийОбмена = СтруктураНастроекОбмена.ОбработкаТранспортаСообщенийОбмена; // ОбработкаОбъект.ТранспортСообщенийОбменаВнешняяСистема
...
Процедура ВыполнитьИнициализациюСтруктурыНастроекОбмена(СтруктураНастроекОбмена, НастройкаВыполненияОбмена, НомерСтроки)
	...
	СтруктураНастроекОбмена.ТекущийУзелПланаОбменаКод = 
		ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СтруктураНастроекОбмена.ТекущийУзелПланаОбмена, "Код");
...
Процедура ВыполнитьПроверкуСтруктурыОбменаНаВалидность(СтруктураНастроекОбмена, ИспользоватьНастройкиТранспорта = Истина)
	...
	ИначеЕсли ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СтруктураНастроекОбмена.УзелИнформационнойБазы, "ПометкаУдаления") Тогда
