...
//  ПараметрыОбновления - Структура - см. УправлениеДоступомПереопределяемый.ПриЗаполненииПоставляемыхПрофилейГруппДоступа
// 
...
// 
// Параметры:
//  Зависимости - ТаблицаЗначений - см. РегламентныеЗаданияПереопределяемый.ПриОпределенииНастроекРегламентныхЗаданий.
// 
...
// Параметры:
//   СтрокиДерева - КоллекцияСтрокДереваЗначений - строки дерева идентификаторов:
...
//       * ДополнительнаяРегистрация - ДеревоЗначений -
