...
Процедура ПриДобавленииИсключенийПоискаСсылок(Массив) Экспорт
	...
	Массив.Добавить("Справочник.ДополнительныеОтчетыИОбработки.ТабличнаяЧасть.Разделы.Реквизит.Раздел");
	Массив.Добавить("Справочник.ДополнительныеОтчетыИОбработки.ТабличнаяЧасть.Назначение.Реквизит.ОбъектНазначения");
	
КонецПроцедуры

Функция ЕстьЗаблокированныеПредыдущимиОчередямиДанные(Очередь) Экспорт
...
Функция ЗарегистрироватьОбработку(Знач Объект, Знач ПараметрыРегистрации) Экспорт
	...
	Если Объект.Публикация = Перечисления.ВариантыПубликацииДополнительныхОтчетовИОбработок.Используется Тогда
		// Проверка имени
		Конфликтующие = КонфликтующиеДополнительныеОтчетыИОбработки(Объект, ПараметрыРегистрации.ЭтоОтчет, Результат.ИмяОбъекта);
	...
	Если ЭтоВнешнийОтчет Тогда
		...
		Объект.ИспользуетХранилищеВариантов = (РегистрационныеДанные.ХранилищеВариантов = "ХранилищеВариантовОтчетов"
			ИЛИ (Хранилище <> Неопределено 
				И Хранилище.Имя = "ХранилищеВариантовОтчетов"));
	...
	Если РегистрационныеДанные.Свойство("Разрешения") Тогда
		Разрешения = РегистрационныеДанные.Разрешения;
...
//  * ЭтоОтчет - Булево
//
Функция ДополнительныеПараметрыКомандыЗаполнения()
