...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ВыполнитьОбработкуЗапросов", Истина);
	Методы.Вставить("ВыполнитьОбработкуЗапросовОбновления", Истина);
	Методы.Вставить("ВыполнитьОбработкуЗапросовОтключения", Истина);
	Методы.Вставить("ВыполнитьОбработкуЗапросовВосстановления", Истина);
