...
//   ДанныеФормыСтруктура - Виды контактной информации. Где:
...
// Возвращаемое значение:
// 	Структура - Описание:
//		Код - Строка - Числовой код страны по ОКСМ;
//		КодАльфа2 - Строка - Двузначный буквенный код альфа-2 страны по ОКСМ;
//		КодАльфа3 - Строка - Трехзначный буквенный код альфа-3 страны по ОКСМ;
