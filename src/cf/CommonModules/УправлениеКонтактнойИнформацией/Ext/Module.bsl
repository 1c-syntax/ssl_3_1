...
//
// Параметры:
//  КонтактнаяИнформация - ТаблицаЗначений - см. УправлениеКонтактнойИнформацией.НоваяКонтактнаяИнформация
//                                           Таблица содержащая контактную информацию
...
//
// Параметры:
//  СсылкаИлиОбъект - СправочникСсылка, ДокументСсылка, СправочникОбъект, ДокументОбъект - ссылка или объект владелец
...
Процедура УстановитьКонтактнуюИнформациюОбъекта(СсылкаИлиОбъект, Знач КонтактнаяИнформация, Замещать = Истина) Экспорт
	...
	Если ОбъектМетаданных = Неопределено
		Или ОбъектМетаданных.ТабличныеЧасти.Найти("КонтактнаяИнформация") = Неопределено Тогда
		ВызватьИсключение НСтр("ru = 'Добавление контактной информации невозможно, у объекта нет таблицы с контактной информацией.'");;
	КонецЕсли;
...
// Если страна не найдена в справочнике, но найдена в классификаторе стран, то поле Ссылка результата не будет заполнено.
// Если страна не найдена ни в адресе, ни в классификаторе стран, то будет заполнено только поле Наименование.
//
// Параметры:
	...
	Для каждого ОбъектСКонтактнойИнформацией Из ОбъектыСГруппировкойПоТипам Цикл
		...
		Если МетаданныеОбъекта.ТабличныеЧасти.Найти("КонтактнаяИнформация") = Неопределено Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = '%1 не содержит контактную информацию.'"), МетаданныеОбъекта.Имя);
		КонецЕсли;
...
//    Объект - СправочникСсылка, ДокументСсылка, СправочникОбъект, ДокументОбъект - Объект-владелец контактной информации. 
...
//
// Параметры:
//  Источник             - СправочникОбъект, ДокументОбъект - объект, содержащий контактную информацию.
...
//
// Параметры:
//  ВладелецКонтактнойИнформации - СправочникСсылка.ВидыКонтактнойИнформации, СправочникОбъект.ВидыКонтактнойИнформации,
//    ДанныеФормыСтруктура - где:
//    * Ссылка - СправочникСсылка.ВидыКонтактнойИнформации - ссылка на вид контактной информации.
//
// Возвращаемое значение:
...
// 	ПоложениеЗаголовкаКИ - Строка, ПоложениеЗаголовкаЭлементаФормы - 
// 	ОтложеннаяИнициализация - Массив, Булево - 
// 	ИсключаемыеВиды - Массив, Неопределено - 
// 	СкрываемыеВиды - Массив, Неопределено - 
// 	
// Возвращаемое значение:
//  Структура - где:
...
//	 * СписокДобавляемыхЭлементов - СписокЗначений - список элементов, где:
