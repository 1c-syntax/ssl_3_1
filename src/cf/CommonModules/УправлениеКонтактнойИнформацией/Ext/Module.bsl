...
//  ТаблицаЗначений -  контактная информация объектов:
...
Функция КонтактнаяИнформация(Источник, Отбор) Экспорт
	...
	Перем ТипыКонтактнойИнформации, ВидыКонтактнойИнформации, Дата;
...
//                           - Объект - ссылка или объект-владелец контактной информации (организация,
...
//
// Параметры:
//  СсылкаИлиОбъект - ОпределяемыеТипы.ВладелецКонтактнойИнформации - ссылка на объект с контактной информацией.
//                  - СправочникОбъекта
//                  - ДокументОбъект - объект-владелец контактной информации (организация,
//                                    контрагент, партнер и т.д.).
// 
// Возвращаемое значение:
//  Булево - если, Истина, то контактная информация был преобразована в JSON.
//
...
//                                     - см. УправлениеКонтактнойИнформацией.СведенияОТелефоне
...
//      * ФорматАдреса                 - Строка - устарело. Варианты: "ФИАС" или "КЛАДР".
...
Процедура СоздатьВТКонтактнаяИнформация(МенеджерВременныхТаблиц, МассивОбъектов, ТипыКонтактнойИнформации = Неопределено, ВидыКонтактнойИнформации = Неопределено, Дата = Неопределено) Экспорт
	...
	СтрокаРАЗРЕШЕННЫЕ = " РАЗРЕШЕННЫЕ "; // @Query-part-1
...
//      * Имя - имя предопределенного вида контактной информации;
//      * Наименование - наименование вида контактной информации;
...
//                          - Неопределено - настройки проверки вида контактной информации.
...
//                                                          Для запрета пользователю записывать некорректные адреса
//                                                          следует использовать параметр ПроверятьКорректность.
//          Для типа Телефон и Факс - Структура, содержащая поля:
//              * ТелефонCДобавочнымНомером  - Булево - если Истина, то телефон/факс содержит добавочный номер.
//              * ВводитьНомерПоМаске - Булево - Истина, если требуется ввод телефона по маске.
//              * МаскаНомераТелефон  - Строка -  содержит посимвольную строку маски интерактивного ввода текста в поле.
//                                                 Формат маски соответствует платформенной маске для поля ввода.
...
//            Для типа АдресЭлектроннойПочты
...
//   ИмяОбъекта - Строка
//   ИсключаемыеВиды - Неопределено, Массив
...
//    * Комментарий    - Строка.
//   ОтложеннаяИнициализация - Булево, Массив
...
Процедура СоздатьРеквизитыКонтактнойИнформации(Знач Форма, Знач ДобавляемыеРеквизиты, Знач ИмяОбъекта, Знач ИсключаемыеВиды,
	...
	Для Каждого ОбъектКонтактнойИнформации Из КонтактнаяИнформация Цикл // СтрокаТаблицыЗначений: см. КонтактнаяИнформацияОбъекта
		...
		Если ОбъектКонтактнойИнформации.ЭтоРеквизитТабличнойЧасти Тогда
			...
			Для Каждого СтрокаКИ Из ОбъектКонтактнойИнформации.Строки Цикл // СтрокаТаблицыЗначений: см. КонтактнаяИнформацияОбъекта
...
//     * ХранитьИсториюИзменений     - Булево - признак возможности хранения истории контактной информации.
//                                              Хранение истории допускается, если признак ВидРедактирования = "Диалог".
//                                              Свойство применимо если табличная часть
