...
//
//    * Сотрудник    - СправочникСсылка - (возвращаемое значение) - это владелец сертификата из ТипВладельца,
...
//
//    * Директор     - СправочникСсылка - (возвращаемое значение) - это директор из ТипВладельца, который может быть
...
//
//    * ГлавныйБухгалтер - СправочникСсылка - (возвращаемое значение) это главный бухгалтер из ТипВладельца, который может
