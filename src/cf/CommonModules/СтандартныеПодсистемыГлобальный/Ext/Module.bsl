...
// Вызывается после запуска конфигурации, открывает окно предупреждения безопасности.
Процедура ЗадатьВопросПроОтключениеOpenIDConnectОбработчикОжидания() Экспорт
	
	// АПК:277-выкл Используется модуль СтандартныеПодсистемыГлобальный,
	// чтобы не создавать ПользователиГлобальный из-за одной процедуры.
	ПользователиСлужебныйКлиент.ЗадатьВопросПроОтключениеOpenIDConnect();
	// АПК:277-вкл
