...
Процедура ПоказатьПредупреждениеБезопасностиПослеЗапуска() Экспорт
	ПользователиСлужебныйКлиент.ПоказатьПредупреждениеБезопасностиПослеЗапускаЕслиНужно();
КонецПроцедуры
...
Процедура КонтрольПерезапускаПриСокращенииПравДоступа() Экспорт
	ПользователиСлужебныйКлиент.ПриКонтролеПерезапускаПриСокращенииПравДоступа();
КонецПроцедуры
