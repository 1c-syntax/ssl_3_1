...
#Область ОбслуживаниеТаблицВидыДоступаИЗначенияДоступаВФормахРедактирования
...
Процедура ПриИзмененииТекущегоВидаДоступа(Форма, ОбработкаНаКлиенте = Истина) Экспорт
	...
	Если ТекущиеДанные <> Неопределено Тогда
		...
		Если ТекущиеДанные.ВидДоступа = Форма.ВидДоступаПользователи
		 Или ТекущиеДанные.ВидДоступа = Форма.ВидДоступаВнешниеПользователи Тогда
			
			ШаблонНадписи = ?(ТекущиеДанные.ВсеРазрешены,
				НСтр("ru = 'Запрещенные значения (%1) - авторизованный пользователь и его группы всегда разрешены'"),
				НСтр("ru = 'Разрешенные значения (%1) - авторизованный пользователь и его группы всегда разрешены'") );
		Иначе
			ШаблонНадписи = ?(ТекущиеДанные.ВсеРазрешены,
...
// Только для внутреннего использования.
Процедура ДобавитьКоллекцииОбъектовМетаданныхСПравами(Коллекции) Экспорт
	
	Коллекции.Добавить("Подсистемы",              НСтр("ru = 'Подсистемы'"));
	Коллекции.Добавить("ПараметрыСеанса",         НСтр("ru = 'Параметры сеанса'"));
	Коллекции.Добавить("ОбщиеРеквизиты",          НСтр("ru = 'Общие реквизиты'"));
	Коллекции.Добавить("ПланыОбмена",             НСтр("ru = 'Планы обмена'"));
	Коллекции.Добавить("КритерииОтбора",          НСтр("ru = 'Критерии отбора'"));
	Коллекции.Добавить("ОбщиеФормы",              НСтр("ru = 'Общие формы'"));
	Коллекции.Добавить("ОбщиеКоманды",            НСтр("ru = 'Общие команды'"));
	Коллекции.Добавить("WebСервисы",              НСтр("ru = 'Web-сервисы'"));
	Коллекции.Добавить("HTTPСервисы",             НСтр("ru = 'HTTP-сервисы'"));
	Коллекции.Добавить("Константы",               НСтр("ru = 'Константы'"));
	Коллекции.Добавить("Справочники",             НСтр("ru = 'Справочники'"));
	Коллекции.Добавить("Документы",               НСтр("ru = 'Документы'"));
	Коллекции.Добавить("ЖурналыДокументов",       НСтр("ru = 'Журналы документов'"));
	Коллекции.Добавить("Перечисления",            НСтр("ru = 'Перечисления'"));
	Коллекции.Добавить("Отчеты",                  НСтр("ru = 'Отчеты'"));
	Коллекции.Добавить("Обработки",               НСтр("ru = 'Обработки'"));
	Коллекции.Добавить("ПланыВидовХарактеристик", НСтр("ru = 'Планы видов характеристик'"));
	Коллекции.Добавить("ПланыСчетов",             НСтр("ru = 'Планы счетов'"));
	Коллекции.Добавить("ПланыВидовРасчета",       НСтр("ru = 'Планы видов расчета'"));
	Коллекции.Добавить("РегистрыСведений",        НСтр("ru = 'Регистры сведений'"));
	Коллекции.Добавить("РегистрыНакопления",      НСтр("ru = 'Регистры накопления'"));
	Коллекции.Добавить("РегистрыБухгалтерии",     НСтр("ru = 'Регистры бухгалтерии'"));
	Коллекции.Добавить("РегистрыРасчета",         НСтр("ru = 'Регистры расчета'"));
	Коллекции.Добавить("БизнесПроцессы",          НСтр("ru = 'Бизнес-процессы'"));
	Коллекции.Добавить("Задачи",                  НСтр("ru = 'Задачи'"));
	Коллекции.Добавить("ВнешниеИсточникиДанных",  НСтр("ru = 'Внешние источники данных'"));
