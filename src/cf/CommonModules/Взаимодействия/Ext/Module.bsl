...
Процедура ЗаполнитьРеквизитыПоУмолчанию(Объект, ДанныеЗаполнения) Экспорт
	...
	// На основании предмета или взаимодействия
...
//      ** ИсточникКонтактнойИнформации - ОпределяемыйТип.ВладелецКонтактнойИнформации
//    * ПолучателиОтвета
//      ** Представление - Строка
//      ** Адрес - Строка - адрес во временном хранилище
//      ** ИсточникКонтактнойИнформации - ОпределяемыйТип.ВладелецКонтактнойИнформации
...
Функция ПараметрыПисьма() Экспорт
	...
	Получатели.Колонки.Добавить("ИсточникКонтактнойИнформации", Метаданные.ОпределяемыеТипы.ВладелецКонтактнойИнформации.Тип);
	...
	ПолучателиОтвета.Колонки.Добавить("ИсточникКонтактнойИнформации", Метаданные.ОпределяемыеТипы.ВладелецКонтактнойИнформации.Тип);
	...
	ПолучателиСкрытыхКопий.Колонки.Добавить("ИсточникКонтактнойИнформации", Метаданные.ОпределяемыеТипы.ВладелецКонтактнойИнформации.Тип);
		...
		Если ОписаниеКонтакта.Имя = ИмяМетаданныхКонтакта Тогда
			...
			Если ОписаниеКонтакта.ЕстьВладелец Тогда
				...
				ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
					Форма["Список_" + ОписаниеКонтакта.Имя],"Владелец",Контакт.Владелец,,, Истина);
			КонецЕсли;
...
// 
// Параметры:
//  Документ - ДокументОбъект.СообщениеSMS, ДанныеФормыСтруктура
//
// Возвращаемое значение:
...
// Проверяет, является ли текущий пользователь ответственным за ведение папок почты.
//
// Параметры:
...
// Определяет папки по умолчанию для переданных писем.
//
// Параметры:
//  Письма  - Массив из ДокументСсылка.ЭлектронноеПисьмоВходящее
//          - Массив из ДокументСсылка.ЭлектронноеПисьмоИсходящее
...
//
// Параметры:
//  ПисьмоОбъект - ДокументОбъект.ЭлектронноеПисьмоИсходящее, ДокументОбъект.ЭлектронноеПисьмоВходящее
//
...
// Возвращаемое значение:
//   ТаблицаЗначений:
//    * ПоЧемуРассчитывать - СправочникСсылка.ПапкиЭлектронныхПисем, ОпределяемыйТип.ПредметВзаимодействия, ОпределяемыйТип.КонтактВзаимодействия
//
