...
// Заполняет наборы значений доступа значениями по умолчанию. 
// 
// Параметры:
...
// Предназначен для получения предмета взаимодействия.
// 
// Параметры:
...
// 	ОпределяемыйТип.ПредметВзаимодействия, Неопределено - Описание
//
