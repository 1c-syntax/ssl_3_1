...
//
Функция ВсеКонтактыПоНачалуНаименования(СтрокаПоиска) Экспорт
...
//  Булево - Истина, если найден хотя бы один контакт.
//
Функция НайтиКонтактыСАдресамиПоНаименованию(СтрокаПоиска, Форма) Экспорт
...
Функция НайтиКонтакты(Знач СтрокаПоиска, Форма) Экспорт
	...
	Если ПолнотекстовыйПоиск.ПолучитьРежимПолнотекстовогоПоиска() = РежимПолнотекстовогоПоиска.Запретить
		...
		НайтиКонтактыСАдресамиПоНаименованию(СтрокаПоиска, Форма);
		Возврат "";
	Иначе
		Результат = ПолнотекстовыйПоискКонтактовПоСтроке(СтрокаПоиска, Форма, Истина);
		Если ПустаяСтрока(Результат) Тогда
			НайтиПоEmail(СтрокаПоиска, Ложь, Форма);
		КонецЕсли;
		Возврат Результат;
	КонецЕсли;
...
//
Функция ПолнотекстовыйПоискКонтактовПоСтроке(Знач СтрокаПоиска, Форма, ДляАдреснойКниги = Ложь) Экспорт
