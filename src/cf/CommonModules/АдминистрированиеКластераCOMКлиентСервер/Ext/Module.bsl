...
//
// Возвращаемое значение:
//   Массив Из Структура, массив структур, описывающих свойства сеансов. Описание структур -
...
//
// Возвращаемое значение:
//   Массив Из Структура, массив структур, описывающих свойства соединений. Описание структур -
...
//
// Возвращаемое значение:
//   COMОбъект - , реализующий интерфейс IV8AgentConnection.
//
...
//
// Возвращаемое значение:
//   COMОбъект - , реализующий интерфейс IClusterInfo.
//
...
//
// Возвращаемое значение:
//   COMОбъект - , реализующий интерфейс IV8ServerConnection.
//
...
//
// Возвращаемое значение:
//   COMОбъект - , реализующий интерфейс IInfoBaseShort.
//
...
//
// Возвращаемое значение:
//   COMОбъект - , реализующий интерфейс IInfoBaseInfo.
//
...
//
// Возвращаемое значение:
//   Массив(COMОбъект), Массив(Структура).
//
...
//
// Возвращаемое значение:
//   COMОбъект - , реализующий интерфейс ISecurityProfile.
//
...
//
// Возвращаемое значение:
//   Массив Из COMОбъект - массив COM-объектов, реализующих интерфейс
...
//
// Возвращаемое значение:
//   Массив Из COMОбъект - массив COM-объектов, реализующих интерфейс ISecurityProfileCOMClass.
//
...
//
// Возвращаемое значение:
//   Массив Из COMОбъект - массив COM-объектов, реализующих интерфейс ISecurityProfileAddIn.
//
...
//
// Возвращаемое значение:
//   Массив Из COMОбъект - массив COM-объектов, реализующих интерфейс ISecurityProfileExternalModule.
//
...
//
// Возвращаемое значение:
//   Массив Из COMОбъект - массив COM-объектов, реализующих интерфейс ISecurityProfileApplication.
//
...
//
// Возвращаемое значение:
//   Структура, описание объекта объектной модели COM-администратора
...
//
// Параметры:
//  Объекты - Массив Из COMОбъект,
//  Словарь - Соответствие, содержит соответствие свойств объекта и в описании:
//    Ключ - Имя свойства в описании,
//    Значение - Имя свойства объекта.
//
// Возвращаемое значение:
//   Массив Из Структура, описания объекта объектной модели COM-администратора
//  по переданному словарю.
//
