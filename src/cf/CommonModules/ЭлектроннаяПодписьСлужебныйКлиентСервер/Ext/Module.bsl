...
Функция АлгоритмПодписи(Данные, ЭтоДанныеСертификата = Ложь, ВключаяOID = Ложь)
	...
	Если ЭтоДанныеСертификата Тогда
		Идентификаторы = ИдентификаторыАлгоритмовПодписиОткрытогоКлючаВСертификате();
	Иначе
		Идентификаторы = ИдентификаторыАлгоритмовПодписиВДанныхПодписи();
	КонецЕсли;
	ПредставлениеАлгоритма = Идентификаторы.Получить(OIDАлгоритмаПодписи);
	
	Если ПредставлениеАлгоритма = Неопределено Тогда
		Если ВключаяOID Тогда
			Возврат НСтр("ru = 'Неизвестный'") + " (OID " + OIDАлгоритмаПодписи + ")";
		КонецЕсли;
		Возврат "";
	ИначеЕсли ВключаяOID Тогда
		Возврат СтрРазделить(ПредставлениеАлгоритма, ",", Ложь)[0] + " (OID " + OIDАлгоритмаПодписи + ")";
	Иначе
...
Функция ИдентификаторыАлгоритмовПодписиВДанныхПодписи()
...
Функция ИдентификаторыАлгоритмовПодписиОткрытогоКлючаВСертификате()
	
	ИдентификаторыАлгоритмов = Новый Соответствие;
	ИдентификаторыАлгоритмов.Вставить("1.2.643.2.2.20", "GOST R 34.11-94");
	ИдентификаторыАлгоритмов.Вставить("1.2.643.2.2.19", "GOST R 34.10-2001");
	ИдентификаторыАлгоритмов.Вставить("1.2.643.7.1.1.1.1", "GR 34.10-2012 256, GOST 34.10-2012 256");
	ИдентификаторыАлгоритмов.Вставить("1.2.643.7.1.1.1.2", "GR 34.10-2012 512, GOST 34.10-2012 512");
	ИдентификаторыАлгоритмов.Вставить("1.2.840.113549.1.1.1", "RSA_SIGN");
