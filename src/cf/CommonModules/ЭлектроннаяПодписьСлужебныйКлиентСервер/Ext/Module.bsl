...
// Описание подключения внешней компоненты (XMLDSIG).
//
// Возвращаемое значение:
//  Структура:
...
Функция ПараметрыXMLDSig() Экспорт
	...
	ДанныеАлгоритмаПодписания.Вставить("XPathSignedInfo",       "(//. | //@* | //namespace::*)[ancestor-or-self::*[local-name()='SignedInfo']]");
	ДанныеАлгоритмаПодписания.Вставить("XPathПодписываемыйТег", "(//. | //@* | //namespace::*)[ancestor-or-self::soap:Body]");
...
Функция ПроверитьВыбратьАлгоритмПодписи(СертификатКриптографииBase64, ДанныеАлгоритмаПодписания, ВызыватьИсключение = Ложь) Экспорт
...
//
Функция НаборыАлгоритмовДляСозданияПодписи()
