...
Функция ПараметрыПодписиКриптографии(КонтейнерПодписи, ДобавкаВремени, ДатаСеанса) Экспорт
	...
	СертификатСуществует = СертификатСуществует(Подпись.СертификатПодписи);
	...
	Если ЗначениеЗаполнено(Подпись.НеподтвержденнаяДатаПодписи) Тогда
		ПараметрыПодписи.НеподтвержденнаяДатаПодписи = Подпись.НеподтвержденнаяДатаПодписи + ДобавкаВремени;
	КонецЕсли;
