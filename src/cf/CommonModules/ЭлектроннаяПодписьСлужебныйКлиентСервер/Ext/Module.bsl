	...
	Иначе
		...
		Если ЗначениеЗаполнено(Сертификат) Тогда
			...
			ИначеЕсли ТипЗнч(Сертификат) = Тип("СправочникСсылка.СертификатыКлючейЭлектроннойПодписиИШифрования") Тогда
				ДанныеСертификата = ЭлектроннаяПодписьСлужебныйВызовСервера.ДанныеСертификата(ЭлектроннаяПодписьСлужебныйВызовСервера.ДанныеСертификата(Сертификат));
...
Функция АлгоритмПодписиСоответствуетСертификату(ПредставлениеСертификата, АлгоритмСертификата, АлгоритмПодписи, АлгоритмХеширования = Неопределено) Экспорт
	...
	Если АлгоритмыДляПроверки <> Неопределено Тогда
		...
		Если ЗначениеЗаполнено(АлгоритмХеширования) Тогда
