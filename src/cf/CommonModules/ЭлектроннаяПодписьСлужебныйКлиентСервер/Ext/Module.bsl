...
Функция СертификатыПоПорядкуДоКорневого(Сертификаты) Экспорт
	...
	Для Каждого Сертификат Из Сертификаты Цикл
		...
		СертификатыПоСубъектам.Вставить(Сертификат.Субъект.CN, Сертификат);
	КонецЦикла;
	
	УпорядочитьСертификаты(ПоПорядку, ОписаниеСертификатов, СертификатыПоСубъектам);
...
Процедура УпорядочитьСертификаты(ПоПорядку, ОписаниеСертификатов, СертификатыПоСубъектам) Экспорт
	...
	Для Каждого ОписаниеСертификата Из ОписаниеСертификатов Цикл
		...
		СертификатИздателя = СертификатыПоСубъектам.Получить(СвойстваСертификата.Издатель.CN);
