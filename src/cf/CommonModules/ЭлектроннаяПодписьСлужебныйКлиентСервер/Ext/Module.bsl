...
Функция АлгоритмСформированнойПодписи(ДанныеПодписи, ВключаяOID = Ложь) Экспорт
	
	Возврат АлгоритмПодписи(ДанныеПодписи, Ложь, ВключаяOID);
	
КонецФункции

Функция АлгоритмПодписиСертификата(ДанныеСертификата, ВключаяOID = Ложь) Экспорт
	
	Возврат АлгоритмПодписи(ДанныеСертификата, Истина, ВключаяOID);
	
КонецФункции

Функция АлгоритмПодписи(Данные, ЭтоДанныеСертификата, ВключаяOID = Ложь)
...
Функция ИдентификаторыАлгоритмовПодписи(ТолькоАлгоритмыОткрытогоКлюча)
	...
	ИдентификаторыАлгоритмов.Вставить("1.2.643.2.2.20",    ИменаАлгоритмовПодписиГОСТ_34_10_94());
	ИдентификаторыАлгоритмов.Вставить("1.2.643.2.2.19",    ИменаАлгоритмовПодписиГОСТ_34_10_2001());
	ИдентификаторыАлгоритмов.Вставить("1.2.643.7.1.1.1.1", ИменаАлгоритмовПодписиГОСТ_34_10_2012_256());
	ИдентификаторыАлгоритмов.Вставить("1.2.643.7.1.1.1.2", ИменаАлгоритмовПодписиГОСТ_34_10_2012_512());
	ИдентификаторыАлгоритмов.Вставить("1.2.840.113549.1.1.1", "RSA_SIGN"); // RSAEncryption.
	
	Если Не ТолькоАлгоритмыОткрытогоКлюча Тогда
		ИдентификаторыАлгоритмов.Вставить("1.2.643.2.2.4",     ИменаАлгоритмовПодписиГОСТ_34_10_94());
		ИдентификаторыАлгоритмов.Вставить("1.2.643.2.2.3",     ИменаАлгоритмовПодписиГОСТ_34_10_2001());
		ИдентификаторыАлгоритмов.Вставить("1.2.643.7.1.1.3.2", ИменаАлгоритмовПодписиГОСТ_34_10_2012_256());
		ИдентификаторыАлгоритмов.Вставить("1.2.643.7.1.1.3.3", ИменаАлгоритмовПодписиГОСТ_34_10_2012_512());
		ИдентификаторыАлгоритмов.Вставить("1.2.840.113549.1.1.2", "RSA_SIGN"); // md2WithRSAEncryption.
		ИдентификаторыАлгоритмов.Вставить("1.2.840.113549.1.1.3", "RSA_SIGN"); // md4withRSAEncryption.
		ИдентификаторыАлгоритмов.Вставить("1.2.840.113549.1.1.4", "RSA_SIGN"); // md5WithRSAEncryption.
		ИдентификаторыАлгоритмов.Вставить("1.2.840.113549.1.1.5", "RSA_SIGN"); // sha1WithRSAEncryption.
	КонецЕсли;
...
Функция ИдентификаторыАлгоритмовХеширования()
	...
	ИдентификаторыАлгоритмов.Вставить("1.2.643.2.2.9",      ИменаАлгоритмовХешированияГОСТ_34_11_94());
	ИдентификаторыАлгоритмов.Вставить("1.2.643.7.1.1.2.2",  ИменаАлгоритмовХешированияГОСТ_34_11_2012_256());
	ИдентификаторыАлгоритмов.Вставить("1.2.643.7.1.1.2.3",  ИменаАлгоритмовХешированияГОСТ_34_11_2012_512());
	ИдентификаторыАлгоритмов.Вставить("1.2.840.113549.2.2", "MD2");
	ИдентификаторыАлгоритмов.Вставить("1.2.840.113549.2.4", "MD4");
	ИдентификаторыАлгоритмов.Вставить("1.2.840.113549.2.5", "MD5");
	ИдентификаторыАлгоритмов.Вставить("1.3.14.3.2.26",      "SHA-1");
