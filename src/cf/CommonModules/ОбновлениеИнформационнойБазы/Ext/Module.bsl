...
Процедура ЗарегистрироватьПакетДанных(ПараметрыРегистрации, Данные, Принудительно = Ложь, РазмерПакета = 1000)
	...
	Если Данные.Количество() >= РазмерПакета Или Принудительно И Данные.Количество() > 0 Тогда
		...
		Если ПараметрыРегистрации.Свойство("ПереиспользуемыеНаборы") Тогда
			ОсвободитьПереиспользуемыеНаборы(ПараметрыРегистрации.ПереиспользуемыеНаборы);
		КонецЕсли;
	КонецЕсли;
...
Процедура УдалитьРегистрациюИзмененийПакетаДанных(ПараметрыУдаления, Данные, Принудительно = Ложь, РазмерПакета = 1000)
	...
	Если Данные.Количество() >= РазмерПакета Или Принудительно И Данные.Количество() > 0 Тогда
		...
		Если ПараметрыУдаления.Свойство("ПереиспользуемыеНаборы") Тогда
			ОсвободитьПереиспользуемыеНаборы(ПараметрыУдаления.ПереиспользуемыеНаборы);
		КонецЕсли;
	КонецЕсли;
...
//
Функция ДоступнаПакетнаяРегистрация()
