...
Процедура ПриАктивизацииРезультатаОтчета(Форма, Элемент) Экспорт 
	...
	ОпределитьВариантОтображениеКомандРедактированияТаблицы(Элементы, ЭтоРасшифровка);
...
Процедура ОпределитьВариантОтображениеКомандРедактированияТаблицы(Элементы, ЭтоРасшифровка)
