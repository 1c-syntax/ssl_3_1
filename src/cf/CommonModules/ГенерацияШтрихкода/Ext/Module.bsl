...
#КонецЕсли
	...
	Если НЕ ВнешняяКомпонента.ГрафикаУстановлена Тогда
		...
		Возврат Неопределено;
	Иначе
		ПодготовитьКомпонентуГенерацииИзображенияШтрихкода(ВнешняяКомпонента);
...
// Подготовить компоненту генерации изображения штрихкода.
//
// Параметры: 
//   ВнешняяКомпонента - ОбъектВнешнейКомпоненты - объект внешней компоненты
//
Процедура ПодготовитьКомпонентуГенерацииИзображенияШтрихкода(ВнешняяКомпонента)
...
//
// Параметры: 
//   ВнешняяКомпонента - ОбъектВнешнейКомпоненты:
//   * Высота - Число
//   * Ширина - Число
//   * АвтоТип - Булево
//   * ТипКода - Число
