...
//    * СписокМетодов				- Соответствие - варианты подтверждения полученные от сервиса
...
Процедура ДополнитьПроизвольноеПодтверждение(
	...
	Если ДанныеПодтверждения.ДоступныеМетоды.Найти(ДанныеПодтверждения.ВторичнаяАвторизация) = Неопределено
...
Процедура ПодготовитьГруппуПодтвержденияРеквизиты(КонтекстФормы)
	...
	ДобавитьНовыйРеквизит(КонтекстФормы, МассивРеквизитов, "СпособПодтверждения", Новый ОписаниеТипов("ПеречислениеСсылка.СпособыАвторизацииDSS"),
				НСтр("ru = 'Запомнить пароль'", КодЯзыка));
...
Процедура ПодготовитьГруппуПодтвержденияЭлементы(КонтекстФормы)
	...
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, "ПодтверждениеСпособПодтвержденияОшибка", "", ГруппаПодтвержденияВыбор, "ДекорацияФормы", "Надпись");
	ЭлементФормы.Заголовок = "                                   " + НСтр("ru = 'Для продолжения укажите способ подтверждения'");
	...
	ЭлементФормы.Шрифт = СервисКриптографииDSSСлужебный.ПолучитьЭлементСтиля("МелкийЗаголовокПодтвержденияШрифт");
	ЭлементФормы.ЦветТекста = WebЦвета.Серый;
