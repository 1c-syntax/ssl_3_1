...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		Элементы.ГруппаНачала.ВыравниваниеЭлементовИЗаголовков    = ВариантВыравниванияЭлементовИЗаголовков.ЭлементыПравоЗаголовкиЛево;
		Элементы.ГруппаОкончание.ВыравниваниеЭлементовИЗаголовков = ВариантВыравниванияЭлементовИЗаголовков.ЭлементыПравоЗаголовкиЛево;
		Элементы.ДатаНачала.КнопкаРегулирования                   = Ложь;
		Элементы.ДатаНачала.ПоложениеЗаголовка                    = ПоложениеЗаголовкаЭлементаФормы.Лево;
		Элементы.ДатаОкончания.КнопкаРегулирования                = Ложь;
		...
		Элементы.ВремяНачала.КнопкаРегулирования                  = Ложь;
		Элементы.ВремяОкончания.КнопкаРегулирования               = Ложь;
	КонецЕсли;
