...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		Объект.ДатаОтзыва = Параметры.ДатаСогласия;
		Если Не ЗначениеЗаполнено(Объект.ДатаОтзыва) Тогда
		...
		Если Параметры.Субъект <> Неопределено И Не Параметры.Субъект.Пустая() Тогда
...
Процедура УстановитьСведенияДействующегоСогласия()
	...
	Если Согласие = Неопределено Тогда
		...
		Элементы.СведенияКартинка.Картинка = БиблиотекаКартинок.ДиалогВосклицание;
