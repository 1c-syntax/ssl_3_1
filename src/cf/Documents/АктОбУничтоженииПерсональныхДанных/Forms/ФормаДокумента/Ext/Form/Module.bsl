	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		Если Не ЗначениеЗаполнено(Объект.Организация) Тогда
			Если Не Параметры.Свойство("Организация", Объект.Организация) Тогда
				Объект.Организация = ЗащитаПерсональныхДанных.ОрганизацияПоУмолчанию();
			КонецЕсли;
		КонецЕсли;
...
Процедура УстановитьСвойстваЭлементов()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ТипСубъекта", "ТолькоПросмотр",
		Объект.Проведен);
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФИОСубъекта", "ТолькоПросмотр",
		Объект.Проведен);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "Провести", "Видимость", Не Объект.Проведен);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаПровести", "Видимость",
		Не Объект.Проведен);
	Команды.ПровестиИЗакрыть.Заголовок = ?(Объект.Проведен, НСтр("ru = 'Записать и закрыть'"),
		НСтр("ru = 'Провести и закрыть'"));
