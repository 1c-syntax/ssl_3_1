...
// Возвращает категории документа.
// 
// Параметры:
...
Функция КатегорииДанныхДокументов(Документы)
	...
	Запрос.Текст =
		...
		|	КатегорииДанных.Категория КАК Категория
		|ИЗ
		|	Документ.АктОбУничтоженииПерсональныхДанных.КатегорииДанных КАК КатегорииДанных
		|ГДЕ
		|	КатегорииДанных.Ссылка В (&Документы)
		|ИТОГИ
		|ПО
		|	Ссылка";
	...
	Пока ВыборкаДокумент.Следующий() Цикл
		КатегорииДокументов.Вставить(ВыборкаДокумент.Ссылка);
		...
		Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
			...
			КонецЕсли;
		КонецЦикла;
		КатегорииДокументов[ВыборкаДокумент.Ссылка] = КатегорииДокумента;
	КонецЦикла;
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("КатегорииУничтожаемыхДанныхСубъекта", Истина);
	Методы.Вставить("ВыполнитьПроведение", Истина);
