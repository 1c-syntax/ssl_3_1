...
Процедура ПриОткрытии(Отказ)
	...
	Если НЕ РаботаСФайламиСлужебныйКлиент.Расширение1СПредприятияПодключено() Тогда
		...
		ПодключитьОбработчикОжидания("ПоказатьПредупреждениеОНеобходимостиРасширения1СПредприятия", 0.1, Истина);
		Отказ = Истина;
		Возврат;
	КонецЕсли;
...
&НаКлиенте
Процедура ПоказатьПредупреждениеОНеобходимостиРасширения1СПредприятия()
...
Процедура СохранитьПараметры()
	...
	ОбщегоНазначенияКлиент.ХранилищеОбщихНастроекСохранитьМассив(ПерсональныеНастройки, Истина);
