...
&НаКлиенте
Процедура Подключаемый_ЭлементСписка_НачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка, Отказ = Ложь)
	СтандартнаяОбработка = Ложь;
...
Функция УстановитьДанныеСтрокиОтборов(Строка, СвойствоЭлементаСтруктуры, ЭлементНастройки, ОписаниеНастройки = Неопределено)
	...
	Если Строка.ТипЗначения = Новый ОписаниеТипов("Дата") Тогда
