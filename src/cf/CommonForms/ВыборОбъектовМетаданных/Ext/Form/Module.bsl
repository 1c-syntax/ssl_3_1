...
Процедура ЗаполнитьДеревоОбъектов()
	...
	Если СпособГруппировкиОбъектов = "ПоРазделам" Тогда
		Если ВыбранныеОбъектыМетаданных.Количество() > 0 
			И ЗначениеЗаполнено(ВыбранныеОбъектыМетаданных[0].Представление) Тогда
			ИскатьВыбранныеПоАдресу = Истина;
		КонецЕсли;
...
// Параметры:
//  КоллекцияЭлементовДерева - ДанныеФормыДерева
