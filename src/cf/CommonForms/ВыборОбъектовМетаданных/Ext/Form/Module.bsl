...
//				В дереве метаданных такие объекты будут отмечены флажком.
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВыбиратьТаблицыВнешнихИсточниковДанных  = Параметры.ВыбиратьТаблицыВнешнихИсточниковДанных;
	ВыбранныеОбъектыМетаданных              = ОбщегоНазначения.СкопироватьРекурсивно(Параметры.ВыбранныеОбъектыМетаданных);
	
	ВыбиратьСсылки          = Параметры.ВыбиратьСсылки;
	ТолькоПодсистемыСКИ     = Параметры.ТолькоПодсистемыСКИ;
	ВыборЕдинственного      = Параметры.ВыборЕдинственного;
...
Процедура ЗаполнитьВыбранныеОбъектыМетаданных()
	...
	ОбъектыМетаданных = ОбщегоНазначения.ОбъектыМетаданныхПоИдентификаторам(Ссылки, Ложь);
	Для Каждого ЭлементСписка Из ВыбранныеОбъектыМетаданных Цикл 
		ОбъектМетаданных = ОбъектыМетаданных[ЭлементСписка.Значение];
		Если ОбъектМетаданных <> Неопределено И ОбъектМетаданных <> Null Тогда 
			ЭлементСписка.Значение = ОбъектМетаданных.ПолноеИмя();
		КонецЕсли;
	КонецЦикла;
...
Процедура ДеревоОбъектовМетаданныхЗаполнить()
	...
	ОбъектыМетаданных.Колонки.Добавить("Имя");
	ОбъектыМетаданных.Колонки.Добавить("Синоним");
	ОбъектыМетаданных.Колонки.Добавить("Картинка");
	ОбъектыМетаданных.Колонки.Добавить("ЭтоКоллекцияОбщие");
	ОбъектыМетаданных.Колонки.Добавить("ПолноеИмя");
	ОбъектыМетаданных.Колонки.Добавить("Родитель");
	
	НоваяСтрокаКоллекции("Подсистемы",                   НСтр("ru = 'Подсистемы'"),                     БиблиотекаКартинок.МетаданныеПодсистемы,                   Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ОбщиеМодули",                  НСтр("ru = 'Общие модули'"),                   БиблиотекаКартинок.МетаданныеОбщиеМодули,                  Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПараметрыСеанса",              НСтр("ru = 'Параметры сеанса'"),               БиблиотекаКартинок.МетаданныеПараметрыСеанса,              Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Роли",                         НСтр("ru = 'Роли'"),                           БиблиотекаКартинок.МетаданныеРоли,                         Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ОбщиеРеквизиты",               НСтр("ru = 'Общие реквизиты'"),                БиблиотекаКартинок.МетаданныеОбщиеРеквизиты,               Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПланыОбмена",                  НСтр("ru = 'Планы обмена'"),                   БиблиотекаКартинок.МетаданныеПланыОбмена,                  Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("КритерииОтбора",               НСтр("ru = 'Критерии отбора'"),                БиблиотекаКартинок.МетаданныеКритерииОтбора,               Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПодпискиНаСобытия",            НСтр("ru = 'Подписки на события'"),            БиблиотекаКартинок.МетаданныеПодпискиНаСобытия,            Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("РегламентныеЗадания",          НСтр("ru = 'Регламентные задания'"),           БиблиотекаКартинок.МетаданныеРегламентныеЗадания,          Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ФункциональныеОпции",          НСтр("ru = 'Функциональные опции'"),           БиблиотекаКартинок.МетаданныеФункциональныеОпции,          Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПараметрыФункциональныхОпций", НСтр("ru = 'Параметры функциональных опций'"), БиблиотекаКартинок.МетаданныеПараметрыФункциональныхОпций, Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ХранилищаНастроек",            НСтр("ru = 'Хранилища настроек'"),             БиблиотекаКартинок.МетаданныеХранилищаНастроек,            Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ОбщиеФормы",                   НСтр("ru = 'Общие формы'"),                    БиблиотекаКартинок.МетаданныеОбщиеФормы,                   Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ОбщиеКоманды",                 НСтр("ru = 'Общие команды'"),                  БиблиотекаКартинок.МетаданныеОбщиеКоманды,                 Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ГруппыКоманд",                 НСтр("ru = 'Группы команд'"),                  БиблиотекаКартинок.МетаданныеГруппыКоманд,                 Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Интерфейсы",                   НСтр("ru = 'Интерфейсы'"),                     Неопределено,                                              Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ОбщиеМакеты",                  НСтр("ru = 'Общие макеты'"),                   БиблиотекаКартинок.МетаданныеОбщиеМакеты,                  Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ОбщиеКартинки",                НСтр("ru = 'Общие картинки'"),                 БиблиотекаКартинок.МетаданныеОбщиеКартинки,                Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПакетыXDTO",                   НСтр("ru = 'XDTO-пакеты'"),                    БиблиотекаКартинок.МетаданныеПакетыXDTO,                   Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("WebСервисы",                   НСтр("ru = 'Web-сервисы'"),                    БиблиотекаКартинок.МетаданныеWebСервисы,                   Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("HTTPСервисы",                  НСтр("ru = 'HTTP-сервисы'"),                   БиблиотекаКартинок.МетаданныеHTTPСервисы,                  Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("WSСсылки",                     НСтр("ru = 'WS-ссылки'"),                      БиблиотекаКартинок.МетаданныеWSСсылки,                     Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Стили",                        НСтр("ru = 'Стили'"),                          БиблиотекаКартинок.МетаданныеСтили,                        Истина, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Языки",                        НСтр("ru = 'Языки'"),                          БиблиотекаКартинок.МетаданныеЯзыки,                        Истина, ОбъектыМетаданных);
	
	НоваяСтрокаКоллекции("Константы",                    НСтр("ru = 'Константы'"),                      БиблиотекаКартинок.МетаданныеКонстанты,               Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Справочники",                  НСтр("ru = 'Справочники'"),                    БиблиотекаКартинок.МетаданныеСправочники,             Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Документы",                    НСтр("ru = 'Документы'"),                      БиблиотекаКартинок.МетаданныеДокументы,               Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ЖурналыДокументов",            НСтр("ru = 'Журналы документов'"),             БиблиотекаКартинок.МетаданныеЖурналыДокументов,       Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Перечисления",                 НСтр("ru = 'Перечисления'"),                   БиблиотекаКартинок.МетаданныеПеречисления,            Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Отчеты",                       НСтр("ru = 'Отчеты'"),                         БиблиотекаКартинок.МетаданныеОтчеты,                  Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Обработки",                    НСтр("ru = 'Обработки'"),                      БиблиотекаКартинок.МетаданныеОбработки,               Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПланыВидовХарактеристик",      НСтр("ru = 'Планы видов характеристик'"),      БиблиотекаКартинок.МетаданныеПланыВидовХарактеристик, Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПланыСчетов",                  НСтр("ru = 'Планы счетов'"),                   БиблиотекаКартинок.МетаданныеПланыСчетов,             Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ПланыВидовРасчета",            НСтр("ru = 'Планы видов расчета'"),            БиблиотекаКартинок.МетаданныеПланыВидовРасчета,       Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("РегистрыСведений",             НСтр("ru = 'Регистры сведений'"),              БиблиотекаКартинок.МетаданныеРегистрыСведений,        Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("РегистрыНакопления",           НСтр("ru = 'Регистры накопления'"),            БиблиотекаКартинок.МетаданныеРегистрыНакопления,      Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("РегистрыБухгалтерии",          НСтр("ru = 'Регистры бухгалтерии'"),           БиблиотекаКартинок.МетаданныеРегистрыБухгалтерии,     Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("РегистрыРасчета",              НСтр("ru = 'Регистры расчета'"),               БиблиотекаКартинок.МетаданныеРегистрыРасчета,         Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("БизнесПроцессы",               НСтр("ru = 'Бизнес-процессы'"),                БиблиотекаКартинок.МетаданныеБизнесПроцессы,          Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("Задачи",                       НСтр("ru = 'Задачи'"),                         БиблиотекаКартинок.МетаданныеЗадачи,                  Ложь, ОбъектыМетаданных);
	НоваяСтрокаКоллекции("ВнешниеИсточникиДанных",       НСтр("ru = 'Внешние источники данных'"),       БиблиотекаКартинок.МетаданныеВнешниеИсточникиДанных,  Ложь, ОбъектыМетаданных);
	...
	Для Каждого ОбъектМетаданных Из ОбъектыМетаданных Цикл
		Если КоллекцииВыбираемыхОбъектовМетаданных.Количество() = 0
			Или КоллекцииВыбираемыхОбъектовМетаданных.НайтиПоЗначению(ОбъектМетаданных.Имя) <> Неопределено Тогда
			ОбъектМетаданных.Родитель = ?(ОбъектМетаданных.ЭтоКоллекцияОбщие, ЭлементОбщие, ЭлементКонфигурация);
			ДобавитьЭлементДереваОбъектовМетаданных(ОбъектМетаданных, ?(ОбъектМетаданных.Имя = "Подсистемы", Метаданные.Подсистемы, Неопределено));
		КонецЕсли;
	КонецЦикла;
...
// Возвращает структуру параметров элемента дерева объектов метаданных.
//
...
//     * Пометка       - Число - начальная пометка коллекции или объекта метаданных.
...
//
// Параметры:
//   ПараметрыЭлемента - см. ПараметрыЭлементаДереваОбъектовМетаданных
...
Функция ДобавитьЭлементДереваОбъектовМетаданных(ПараметрыЭлемента, Подсистемы = Неопределено, Проверять = Истина,
			КоллекцияТаблицВнешнегоИсточникаДанных = Неопределено)
	
	// Проверка на наличие командного интерфейса только в листьях дерева.
	Если Подсистемы <> Неопределено И ТолькоПодсистемыСКИ 
	...
	Если Подсистемы = Неопределено Тогда
		Если КоллекцияТаблицВнешнегоИсточникаДанных = Неопределено Тогда
			КоллекцияМетаданных = Метаданные[ПараметрыЭлемента.Имя];
		Иначе
			КоллекцияМетаданных = КоллекцияТаблицВнешнегоИсточникаДанных;
		КонецЕсли;
		...
		ДобавитьТаблицыВнешнихИсточниковДанных = ВыбиратьТаблицыВнешнихИсточниковДанных
			И ПараметрыЭлемента.Имя = "ВнешниеИсточникиДанных";
		
		Для Каждого ЭлементКоллекцииМетаданных Из КоллекцияМетаданных Цикл
			...
			Если КоллекцияТаблицВнешнегоИсточникаДанных <> Неопределено Тогда
				ПараметрыЭлемента.Картинка = БиблиотекаКартинок.ВнешнийИсточникДанныхТаблица;
			Иначе
			...
			Если ДобавитьТаблицыВнешнихИсточниковДанных Тогда
				ДобавитьЭлементДереваОбъектовМетаданных(ПараметрыЭлемента,,, ЭлементКоллекцииМетаданных.Таблицы);
			Иначе
...
//
&НаСервере
Процедура НоваяСтрокаКоллекции(Имя, Синоним, Картинка, ЭтоКоллекцияОбщие, Таблица)
...
Функция ЗначениеПометкиЭлементов(ЭлементыРодителя)
	...
	Если ЕстьПомеченные Тогда
		Если ЕстьНепомеченные Тогда
			Возврат 2;
		Иначе
			Возврат ?(ТолькоПодсистемыСКИ, 2, 1);
		КонецЕсли;
	Иначе
		Возврат 0;
	КонецЕсли;
...
&НаКлиенте
Процедура ОбновитьКоллекциюВыбранныеОбъектыМетаданных(Ветка = Неопределено)
	
	Если Ветка = Неопределено Тогда
		ВыбранныеОбъектыМетаданных.Очистить();
		Ветка = ДеревоОбъектовМетаданных;
	КонецЕсли;
		...
		Если СпособГруппировкиОбъектов = "ПоВидам"
		   ...
		   И (Элемент.ЭтоКоллекцияОбъектов
			...
			Если Элемент.ЭтоКоллекцияОбъектов Тогда
				ВыбранныеОбъектыМетаданных.Добавить(Элемент.Имя, Элемент.Представление, Истина);
			Иначе
				ВыбранныеОбъектыМетаданных.Добавить("Конфигурация", НСтр("ru = 'Конфигурация'"), Истина);
			КонецЕсли;
			Продолжить;
		КонецЕсли;
		Если Элемент.Пометка = 1 И Не ПустаяСтрока(Элемент.ПолноеИмя) И Элемент.ЭтоОбъектМетаданных Тогда
			ВыбранныеОбъектыМетаданных.Добавить(Элемент.ПолноеИмя, ?(ЗапоминатьРазделыВыбранныхОбъектов
				И СпособГруппировкиОбъектов = "ПоРазделам", Элемент.Адрес, Элемент.Представление), Истина);
		КонецЕсли;
		ОбновитьКоллекциюВыбранныеОбъектыМетаданных(Элемент)
	КонецЦикла;
