...
//       * Идентификатор - Число - идентификатор строки таблицы формы.
//       * Пометка - Булево - признак того, что элемент списка значений выбран. 
//       * Значение - Неопределено - значение списка значений.
