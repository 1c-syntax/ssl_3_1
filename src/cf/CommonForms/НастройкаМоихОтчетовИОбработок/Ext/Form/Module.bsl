...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДополнительныеКоманды = ДополнительныеОтчетыИОбработки.ДополнительныеКоманды(Параметры.ВидОбработок, 
		Параметры.СсылкаРаздела, , ТипыКоманд, Ложь);
	ИспользуемыеКоманды.Загрузить(ДополнительныеКоманды);
КонецПроцедуры
