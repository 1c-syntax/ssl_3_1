...
Функция НайтиПоСтроке()
	...
	Возврат Взаимодействия.ПолнотекстовыйПоискКонтактовПоСтроке(СтрокаПоиска, ЭтотОбъект);
...
Функция НайтиПоНачалуНаименования()
	...
	ТаблицаКонтактов = Взаимодействия.ВсеКонтактыПоНачалуНаименования(СтрокаПоиска);
