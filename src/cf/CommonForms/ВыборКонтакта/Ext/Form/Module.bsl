...
// Конструктор данных строки таблицы КонтактыПоПредмету.
// 
...
Процедура КомандаВыбрать(Команда)
	...
	Если Элементы.СтраницыСписки.ТекущаяСтраница = Элементы.СтраницаПоискКонтактов Тогда
		...
		ТекущиеДанные = Элементы.НайденныеКонтакты.ТекущиеДанные; // см. ДанныеКонтактыПоПредмету
		Если ТекущиеДанные <> Неопределено Тогда
			Оповестить("ВыбранКонтакт", ПараметрыОповещения(ТекущиеДанные.Ссылка));
			Закрыть();
		КонецЕсли;
	...
	ИначеЕсли Элементы.СтраницыСписки.ТекущаяСтраница = Элементы.СтраницаВсеКонтактыПоПредмету Тогда
		...
		ТекущиеДанные = Элементы.КонтактыПоПредмету.ТекущиеДанные; // см. ДанныеКонтактыПоПредмету
		Если ТекущиеДанные <> Неопределено Тогда
			Оповестить("ВыбранКонтакт", ПараметрыОповещения(ТекущиеДанные.Ссылка));
			Закрыть();
		КонецЕсли;
	...
	Для инд = 0 По Элементы.СтраницыСписки.ТекущаяСтраница.ПодчиненныеЭлементы.Количество() -1 Цикл
		...
		ТекущиеДанные = Элементы.СтраницыСписки.ТекущаяСтраница.ПодчиненныеЭлементы[инд].ТекущиеДанные; // см. ДанныеКонтактыПоПредмету
		Если ТекущиеДанные = Неопределено  Тогда
			Продолжить;
		Иначе
