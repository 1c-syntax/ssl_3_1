...
Процедура СохранитьПечатныеФормыВКаталог(СписокФайловВоВременномХранилище, Знач ИмяКаталога = "")
	...
	ПараметрыПодготовки = ПараметрыПодготовкиИменФайлов(СписокФайловВоВременномХранилище, ИмяКаталога, ОписаниеОповещения);
...
//
&НаКлиенте
Функция ПараметрыПодготовкиИменФайлов(ОписанияФайлов, ИмяКаталога, ОбработчикЗавершения)
