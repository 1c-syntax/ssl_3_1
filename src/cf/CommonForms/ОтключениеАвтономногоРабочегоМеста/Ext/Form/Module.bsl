...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("АвтономноеРабочееМесто") Тогда
...
#Область ПереопределяемаяЧастьСлужебныеПроцедурыИФункции
...
#Область ПереопределяемаяЧастьОбработчикиСобытийПереходов
...
#Область ПереопределяемаяЧастьИнициализацияПереходовПомощника
