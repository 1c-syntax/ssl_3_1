...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ХранениеВТабличнойЧасти = МультиязычностьСервер.ОбъектСодержитТЧПредставления(ОбъектМетаданных.ПолноеИмя());
	...
	Для Каждого ЯзыкКонфигурации Из Метаданные.Языки Цикл
		...
		Если ЯзыкКонфигурации.КодЯзыка =  МультиязычностьСервер.КодПервогоДополнительногоЯзыкаИнформационнойБазы() Тогда
	...
	ИначеЕсли МультиязычныеСтрокиВРеквизитах 
