...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользуетсяДополнительныйЯзык = Ложь;
	...
	Для каждого ДанныеОЯзыке Из СведенияОбЯзыках.Используется Цикл
		Если ДанныеОЯзыке.Значение Тогда
			...
			ИспользуетсяДополнительныйЯзык = Истина;
		КонецЕсли;
	КонецЦикла;
	...
	Если МультиязычныеСтрокиВРеквизитах
		...
		И ИспользуетсяДополнительныйЯзык Тогда
		...
		Для Каждого ДополнительныйЯзык Из СведенияОбЯзыках.Используется Цикл
			Если ДополнительныйЯзык.Значение  Тогда
				КодЯзыка = СведенияОбЯзыках[ДополнительныйЯзык.Ключ];
				Если ПустаяСтрока(КодЯзыка) Или СтрСравнить(ТекущийЯзык().КодЯзыка, КодЯзыка) = 0 Тогда
					Продолжить;
				КонецЕсли;
				ОписаниеЯзыка = ОписаниеЯзыка(КодЯзыка);
				
				Если СтрСравнить(ОписаниеЯзыка.КодЯзыка, ТекущийЯзык().КодЯзыка) = 0 Тогда
					ЭтотОбъект[ОписаниеЯзыка.Имя] = Параметры.Объект[Параметры.ИмяРеквизита];
				ИначеЕсли Параметры.ЗначенияРеквизитов <> Неопределено Тогда
					ЭтотОбъект[ОписаниеЯзыка.Имя] = Параметры.ЗначенияРеквизитов[Параметры.ИмяРеквизита + ДополнительныйЯзык.Ключ]
				ИначеЕсли Параметры.Объект <> Неопределено Тогда
					ЭтотОбъект[ОписаниеЯзыка.Имя] = Параметры.Объект[Параметры.ИмяРеквизита +  ДополнительныйЯзык.Ключ];
				ИначеЕсли ПустаяСтрока(ЭтотОбъект[ОписаниеЯзыка.Имя]) Тогда
					ЭтотОбъект[ОписаниеЯзыка.Имя] = Параметры.ТекущиеЗначение;
				КонецЕсли;
