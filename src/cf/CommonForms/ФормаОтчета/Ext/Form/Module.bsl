...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НастройкиОтчета.Вставить("АдресСхемы", АдресСхемыОтчета(ОтчетОбъект));
	НастройкиОтчета.Вставить("КлючСхемы", "");
	НастройкиОтчета.Вставить("Контекстный", ЗначениеЗаполнено(КонтекстВарианта));
	...
	НастройкиОтчета.Вставить("ИспользуемыеТаблицы", ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Параметры, "ИспользуемыеТаблицы"));
...
Процедура ПослеФормирования(Результат, ЗагрузитьРезультатФормированияОтчета) Экспорт 
	...
	ОтчетСформирован = (Результат.Статус = "Выполнено");
...
Процедура ОбновитьИнформациюОВариантеОтчета()
	...
	ОтчетНаименованиеТекущегоВарианта = НастройкиОтчета.Наименование;
	ДополнительныеСвойства.Вставить("ВариантНаименование", ОтчетНаименованиеТекущегоВарианта);
КонецПроцедуры
