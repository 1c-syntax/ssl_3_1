...
Процедура НайтиПодходящиеЗначенияУниверсальногоПоискаЧисла(ПодходящиеЗначения, ПараметрыПоиска)
	...
	ДоступныеПоляПоиска = ДоступныеПоляПоискаЧисла(ПоляПоиска, ЗначениеПоиска, ПараметрыПоиска.УправляющиеСимволы);
...
Процедура НайтиПоляУниверсальногоПоискаПоТипам()
	...
	Коллекции.Добавить(ОписаниеПараметровОтчета());
	Коллекции.Добавить(ОписаниеОтборовОтчета());
	Коллекции.Добавить(ОписаниеПолейОтчета());
...
&НаСервере
Функция ОписаниеПараметровОтчета()
...
&НаСервере
Функция ОписаниеОтборовОтчета(Отбор = Неопределено, ОписаниеОтборов = Неопределено)
	...
	Для Каждого Элемент Из Отбор.Элементы Цикл 
		...
		Если ТипЗнч(Элемент) = Тип("ГруппаЭлементовОтбораКомпоновкиДанных") Тогда 
			...
			ОписаниеОтборовОтчета(Элемент, ОписаниеОтборов);
...
&НаСервере
Функция ОписаниеПолейОтчета()
	
	ОписаниеПолей = Новый Массив;
	
	ИндексСтруктурыОтчета = ВариантыОтчетовСлужебный.ИндексСтруктурыОтчета(ЭтотОбъект);
