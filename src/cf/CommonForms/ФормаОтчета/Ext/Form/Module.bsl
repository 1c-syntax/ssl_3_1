...
Процедура НастройкиПоУмолчанию(Команда)
	...
	УточнитьПризнакАвтоформированияОтчета(ПараметрыЗаполнения);
...
Процедура УточнитьПризнакАвтоформированияОтчета(ПараметрыОбновления)
	...
	ДопустимоеВремяДляАвтоформированияОтчетаВСек = 5;
	ВремяФормированияОтчетаВСек = НастройкиОтчета.СвойстваРезультата.ВремяФормирования;
	Переформировать = (ВремяФормированияОтчетаВСек <= ДопустимоеВремяДляАвтоформированияОтчетаВСек);
	
	ПараметрыОбновления.Вставить("Переформировать", Переформировать);
