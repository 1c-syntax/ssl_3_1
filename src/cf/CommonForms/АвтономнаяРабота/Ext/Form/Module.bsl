...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИдентификаторТранспорта = ТранспортСообщенийОбмена.ТранспортПоУмолчанию(ПриложениеВСервисе);
...
Процедура ВыполнитьСинхронизациюДанных(Команда)
	...
	ПараметрыАутентификации.Корреспондент = ПриложениеВСервисе;
	ПараметрыАутентификации.ИдентификаторТранспорта = ИдентификаторТранспорта;
		
	ТребуетсяАутентификация = Ложь;
	ОповещениеОЗакрытии = Новый ОписаниеОповещения("ЗавершениеАутентификации", ЭтотОбъект);
...
Процедура ЗавершениеАутентификации(ДанныеАутентификации, ДополнительныеПараметры) Экспорт 
	...
	ТранспортСообщенийОбменаВызовСервера.УстановитьПарольСинхронизацииДанных(
		ПриложениеВСервисе, ДанныеАутентификации);
...
Процедура ОбновитьВидимостьНаСервере()
	...
	ПарольПользователяСохраняется = Истина;
...
Процедура НастроитьПодключениеКСервису(НастройкаАвтоматическойСинхронизации = Ложь)
	...
	ПараметрыФормы.Вставить("Корреспондент", ПриложениеВСервисе);
	ПараметрыФормы.Вставить("ИдентификаторТранспорта", ИдентификаторТранспорта);
	...
	ОткрытьФорму("Справочник.НастройкиТранспортаСообщенийОбмена.Форма.НастройкаПодключенияКСервису", 
