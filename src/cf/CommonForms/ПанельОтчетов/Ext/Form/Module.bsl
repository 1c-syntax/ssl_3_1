...
//             СправочникСсылка.ИдентификаторыОбъектовРасширений - ссылка на идентификатор подсистемы.
//       * Варианты - Массив - коллекция вариантов отчета, где:
//             ** Элемент - СтрокаТаблицыЗначений - описание варианта отчета, где:
...
//
// Возвращаемое значение:
//   ТаблицаЗначений - коллекция, хранящая сведения о порядке вывода отчетов на панель, где:
//       * НомерКолонки- Число - номер колонки, в которую выводится отчет.
//       * ЭтоПодсистема - Булево - признак подсистемы.
//       * ЭтоПродолжение - Булево - дополнительный признак.
//       * ЭтоВариант - Булево -признак варианта отчета.
//       * ЭтоПустаяСтрока - Булево - признак не заполненной строки.
//       * СтрокаДерева - СтрокаДереваЗначений - см. ...
//       * Подсистема - СтрокаТаблицыЗначений - описание подсистемы.
//       * ПодсистемаСсылка - СправочникСсылка.ИдентификаторыОбъектовМетаданных,
//             СправочникСсылка.ИдентификаторыОбъектовРасширений - ссылка на идентификатор подсистемы.
//       * ПодсистемаПриоритет - Число - приоритет подсистемы.
//       * Вариант - СтрокаТаблицыЗначений - описание варианта отчета, где:
//             ** КоличествоПодчиненных - Число - счетчик подчиненных элементов.
//       * ВариантСсылка - СправочникСсылка.ВариантыОтчетов - ссылка на вариант отчета.
//       * УровеньВложенности - Число - номер уровня в иерархии.
//
&НаСервере
