...
Процедура ПриОткрытии(Отказ)
	...
	Если Параметры.ВыводитьОкноОжидания Тогда
		...
		ПараметрыОжидания.ОтменятьПриЗакрытииФормыВладельца = ОтменятьПриЗакрытии;
		Если ТипЗнч(Параметры.ОповещениеПользователя) = Тип("Структура") Тогда
			ЗаполнитьЗначенияСвойств(ПараметрыОжидания.ОповещениеПользователя, Параметры.ОповещениеПользователя);
		КонецЕсли;
