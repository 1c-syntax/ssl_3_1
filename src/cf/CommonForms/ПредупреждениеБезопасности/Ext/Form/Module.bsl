...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе 
		Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.РезервноеКопированиеИБ") Тогда
			...
			РезервноеКопирование = Новый Массив;
			РезервноеКопирование.Добавить(НСтр("ru = 'Перед удалением расширения рекомендуется'"));
			РезервноеКопирование.Добавить(Символы.ПС);
			РезервноеКопирование.Добавить(Новый ФорматированнаяСтрока(
				НСтр("ru = 'выполнить резервное копирование информационной базы'"),,,,
				МодульРезервноеКопированиеИБСервер.НавигационнаяСсылкаОбработкиРезервногоКопирования()));
			РезервноеКопирование.Добавить(".");
			
			Элементы.ПредупрежденииПередУдалениемРасширенияРезервноеКопирование.Заголовок = 
				Новый ФорматированнаяСтрока(РезервноеКопирование);
			
		КонецЕсли;
	КонецЕсли;
	
	Если Параметры.МножественныйВыбор Тогда 
		Элементы.ПредупрежденииПередУдалениемРасширенияТекстУдалить.Заголовок = НСтр("ru = 'Удалить выделенные расширения?'");
	Иначе 
		Элементы.ПредупрежденииПередУдалениемРасширенияТекстУдалить.Заголовок = НСтр("ru = 'Удалить расширение?'");
	КонецЕсли;
