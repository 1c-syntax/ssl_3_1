...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПользователиСлужебныйКлиентСервер.ВидыПредупрежденийБезопасности().Свойство(Параметры.Ключ) Тогда
	...
	ИначеЕсли ТекущаяСтраница = Элементы.ПередОткрытиемФайла Тогда
		Если ЗначениеЗаполнено(Параметры.ДополнительныйПараметр) Тогда
			Элементы.ПредупреждениеПриОткрытииФайла.Заголовок =
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					Элементы.ПредупреждениеПриОткрытииФайла.Заголовок,
					Параметры.ДополнительныйПараметр);
		КонецЕсли;
	
	ИначеЕсли ТекущаяСтраница = Элементы.ПередУдалениемРасширенияСДанными
		...
		Если Параметры.ДополнительныйПараметр = Истина Тогда
