...
Процедура ПередДобавлениемКомандОтчетов(КомандыОтчетов, Параметры, СтандартнаяОбработка) Экспорт
	...
	Команда.Представление = НСтр("ru = 'Требуется добавить архивные метки.'");
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Требуется добавить архивные метки.'");
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Ошибки при автоматическом продлении.'");
	НастройкиВарианта.Включен = ДоступнаУсовершенствованнаяПодпись
	 И (ДобавлятьМеткиВремениАвтоматически Или УсовершенствоватьПодписиАвтоматически = 0);
