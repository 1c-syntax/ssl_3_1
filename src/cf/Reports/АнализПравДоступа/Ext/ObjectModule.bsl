...
Функция ПраваПользователей()
	...
	ТекстЗапроса = 
	"ВЫБРАТЬ
	|	СоставыГруппПользователей.Пользователь КАК Ссылка,
	|	СоставыГруппПользователей.ГруппаПользователей КАК ПользовательИлиГруппа,
	...
	|	ВсеПользователи.ПользовательИлиГруппа КАК ПользовательИлиГруппа,
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВсеПользователи КАК ПользователиГрупп
	|		ПО ГруппыДоступаПользователи.Пользователь = ПользователиГрупп.ПользовательИлиГруппа
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВсеПользователи КАК ВсеПользователи
	|		ПО (ПользователиГрупп.Ссылка = ВсеПользователи.Ссылка)
	|ГДЕ
	|	НЕ ГруппыДоступа.ПометкаУдаления
	|
	|СГРУППИРОВАТЬ ПО
	|	ВсеПользователи.Ссылка,
	|	ВсеПользователи.ПользовательИлиГруппа,
	...
	|	ГруппыДоступаПользователей.ПользовательИлиГруппа КАК ПользовательИлиГруппа,
	...
	|	ГруппыДоступаПользователей.ПользовательИлиГруппа,
	...
	|	ПраваОбъектов.ПользовательИлиГруппа КАК ПользовательИлиГруппа,
	...
	|	ПраваОбъектовИСвязанныеОтчеты.ПользовательИлиГруппа КАК ПользовательИлиГруппа,
	...
	|	ЕСТЬNULL(ПраваПользователейСНастроеннымиПравами.ПользовательИлиГруппа, ВсеПользователиИОбъекты.ПользовательИлиГруппа) КАК ПользовательИлиГруппа,
	|	ВЫБОР
