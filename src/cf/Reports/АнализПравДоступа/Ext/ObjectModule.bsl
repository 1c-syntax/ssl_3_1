	...
	Для Каждого Отчет Из Метаданные.Отчеты Цикл
		Для Каждого Роль Из Метаданные.Роли Цикл
			Если ПравоДоступа("Просмотр", Отчет, Роль) Тогда
				...
				СтрокаТаблицы.ПравоПросмотр = Истина;
			КонецЕсли;
		КонецЦикла;
	КонецЦикла;
...
Функция ПустаяКоллекцияПравОтчетов()
	...
	Результат.Колонки.Добавить("ПравоПросмотр", Новый ОписаниеТипов("Булево"));
...
Функция ПраваПользователей()
	...
	|	МАКСИМУМ(ПраваПрофилей.ПравоПросмотр) КАК ПравоПросмотр,
	|	МАКСИМУМ(ПраваПрофилей.ПравоРедактирование) КАК ПравоРедактирование,
	|	МАКСИМУМ(ПраваПрофилей.ПравоИнтерактивноеДобавление) КАК ПравоИнтерактивноеДобавление,
	...
	|	ПраваОбъектов.ПравоПросмотр КАК ПравоПросмотр
	...
	|	ПраваОбъектов.ОбъектМетаданных КАК ОбъектМетаданных,
	|	ПраваОбъектов.ПравоПросмотр КАК ПравоПросмотр,
	|	ПраваОбъектов.ПравоРедактирование КАК ПравоРедактирование,
	|	ПраваОбъектов.ПравоИнтерактивноеДобавление КАК ПравоИнтерактивноеДобавление,
	|	ТаблицыОтчетов.Отчет КАК Отчет,
	...
	|	ПраваОбъектовИСвязанныеОтчеты.ПравоПросмотр КАК ПравоПросмотр,
	|	ПраваОбъектовИСвязанныеОтчеты.ПравоРедактирование КАК ПравоРедактирование,
	|	ПраваОбъектовИСвязанныеОтчеты.ПравоИнтерактивноеДобавление КАК ПравоИнтерактивноеДобавление,
	|	ВЫБОР
	|		КОГДА ПраваОбъектовИСвязанныеОтчеты.ПравоИнтерактивноеДобавление
	|			ТОГДА 3
	|		КОГДА ПраваОбъектовИСвязанныеОтчеты.ПравоРедактирование
	|			ТОГДА 2
	|		КОГДА ПраваОбъектовИСвязанныеОтчеты.ПравоПросмотр
	|			ТОГДА 1
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК Право,
	|	ВЫБОР
	...
	|	ВЫБОР
	|		КОГДА ПраваОтчетов.ПравоПросмотр
	|			ТОГДА 1
	|		ИНАЧЕ 0
	...
	|	ЕСТЬNULL(ПраваПользователейСНастроеннымиПравами.ПравоПросмотр, ЛОЖЬ) КАК ПравоПросмотр,
	|	ЕСТЬNULL(ПраваПользователейСНастроеннымиПравами.ПравоРедактирование, ЛОЖЬ) КАК ПравоРедактирование,
	|	ЕСТЬNULL(ПраваПользователейСНастроеннымиПравами.ПравоИнтерактивноеДобавление, ЛОЖЬ) КАК ПравоИнтерактивноеДобавление,
