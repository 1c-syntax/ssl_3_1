...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	ОтключеноОграничениеНаУровнеЗаписей = УправлениеДоступомСлужебный.ОтключеноОграничениеНаУровнеЗаписей();
	...
	НастройкиВарианта.Включен = Не ОтключеноОграничениеНаУровнеЗаписей;
...
Функция ВидыОграниченийПрав(ДляВнешнихПользователей = Неопределено, ДобавитьЭтоАвторизованныйПользователь = Ложь,
	...
	Если УправлениеДоступомСлужебный.ОтключеноОграничениеНаУровнеЗаписей() Тогда
		...
		Результат.Колонки.Добавить("Таблица", Новый ОписаниеТипов(
			"СправочникСсылка.ИдентификаторыОбъектовМетаданных, СправочникСсылка.ИдентификаторыОбъектовРасширений"));
		Результат.Колонки.Добавить("Право", Новый ОписаниеТипов("Строка",,,, Новый КвалификаторыСтроки(50)));
		Результат.Колонки.Добавить("ВидДоступа", Метаданные.ОпределяемыеТипы.ЗначениеДоступа.Тип);
		Результат.Колонки.Добавить("ЭтоАвторизованныйПользователь", Новый ОписаниеТипов("Булево"));
