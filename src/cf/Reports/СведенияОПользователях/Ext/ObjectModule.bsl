...
Функция КонтактнаяИнформация(Настройки)
	...
	ВидыКонтактнойИнформации.Добавить(ВидКонтактнойИнформацииEmailПользователя);
	ВидыКонтактнойИнформации.Добавить(ВидКонтактнойИнформацииТелефонПользователя);
	Запрос = Новый Запрос;
	...
	Пока ВыборкаПоПользователям.Следующий() Цикл
		...
		Пока Выборка.Следующий() Цикл
			Если Выборка.Вид = ВидКонтактнойИнформацииТелефонПользователя Тогда
				Телефоны = Телефоны + ?(ЗначениеЗаполнено(Телефоны), ", ", "");
				Телефоны = Телефоны + Выборка.Представление;
			КонецЕсли;
			Если Выборка.Вид = ВидКонтактнойИнформацииEmailПользователя Тогда
