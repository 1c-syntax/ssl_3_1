...
Функция ПериодДатаОкончания(Период, ТипОбъектаМетаданных, ИмяТаблицы) Экспорт
	...
	Если СтрНайти(ВРег(ТипОбъектаМетаданных), "РЕГИСТР") = 0
		Или СтрСравнить(ИмяТаблицы, ПредставлениеИмениТаблицыОсновныеДанные()) = 0
		Или СтрСравнить(ТипОбъектаМетаданных, ПредставлениеТипаОбъектаМетаданныхРегистрРасчета()) = 0 Тогда
...
Функция ПредставлениеТипаОбъектаМетаданныхРегистрРасчета()
