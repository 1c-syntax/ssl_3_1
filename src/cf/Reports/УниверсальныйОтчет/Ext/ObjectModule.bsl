...
Процедура ПередЗагрузкойНастроекВКомпоновщик(Контекст, КлючСхемы, КлючВарианта, НовыеНастройкиКД, НовыеПользовательскиеНастройкиКД) Экспорт
	...
	Если ТипЗнч(Контекст) = Тип("Структура") Тогда
		ЗаменитьЗначенияПараметровНаПредставления(НовыеНастройкиКД, НовыеНастройкиКД.ДополнительныеСвойства.ДоступныеЗначения);
	КонецЕсли;
...
Процедура ЗаменитьЗначенияПараметровНаПредставления(Настройки, ДоступныеЗначения)
	...
	Для Каждого ИмяПараметра Из ИменаПараметров Цикл
		...
		Если Параметр <> Неопределено И ДоступныеЗначения.Свойство(ИмяПараметра) Тогда
