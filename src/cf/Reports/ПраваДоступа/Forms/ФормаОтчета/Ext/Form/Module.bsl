...
Функция ВыбратьСведенияОПравахДоступа(Знач ВозможныеПрава, Знач ВыводПравГруппы, Знач ПользовательИлиГруппа)
	...
	// АПК:96-выкл: допустимо, так как строки не должны повторятся и это запрос для отчета.
	Запрос.Текст =
	"ВЫБРАТЬ
	...
	// АПК:96-вкл: допустимо, так как строки не должны повторятся и это запрос для отчета.
...
Функция ВидыОграниченийПравОбъектовМетаданных()
	...
	// АПК:96-выкл: допустимо, так как строки не должны повторятся и результат кэшируется.
	Запрос.Текст =
	"ВЫБРАТЬ
	...
	// АПК:96-вкл: допустимо, так как строки не должны повторятся и результат кэшируется.
