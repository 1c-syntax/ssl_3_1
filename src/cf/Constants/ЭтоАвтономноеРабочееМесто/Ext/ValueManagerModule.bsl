...
Процедура ПередЗаписью(Отказ)
	...
	ДополнительныеСвойства.Вставить("ТекущееЗначение", Константы.ЭтоАвтономноеРабочееМесто.Получить());
...
Процедура ПриЗаписи(Отказ)
	...
	ПредыдущееЗначение = ДополнительныеСвойства.ТекущееЗначение;
	НовоеТекущее = Значение;
