...
//   НастроечнаяТаблицаИнтервалов - ТаблицаЗначений - содержащая настройки интервалов по умолчанию.
...
//
// Возвращаемое значение:
//   ТаблицаИнтервалов   - ТаблицаЗначений - содержащая нижнее и верхнее граничные значения для каждого из интервалов.
