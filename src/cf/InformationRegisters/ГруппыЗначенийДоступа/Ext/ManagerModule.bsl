...
//
// Параметры:
//  ЗначениеДоступа - ОпределяемыйТип.ЗначениеДоступаОбъект - если у объекта в дополнительных
//                      свойствах есть ключ ЭтоНовыйОбъектЗначенияДоступа, тогда не будет
//                      планирования обновления доступа производительного варианта (не требуется).
...
Процедура ОбновитьГруппыНепустыхЗначенийДоступа(ЗначениеДоступа, ЕстьИзменения)
	...
	ЭтоНовый = Объект <> Неопределено
		И Объект.ДополнительныеСвойства.Свойство("ЭтоНовыйОбъектЗначенияДоступа");
