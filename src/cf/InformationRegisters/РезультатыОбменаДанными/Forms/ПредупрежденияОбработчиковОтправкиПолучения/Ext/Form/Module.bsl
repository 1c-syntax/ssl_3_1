...
Процедура ПередЗакрытиемНаСервере()
	...
	Попытка
		...
		ЭлементБлокировкиДанных.УстановитьЗначение("ТипПроблемы", ТипПредупреждения);
		ЭлементБлокировкиДанных.УстановитьЗначение("УзелИнформационнойБазы", УзелИнформационнойБазы);
		ЭлементБлокировкиДанных.УстановитьЗначение("ОбъектМетаданных", ОбъектМетаданных);
		ЭлементБлокировкиДанных.УстановитьЗначение("ПроблемныйОбъект", ПроблемныйОбъект);
		ЭлементБлокировкиДанных.УстановитьЗначение("КлючУникальности", КлючУникальностиЗаписиРегистраСведений);
	...
	Исключение
		...
		Событие = НСтр("ru = 'Обмен данными.Запись результата обмена данными'", ОбщегоНазначения.КодОсновногоЯзыка());

		ЗаписьЖурналаРегистрации(Событие, УровеньЖурналаРегистрации.Ошибка,
			Метаданные.РегистрыСведений.РезультатыОбменаДанными, , СообщениеОбОшибке);
	КонецПопытки;
