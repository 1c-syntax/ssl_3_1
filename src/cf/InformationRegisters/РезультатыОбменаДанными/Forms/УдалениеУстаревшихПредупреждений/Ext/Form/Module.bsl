...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КэшЗначений.Вставить("МассивУзловПланаОбмена");
	КэшЗначений.Вставить("ОтборПоДатеВозникновения");
	КэшЗначений.Вставить("ОтборУзловПланаОбмена");
	КэшЗначений.Вставить("ОтборТипыПредупреждений");
...
Процедура ОтборыПоПереданнымПараметрам()
	...
	Если КэшЗначений.МассивУзловПланаОбмена = Неопределено Тогда
		КэшЗначений.МассивУзловПланаОбмена = Новый Массив;
	КонецЕсли;
	
	Если КэшЗначений.ОтборТипыПредупреждений = Неопределено Тогда
		КэшЗначений.ОтборТипыПредупреждений = Новый Массив;
	КонецЕсли;
	
	Если КэшЗначений.ОтборУзловПланаОбмена = Неопределено Тогда
		КэшЗначений.ОтборУзловПланаОбмена = Новый Массив;
	КонецЕсли;
