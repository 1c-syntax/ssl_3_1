...
//   Структура - набор полей отбора:
//     * Пропущена - ИдентификаторКомпоновкиДанных, Неопределено - идентификатор элемента компоновки.
//     * ДатаНачала - ИдентификаторКомпоновкиДанных, Неопределено - идентификатор элемента компоновки.
//     * ДатаОкончания - ИдентификаторКомпоновкиДанных, Неопределено - идентификатор элемента компоновки.
//     * УзелРавно - ИдентификаторКомпоновкиДанных, Неопределено - идентификатор элемента компоновки.
//     * Причина - ИдентификаторКомпоновкиДанных, Неопределено - идентификатор элемента компоновки.
//     * УзелВСписке - ИдентификаторКомпоновкиДанных, Неопределено - идентификатор элемента компоновки.
//
&НаСервере
...
// Возвращаемое значение:
//   Структура - набор полей отбора:
//     * АвторРавно - ИдентификаторКомпоновкиДанных, Неопределено - идентификатор элемента компоновки.
//     * ДатаНачала - ИдентификаторКомпоновкиДанных, Неопределено - идентификатор элемента компоновки.
//     * ДатаОкончания - ИдентификаторКомпоновкиДанных, Неопределено - идентификатор элемента компоновки.
//     * ВерсияПроигнорирована - ИдентификаторКомпоновкиДанных, Неопределено - идентификатор элемента компоновки.
//     * АвторВСписке - ИдентификаторКомпоновкиДанных, Неопределено - идентификатор элемента компоновки.
//     * ПричинаЗапрета - ИдентификаторКомпоновкиДанных, Неопределено - (необязательное) идентификатор элемента компоновки.
//
&НаСервере
...
// Возвращаемое значение:
//   Структура - набор настроек отборов:
