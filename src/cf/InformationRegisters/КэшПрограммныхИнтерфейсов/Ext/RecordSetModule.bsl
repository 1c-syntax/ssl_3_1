...
Процедура ПодготовитьДанныеДляЗаписи(ХранилищеДанных) Экспорт
	...
	Для Каждого Строка Из ДанныеДляЗаписи Цикл
		...
		ХранилищеДанных = Новый ХранилищеЗначения(Данные, Новый СжатиеДанных(9));
		Строка.Данные = ХранилищеДанных;
	КонецЦикла;
