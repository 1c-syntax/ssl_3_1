...
Процедура Записать(Знач СсылкаНаОбъект, Знач Настройки, Знач Наследовать) Экспорт
	...
	ВозможныеПрава = УправлениеДоступомСлужебныйПовтИсп.ВозможныеПраваДляНастройкиПравОбъектов(); // См. ВозможныеПраваДляНастройкиПравОбъектов
...
Процедура ОбновитьВспомогательныеДанныеРегистра(ЕстьИзменения = Неопределено) Экспорт
	...
	Для каждого КлючИЗначение Из ВозможныеПрава.ПоТипамСсылок Цикл
		...
		ОписаниеПрав     = КлючИЗначение.Значение; // Массив из см. СвойстваВозможногоПрава
...
// Возвращаемое значение:
//   Структура:
//     * ПоТипам - ФиксированноеСоответствие:
//         * Ключ - Тип - тип ссылки или объекта из ОпределяемыйТип.ВладельцыНастроекПрав
//         * Значение - ФиксированноеСоответствие:
//             ** Ключ - Строка - имя возможного права
//             ** Значение - см. СвойстваВозможногоПрава
//     * ПоТипамСсылок - ФиксированноеСоответствие:
//         * Ключ - Тип - тип ссылки из ОпределяемыйТип.ВладельцыНастроекПрав
//         * Значение - Массив из см. СвойстваВозможногоПрава
//     * ПоПолнымИменам - ФиксированноеСоответствие:
//         * Ключ - Строка - владелец прав (полное имя таблицы)
//         * Значение - см. СвойстваВозможногоПрава
//     * ТипыВладельцев - Массив из ОпределяемыйТип.ВладелецНастроекПрав
//     * ОтдельныеТаблицы - ФиксированноеСоответствие:
...
//     * ИерархическиеТаблицы - ФиксированноеСоответствие:
//         * Ключ - Тип - тип ссылки или объекта из ОпределяемыйТип.ВладельцыНастроекПрав
...
Функция ЗаполненныеВозможныеПрава()
...
//
// Возвращаемое значение:
//   см. ВозможныеПраваДляНастройкиПравОбъектов
//
Функция ВозможныеПрава()
	
	ВозможныеПрава = ЗаполненныеВозможныеПрава();
...
//   * ТребуемыеПрава - Массив Из Строка
//   * ЧтениеВТаблицах - Массив Из Строка
//   * ИзменениеВТаблицах - Массив Из Строка
//
Функция СвойстваВозможногоПрава(ВозможноеПраво)
