...
Функция ПредставлениеВозможныхПрав() Экспорт
	...
	Для Каждого ВозможноеПраво Из ВозможныеПрава Цикл
		...
		ПредставлениеВозможныхПрав.Вставить(ПолноеИмяПрава, Новый ФиксированнаяСтруктура(
			Новый Структура("Заголовок, Подсказка", ВозможноеПраво.Заголовок, ВозможноеПраво.Подсказка)));
	КонецЦикла;
...
Функция ПредставлениеВозможногоПрава(ОписаниеВозможногоПрава) Экспорт
	...
	Если Не ЗначениеЗаполнено(Представление) Тогда
		Представление = Новый ФиксированнаяСтруктура(
			Новый Структура("Заголовок, Подсказка", ОписаниеВозможногоПрава.Имя, ""));
	КонецЕсли;
