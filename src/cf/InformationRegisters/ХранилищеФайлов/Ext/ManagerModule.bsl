...
Процедура ЗаписатьДвоичныеДанные(Файл, ДвоичныеДанные) Экспорт
	...
	Попытка
		...
		Иначе
			...
			ХранилищеДвоичныхДанныхОбъект.ДвоичныеДанные = Новый ХранилищеЗначения(ДвоичныеДанные, Новый СжатиеДанных(9));
...
Процедура ПеренестиДанные(СообщатьПрогресс = Ложь) Экспорт
