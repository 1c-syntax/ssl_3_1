...
Функция СформироватьОтчетПоВерсиям()
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("РегистрыСведений.ВерсииОбъектов.СформироватьОтчетПоИзменениям", 
...
Процедура ОткрытьФормуСравненияТабличныхДокументов(ИмяТабличногоДокумента, Версия0, Версия1)
	...
	ПараметрыОткрытияФормы.АдресТабличныхДокументов = АдресТабличныхДокументов(ИмяТабличногоДокумента, Версия1, 
		Версия0);
	ПараметрыОткрытияФормы.ЗаголовокЛевый = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ЗаголовокШаблон, 
		НомерВерсии1);
	ПараметрыОткрытияФормы.ЗаголовокПравый = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ЗаголовокШаблон, 
		НомерВерсии0);
	СтандартныеПодсистемыКлиент.ПоказатьСравнениеТабличныхДокументов(Неопределено, Неопределено, 
