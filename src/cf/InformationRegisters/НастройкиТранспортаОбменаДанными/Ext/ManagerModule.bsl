...
// 
// Параметры:
//  СтруктураЗаписи - Структура - Структура, содержащая ключи регистра НастройкиТранспортаОбменаДанными
//
...
// 
// Параметры:
//  Корреспондент - ПланОбменаСсылка - Ссылка на узел корреспондента
//  ПараметрыАутентификации - Неопределено, Структура - Параметры аутентификации
// 
// Возвращаемое значение:
//  Структура - Настройки транспорта WS:
//   * ИдентификаторИнформационнойБазыИсточника - Строка 
//   * WSПароль - Строка -Пароль пользователя из безопасного хранилища
//              - Неопределено - Если пароль не задан или не вводился
//
...
// Параметры:
//  Корреспондент - ПланОбменаСсылка - Ссылка на узел корреспондента
//  ВидТранспортаОбмена - Неопределено, ПеречислениеСсылка.ВидыТранспортаСообщенийОбмена - Вид транспорта обмена
// 
// Возвращаемое значение:
//   см. НастройкиТранспортаОбмена
//
...
// 
// Возвращаемое значение:
//  Структура - Настройки транспорта обмена:
//   * ИспользоватьВременныйКаталогДляОтправкиИПриемаСообщений - Булево
//   * ИдентификаторИнформационнойБазыИсточника - Строка
// 
