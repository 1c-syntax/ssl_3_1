...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Перем РазрешенныеНастройкиТранспорта;
	
	Параметры.Свойство("РазрешенныеНастройкиТранспорта", РазрешенныеНастройкиТранспорта);
	ЗаполнитьДоступныеВидыТранспорта(РазрешенныеНастройкиТранспорта);
...
&НаСервере
Процедура ЗаполнитьДоступныеВидыТранспорта(РазрешенныеНастройкиТранспорта = Неопределено)
	...
	Для Каждого Элемент Из ИспользуемыеТранспорты Цикл
		...
		Если ТипЗнч(РазрешенныеНастройкиТранспорта) = Тип("Массив")
			И РазрешенныеНастройкиТранспорта.Найти(Элемент) = Неопределено Тогда
		...
		СтрокаДоступныеВидыТранспорта.ИмяСтраницы   = СтрЗаменить("НастройкиТранспорта[ВидТранспорта]",
			"[ВидТранспорта]",
			ОбщегоНазначения.ИмяЗначенияПеречисления(Элемент));
