...
Процедура ОбновитьДанныеРегистра(ЕстьИзменения = Неопределено, БезОбновленияЗависимыхДанных = Ложь) Экспорт
	...
	Если УправлениеДоступомСлужебный.ОтключеноОграничениеНаУровнеЗаписей() Тогда
		УправлениеДоступомСлужебный.ОчиститьРегистрСведений(
			Метаданные.РегистрыСведений.ИспользуемыеВидыДоступа.ПолноеИмя(), ЕстьИзменения);
		Возврат;
	КонецЕсли;
...
Процедура ЗарегистрироватьИзменениеПриПолученииДанных(ЭлементДанных) Экспорт
	...
	Если УправлениеДоступомСлужебный.ОтключеноОграничениеНаУровнеЗаписей()
	 Или Не ЕстьИзмененияИспользованияВидовДоступа(ЭлементДанных) Тогда
		Возврат;
	КонецЕсли;
