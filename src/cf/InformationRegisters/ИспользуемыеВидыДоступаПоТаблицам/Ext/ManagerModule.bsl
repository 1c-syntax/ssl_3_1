...
Процедура ОбновитьДанныеРегистра(Таблицы = Неопределено, ТипыЗначенийДоступа = Неопределено,
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ИспользуемыеВидыДоступа КАК ИспользуемыеВидыДоступа
	|		ПО (ИспользуемыеВидыДоступа.ТипЗначенийДоступа = ЗначенияГруппДоступаПоУмолчанию.ТипЗначенийДоступа)
