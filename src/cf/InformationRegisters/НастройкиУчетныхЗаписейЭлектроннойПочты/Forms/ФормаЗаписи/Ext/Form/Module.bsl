...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РеквизитыУчетнойЗаписи = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Запись.УчетнаяЗаписьЭлектроннойПочты, "ВладелецУчетнойЗаписи, ПротоколВходящейПочты");
	
	ПользовательУчетнойЗаписи = РеквизитыУчетнойЗаписи.ВладелецУчетнойЗаписи;
...
Процедура ОбновитьСостояниеЭлементовФормы(Форма)
	...
	Форма.Элементы.УдалятьПисьмаПослеОтправки.Видимость = Не Форма.ЭтоПерсональнаяУчетнаяЗапись 
	                                                      И Форма.ПротоколВходящейПочты <> "IMAP";
