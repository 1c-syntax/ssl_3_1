...
//
Функция НовыйСрезРазрешений() Экспорт
...
//       ** Значение - см. РегистрСведений.РазрешенияНаИспользованиеВнешнихРесурсов.ДополнениеРазрешения
//
Функция НовыйСрезРазрешенийВРазрезеВладельцев() Экспорт
	
	Результат = НовыйСрезРазрешений();
...
Функция СрезРазрешений(Знач ВРазрезеВладельцев = Истина, Знач БезОписаний = Ложь) Экспорт
	...
	Результат = ?(ВРазрезеВладельцев, НовыйСрезРазрешенийВРазрезеВладельцев(), НовыйСрезРазрешений());
