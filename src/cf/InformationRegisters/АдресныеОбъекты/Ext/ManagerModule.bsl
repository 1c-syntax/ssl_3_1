...
// Возвращает часовые зоны РФ согласно федеральному закону от 03.06.2011 N 107-ФЗ (ред. от 14.04.2023) "Об исчислении времени".
//
// Возвращаемое значение:
//   ТаблицаЗначений - поставляемые данные. Колонки:
...
Функция ЧасовыеЗоныСубъектовРФ() Экспорт
	...
	Результат = АдресныйКлассификаторПовтИсп.ЧасовыеЗоныСубъектовРФ();
	Возврат Результат.ЧасовыеЗоныСубъектовРФ;
