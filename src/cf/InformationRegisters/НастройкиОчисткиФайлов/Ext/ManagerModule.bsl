...
Процедура ДобавитьКомандыОтчетов(КомандыОтчетов, Параметры) Экспорт
	...
	Если Не ПравоДоступа("Просмотр", Метаданные.Отчеты.ОбъемНенужныхФайлов) Тогда
		Возврат;
	КонецЕсли;
	
	Команда = КомандыОтчетов.Добавить();
	Команда.КлючВарианта      = "ОбъемНенужныхФайловПоВладельцам";
	Команда.Представление     = НСтр("ru = 'Объем ненужных файлов по владельцам (Первые 10)'");
	Команда.Идентификатор     = "ОбъемНенужныхФайловПоВладельцам";
	Команда.Менеджер          = "Отчет.ОбъемНенужныхФайлов";
