...
Процедура ДобавитьМакетыИзМетаданных(СписокМакетов, ИдентификаторыОбъектовМетаданных)
	...
	Если ИдентификаторыОбъектовМетаданных[0] = Справочники.ИдентификаторыОбъектовМетаданных.ПустаяСсылка() Тогда
		ОбъектыМетаданныхПоИдентификаторам = Новый Соответствие;
	...
	Иначе
		ОбъектыМетаданныхПоИдентификаторам = ОбщегоНазначения.ОбъектыМетаданныхПоИдентификаторам(ИдентификаторыОбъектовМетаданных);
	КонецЕсли;
...
Функция ИзмененныеМакеты(ОбъектыМетаданных = Неопределено) Экспорт
...
Функция ТипМакета(ИмяОбъектаМетаданныхМакета, ИмяОбъекта = "ОбщийМакет") Экспорт
...
Функция КартинкаМакета(Знач ТипМакета) Экспорт
