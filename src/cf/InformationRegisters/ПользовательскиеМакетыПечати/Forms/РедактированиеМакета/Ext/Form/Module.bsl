...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(СсылкаМакета) Тогда
		СсылкаМакета = УправлениеПечатью.СсылкаМакета(ИмяОбъектаМетаданныхМакета);
	КонецЕсли;
...
Процедура ЗаписатьМакет(Макет)
	...
	ОписаниеМакета.АдресМакетаВоВременномХранилище = ПоместитьВоВременноеХранилище(Макет, УникальныйИдентификатор);
	...
	Если ЗначениеЗаполнено(СсылкаМакета) Тогда
		РеквизитыМакета = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(СсылкаМакета, "Наименование,
			|НаименованиеПечатнойФормы, ОсновнаяПечатнаяФорма, МакетДляВыгрузкиОбъекта, ФорматСохраненияОбъекта");
		ОписаниеМакета.Ссылка = СсылкаМакета;
		ОписаниеМакета.ФорматСохраненияВыгрузки = РеквизитыМакета.ФорматСохраненияОбъекта;
		ЗаполнитьЗначенияСвойств(ОписаниеМакета, РеквизитыМакета);
	КонецЕсли;
	
	ИмяОбъектаМетаданныхМакета = УправлениеПечатью.ЗаписатьМакет(ОписаниеМакета);
