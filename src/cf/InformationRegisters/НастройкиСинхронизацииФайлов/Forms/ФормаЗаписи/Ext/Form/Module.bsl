...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ТекущийОбъект.ПравилоОтбора = Новый ХранилищеЗначения(ПравилоОтбора, Новый СжатиеДанных(9));
...
Функция ПолучитьТекстЗапроса()
	...
	РеквизитыТипаОбъекта = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ТипОбъекта, "Имя, ЗначениеПустойСсылки, ПолноеИмя");
	ПоляВладельцаФайла = РеквизитыТипаОбъекта.Имя + ".Ссылка";
	Если ВсеСправочники.СодержитТип(ТипЗнч(РеквизитыТипаОбъекта.ЗначениеПустойСсылки)) Тогда
		Справочник = Метаданные.Справочники[РеквизитыТипаОбъекта.Имя];
		Для Каждого Реквизит Из Справочник.Реквизиты Цикл
			ПоляВладельцаФайла = ПоляВладельцаФайла + "," + Символы.ПС + РеквизитыТипаОбъекта.Имя + "." + Реквизит.Имя;
		КонецЦикла;
	ИначеЕсли ВсеДокументы.СодержитТип(ТипЗнч(РеквизитыТипаОбъекта.ЗначениеПустойСсылки)) Тогда
		Документ = Метаданные.Документы[РеквизитыТипаОбъекта.Имя];
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "#ПолноеИмяВладелецФайла", РеквизитыТипаОбъекта.ПолноеИмя + " КАК "
		+ РеквизитыТипаОбъекта.Имя);
