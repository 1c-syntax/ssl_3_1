...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СпискиСКлючамиДоступа = УправлениеДоступомСлужебный.СпискиСКлючамиДоступа(, Истина);
	ВерсииОграничений = Новый Соответствие;
	
	Для Каждого ОписаниеСписка Из СпискиСКлючамиДоступа Цикл
		Список = ОписаниеСписка.Ключ;
		СвойстваТаблицы = ОписаниеСписка.Значение;
		ПолноеИмя = СвойстваТаблицы.ИмяТаблицы;
		СпискиДляОбновления.Добавить(Список, Строка(Список), Истина);
		ВерсииОграничений.Вставить(ПолноеИмя, СвойстваТаблицы.ВерсияОграничения);
	...
	ВерсииОграниченийСписков = Новый ФиксированноеСоответствие(ВерсииОграничений);
...
Функция ЗапланироватьОбновлениеДоступаСписковНаСервере()
	...
	Если ОбновитьКлючиДоступаКЭлементамДанных Или ОбновитьПраваНаКлючиДоступа Тогда
		...
		ПараметрыПланирования.ВерсииОграниченийСписков = Новый Соответствие(ВерсииОграниченийСписков);
