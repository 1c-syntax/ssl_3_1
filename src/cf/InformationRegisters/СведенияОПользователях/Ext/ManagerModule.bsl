...
Процедура ОбновитьДанныеРегистра(Пользователь = Неопределено, ЕстьИзменения = Неопределено) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		ОбновитьСведенияОПользователе(Выборка.Ссылка, Неопределено,,, ЕстьИзменения);
	КонецЦикла;
...
//                 - Неопределено
//
//  ЗаписатьИзмененияВЖурнал - Булево - записать изменения журнал регистрации, так как было
