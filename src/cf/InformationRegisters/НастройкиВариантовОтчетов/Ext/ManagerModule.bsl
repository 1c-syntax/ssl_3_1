...
////////////////////////////////////////////////////////////////////////////////
// Настройка доступности вариантов отчетов по умолчанию.

Процедура УстановитьДоступностьВариантовОтчетовПоУмолчанию() Экспорт 
	
	Запрос = Новый Запрос(ТекстЗапросаНастроекДоступностиВариантовОтчетовПоУмолчанию());
	...
	Пока Данные.Следующий() Цикл 
		...
		Исключение
			...
			ШаблонКомментария = НСтр("ru = 'Не удалось установить доступность варианта отчета ""%1"" по умолчанию
				|по причине: %2'");
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Варианты отчетов.Установка настроек доступности по умолчанию'", КодОсновногоЯзыка),
...
Функция ТекстЗапросаНастроекДоступностиВариантовОтчетовПоУмолчанию()
