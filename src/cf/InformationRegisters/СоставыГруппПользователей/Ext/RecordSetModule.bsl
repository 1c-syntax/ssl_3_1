...
Процедура ПодготовитьЗаписьИзмененийВЖурналРегистрации(НаборЗаписей, Замещение, СтарыеЗаписи)
	...
	Если НаборЗаписей.ДополнительныеСвойства.Свойство("ЭтоСтандартноеОбновлениеРегистра") Тогда
		Возврат;
	КонецЕсли;
...
Функция СписокПолей()
	...
	Поля = Новый Массив;
	Поля.Добавить(МетаданныеРегистра.Измерения.ГруппаПользователей.Имя);
