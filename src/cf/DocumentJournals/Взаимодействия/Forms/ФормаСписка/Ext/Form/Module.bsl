...
Процедура ЗаполнитьПанельКонтактов()
	...
	Если ТолькоЗначимыеКонтакты Тогда
		...
		Для Каждого СтрокаУсловия Из МассивСтрокУсловия Цикл
			...
			Инд = Инд + 1;
		КонецЦикла;
		ТекстУсловийПоЖурналуДокументов = ?(ПустаяСтрока(ТекстУсловийПоЖурналуДокументов), "ИСТИНА", ТекстУсловийПоЖурналуДокументов);
		ТекстУсловийПоРегистру = ?(ПустаяСтрока(ТекстУсловийПоРегистру), "ИСТИНА", ТекстУсловийПоРегистру);
...
Процедура ЗаполнитьОписаниеНайденоПолнотекстовымПоиском(Взаимодействие)
	...
	Иначе
		...
		ОписаниеНайденоПолнотекстовымПоиском = ТекстНайдено + " - " + СтрокаТаблицыСОписанием.Описание;
	КонецЕсли;
...
Процедура СФормироватьДекорациюТолькоЗначимыеКонтакты()
	...
	Если ТолькоЗначимыеКонтакты Тогда
		ТекстЗаголовка = СтроковыеФункции.ФорматированнаяСтрока(НСтр("ru='Контакты с взаимодействиями по отбору, <a href = ""ИзменитьТолькоЗначимыеКонтакты"">изменить</a>'"));
	Иначе
		ТекстЗаголовка = СтроковыеФункции.ФорматированнаяСтрока(НСтр("ru='Отображаются все контакты, <a href = ""ИзменитьТолькоЗначимыеКонтакты"">изменить</a>'"));
	КонецЕсли;
...
Процедура СФормироватьДекорациюТолькоЗначимыеПредметы()
	...
	Если ТолькоЗначимыеПредметы Тогда
		ТекстЗаголовка = СтроковыеФункции.ФорматированнаяСтрока(НСтр("ru='Предметы с взаимодействиями по отбору, <a href = ""ИзменитьТолькоЗначимыеПредметы"">изменить</a>'"));
	Иначе
		ТекстЗаголовка = СтроковыеФункции.ФорматированнаяСтрока(НСтр("ru='Отображаются все предметы, <a href = ""ИзменитьТолькоЗначимыеПредметы"">изменить</a>'"));
	КонецЕсли;
