...
Процедура ИсполнительПриИзменении(Элемент)
	...
	УстановитьСостояниеЭлементовИТипыОбъектовАдресации();
...
&НаСервере
Процедура УстановитьСостояниеЭлементовИТипыОбъектовАдресации()
	
	Если ЗначениеЗаполнено(Исполнитель) Тогда
		ОписаниеПользователя = ПользователиСлужебный.ОписаниеПользователя(Исполнитель);
		Если ОписаниеПользователя.Недействителен Или ОписаниеПользователя.ПометкаУдаления Тогда
