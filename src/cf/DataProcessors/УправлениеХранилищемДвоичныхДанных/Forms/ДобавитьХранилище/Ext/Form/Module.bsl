...
Процедура ДобавитьХранилище()
	...
	Выполнить("ПараметрыДоступаВХДД = Новый ПараметрыДоступаВнешнегоХранилищаДвоичныхДанных()"); // Не нарушает безопасность информации, так как выполняется фиксированная строка, содержащая только вызов метода платформы.
	// АПК:487-вкл	
