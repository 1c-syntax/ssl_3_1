	...
	Если РежимИспользования = РежимИспользованияХранилищаДвоичныхДанных.Разрешить Тогда
		...
		Попытка
			...
			Если ХранилищеПоУмолчанию Тогда
				...
				Выполнить("ХранилищеПоУмолчанию = ХранилищеДвоичныхДанных.ПолучитьИспользованиеКакХранилищаПоУмолчанию()"); // Не нарушает безопасность информации, так как выполняется фиксированная строка, содержащая только вызов метода платформы.
				// АПК:487-вкл				
			КонецЕсли; 
