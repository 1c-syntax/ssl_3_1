...
Процедура Печать(Команда)
	...
	Если ЗначениеЗаполнено(ТекущаяСсылкаНаФайл())
...
Процедура УстановитьВидимостьКомандФормы()
	...
	Для Каждого Команда Из ИменаКомандИзмененияДанныхФайла() Цикл
		Для каждого КоманаФормы Из Команда.Значение Цикл
			Элементы[КоманаФормы].Видимость = НЕ ТолькоЧтениеДанныхФайла И Элементы[КоманаФормы].Видимость;	
		КонецЦикла;
	КонецЦикла;	
