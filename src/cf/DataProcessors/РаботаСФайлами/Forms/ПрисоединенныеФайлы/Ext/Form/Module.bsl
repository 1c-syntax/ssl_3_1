...
Процедура СписокПеретаскивание(Элемент, ПараметрыПеретаскивания, СтандартнаяОбработка, Строка, Поле)
	...
	Если ТипЗнч(ПараметрыПеретаскивания.Значение) = Тип("Файл")
		...
		Если СтрСравнить(ИмяСправочникаХранилищаФайлов, "Файлы") <> 0 Тогда
			МассивИменФайлов.Добавить(ПараметрыПеретаскивания.Значение.ПолноеИмя);
		Иначе
			ПеретаскиваниеФайлов(ВладелецФайла, ПараметрыПеретаскивания.Значение, ПараметрыПеретаскивания.Действие);
			Возврат;
		КонецЕсли;
		...
		Если ПараметрыПеретаскивания.Значение.Количество() > 0 Тогда
			...
			Если ТипЗнч(ПараметрыПеретаскивания.Значение[0]) = Тип("Файл") Тогда
				...
				Иначе
					...
					Возврат;
				КонецЕсли;
			ИначеЕсли ТипЗнч(ПараметрыПеретаскивания.Значение[0]) = ТипСправочникаСФайлами Тогда 
				Для Каждого Значение Из ПараметрыПеретаскивания.Значение Цикл
					МассивЭлементовСписка.Добавить(Значение);
				КонецЦикла;
			КонецЕсли;
		КонецЕсли;
	...
	Если МассивЭлементовСписка.Количество() > 0 И ВозможностьСоздаватьГруппыФайлов Тогда
...
&НаКлиенте
Процедура ПеретаскиваниеФайлов(ВладелецФайла, ЗначениеПеретаскивания, Действие)
	...
	Для Каждого ФайлПринятый Из МассивИменФайлов Цикл
		ПараметрыДобавления.ПолноеИмяФайла = ФайлПринятый;
