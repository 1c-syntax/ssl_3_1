...
Процедура ПечатьСоШтампом(Команда)
	...
	Если ТекущиеДанные.Расширение = "mxl" Тогда
		ДокументСоШтампом = РаботаСФайламиСлужебныйВызовСервера.ТабличныйДокументСоШтампом(ТекущиеДанные.Ссылка);
		РаботаСФайламиСлужебныйКлиент.ПечатьФайлаСоШтампом(ДокументСоШтампом);
	ИначеЕсли ТекущиеДанные.Расширение = "docx" Тогда
		ДокументСоШтампом = РаботаСФайламиСлужебныйВызовСервера.ОфисныйДокументСоШтампом(ТекущиеДанные.Ссылка);
