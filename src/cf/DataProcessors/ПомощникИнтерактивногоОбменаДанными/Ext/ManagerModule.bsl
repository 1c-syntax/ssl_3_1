...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ВыполнитьЗагрузкуДанных", Истина);
	Методы.Вставить("ПолучитьСообщениеОбменаВоВременныйКаталог", Истина);
	Методы.Вставить("ВыполнитьАвтоматическоеСопоставлениеДанных", Истина);
	Методы.Вставить("ВыгрузитьДанныеДляСопоставления", Истина);
	Методы.Вставить("ЗарегистрироватьДанныеДляВыгрузки", Истина);
	Методы.Вставить("ВыполнитьВыгрузкуДанных", Истина);
