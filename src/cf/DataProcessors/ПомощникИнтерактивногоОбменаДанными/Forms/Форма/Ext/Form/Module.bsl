...
Процедура ОткрытьРезультатыПакетнойСинхронизации(УзелИнформационнойБазы, ИмяНабораСобытий)
	...
	ОтборТипыПредупреждений = "";
	Если ИмяНабораСобытий = "СобытияВыгрузки" Тогда
		
		ОтборТипыПредупреждений = "Отправка";
		
	ИначеЕсли ИмяНабораСобытий = "СобытияЗагрузки" Тогда
		
		ОтборТипыПредупреждений = "Получение";
