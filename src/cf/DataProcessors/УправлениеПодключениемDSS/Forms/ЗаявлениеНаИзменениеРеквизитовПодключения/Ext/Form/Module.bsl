...
Процедура ОтправитьЗаявлениеСформироватьЗаявлениеЗавершение(ОтветСервиса, ПараметрыЦикла) Экспорт
	...
	Иначе
		ПоказатьОшибку(ОповещениеОЗавершении, РезультатВыполнения.СтатусОшибки);
	КонецЕсли;	
...
Функция ВидКонтактнойИнформацииТелефон()
	...
	Возврат МодульУправлениеКонтактнойИнформацией.ПараметрыТелефона();
...
Функция ЗначениеТелефонаОблачнойПодписиПоПредставлению(ТекущийТелефон)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.КонтактнаяИнформация") Тогда
		...
		Результат = МодульУправлениеКонтактнойИнформацией.КонтактнаяИнформацияПоПредставлению(ТекущийТелефон, 
