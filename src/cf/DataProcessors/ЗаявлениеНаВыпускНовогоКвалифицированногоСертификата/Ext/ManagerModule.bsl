...
Функция РеквизитыОрганизации(Форма) Экспорт
	...
	Реквизиты.Добавить("ЮридическийАдрес",                 НСтр("ru = 'Юридический адрес'"));
	Реквизиты.Добавить("ФактическийАдрес",                 НСтр("ru = 'Фактический адрес'"));
...
Функция РеквизитыВладельцаСертификата(Форма, ЭтоИП = Неопределено) Экспорт
	...
	Если Форма <> Неопределено Тогда
		Если ЭтоИП =  Неопределено И Форма.ЭтоИндивидуальныйПредприниматель
		 Или ЭтоИП <> Неопределено И ЭтоИП Тогда
...
Функция ПроверитьЗаполнениеРеквизитов(Реквизиты, ЭтоИП) Экспорт
...
Процедура ПроверитьЗаполнениеРеквизита(Реквизит, Отказ, ЭтоИП = Ложь)
	...
	Для Каждого ТекстОшибки Из ТекстыОшибок Цикл
		...
		ОбщегоНазначения.СообщитьПользователю(ТекстОшибки, , ПолеСообщения, ,
