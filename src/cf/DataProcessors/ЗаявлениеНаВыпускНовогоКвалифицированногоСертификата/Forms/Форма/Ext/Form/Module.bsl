...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НСтр("ru = 'Если не установлено приложение электронной подписи и шифрования, установите %1 или %2.
		|
...
Процедура ОткрытьФормуОшибки(ОписаниеОшибки, ОбработкаПродолжения = Неопределено)
	...
	ЭлектроннаяПодписьСлужебныйКлиент.ОткрытьФормуРасширенногоПредставленияОшибки(ПараметрыОшибки, ЭтотОбъект);
...
Процедура ПоказатьПодсказкуКриптопровайдеры(Результат)
	...
	Элементы.ДекорацияПроверкаУстановкиКриптопровайдера.Заголовок = СтроковыеФункцииКлиент.ФорматированнаяСтрока(
			НСтр(
		"ru = '<a href = ""%1"">Нажмите здесь</a>, чтобы определить установленные приложения для работы с электронной подписью.'"),
...
Функция ЗаполнитьСписокПрограмм(ОписаниеОшибки = "")
	...
	Если ЗначениеЗаполнено(ТекстОшибки) Тогда
		...
		ЭлектроннаяПодписьСлужебныйКлиент.ПоказатьОшибкуОбращенияКПрограмме(
			НСтр("ru = 'Заполнение списка приложений электронной подписи'"), "",
