...
Процедура УстановитьВидимостьИДоступность()
	...
	Элементы.СведенияОЗаявленииИВладельцеСертификата.Видимость = ЗаявлениеОтправлено И ДанныеЗаявления.ОформленоВЭлектронномВиде И Не ПродлениеСертификатаСтороннегоУЦ;
