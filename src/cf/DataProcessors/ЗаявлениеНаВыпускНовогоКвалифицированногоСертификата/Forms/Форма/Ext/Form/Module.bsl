...
Процедура ЗаписатьЗаявление()
	...
	ИначеЕсли Объект.СостояниеЗаявления = Перечисления.СостоянияЗаявленияНаВыпускСертификата.Исполнено Тогда
		...
		НаименованиеСертификата = ЭлектроннаяПодпись.ПредставлениеСертификата(ТекущийОбъект.Ссылка);
		
	КонецЕсли;
	
	Если Не ПустаяСтрока(НаименованиеСертификата)
		И ТекущийОбъект.Наименование <> НаименованиеСертификата Тогда
