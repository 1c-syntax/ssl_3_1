...
Процедура ЗаполнитьСписокПрограммНаСервере(СписокПрограмм, ВариантАлгоритмов,
	...
	ЭтоСеансWindows = ОбщегоНазначения.ЭтоWindowsКлиент() Или ОбщегоНазначения.ЭтоWindowsСервер();
	ЭтоСеансLinux = ОбщегоНазначения.ЭтоLinuxКлиент() Или ОбщегоНазначения.ЭтоLinuxСервер();
