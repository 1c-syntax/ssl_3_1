...
Функция ЭтоРазделенныйОбъект(Знач ОписаниеОбъекта, СвойстваРазделенияДанных = Неопределено)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса.ВыгрузкаЗагрузкаДанных") Тогда
		Если СвойстваРазделенияДанных = Неопределено Тогда
			...
			СвойстваРазделенияДанных = Новый Структура("РазделительОсновныхДанных,РазделительВспомогательныхДанных,СлужебныеДанные");
			...
			СвойстваРазделенияДанных.СлужебныеДанные = ПолныеИменаТипов(
				МодульВыгрузкаЗагрузкаДанныхСлужебныйСобытия.ПолучитьТипыИсключаемыеИзВыгрузкиЗагрузки());
		КонецЕсли;
		
		Возврат СвойстваРазделенияДанных.СлужебныеДанные[ОписаниеОбъекта.ПолноеИмя] = Неопределено 
			И (ОписаниеОбъекта.РазделениеДанных.Свойство(СвойстваРазделенияДанных.РазделительОсновныхДанных)
...
Функция ПолныеИменаТипов(Типы)
	...
	Для Каждого Тип Из Типы Цикл
		Результат[Тип.ПолноеИмя()] = Истина;
	КонецЦикла;
	Возврат Результат;
КонецФункции
