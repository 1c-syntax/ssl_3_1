...
Процедура ПроверитьДоступностьНаСервере()
	...
	Файл = Новый Файл(Объект.ИмяФайлаВнешнейОбработкиОбработчиковСобытий);
	
	Если Файл.Существует() Тогда
		
		ТекстСообщения = НСтр("ru = 'Обработка доступна'");
		
	Иначе
		
		ТекстСообщения = НСтр("ru = 'Обработка не доступна'");
