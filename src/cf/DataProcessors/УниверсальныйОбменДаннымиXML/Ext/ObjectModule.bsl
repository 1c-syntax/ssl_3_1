...
//
// Параметры:
//  Объект         - XMLЗапись - объект типа XMLЗапись.
...
//
// Параметры:
//  Объект      - XMLЧтение - объект типа XMLЧтение, спозиционированный на начале элемента,
...
//
// Параметры:
//  Объект   - XMLЧтение - объект типа XMLЧтение.
...
//
// Параметры:
//  Объект           - XMLЧтение - объект типа XMLЧтение, из которого осуществляется чтение.
...
//
// Возвращаемое значение:
//   РезультатЗапроса или Неопределено - результат запроса для выгрузки очистки данных.
//
...
Функция ВыполнитьПодключениеКИБПриемнику() Экспорт
	...
	Если РезультатПодключения <> Неопределено Тогда
		...
		СвойстваЗаполнения.Вставить("ИспользоватьТранзакции",                ИспользоватьТранзакции);
		СвойстваЗаполнения.Вставить("КоличествоОбъектовНаТранзакцию",        КоличествоОбъектовНаТранзакцию);
		СвойстваЗаполнения.Вставить("ФлагРежимОтладки",                      ФлагРежимОтладки);
		СвойстваЗаполнения.Вставить("ИмяФайлаПротоколаОбмена",               ПолучитьИмяПротоколаДляВторойИнформационнойБазыComСоединения());
		СвойстваЗаполнения.Вставить("ДописыватьДанныеВПротоколОбмена",       ДописыватьДанныеВПротоколОбмена);
		СвойстваЗаполнения.Вставить("ВыводВПротоколИнформационныхСообщений", ВыводВПротоколИнформационныхСообщений);
		СвойстваЗаполнения.Вставить("РежимОбмена",                           "Загрузка");
		СвойстваЗаполнения.Вставить("КодировкаФайлаПротоколаОбмена",         КодировкаФайлаПротоколаОбмена);
		
		ЗаполнитьЗначенияСвойств(РезультатПодключения, СвойстваЗаполнения);
