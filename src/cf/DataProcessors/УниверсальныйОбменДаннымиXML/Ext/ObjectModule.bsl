...
Функция СоздатьНовыйОбъект(Тип, СвойстваПоиска, Объект = Неопределено, 
	...
	Менеджер        = СвойстваМД.Менеджер; // СправочникМенеджер, ДокументМенеджер, РегистрСведенийМенеджер, ПланСчетовМенеджер, ПланВидовРасчетаМенеджер, ПланОбменаМенеджер, ЗадачаМенеджер, БизнесПроцессМенеджер
...
// Параметры:
//   Данные - - ДокументОбъект
//            - ПланВидовХарактеристикОбъект
//            - ПланСчетовОбъект
//            - БизнесПроцессОбъект
//            - ЗадачаОбъект
//            - РегистрСведенийМенеджерЗаписи - справочник объект, документ объект, ключ регистра сведений и т.д.
//
