...
Функция СформироватьФайлыСкрипта() 
	...
	ПараметрыСкрипта.ИмяCOMСоединителя = ПараметрыРаботыКлиента.ИмяCOMСоединителя;
	ПараметрыСкрипта.ЭтоБазоваяВерсияКонфигурации = ПараметрыРаботыКлиента.ЭтоБазоваяВерсияКонфигурации;
