	...
	Если СтрСравнить(УправлениеКонтактнойИнформациейКлиентСервер.АдресЕАЭС(), ТипАдреса) <> 0 Тогда
		...
		Если ЭтоМуниципальныйАдрес
			...
			И ЗначениеЗаполнено(НаселенныйПунктДетально.city) Тогда
				НаселенныйПункт = НаселенныйПунктДетально.city + " " + НаселенныйПунктДетально.cityType;
		Иначе
				НаселенныйПункт = НаселенныйПунктДетально.locality + " " + НаселенныйПунктДетально.localityType;
		КонецЕсли;
