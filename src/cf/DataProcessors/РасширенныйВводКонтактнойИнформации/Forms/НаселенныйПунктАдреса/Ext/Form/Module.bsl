	...
	Если НаселенныйПунктДетально <> Неопределено Тогда
		...
		Если НаселенныйПунктДетально.Свойство("Country")
			...
			Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.АдресныйКлассификатор") Тогда
				...
				ИсключатьГородИзМуниципальногоАдреса = МодульАдресныйКлассификаторСлужебный.ИсключатьГородИзМуниципальногоАдреса(НаселенныйПунктДетально);
			Иначе 
...
Процедура ОпределитьПоляАдреса()
	...
	Если ИсключатьГородИзМуниципальногоАдреса И РаботаСАдресамиКлиентСервер.ЭтоМуниципальныйАдрес(ТипАдреса) Тогда
		Город            = "";
	Иначе
		Город            = ПредставлениеУровняАдреса(НаселенныйПунктДетально, "City");
	КонецЕсли;
