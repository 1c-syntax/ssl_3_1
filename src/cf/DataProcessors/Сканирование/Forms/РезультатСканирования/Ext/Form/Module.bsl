...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ВРег(ИсточникВыбора.ИмяФормы) = ВРег("Обработка.Сканирование.Форма.НастройкаСканированияНаСеанс") Тогда
		...
		АвтоматическаяПодачаДокументов = ВыбранноеЗначение.АвтоматическаяПодачаДокументов;
...
Процедура ТребуетсяПомощьНажатие(Элемент)
	...
	РаботаСФайламиСлужебныйКлиент.ПоказатьОшибкуСканирования(ЭтотОбъект, НСтр("ru='Проблема при сканировании'"), 
		НСтр("ru='Вызвана помощь из окна сканирования.'"), Истина);
	...
	ИначеЕсли Источник = "TWAIN" И Событие = "UserPressedCancel" Тогда
		Если Открыта() Тогда
			...
			Если ТекущаяДата < НачалоСканирования + 3 И ТаблицаФайлов.Количество() = 0 Тогда
				...
				РаботаСФайламиСлужебныйКлиент.ПоказатьОшибкуСканирования(ЭтотОбъект, 
