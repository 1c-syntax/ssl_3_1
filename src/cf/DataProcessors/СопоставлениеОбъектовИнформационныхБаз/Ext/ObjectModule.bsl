...
Процедура ДанныеСопоставленияОбъектов(ТаблицаИсточника, ПользовательскиеПоля, МенеджерВременныхТаблиц)
	...
	Если ОбменДаннымиСервер.ЭтоПланОбменаXDTO(УзелИнформационнойБазы) Тогда
		...
		ТекстЗапроса = ТекстЗапроса + "
			...
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса,
				...
				"СоответствияОбъектовИнформационныхБаз.Ссылка ССЫЛКА #ТаблицаПриемника#");
	...
	Если ОбменДаннымиСервер.ЭтоПланОбменаXDTO(УзелИнформационнойБазы) Тогда
		...
		ТекстЗапроса = ТекстЗапроса + "
			...
			|	ЛЕВОЕ СОЕДИНЕНИЕ
			|		Справочник.СценарииОбменовДанными КАК ТаблицаПриемника // СтрокаАвтоматическойЗамены
			|	ПО
		...
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса,
			...
			"ТаблицаНеутвержденныхСвязей.УникальныйИдентификаторИсточника ССЫЛКА #ТаблицаПриемника#");
