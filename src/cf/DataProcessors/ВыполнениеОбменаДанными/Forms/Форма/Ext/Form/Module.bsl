...
Функция Подключаемый_ЗагрузкаДанных_ОбработкаДлительнойОперации(Отказ, ПерейтиДалее)
	...
	Иначе
		...
		ЗапуститьФоновоеЗаданиеВыполнитьЗапускОбменаДанными(ФоновоеЗаданиеВыполняемоеДействие, Отказ);
	КонецЕсли;
...
&НаКлиенте
Процедура ЗапуститьФоновоеЗаданиеВыполнитьЗапускОбменаДанными(Действие, Отказ)
	
	ПараметрыЗадания = ИнициализироватьПараметрыЗадания(Отказ);
	
	Результат = ЗапуститьФоновоеЗаданиеВыполнитьЗапускОбменаДаннымиНаСервере(ПараметрыЗадания, ОшибкаРасхожденияВерсийПриПолученииДанных, ПроверятьРасхождениеВерсий);
	...
	Если Результат.Статус = "Выполняется" Тогда
		...
		ЗапуститьОжиданиеЗавершенияФоновогоЗадания(Результат);
...
&НаКлиенте
Функция ИнициализироватьПараметрыЗадания(Отказ)
	...
	ПараметрыЗадания.Вставить("КлючОбрабатывающегоЗадания",          "");
...
&НаКлиенте
Процедура ЗапуститьОжиданиеЗавершенияФоновогоЗадания(Результат)
...
&НаСервере
Функция ЗапуститьФоновоеЗаданиеВыполнитьЗапускОбменаДаннымиНаСервере(Знач ПараметрыЗадания, ОшибкаРасхожденияВерсийПриПолученииДанных, ПроверятьРасхождениеВерсий)
	
	ПараметрыВыполнения = ИнициализироватьПараметрыВыполнения(ПараметрыЗадания, ПроверятьРасхождениеВерсий);
...
&НаСервере
Функция ИнициализироватьПараметрыВыполнения(ПараметрыЗадания, ПроверятьРасхождениеВерсий)
	...
	Если ПараметрыЗадания.ВыполнятьЗагрузку Тогда
		...
		ПараметрыЗадания.КлючОбрабатывающегоЗадания = РаботаСРезультатамиОбмена.НовыйИдентификаторФоновогоЗадания();
	...
	ПараметрыВыполнения.КлючФоновогоЗадания = ПараметрыЗадания.КлючОбрабатывающегоЗадания;
