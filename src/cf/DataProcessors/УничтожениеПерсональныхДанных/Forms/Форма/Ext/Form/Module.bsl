...
Процедура УстановитьВидимостьЭлементов()
	...
	ВидимостьТипаСубъекта = ЗащитаПерсональныхДанных.ТипыСубъектовДоступныхПоФункциональнымОпциям().Количество() > 1;
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СрокиХраненияТипСубъекта", "Видимость",
		ВидимостьТипаСубъекта);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "АктыОбУничтоженииТипСубъекта", "Видимость",
		ВидимостьТипаСубъекта);
