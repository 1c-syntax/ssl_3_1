...
Процедура УстановитьВидимостьОрганизации(Организации)
	...
	Если ВсеОрганизацииЗаполнены Тогда
		...
		ТекстОкончание = ".";
	Иначе	
		ТекстОкончание = НСтр("ru = ', а также организации:'");
	КонецЕсли;

	ОрганизацииСтрокой = СтрСоединить(ЗаполненныеОрганизации, ", ");
	
	ТекстОрганизации = СтроковыеФункции.ФорматированнаяСтрока(НСтр("ru = 'Акты формируются от имени: <b>%1</b>%2'"),
		ОрганизацииСтрокой, ТекстОкончание);
