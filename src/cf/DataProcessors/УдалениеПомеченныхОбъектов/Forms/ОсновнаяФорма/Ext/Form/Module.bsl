...
Процедура ПоказатьСвязиНеУдаленныхНаКлиенте()
	Если НеУдаленныеИдентификаторТекущейСтроки = Элементы.НеУдаленные.ТекущаяСтрока Тогда
		Возврат;
	КонецЕсли;
	ПоказатьСвязиНеУдаленныхНаСервере();
КонецПроцедуры

&НаСервере
Процедура ПоказатьСвязиНеУдаленныхНаСервере()
	...
	Иначе
		СтрокаДерева = НеУдаленные.НайтиПоИдентификатору(НеУдаленныеИдентификаторТекущейСтроки);
	КонецЕсли;
	...
	Иначе
		...
		Элементы.СвязиНеУдаленных.ОтборСтрок = Новый ФиксированнаяСтруктура("УдаляемыйСсылка", СтрокаДерева.УдаляемыйСсылка);
