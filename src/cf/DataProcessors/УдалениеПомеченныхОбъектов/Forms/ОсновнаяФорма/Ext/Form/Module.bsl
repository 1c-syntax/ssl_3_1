...
&НаКлиентеНаСервереБезКонтекста
Функция ЭтоОшибкаУстановкиМонопольногоРежима(ИнформацияОбОшибкеФоновогоЗадания)
	ТекстОшибкиМонопольно = НСтр("ru='Ошибка разделенного доступа к базе'");	
	Возврат СтрНайти(ОбработкаОшибок.КраткоеПредставлениеОшибки(ИнформацияОбОшибкеФоновогоЗадания), ТекстОшибкиМонопольно) <> 0;
КонецФункции
