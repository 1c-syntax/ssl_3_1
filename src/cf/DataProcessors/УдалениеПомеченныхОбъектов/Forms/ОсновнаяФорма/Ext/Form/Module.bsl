...
Процедура УдалитьВыбранные(Команда)
	...
	Если СведенияОВыбранныхОбъектах.КоличествоВыбранных = 0 Тогда
		ТекстВопроса = НСтр("ru='Необходимо выбрать хотя бы один элемент для удаления.'");
		ПоказатьПредупреждение(, ТекстВопроса);
		Возврат;
	ИначеЕсли СведенияОВыбранныхОбъектах.КоличествоВыбранных = 1 Тогда
		ТекстВопроса = НСтр("ru='Удалить элемент, помеченный на удаление?'");
	ИначеЕсли СведенияОВыбранныхОбъектах.КоличествоВыбранных = СведенияОВыбранныхОбъектах.КоличествоВсего Тогда
