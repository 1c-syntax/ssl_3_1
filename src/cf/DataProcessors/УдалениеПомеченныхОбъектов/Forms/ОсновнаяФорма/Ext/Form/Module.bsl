...
Процедура ОтменитьОперациюСервер(ВыполняемаяОперация)
	...
	ИдентификаторЗадания = ?(ОбщегоНазначения.РежимОтладки(), УникальныйИдентификатор, ВыполняемаяОперация.ИдентификаторЗадания);
	УдалениеПомеченныхОбъектовСлужебный.СнятьБлокировкуИспользованияУдаляемыхОбъектов(ИдентификаторЗадания);
