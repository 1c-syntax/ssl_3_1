...
Функция ОбработатьПакет(ПараметрыУдаления, Пакет)
	...
	ОсновнойИПодчиненныеОбъекты = Новый Структура;
	ОсновнойИПодчиненныеОбъекты.Вставить("Элементы", Новый Массив);
	ОсновнойИПодчиненныеОбъекты.Вставить("Код", КодыРезультатаУдаления().Успешно);
	ОсновнойИПодчиненныеОбъекты.Вставить("РезультатУдаления");
	Для Каждого Элемент Из Пакет Цикл
		ОсновнойИПодчиненныеОбъекты.Элементы.Добавить(Элемент);
		...
		Попытка
			...
			Для каждого УдаляемыйСсылка Из ОсновнойИПодчиненныеОбъекты.Элементы Цикл
		...
		ОсновнойИПодчиненныеОбъекты.Элементы.Очистить();
		ОсновнойИПодчиненныеОбъекты.РезультатУдаления = Неопределено;
		ОсновнойИПодчиненныеОбъекты.Код = КодыРезультатаУдаления().Успешно;
