...
Процедура ОтразитьНеУдаленные(ПараметрыУдаления, НеУдаленные)
	...
	Для Каждого Элемент Из НеУдаленные Цикл
		...
		// Объект может быть не удален из-за ПометкаУдаления = Ложь, но удален как подчиненный.
	...
	Для Каждого Элемент Из Пакет Цикл
		...
		Попытка
			...
			Для каждого УдаляемыйСсылка Из ОсновнойИПодчиненныеОбъекты Цикл
				...
				РезультатУдаления = УдалитьЭлементПакета(ПараметрыУдаления, УдаляемыйСсылка,
