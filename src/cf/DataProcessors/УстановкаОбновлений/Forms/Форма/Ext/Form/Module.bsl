...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступнаУстановкаПатчейВБазовойВерсии = ОбновлениеКонфигурации.ДоступнаУстановкаПатчейВБазовойВерсии();
...
Процедура УстановитьИсправленияНаСервере(ПомещенныеФайлы)
	...
	Иначе
		Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ЦентрМониторинга") Тогда 
			...
			МодульЦентрМониторинга.ЗаписатьОперациюБизнесСтатистики("РучнаяУстановкаПатча", 1);
		КонецЕсли;
	КонецЕсли;
