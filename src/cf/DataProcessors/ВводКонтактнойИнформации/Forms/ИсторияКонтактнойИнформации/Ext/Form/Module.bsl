...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ИзФормыВводаАдреса Тогда
		...
		Если ЗначениеЗаполнено(Параметры.ДействуетС) Тогда
			Отбор = Новый Структура("ДействуетС", Параметры.ДействуетС);
...
Процедура ОткрытьФормуРедактированияАдреса(Знач ВыбраннаяСтрока)
	...
	Иначе
		...
		ПараметрыОткрытия.Вставить("КонтактнаяИнформацияОписаниеДополнительныхРеквизитов", История);
