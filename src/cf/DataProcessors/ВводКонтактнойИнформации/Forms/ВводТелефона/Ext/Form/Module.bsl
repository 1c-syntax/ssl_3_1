...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗначенияПолей = ОпределитьЗначениеКонтактнойИнформации(Параметры);
	...
	Если НЕ ВводитьНомерПоМаске И Метаданные.Обработки.Найти("РасширенныйВводКонтактнойИнформации") <> Неопределено Тогда
		...
		ПодсказкиПриВводеТелефона = МодульРасширенныйВводКонтактнойИнформации.ПодсказкиПриВводеТелефона();
	...
	Иначе
		...
		Если УправлениеКонтактнойИнформациейКлиентСервер.ЭтоКонтактнаяИнформацияВXML(ЗначенияПолей) Тогда
			...
			УправлениеКонтактнойИнформациейЛокализация.ПриКонвертированииКонтактнойИнформацииИзXML(ЗначенияПолей, КонтактнаяИнформация, ТипКонтактнойИнформации, РезультатыЧтения);
		...
		Иначе
			...
			Если ТипКонтактнойИнформации = Перечисления.ТипыКонтактнойИнформации.Телефон Тогда
				УправлениеКонтактнойИнформациейЛокализация.ПриКонвертацииТелефонаВОбъектXDTO(ЗначенияПолей, 
					КонтактнаяИнформация, Параметры.Представление, ТипКонтактнойИнформации);
					
			Иначе
				УправлениеКонтактнойИнформациейЛокализация.ПриКонвертацииФаксаВОбъектXDTO(ЗначенияПолей, 
					КонтактнаяИнформация, Параметры.Представление, ТипКонтактнойИнформации);
	...
	Если НЕ ВводитьНомерПоМаске Тогда
		...
		Если СтруктураВидКонтактнойИнформации.ХранитьИсториюИзменений Тогда
			Если Параметры.КонтактнаяИнформацияОписаниеДополнительныхРеквизитов <> Неопределено Тогда
...
Функция РезультатВыбораТолькоКомментария()
	...
	ЗначениеКонтактнойИнформации = ОпределитьЗначениеКонтактнойИнформации(Параметры);
	Если ПустаяСтрока(ЗначениеКонтактнойИнформации) Тогда
		
			Если ТипКонтактнойИнформации = Перечисления.ТипыКонтактнойИнформации.Телефон Тогда
				УправлениеКонтактнойИнформациейЛокализация.ПриКонвертацииТелефонаВОбъектXDTO("", ЗначениеКонтактнойИнформации, "", ТипКонтактнойИнформации);
			Иначе
				УправлениеКонтактнойИнформациейЛокализация.ПриКонвертацииФаксаВОбъектXDTO("", ЗначениеКонтактнойИнформации, "", ТипКонтактнойИнформации);
			КонецЕсли;
			
			УправлениеКонтактнойИнформацией.УстановитьКомментарийКонтактнойИнформации(ЗначениеКонтактнойИнформации, Комментарий);
			ЗначениеКонтактнойИнформации = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияВXML(ЗначениеКонтактнойИнформации);
			
	ИначеЕсли УправлениеКонтактнойИнформациейКлиентСервер.ЭтоКонтактнаяИнформацияВXML(ЗначениеКонтактнойИнформации) Тогда
		УправлениеКонтактнойИнформацией.УстановитьКомментарийКонтактнойИнформации(ЗначениеКонтактнойИнформации, Комментарий);
	КонецЕсли;
	
	Возврат Новый Структура("КонтактнаяИнформация, Представление, Комментарий",
		ЗначениеКонтактнойИнформации, Параметры.Представление, Комментарий);
КонецФункции
...
&НаСервере
Функция ОпределитьЗначениеКонтактнойИнформации(Параметры)
