...
Процедура ДекорацияПредварительныеНастройкиОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если НавигационнаяСсылкаФорматированнойСтроки = "СервисыИнтеграции" Тогда
		...
		ОткрытьФорму("Обработка.ТранспортСообщенийОбменаESB1C.Форма.ФормаУправлениеСервисамиИнтеграции");
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "РегламентноеЗадание" Тогда
		...
		Если ЕстьПодсистемаРегламентныеЗадания Тогда
			...
			ИмяФормыРегламентногоЗадания = "Обработка.РегламентныеИФоновыеЗадания.Форма.РегламентноеЗадание";
			ОткрытьФорму(ИмяФормыРегламентногоЗадания, ПараметрыФормы, ЭтотОбъект);
		...
		Иначе
			...
			ИмяФормыРегламентногоЗадания = "Обработка.ТранспортСообщенийОбменаESB1C.Форма.ФормаНастройкиРегламентногоЗадания";
			ОткрытьФорму(ИмяФормыРегламентногоЗадания, ПараметрыФормы, ЭтотОбъект);
