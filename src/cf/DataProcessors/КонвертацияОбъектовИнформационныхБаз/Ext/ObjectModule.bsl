...
#Область ПеременныеОтладкиОбработчиков
...
#Область ПеременныеДляЗначенийСвойств
