...
// Параметры:
//   Приемник - ЗаписьXML - xml-узел объекта приемника.
//   Тип - Строка, Массив из Строка - выгружаемый одиночный тип, или список выгружаемых строковых типов.
...
//
// Параметры:
//   Источник     - ЧтениеXML, Строка - Объект, из которого осуществляется загрузка правил обмена;
