...
Процедура ПриЗавершенииОперацииИзменения(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат.Статус <> "Выполнено" Тогда
		...
		МодульСтандартныеПодсистемыКлиент.ВывестиИнформациюОбОшибке(
	...
	Для Каждого РезультатИзменения Из РезультатыИзменений Цикл
		...
		Если РезультатВыполненияПорции.Статус = СтатусОшибка Тогда
			МодульСтандартныеПодсистемыКлиент = ОбщийМодуль("СтандартныеПодсистемыКлиент");
			МодульСтандартныеПодсистемыКлиент.ВывестиИнформациюОбОшибке(
				РезультатВыполненияПорции.ИнформацияОбОшибке);
		Иначе
...
Процедура ЗаполнитьРеквизитыОбъекта(БлокируемыеРеквизиты, НеРедактируемые, ФильтруемыеРеквизиты, ДоступныеРеквизиты)
	...
	ДобавитьВнешниеРеквизитыВНабор(НаборыРеквизитов, СписокВидовИзменяемыхОбъектов);
...
Процедура ДобавитьВнешниеРеквизитыВНабор(НаборыРеквизитов, СписокВидовИзменяемыхОбъектов)
	...
	Если МодульПользователиСлужебный = Неопределено
	 Или Не ВерсияБСППоддерживаетВнешниеРеквизитыПользователей() Тогда
		Возврат;
	КонецЕсли;
...
&НаСервере
Функция ВерсияБСППоддерживаетВнешниеРеквизитыПользователей()
	ОбработкаОбъект = РеквизитФормыВЗначение("Объект");
	Возврат ОбработкаОбъект.ВерсияБСППоддерживаетВнешниеРеквизитыПользователей();
КонецФункции
