...
Функция ЕстьОшибкаВВыражении(Знач Выражение, ТекстОшибки = "")
	...
	Попытка
		Возврат Вычислить(Выражение) = Неопределено; // Не нарушает безопасность информации, так как на клиенте вычисляется произвольный код, введенный только самим пользователем.
	Исключение
