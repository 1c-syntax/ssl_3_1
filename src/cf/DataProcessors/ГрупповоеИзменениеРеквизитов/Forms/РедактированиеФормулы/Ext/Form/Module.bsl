...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользуетсяДеревоОперандов = Параметры.ИспользуетсяДеревоОперандов;
	...
	Если ЗначениеЗаполнено(Параметры.ОперандыЗаголовок) Тогда
...
Функция ПолучитьСтандартноеДеревоОператоров()
	...
	ДобавитьОператор(Дерево, ГруппаОператоров, "=", " = ");
	ДобавитьОператор(Дерево, ГруппаОператоров, "<>", " <> ");
	ДобавитьОператор(Дерево, ГруппаОператоров, "И",      " " + "И"      + " ");
	ДобавитьОператор(Дерево, ГруппаОператоров, "Или",    " " + "Или"    + " ");
	ДобавитьОператор(Дерево, ГруппаОператоров, "Не",     " " + "Не"     + " ");
	ДобавитьОператор(Дерево, ГруппаОператоров, "ИСТИНА", " " + "ИСТИНА" + " ");
	ДобавитьОператор(Дерево, ГруппаОператоров, "ЛОЖЬ",   " " + "ЛОЖЬ"   + " ");
	
	ГруппаОператоров = ДобавитьГруппуОператоров(Дерево, НСтр("ru = 'Числовые функции'"));
	
	ДобавитьОператор(Дерево, ГруппаОператоров, "Макс", "Макс(,)", 2);
	ДобавитьОператор(Дерево, ГруппаОператоров, "Мин",  "Мин(,)", 2);
	ДобавитьОператор(Дерево, ГруппаОператоров, "Окр",  "Окр(,)", 2);
	ДобавитьОператор(Дерево, ГруппаОператоров, "Цел",  "Цел()", 1);
	
	ГруппаОператоров = ДобавитьГруппуОператоров(Дерево, НСтр("ru = 'Строковые функции'"));
	
	ДобавитьОператор(Дерево, ГруппаОператоров, "Строка", "Строка()");
	ДобавитьОператор(Дерево, ГруппаОператоров, "ВРег", "ВРег()");
	ДобавитьОператор(Дерево, ГруппаОператоров, "Лев", "Лев()");
	ДобавитьОператор(Дерево, ГруппаОператоров, "НРег", "НРег()");
	ДобавитьОператор(Дерево, ГруппаОператоров, "Прав", "Прав()");
	ДобавитьОператор(Дерево, ГруппаОператоров, "СокрЛ", "СокрЛ()");
	ДобавитьОператор(Дерево, ГруппаОператоров, "СокрЛП", "СокрЛП()");
	ДобавитьОператор(Дерево, ГруппаОператоров, "СокрП", "СокрП()");
	ДобавитьОператор(Дерево, ГруппаОператоров, "ТРег", "ТРег()");
	ДобавитьОператор(Дерево, ГруппаОператоров, "СтрЗаменить", "СтрЗаменить(,,)");
	ДобавитьОператор(Дерево, ГруппаОператоров, "СтрДлина", "СтрДлина()");
	...
	ДобавитьОператор(Дерево, ГруппаОператоров, "ПредопределенноеЗначение", "ПредопределенноеЗначение()");
	ДобавитьОператор(Дерево, ГруппаОператоров, "ЗначениеЗаполнено", "ЗначениеЗаполнено()");
...
Функция ПроверитьФормулу(Формула, Операнды)
	...
	Попытка
		РезультатРасчета = Вычислить(ТекстРасчета); // Не нарушает безопасность информации, так как на клиенте вычисляется произвольный код, введенный только самим пользователем.
	Исключение
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(ТекстОшибки, , "Формула");
		Возврат Ложь;
	КонецПопытки;
