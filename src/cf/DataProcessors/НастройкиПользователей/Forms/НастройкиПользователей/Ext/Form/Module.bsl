...
Процедура ПриОткрытии(Отказ)
	...
	Если НетПравНаПросмотр
	 Или Элементы.ОтчетИлиПредупреждение.ТекущаяСтраница = Элементы.ОтображатьПредупреждение Тогда
		Возврат;
	КонецЕсли;
...
#Область ПроцедурыИФункцииДляВыводаСписковНастроек
...
#Область ПроцедурыИФункцииДляРасчетаКоличестваНастроек
...
#Область ПроцедурыИФункцииОтвечающиеЗаКопированиеУдалениеИОчисткуНастроек
...
Процедура ОчиститьНастройкиВсехПользователейЗавершение(Ответ, ДополнительныеПараметры) Экспорт
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Очистка настроек'"), ,
		НСтр("ru = 'Очищены все настройки всех пользователя'"), БиблиотекаКартинок.ДиалогИнформация);
...
Процедура ОчиститьУстаревшиеНастройкиВсехПользователейЗавершение(Ответ, ДополнительныеПараметры) Экспорт
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Очистка настроек'"), ,
		НСтр("ru = 'Очищены устаревшие настройки всех пользователя'"), БиблиотекаКартинок.ДиалогИнформация);
...
Процедура ОчиститьВсеНастройкиЗавершение(Ответ, ДополнительныеПараметры) Экспорт
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Очистка настроек'"), , ТекстПояснения, БиблиотекаКартинок.ДиалогИнформация);
...
Процедура ОповеститьОбУдалении(КоличествоНастроек, НазваниеНастройки = Неопределено, КоличествоПользователей = Неопределено)
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Очистка настроек'"),
		, ТекстПояснения, БиблиотекаКартинок.ДиалогИнформация);
