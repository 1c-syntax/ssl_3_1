...
#Область ПроцедурыИФункцииОтвечающиеЗаПолучениеНастроекФорм
...
Функция СписокНастроекФорм(СписокФорм, ИмяПользователя)
	...
	Для Каждого Настройка Из Настройки Цикл
		...
		СтрокаРезультата = Результат.Найти(ИмяФормы, "Значение");
...
#Область ПроцедурыИФункцииОтвечающиеЗаКопированиеИУдалениеВсехНастроекПользователя
...
Процедура УдалитьУстаревшуюНастройку(Выборка, Хранилище, Контекст)
	...
	Если ЧастиИмени.Количество() > 3
	   И (    ВРег(ЧастиИмени[2]) = ВРег("Форма")
		  Или ВРег(ЧастиИмени[2]) = ВРег("Form")) Тогда // @Non-NLS
...
#Область ПроцедурыИФункцииОтвечающиеЗаКопированиеИУдалениеВыбранныхНастроекНастроек
...
#Область ПроцедурыИФункцииДляПолученияСпискаПользователейИГруппПользователей
...
Функция ОтчетыДоступныеПользователю(ИмяПользователяИБ, ПользовательСсылка)
	...
	ПользовательИБ = ?(ПользовательСсылка = Пользователи.АвторизованныйПользователь(),
		...
		ПользователиИнформационнойБазы.НайтиПоИмени(ИмяПользователяИБ));
...
#Область ПроцедурыИФункцииДляФормНастройкиПользователейИВыборНастроек
