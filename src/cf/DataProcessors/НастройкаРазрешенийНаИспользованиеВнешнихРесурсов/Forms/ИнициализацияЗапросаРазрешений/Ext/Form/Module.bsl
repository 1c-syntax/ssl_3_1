...
Функция НачатьОбработкуЗапросов(Знач Запросы, Знач РежимВключения, РежимОтключения, Знач РежимВосстановления, Знач РежимПроверкиПрименения)
	...
	НаименованиеЗадания = НСтр("ru = 'Обработка запросов на использование внешних ресурсов...'");
	...
	Если РежимВключения Тогда
		...
		Задание = ФоновыеЗадания.Выполнить("РаботаВБезопасномРежимеСлужебный.ВыполнитьОбработкуЗапросовОбновления",
	...
	ИначеЕсли РежимОтключения Тогда
		...
		Задание = ФоновыеЗадания.Выполнить("РаботаВБезопасномРежимеСлужебный.ВыполнитьОбработкуЗапросовОтключения",
			ПараметрыЗадания,, НаименованиеЗадания);
	...
	ИначеЕсли РежимВосстановления Тогда
		...
		Задание = ФоновыеЗадания.Выполнить("РаботаВБезопасномРежимеСлужебный.ВыполнитьОбработкуЗапросовВосстановления",
			ПараметрыЗадания,, НаименованиеЗадания);
	Иначе
		...
		Задание = ФоновыеЗадания.Выполнить("РаботаВБезопасномРежимеСлужебный.ВыполнитьОбработкуЗапросов",
			ПараметрыЗадания,, НаименованиеЗадания);
	КонецЕсли;
...
Процедура ОтменитьОбработкуЗапросов(Знач ИдентификаторЗадания)
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Настройка разрешений на использование внешних ресурсов.Отмена выполнения фонового задания'", ОбщегоНазначения.КодОсновногоЯзыка()),
