...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не РаботаВБезопасномРежимеСлужебный.ВозможноИспользованиеПрофилейБезопасности() Тогда
		ВызватьИсключение НСтр("ru = 'Недоступно использование профилей безопасности.'");
	КонецЕсли;
...
Процедура ПрофильБезопасностиИнформационнойБазыПриИзменении(Элемент)
	Если ТипЗнч(НаборКонстант.ПрофильБезопасностиИнформационнойБазы) <> Тип("Строка") Тогда
		НаборКонстант.ПрофильБезопасностиИнформационнойБазы = "";
	КонецЕсли;
