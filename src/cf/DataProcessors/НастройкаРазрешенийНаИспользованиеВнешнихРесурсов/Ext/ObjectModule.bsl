...
//  ДобавляемыеРазрешения - Массив Из ОбъектXDTO или Неопределено,
//  УдаляемыеРазрешения - Массив Из ОбъектXDTO или Неопределено.
//
...
//
// Возвращаемое значение:
//   Массив(Структура), поля структуры:
//                        * Операция - ПеречислениеСсылка.ОперацииАдминистрированияПрофилейБезопасности,
...
Процедура РассчитатьРезультатПримененияЗапросовБезУчетаВладельцев()
	...
	Для Каждого СтрокаРезультата Из РезультатПримененияЗапросовВРазрезеВладельцев Цикл
		...
		Для Каждого КлючИЗначение Из СтрокаРезультата.Разрешения Цикл
			...
			// Описания не должны влиять на хэш-суммы для варианта без учета владельцев.
...
//
// Возвращаемое значение:
//   Структура - см. АдминистрированиеКластера.СвойстваПрофиляБезопасности().
//
