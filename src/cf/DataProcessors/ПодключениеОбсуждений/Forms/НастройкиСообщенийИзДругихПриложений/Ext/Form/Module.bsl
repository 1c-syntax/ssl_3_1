...
&НаКлиенте
Процедура СоздатьБотаMax(Команда)
	...
	ОбсужденияСлужебныйКлиент.ПоказатьИнформациюОбИнтеграции(ЭтотОбъект, 
		Новый Структура("Тип", ОбсужденияСлужебныйКлиентСервер.ТипыВнешнихСистем().Max),
		Оповещение);
КонецПроцедуры
