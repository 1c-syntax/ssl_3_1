...
Процедура РасширенияФорматаВКомпонентыОбмена(КомпонентыОбмена)
	
	ДоступныеРасширенияФормата = ОбменДаннымиXDTOСервер.ДоступныеРасширенияФормата(КомпонентыОбмена.ВерсияФорматаОбмена);
	Для Каждого РасширениеФорматаОбмена Из ДоступныеРасширенияФормата Цикл
		
		ОбменДаннымиXDTOСервер.ВключитьПространствоИмен(КомпонентыОбмена,
