...
Функция МенеджерСервиса_СохранитьНастройкиВКорреспонденте(НастройкиПодключения)
	...
	МодульОбменДаннымиВМоделиСервиса.ОбновитьНастройкиТранспортаОбластиДанных(Параметры);
	...
	Попытка
		...
		МодульСообщенияОбменаДаннымиУправлениеИнтерфейс = ОбщегоНазначения.ОбщийМодуль("СообщенияОбменаДаннымиУправлениеИнтерфейс");
		
		// Отправляем сообщение корреспонденту.
		Сообщение = МодульСообщенияВМоделиСервиса.НовоеСообщение(
			МодульСообщенияОбменаДаннымиУправлениеИнтерфейс.СообщениеНастроитьОбменШаг1());
		...
		ПараметрыОбработчикаСессии.ИдентификаторОперации = МодульОбменДаннымиВМоделиСервиса.ОтправитьСообщение(Сообщение);
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(МодульОбменДаннымиВМоделиСервиса.СобытиеЖурналаРегистрацииНастройкаСинхронизацииДанных(),
