...
&НаКлиенте
Функция Подключаемый_ПолучениеПараметровКорреспондента_ПриОткрытии(Отказ, ПропуститьСтраницу, Знач ЭтоПереходДалее)
...
Процедура ЗаполнитьПараметрыКорреспондента(ПараметрыКорреспондента, КорреспондентВМоделиСервиса = Ложь)
	...
	ПоддерживаемыеОбъектыФормата = ОбменДаннымиXDTOСервер.ПоддерживаемыеОбъектыФормата(Объект.ИмяПланаОбмена);
	Если ТипЗнч(ПоддерживаемыеОбъектыФормата) = Тип("ТаблицаЗначений") Тогда
		
		Объект.ПоддерживаемыеОбъектыФормата = Новый ХранилищеЗначения(ПоддерживаемыеОбъектыФормата, Новый СжатиеДанных(9));
...
Процедура ЗаполнитьТаблицуПереходов()
	...
	Переход.ИмяОсновнойСтраницы     = "СтраницаПолучениеПараметровКорреспондента";
	Переход.ИмяСтраницыНавигации    = "СтраницаНавигацииОжидание";
	Переход.ИмяОбработчикаПриОткрытии = "Подключаемый_ПолучениеПараметровКорреспондента_ПриОткрытии";
