...
Процедура НастроитьОбщиеПараметрыПродолжение()
	...
	ОповещениеОЗакрытии = Новый ОписаниеОповещения("НастроитьОбщиеПараметрыЗавершение", ЭтотОбъект);
...
&НаКлиенте
Процедура НастроитьОбщиеПараметрыЗавершение(РезультатЗакрытия, ДополнительныеПараметры) Экспорт
