...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыОбработчика = НовыеПараметрыОбработчика(ОтборПоВариантамНастроек);
...
Процедура ПриЗавершенииПолученияВариантовНастроекОбменаДаннымиНаСервере()
	...
	Если (Настройки.Свойство("СтандартныеНастройки")
			И ТипЗнч(Настройки.СтандартныеНастройки) = Тип("ТаблицаЗначений")
			И Настройки.СтандартныеНастройки.Количество() > 0)
		ИЛИ (Настройки.Свойство("НастройкиВнешниеСистемы")
			И ТипЗнч(Настройки.НастройкиВнешниеСистемы) = Тип("Структура")
			И Настройки.НастройкиВнешниеСистемы.Свойство("ВариантыНастроек")
			И ТипЗнч(Настройки.НастройкиВнешниеСистемы.ВариантыНастроек) = Тип("ТаблицаЗначений")
			И Настройки.НастройкиВнешниеСистемы.ВариантыНастроек.Количество() > 0)
		Тогда
	...
	Иначе
		...
		Элементы.ПанельВариантыНастроек.ТекущаяСтраница  = Элементы.СтраницаНетНастроек;
...
&НаСервереБезКонтекста
Функция НовыеПараметрыОбработчика(Знач ОтборПоВариантамНастроек)
	
	ПараметрыОбработчика = Новый Структура;
	ПараметрыОбработчика.Вставить("ОтборПоВариантамНастроек", ОтборПоВариантамНастроек);
