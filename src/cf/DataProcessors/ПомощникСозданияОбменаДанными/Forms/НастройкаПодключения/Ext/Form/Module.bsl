...
Процедура ПрочитатьСтруктуруПараметровПодключенияПомощника(СтруктураНастроекПомощника)
	...
	Если СтрДлина(ИдентификаторИнформационнойБазыИсточника) = 36
		...
		Если ПланыОбмена[ИмяПланаОбменаКорреспондента].ЭтотУзел().Код <> ИдентификаторИнформационнойБазыИсточника
			И ОбменДаннымиСервер.УзлыПланаОбмена(ИмяПланаОбменаКорреспондента).Количество() > 0 Тогда
