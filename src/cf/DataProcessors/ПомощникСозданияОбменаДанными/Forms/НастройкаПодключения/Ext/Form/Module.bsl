...
Процедура ПриНачалеСохраненияНастроекПодключенияНаСервере(ПродолжитьОжидание)
	...
	Если ЭтоОбменСПриложениемВСервисе Тогда
		...
		Если НастройкаXDTO Тогда
			НастройкиПодключения.Вставить("НастройкиXDTOКорреспондента", Новый Структура);
			НастройкиПодключения.НастройкиXDTOКорреспондента.Вставить("ПоддерживаемыеВерсии", Новый Массив);
			НастройкиПодключения.НастройкиXDTOКорреспондента.Вставить("ПоддерживаемыеОбъекты", ПоддерживаемыеОбъектыФорматаКорреспондента);
