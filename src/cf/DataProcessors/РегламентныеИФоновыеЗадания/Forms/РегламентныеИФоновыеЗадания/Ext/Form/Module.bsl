...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		...
		Элементы.ТаблицаРегламентныеЗаданияОбновитьДанные.ТолькоВоВсехДействиях = Истина;
		Элементы.ТаблицаРегламентныеЗаданияНастроитьРасписание.ТолькоВоВсехДействиях = Истина;
