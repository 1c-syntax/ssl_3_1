...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Событие = "_$Access$_.Access" Тогда
		...
		Если ДанныеСобытия <> Неопределено И ДанныеСобытия.Свойство("Данные") Тогда
	...
	ИначеЕсли Событие = "_$Access$_.AccessDenied" Тогда
		...
		Если ДанныеСобытия <> Неопределено Тогда
			...
			Иначе
				...
				Иначе
					СоздатьТаблицуФормы("ТаблицаДанныхОтказаДействияДоступа", "ТаблицаДанных", ДанныеСобытия);
				КонецЕсли;
				Элементы.Комментарий.РастягиватьПоВертикали = Ложь;
				Элементы.Комментарий.Высота = 1;
			КонецЕсли;
...
&НаСервере
Процедура СоздатьТаблицуФормы(Знач ИмяПоляТаблицыФормы, Знач ИмяРеквизитаДанныеФормыКоллекция, Знач Данные)
