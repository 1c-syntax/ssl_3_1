...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПереданОтборПоДате = ЗначениеЗаполнено(Параметры.ДатаНачала)
		Или ЗначениеЗаполнено(Параметры.ДатаОкончания);
	
	Если МодельСервиса И Не ПереданОтборПоДате Тогда
