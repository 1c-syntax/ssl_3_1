...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.ОткрытиеИзСписка Тогда
...
Функция ВыполнитьЗагрузкуКурсов()
	...
	НаименованиеФоновогоЗадания = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		...
		Метаданные.РегламентныеЗадания.ЗагрузкаКурсовВалют.Синоним);
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(Метаданные.РегламентныеЗадания.ЗагрузкаКурсовВалют.ИмяМетода,
		ПараметрыЗагрузки, ПараметрыВыполнения);
