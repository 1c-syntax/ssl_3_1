...
Процедура ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан, ДополнительныеПараметры) Экспорт
	...
	СтандартныеПодсистемыСервер.УстановитьПараметрРаботыПрограммы(ИдентификаторКлассификатора(), КлассификаторXML);
	Обработан = Истина;
...
Функция КлассификаторВалют() Экспорт
	...
	Попытка
		...
		КлассификаторXML = СтандартныеПодсистемыСервер.ПараметрРаботыПрограммы(ИдентификаторКлассификатора());
	
	Исключение
		
		// Не удалось получить классификатор из кэша, будем использовать поставляемый из макета.
