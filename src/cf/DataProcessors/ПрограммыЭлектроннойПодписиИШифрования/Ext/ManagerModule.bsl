...
Процедура ДобавитьПоставляемыеНастройкиПрограмм(Настройки) Экспорт
	...
	Настройка.АлгоритмыХеширования.Добавить("GR 34.11-2012 256");
	Настройка.АлгоритмыШифрования.Добавить("GOST 28147-89");
	Настройка.АлгоритмыШифрования.Добавить("GR 34.12-15 M");
	Настройка.АлгоритмыШифрования.Добавить("GR 34.12-15 K");
	...
	Настройка.АлгоритмыШифрования.Добавить("kuznyechik-ctracpkm");
	Настройка.АлгоритмыШифрования.Добавить("magma-ctracpkm");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ru = 'Crypto-Pro Enhanced RSA and AES KC1 CSP'");
	Настройка.ИмяПрограммы        = "Crypto-Pro Enhanced RSA and AES KC1 CSP";
	...
	Настройка.Идентификатор       = "CryptoProEnhanced_RSA_AES_KC1";
	...
	Исключение
		...
		Если ВстроенныйКриптопровайдер <> Неопределено Тогда
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось обновить приложение ""%1"" по причине:
		...
		Иначе
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось добавить приложение ""%1"" по причине:
...
Функция АдресаСерверовМетокВремениПоУмолчанию() Экспорт
	...
	МассивАдресов.Добавить("http://pki.tax.gov.ru/tsp/tsp.srf");
...
Функция ПредставленияСвойствСубъектаСертификата() Экспорт
	...
	ПредставленияСвойств["ИмяОтчество"] = НСтр("ru = 'Имя Отчество'");
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ОбновитьНаименованиеВстроенногоКриптопровайдера");
