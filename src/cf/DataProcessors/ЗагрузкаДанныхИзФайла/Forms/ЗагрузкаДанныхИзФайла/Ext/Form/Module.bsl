...
Процедура ВыполнитьШагЗаполнениеТаблицыДаннымиНаСервере(ОписаниеСтрокиВыбора)
	...
	Если ТипЗнч(ОписаниеСтрокиВыбора) = Тип("Структура") И ОписаниеСтрокиВыбора.Свойство("Представление") Тогда
		ЭтотОбъект.Заголовок = НСтр("ru = 'Загрузка данных в справочник'") + " """ +ОписаниеСтрокиВыбора.Представление + """";
	Иначе
...
// 	КолонкиМакета - Массив из Структура - где:
// 	 См. ЗагрузкаДанныхИзФайлаКлиентСервер.ОписаниеКолонкиМакета
//
&НаСервере
...
// Параметры:
//  ПараметрыЗагрузкиИзФайла - Структура - где:
//   * Заголовок - Строка - 
//   * ОбязательныеКолонки - Массив - 
