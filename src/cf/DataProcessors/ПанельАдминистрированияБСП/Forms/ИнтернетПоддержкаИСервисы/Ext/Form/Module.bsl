...
&НаКлиенте
Процедура БИПИспользоватьОнлайнОплатыПриИзменении(Элемент)
	
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ОнлайнОплаты") Тогда
		МодульОнлайнОплаты = ОбщегоНазначенияКлиент.ОбщийМодуль("ОнлайнОплатыКлиент");
		МодульОнлайнОплаты.ИнтернетПоддержкаИСервисы_БИПОнлайнОплатыПриИзменении(
			ЭтотОбъект,
			Элемент);
	КонецЕсли;
...
&НаКлиенте
Процедура БИПИспользоватьАвтоматическоеПолучениеУведомленияОтОнлайнОплатПриИзменении(Элемент)
	
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ОнлайнОплаты") Тогда
		МодульПолучениеУведомленияОтОнлайнОплат = ОбщегоНазначенияКлиент.ОбщийМодуль("ОнлайнОплатыКлиент");
		МодульПолучениеУведомленияОтОнлайнОплат.ИнтернетПоддержкаИСервисы_ПолучениеУведомленияОтОнлайнОплатПриИзменении(
			ЭтотОбъект,
			Элемент);
	КонецЕсли;
...
Процедура ДекорацияРасписаниеПолученияУведомленийОтОнлайнОплатНажатие(Элемент)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ОнлайнОплаты") Тогда
		...
		МодульОнлайнОплатыКлиент =
			ОбщегоНазначенияКлиент.ОбщийМодуль("ОнлайнОплатыКлиент");
		МодульОнлайнОплатыКлиент.ИнтернетПоддержкаИСервисы_ДекорацияРасписаниеПолученияУведомленийОтОнлайнОплатНажатие(
			ЭтотОбъект,
			Элемент);
...
&НаКлиенте
Процедура БИПОткрытьНастройкиОнлайнОплат(Команда)
	
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ОнлайнОплаты") Тогда
		ФормаСписка = "Справочник.НастройкиОнлайнОплат.Форма.ФормаСписка";
...
&НаКлиенте
Процедура БИПОткрытьШаблоныСообщенийОнлайнОплат(Команда)
	...
	Если (ОбщегоНазначенияКлиент.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ОнлайнОплаты") 
		...
		МодульОнлайнОплатыКлиент.ИнтернетПоддержкаИСервисы_ОткрытьШаблоныСообщенийОнлайнОплат(УникальныйИдентификатор);
...
&НаКлиенте
Процедура БИПОткрытьШаблоныСообщенийСБП(Команда)
	
	Если (ОбщегоНазначенияКлиент.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ИнтеграцияСПлатежнымиСистемами") 
		И ОбщегоНазначенияКлиент.ПодсистемаСуществует("СтандартныеПодсистемы.ШаблоныСообщений")) Тогда
		
		МодульИнтеграцияСПлатежнымиСистемамиКлиент 
			= ОбщегоНазначенияКлиент.ОбщийМодуль("ИнтеграцияСПлатежнымиСистемамиКлиент");
		МодульИнтеграцияСПлатежнымиСистемамиКлиент.ИнтернетПоддержкаИСервисы_ОткрытьШаблоныСообщенийСБП(
...
&НаКлиенте
Процедура БИПИнформационноТехнологическоеСопровождение(Команда)
