...
Процедура ОткрытьШаблоныСообщений(Команда)
	...
	МодульОнлайнОплатыСлужебныйВызовСервера =
		ОбщегоНазначенияКлиент.ОбщийМодуль("ОнлайнОплатыСлужебныйВызовСервера");
	
	РезультатПроверки = МодульОнлайнОплатыСлужебныйВызовСервера.ВсеШаблоныСозданы();
	
	Если РезультатПроверки.ВсеШаблоны Тогда
		
		МодульОнлайнОплатыСлужебныйКлиент =
			ОбщегоНазначенияКлиент.ОбщийМодуль("ОнлайнОплатыСлужебныйКлиент");
		
		МодульОнлайнОплатыСлужебныйКлиент.ОткрытьФормуШаблонаСообщенийСОтбором(
