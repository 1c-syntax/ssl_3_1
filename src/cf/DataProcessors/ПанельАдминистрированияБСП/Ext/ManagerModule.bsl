...
Процедура ПриДобавленииПереименованийОбъектовМетаданных(Переименования) Экспорт
	...
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "2.2.1.12",
		"Подсистема.НастройкаИАдминистрирование", "Подсистема.Администрирование", "СтандартныеПодсистемы");
...
Процедура ПриОпределенииРазделовСВариантамиОтчетов(Разделы) Экспорт
	...
	Если Подсистема <> Неопределено Тогда
		Разделы.Добавить(Подсистема, НСтр("ru = 'Отчеты администратора'"));
	КонецЕсли;
