...
Процедура ВидСвойствПриИзменении(Элемент)
	...
	Объект.ВидСвойства = ВидСвойства;
	Если Объект.ВидСвойства = ПредопределенноеЗначение("Перечисление.ВидыСвойств.ДополнительныеСведения") Тогда
...
Процедура Подключаемый_РазрешитьРедактированиеРеквизитовОбъекта(Команда)
	...
	Если ЗаблокированныеРеквизиты.Количество() > 0 Тогда
		...
		ПараметрыФормы.Вставить("ВидСвойства", Объект.ВидСвойства);
...
Процедура СвойствоСерое(Команда)
	...
	УстановитьЦветМетки(ЭтотОбъект, Объект.ЦветСвойства);
...
Процедура ЗаполнитьСтраницуВыбора()
	...
	Если ПереданныеПараметрыФормы.ВидСвойства <> Неопределено Тогда
		ВидСвойства = ПереданныеПараметрыФормы.ВидСвойства;
	КонецЕсли;
	...
	Для Каждого Ссылка Из Наборы Цикл
		...
		Если ВидСвойства = Перечисления.ВидыСвойств.ДополнительныеСведения И ВидыСвойствНабора.ДополнительныеСведения
			ИЛИ ВидСвойства = Перечисления.ВидыСвойств.ДополнительныеРеквизиты И ВидыСвойствНабора.ДополнительныеРеквизиты
			ИЛИ ВидСвойства = Перечисления.ВидыСвойств.Метки И ВидыСвойствНабора.Метки Тогда
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		НаборыСвойств, "ВидСвойства", ВидСвойства, Истина);
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		ОбщиеНаборыСвойств, "ВидСвойства", ВидСвойства, Истина);
	
	ПредставлениеСписка = "";
	Если ВидСвойства = ПредопределенноеЗначение("Перечисление.ВидыСвойств.ДополнительныеСведения") Тогда
		ПредставлениеСписка = НСтр("ru = 'Неиспользуемые дополнительные сведения'");
	ИначеЕсли ВидСвойства = ПредопределенноеЗначение("Перечисление.ВидыСвойств.ДополнительныеРеквизиты") Тогда
		ПредставлениеСписка = НСтр("ru = 'Неиспользуемые дополнительные реквизиты'");
	ИначеЕсли ВидСвойства = ПредопределенноеЗначение("Перечисление.ВидыСвойств.Метки") Тогда
...
Процедура ЗаполнитьКарточкуСвойства()
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		Элементы.ВидСвойства.Доступность = Ложь;
	...
	Иначе
		...
		Если ПереданныеПараметрыФормы.ВидСвойства <> Неопределено Тогда
			Объект.ВидСвойства = ПереданныеПараметрыФормы.ВидСвойства;
			Если Объект.ВидСвойства = Перечисления.ВидыСвойств.ДополнительныеСведения Тогда
				Объект.ЭтоДополнительноеСведение = Истина;
			КонецЕсли;
		ИначеЕсли НЕ ЗначениеЗаполнено(ПереданныеПараметрыФормы.ЗначениеКопирования) Тогда
			Элементы.ВидСвойства.Видимость = Истина;
		КонецЕсли;
	КонецЕсли;
	...
	ВидСвойства = Объект.ВидСвойства;
...
Процедура УточнениеНаборовКомментарийНажатиеЗавершение(ВыбранныйЭлемент, ВыбранныйНабор) Экспорт
	...
	Если ВыбранныйНабор <> Неопределено Тогда
		...
		Если Не ЗначениеЗаполнено(Объект.ВидСвойства)
			И Объект.ЭтоДополнительноеСведение Тогда
			ЗначениеВыбора.Вставить("ВидСвойства", ПредопределенноеЗначение("Перечисление.ВидыСвойств.ДополнительныеСведения"));
		ИначеЕсли Не ЗначениеЗаполнено(Объект.ВидСвойства)
			И Не Объект.ЭтоДополнительноеСведение Тогда
			ЗначениеВыбора.Вставить("ВидСвойства", ПредопределенноеЗначение("Перечисление.ВидыСвойств.ДополнительныеРеквизиты"));
		Иначе
			ЗначениеВыбора.Вставить("ВидСвойства", Объект.ВидСвойства);
		КонецЕсли;
...
Процедура УстановитьНастройкиПомощника(ТекущаяСтраница = Неопределено)
	...
	Если ТекущаяСтраница = Элементы.ВыборРеквизита Тогда
		...
		Если ПереданныеПараметрыФормы.ВидСвойства =
		...
		ИначеЕсли ПереданныеПараметрыФормы.ВидСвойства =
...
Процедура ОбновитьСоставЭлементовФормы(ТекстПредупреждения = "")
	...
	Если Объект.ВидСвойства = Перечисления.ВидыСвойств.Метки Тогда
		...
		Если Не ЗначениеЗаполнено(Объект.ЦветСвойства) Тогда
	...
	Иначе
		...
		СвойстваВладельца = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
			Объект.ВладелецДополнительныхЗначений, "Заголовок, ВидСвойства");
		
		Если СвойстваВладельца.ВидСвойства = Перечисления.ВидыСвойств.ДополнительныеСведения Тогда
			ШаблонУточнения = НСтр("ru = 'Список значений общий со сведением ""%1""'");
		ИначеЕсли СвойстваВладельца.ВидСвойства = Перечисления.ВидыСвойств.Метки Тогда
	...
	Иначе
		...
		Если СписокНаборов.Количество() = 0 Тогда
			...
			Если Объект.ВидСвойства = Перечисления.ВидыСвойств.ДополнительныеСведения
				Или Объект.ЭтоДополнительноеСведение Тогда
				ТекстКомментария = НСтр("ru = 'Сведение не входит в наборы'");
			ИначеЕсли Объект.ВидСвойства = Перечисления.ВидыСвойств.Метки Тогда
...
Процедура ЗаполнитьСписокДействийПриДобавленииРеквизита()
	...
	Если ПереданныеПараметрыФормы.ВидСвойства = Перечисления.ВидыСвойств.ДополнительныеСведения Тогда
		...
		КонецЕсли;
	ИначеЕсли ПереданныеПараметрыФормы.ВидСвойства = Перечисления.ВидыСвойств.Метки Тогда
...
Процедура СоздатьСтруктуруПереданныхПараметров()
	...
	ПереданныеПараметрыФормы.Вставить("ВидСвойства");
